...
int main()
 ...
 LBL_10:;
   ...
   for(I=1;I<=10;I++)
   {
      if (N >  5)
      {
         SCR1C(I)=SCR1B(10)+SCR1C(10);
      }
      else
      {
         SCR1D(I)=SCR1D(10)*2;
      }
      SCR1D(I)=SCR1D(10)+SCR1A(I)+SCR1C(I);
      SCR1C(I)=SCR1D(I);
      SCR1B(I)=SCR1D(I);
 LBL_20:;
   }
   for(I=1;I<=10;I+=2)
   {
      ...
      if (M >  5)
      {
         SCR3C(I)=SCR3B(10)+SCR3C(10);
      }
      else
      {
         SCR3D(I)=SCR3D(10)*2;
      }
      SCR3D(I)=SCR4D(10)+SCR3A(I);
      SCR3C(I)=SCR3D(I);
      SCR3B(I)=SCR3D(I);
 LBL_30:;
   }
   for(I=10;I<=30;I++)
   {
      if (I >  20)
      {
         ...
         if (N <  100) SCR4B(I)=SCR4B(30);
         SCR1C(I)=SCR1B(I)+SCR1C(I)+SCR1D(30);
         if (M+10 != 99) SCR4C(I)=SCR4C(I)+SCR4C(30);
   ...
   for(J=30;J<=33;J++)
   {
      for(I=10;I<=30;I++)
      {
         if (I >  20)
         {
            ...
            if (SCR1A(30) >  -9999999.0) SCR1A(I)=SCR1A(30);
            SCR2C(I)=SCR2B(I)+SCR2C(I)+SCR2D(30)+SCR2D(30);
            SCR2D(I)=SCR2C(I)+SCR2D(I)+SCR2D(30)+SCR2D(J);
         }
         else
         {
            SCR3A(I)=SCR3D(30)+SCR3D(30)+SCR3C(30)+SCR3D(30);
            SCR3B(I)=SCR3A(I)+SCR3B(I)+J;
            if (SCR4A(30) >  -9999999.0) SCR4A(I)=SCR4A(30);
   ...
   for(J=2;J<=6;J++)
   {
      for(I=10;I<=30;I+=2)
      {
         if (SCR1A(100) <  1000000)
         {
            ...
            if (SCR1A(30) >  -1000000+J)goto LBL_333         ;
 LBL_111:;
