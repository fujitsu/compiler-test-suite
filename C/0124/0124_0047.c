...
int main()
  {
   ...
   for(I=1;I<=50;I++)
   {
      SCR1A(I)  =(0.5+pow(SCR1A(I+1),J));
      SCR1A(I+1)=(0.5+pow(SCR1A(I+2),J));
      SCR1B(I)  =(0.5+pow(SCR1A(I+1),J));
      SCR1B(I+1)=(0.5+pow(pow(pow(SCR1A(I+2),J),SCR1A(I+2)),SCR1A(I+1)));
      SCR1C(I)  =(0.5+pow(SCR1A(I+1),J));
      SCR1C(I+1)=(0.5+pow(SCR1A(I+2),J));
      SCR1D(I)  =(0.5+pow(SCR1A(I+1),J));
      SCR1D(I+1)=(0.5+pow((J+1),SCR1A(I+2)));
 LBL_10:;
   }
   for(J=1;J<=2;J++)
   {
      for(I=1;I<=50;I++)
      {
         ...
         SCR2B(I)  =(0.5+pow(SCR1A(I+1),J));
         SCR2B(I+1)=(0.5+pow(SCR1A(I+2),I));
         SCR2B(I+2)=(0.5+pow(pow(SCR1A(I+2),I),SCR1A(I+2)));
         SCR2C(I)  =SCR1A(I+3)+1;
 ...
 LBL_20:;
   ...
   for(I=1;I<=N;I++)
   {
      ...
      if (I <= 96)
      {
         SCR3A(I+2)=(0.5+pow(SCR1A(I+3),(int)(VLR1B(I))));
         SCR3A(I+3)=(0.5+pow(SCR1A(I+3),(int)(VLR1B(I))));
         SCR3B(I)  =SCR1A(I+1)+1;
 ...
 LBL_30:;
   ...
   for(I=1;I<=N-12;I++)
   {
      ...
      SCR4A(I+4)=(0.5+pow(SCR1A(I+3),abs(N-98)));
      SCR4B(I)  =SCR1A(I+1)+1;
      SCR4B(I+1)=(0.5+pow(SCR1A(I+2),abs(N-98)));
      SCR4B(I+2)=SCR1A(I+2)+1;
      SCR4B(I+3)=(0.5+pow(SCR1A(I+2),abs(N-97)));
 ...
 LBL_110:;
      ...
      for(J=1;J<=2;J++)
      {
         for(I=1;I<=50;I++)
         {
            ...
            SCR2A(I+1)=SCR1A(I+2)+1;
            SCR2A(I+2)=SCR1A(I+3)+1;
            SCR2B(I)  =(0.5+pow(SCR1A(I+1),KKK));
            SCR2B(I+1)=(0.5+pow(SCR1A(I+2),I));
            SCR2B(I+2)=(0.5+pow(pow(SCR1A(I+2),J),KKK));
            SCR2C(I)  =SCR1A(I+3)+1;
            SCR2C(I+1)=SCR1A(I+2)+1;
 ...
 LBL_120:;
      ...
      for(I=1;I<=N;I++)
      {
         ...
         {
            SCR3A(I+2)=(0.5+pow(SCR1A(I+3),(int)(VLR1B(I))));
            SCR3A(I+3)=(0.5+pow(SCR1A(I+3),(int)(VLR1B(I))+1));
            SCR3B(I)  =(0.5+pow(SCR1A(I+1),KKK));
            SCR3B(I+1)=(0.5+pow(SCR1A(I+2),I));
            SCR3B(I+2)=(0.5+pow(SCR1A(I+2),I));
            SCR3B(I+3)=SCR1A(I+2)+1;
            SCR3C(I)  =SCR1A(I+3)+1;
            SCR3C(I+1)=SCR1A(I+2)+1;
            SCR3C(I+2)=SCR1A(I+2)+1;
            SCR3C(I+3)=SCR1A(I+2)+1;
            SCR3D(I)  =(0.5+pow(SCR1A(I+3),KKK));
            SCR3D(I+1)=SCR1A(I+2)+1;
            SCR3D(I+2)=SCR1A(I+2)+1;
            SCR3D(I+3)=SCR1A(I+2)+1;
         }
 LBL_130:;
      ...
      for(I=1;I<=N-20;I+=2)
      {
         SCR4A(I)  =SCR1A(I+1)+1;
         SCR4A(I+1)=SCR1A(I+2)+1;
         SCR4A(I+2)=(0.5+pow(SCR1A(I+3),KKK));
         SCR4A(I+3)=(0.5+pow(SCR1A(I+3),I));
         SCR4A(I+4)=SCR1A(I+3)+1;
         SCR4B(I)  =(0.5+pow(SCR1A(I+1),KKK));
