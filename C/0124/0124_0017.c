...
int main()
  {
   ...
   for(I=1;I<=100;I++)
   {
      VLR3B(I)=(pow(VLR3A(I),VLR3A(I))+0.5);
      VLR3C(I)=VLR3B(I)+VLR3A(I);
   }
   printf("** LABEL :  31 ** \n");
   for(I=1;I<=50;I++)
   {
      if (I >  25) VLR3B(I)=(pow(VLR3A(I),VLR3A(I)+0.5));
      if (I <= 25) VLR3B(I)=I;
      VLR3C(I)=VLR3B(I)+VLR3A(I);
   }
   printf("** LABEL :  40 ** \n");
   ...
   for(I=1;I<=10;I++)
   {
      VLR3B(I)=(pow((double)VLR3A(I),(double)(VLR3A(I))+0.5));
      if (I >= 5)
      {
         VLR3B(I)=(pow(VLR3B(I),VLR3B(I))+0.5)+2;
      }
      else
      {
         VLR3B(I)=(pow(VLR3B(I),VLR3A(I))+0.5)*2;
      } 
      VLR3B(I)=(pow(VLR3A(I),VLR3A(I))+0.5);
