...
static void sub01 (double a[][100],double b[][100],double c[][100],
	    double not_art1[][100],double not_art2[][100], int i);
...
int lto_sub_10(void) {
  ...
  for(i=0; i<100; ++i) {
    sub01(a,b,c,not_art1,not_art2,i);
  }
  ...
  for(i=0; i<100; ++i) {
    sub02(a,b,c,not_art1,not_art2,i);
  }
  ...
  for(i=0; i<100; ++i) {
    sub03(a,b,c,not_art1,not_art2,i);
  }
  print_each_sum(a,b,c,not_art1,not_art2,3);

  
  for(i=0; i<100; ++i) {
    sub04(a,b,c,not_art1,not_art2,i);
  }
  ...
  for(i=0; i<100; ++i) {
    sub05(a,b,c,not_art1,not_art2,i);
  }
  ...
  for(i=0; i<100; ++i) {
    sub06(a,b,c,not_art1,not_art2,i);
  }
  print_each_sum(a,b,c,not_art1,not_art2,6);

  
  for(i=0; i<100; ++i) {
    sub07(a,b,c,not_art1,not_art2,i);
  }
