...
static short sub_short(short j, short i, short n) {
 ...
 int 
lto_sub_23 (void) {
  printf("%s\n",sub_int(1,5,3) == 12 ? "sub_int:ok":"sub_int:ng");
  printf("%s\n",sub_uint(1,5,3) == 12 ? "sub_uint:ok":"sub_uint:ng");
  printf("%s\n",sub_lint(1,5,3) == 12 ? "sub_lint:ok":"sub_lint:ng");
  printf("%s\n",sub_ulint(1,5,3) == 12 ? "sub_ulint:ok":"sub_ulint:ng");
  printf("%s\n",sub_float(1.0,5.0,3.0) == 12.0 ? "sub_float:ok":"sub_float:ng");
  printf("%s\n",sub_double(1.0,5.0,3.0) == 12.0 ? "sub_double:ok":"sub_double:ng");
  printf("%s\n",sub_ldouble(1.0,5.0,3.0) == 12.0 ? "sub_ldouble:ok":"sub_ldouble:ng");
  printf("%s\n",sub_short(1,5,3) == 12 ? "sub_short:ok":"sub_short:ng");
}
