...
long fxtestdsp29( seltype_2**   p, seltype_1**   q, seltype_distance n )
{
	long i;
	seltype_2** p_base;
	seltype_1** q_base;
...
long fxtestdsp_scl_29(  seltype_2** scl_p, seltype_1** scl_q, seltype_distance n )
{
	long i;
	seltype_2** scl_p_base;
	seltype_1** scl_q_base;
...
long fxtestdsp30( seltype_2**   p, seltype_1**   q, seltype_distance n )
{
	long i;
	for( i=1; i<100; i++){
		**(p+(100-i))=**(q+(100-i)) OPRTN;
...
long fxtestdsp_scl_30(  seltype_2** scl_p, seltype_1** scl_q, seltype_distance n )
{
	long i;
	for( i=1; i<100; i++){
		**(scl_p+(100-i))=**(scl_q+(100-i)) OPRTN;
...
long fxtestdsp31( seltype_2**   p, seltype_1**   q, seltype_distance n )
{
	long i;
	for( i=1; i<100; i++){
		**(p+(100-i))=**(q+(100-i)) OPRTN;
...
long fxtestdsp_scl_31(  seltype_2** scl_p, seltype_1** scl_q, seltype_distance n )
{
	long i;
	for( i=1; i<100; i++){
		**(scl_p+(100-i))=**(scl_q+(100-i)) OPRTN;
