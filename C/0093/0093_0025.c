...
int main( ) {
  ...
  i8 = ai8[1];         
                       if (i8==3ll)  printf("** (1) ** OK\n");
                       else         printf("** (1) ** NG i8=%d\n", i8);                                
                       pi8=pi8_area;
                       *pi8=ai8[0];
  i8 = *pi8;                   
                       if (i8==3ll)  printf("** (2) ** OK\n");
                       else         printf("** (2) ** NG i8=%d\n", i8);                                
                       si8=&si8_area;
                       for (i=0;i<10;i++) si8->r_ai8[i]=111ll;i=2;
  i8 = si8->r_ai8[i];  
                       if (i8==111ll) printf("** (3) ** OK\n");
                       else         printf("** (3) ** NG i8=%d\n", i8);                                
                       for (i=0;i<10;i++) au8[i]=3ll;
  u8 = au8[1];         
                       if (u8==3ll )  printf("** (4) ** OK\n");
                       else         printf("** (4) ** NG u8=%d\n", u8);                                
                       pu8=pu8_area;
                       *pu8=au8[0];
  u8 = *pu8;                   
                       if (u8==3ll )  printf("** (5) ** OK\n");
                       else         printf("** (5) ** NG u8=%d\n", u8);                                
                       su8=&su8_area;
                       for (i=0;i<10;i++) su8->r_au8[i]=111ll;i=2;
  u8 = su8->r_au8[i];  
                       if (u8==111ll) printf("** (6) ** OK\n");
                       else         printf("** (6) ** NG u8=%d\n", u8);                                
}  
