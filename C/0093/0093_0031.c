...
signed long long int  subi8( );
 ...
 i8 = i1; 
          if (i8==ai8) printf("**(27)** OK\n");
          else         printf("**(27)** NG i8=%d\n",i8);
 i8 = i2; 
          if (i8==ai8) printf("**(27)** OK\n");
          else         printf("**(27)** NG i8=%d\n",i8);
 i8 = i4; 
          if (i8==ai8) printf("**(28)** OK\n");
          else         printf("**(28)** NG i8=%d\n",i8);
 i8 = u1; 
          if (i8==ai8) printf("**(29)** OK\n");
          else         printf("**(29)** NG i8=%d\n",i8);
 i8 = u2;
          if (i4==ai8) printf("**(30)** OK\n");
          else         printf("**(30)** NG i8=%d\n",i8);
 i8 = u4;
          if (i4==ai8) printf("**(30)** OK\n");
          else         printf("**(30)** NG i8=%d\n",i8);
 i8 = u8; 
 ...
 u8 = i1; 
          if (u8==au8) printf("**(27)** OK\n");
          else         printf("**(27)** NG u8=%d\n",u8);
 u8 = i2; 
          if (u8==au8) printf("**(27)** OK\n");
          else         printf("**(27)** NG u8=%d\n",u8);
 u8 = i4; 
          if (u8==au8) printf("**(28)** OK\n");
          else         printf("**(28)** NG u8=%d\n",u8);
 u8 = i8; 
          if (u8==au8) printf("**(28)** OK\n");
          else         printf("**(28)** NG u8=%d\n",u8);
 u8 = u1; 
          if (u8==au8) printf("**(29)** OK\n");
          else         printf("**(29)** NG u8=%d\n",u8);
 u8 = u2;
          if (u4==au8) printf("**(30)** OK\n");
          else         printf("**(30)** NG u8=%d\n",u8);
 u8 = u4;
          if (u4==au8) printf("**(30)** OK\n");
          else         printf("**(30)** NG u8=%d\n",u8);
}
