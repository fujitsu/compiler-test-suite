...
int main(){
  ...
  x.b07=i1; 
            if (x.b07==1) printf("*(01)** OK \n");
            else          printf("*(01)** NG x.b07=%.64x\n",x.b07);
  x.b08=i1; 
            if (x.b08==1) printf("*(02)** OK \n");
            else          printf("*(02)** NG x.b08=%.64x\n",x.b08);
  x.b01=i2; 
  ...
  x.b07=i2; 
            if (x.b07==0) printf("*(03)** OK \n");
            else          printf("*(03)** NG x.b07=%.64x\n",x.b07);
  x.b08=i2; 
            if (x.b08==0) printf("*(04)** OK \n");
            else          printf("*(04)** NG x.b08=%.64x\n",x.b08);
  x.b01=i4;
  ...
  x.b07=i4; 
            if (x.b07==1) printf("*(05)** OK \n");
            else          printf("*(05)** NG x.b07=%.64x\n",x.b07);
  x.b08=i4; 
            if (x.b08==1) printf("*(06)** OK \n");
            else          printf("*(06)** NG x.b08=%.64x\n",x.b08);
  ...
  y.b07=i8; 
            if (y.b07==1) printf("*(07)** OK \n");
            else          printf("*(07)** NG y.b07=%.64x\n",x.b07);
  y.b08=i8; 
            if (y.b08==1) printf("*(08)** OK \n");
            else          printf("*(08)** NG y.b08=%.64x\n",y.b08);
