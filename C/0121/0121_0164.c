...
LBL_10:
	...
	printf(" #####  #####\n");
	printf(" ----- TEST NO.1 ----- MASK OPTIMIZATION        \n");
	printf("                    APPEARING LOWER SAB         \n");
	for(I=1;I<=L1;I++)
	{
		for(J=1;J<=L2;J++)
		{
...
LBL_110:
	...
	printf("\n");
	printf(" ----- TEST NO.2 ----- MASK OPTIMIZATION      \n");
	printf("                       IN THE MIDDLE          \n");
	for(I=1;I<=L1;I++)
	{
		RB1(I)=sin(RB1(I))*RB1(I)+2.5;
		RA1(I)=RB1(I)+RC1(I);
		for(J=1;J<=L2;J++)
		{
			if (LA3(I,2,2)==1)
...
LBL_37:
				;
				RC2(I,J)=sin(RB2(I,J))*RB2(I,J);
				RA2(I,J)=RB2(I,J)+RC2(I,J);
				DA2(I,J)=sin(DA2(I,J))*DA2(I,J)+cos(DA2(I,J));
LBL_41:
				;
			}
		}
