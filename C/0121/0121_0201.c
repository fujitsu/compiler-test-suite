...
LBL_10:
	...
	for(i=1;i<=10;i++){
		printf(" %ld %g %g %ld %g %g %g \n",
		    I1(i),R1(i),RD1(i),L2(i),R2(i),C1(i).real,C1(i).imag);
	}
	printf("  NO.2   LOGICAL IF \n");
	for(I=1;I<=N;I++)
	{
...
LBL_20:
	...
	for(I=1;I<=N;I++)
	{
		if ((R1(I) - R2(I)) < 0)goto LBL_31;
		if ((R1(I) - R2(I)) ==0)goto LBL_32;
		goto LBL_33;
LBL_33:
		;
		I21(I)=I;
		R21(I)=sqrt((float)(I));
		RD21(I)=sqrt((double)(R21(I)));
