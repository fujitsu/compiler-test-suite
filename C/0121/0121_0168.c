...
LBL_10:
	...
	printf(" #####  #####\n");
	printf(" ----- TEST NO.1 ----- EXTENDED DO RANGE        \n");
	printf("                       DOUBLY NESTED DO         \n");
	for(J=1;J<=L1;J++)
	{
		for(K=1;K<=L2;K++)
		{
...
LBL_1553:
	...
	printf("\n");
	printf(" ----- TEST NO.2 ----- EXTENDED DO RANGE        \n");
	printf("                       NEST LEVEL THREE         \n");
	for(I=1;I<=L1;I++)
	{
		for(J=1;J<=L2;J++)
		{
...
LBL_1653:
	...
	printf("\n");
	printf(" ----- TEST NO.3 ----- DO LOOP WITH A JUMP      \n");
	printf("                       NEST LEVEL THREE         \n");
	for(I=1;I<=L1;I++)
	{
		for(J=1;J<=L2;J++)
		{
			for(K=1;K<=L3;K++)
			{
				if (RA3(I,J,K) == 0.0) goto LBL_1753;
				RA3(I,J,K)=RA3(I,J,K)*RC3(I,J,K);
LBL_1700:
				;
			}
...
LBL_1753:
	...
	printf("\n");
	printf(" ----- TEST NO.3 ----- EXTENDED DO RANGE        \n");
	printf("       TAKING PLACE AT TWO DIFFERENT POINTS     \n");
	for(I=1;I<=L1;I++)
	{
		for(J=1;J<=L2;J++)
		{
