...
static double d11[10],d12[10],d13[10];
static double d21[10][10],d22[10][10],d23[10][10];
static double d31[10][10][10],d32[10][10][10],d33[10][10][10];
static double d41[8][8][8][8],d42[8][8][8][8];
static double d51[5][5][5][5][5],d52[5][5][5][5][5];
static double d61[5][3][3][3][3][2],d62[5][3][3][3][3][2];
static float e11[10],e12[10],e13[10];
static float e21[10][10],e22[10][10],e23[10][10];
static float e31[10][10][10],e32[10][10][10],e33[10][10][10];
static float e41[8][8][8][8],e42[8][8][8][8];
static float e51[5][5][5][5][5],e52[5][5][5][5][5];
static float e61[5][3][3][3][3][2],e62[5][3][3][3][3][2];
static COMPLEX16 cd11[10],cd12[10],cd13[10];
static COMPLEX16 cd21[10][10],cd22[10][10],cd23[10][10];
static COMPLEX16 cd31[10][10][10],cd32[10][10][10],cd33[10][10][10];
static COMPLEX16 cd41[8][8][8][8],cd42[8][8][8][8];
static COMPLEX16 cd51[5][5][5][5][5],cd52[5][5][5][5][5];
static COMPLEX16 cd61[5][3][3][3][3][2],cd62[5][3][3][3][3][2];
static COMPLEX16 cds1,cds2,cds3;
static COMPLEX8 ce11[10],ce12[10],ce13[10];
static COMPLEX8 ce21[10][10],ce22[10][10],ce23[10][10];
static COMPLEX8 ce31[10][10][10],ce32[10][10][10],ce33[10][10][10];
static COMPLEX8 ce41[8][8][8][8],ce42[8][8][8][8];
static COMPLEX8 ce51[5][5][5][5][5],ce52[5][5][5][5][5];
static COMPLEX8 ce61[5][3][3][3][3][2],ce62[5][3][3][3][3][2];
static COMPLEX8 ces1,ces2,ces3;
static long int n11[10],n12[10],n13[10];
static long int n21[10][10],n22[10][10],n23[10][10];
static long int n31[10][10][10],n32[10][10][10],n33[10][10][10];
static long int n41[8][8][8][8],n42[8][8][8][8];
static long int n51[5][5][5][5][5],n52[5][5][5][5][5];
static long int n61[5][3][3][3][3][2],n62[5][3][3][3][3][2];
static unsigned long int l11[10],l12[10],l13[10];
static unsigned long int l21[10][10],l22[10][10],l23[10][10];
static unsigned long int l31[10][10][10],l32[10][10][10],l33[10][10][10];
static unsigned long int l41[8][8][8][8],l42[8][8][8][8];
static unsigned long int l51[5][5][5][5][5],l52[5][5][5][5][5];
static unsigned long int l61[5][3][3][3][3][2],l62[5][3][3][3][3][2];
int INITR(double d11[10], double d12[10], double d13[10],
	  double *DS1, double *DS2, double *DS3,
	  double d21[10][10], double d22[10][10], double d23[10][10],
	  double d31[10][10][10], double d32[10][10][10], double d33[10][10][10],
	  double d41[8][8][8][8], double d42[8][8][8][8],
	  double d51[5][5][5][5][5], double d52[5][5][5][5][5],
	  double d61[5][3][3][3][3][2], double d62[5][3][3][3][3][2],
	  float e11[10], float e12[10], float e13[10],
	  float *ES1, float *ES2, float *ES3,
	  float e21[10][10], float e22[10][10], float e23[10][10],
	  float e31[10][10][10], float e32[10][10][10], float e33[10][10][10],
	  float e41[8][8][8][8], float e42[8][8][8][8],
	  float e51[5][5][5][5][5], float e52[5][5][5][5][5],
	  float e61[5][3][3][3][3][2], float e62[5][3][3][3][3][2]);
int INITC(COMPLEX16 cd11[10], COMPLEX16 cd12[10], COMPLEX16 cd13[10],
	  COMPLEX16 *cds1, COMPLEX16 *cds2, COMPLEX16 *cds3,
	  COMPLEX16 cd21[10][10], COMPLEX16 cd22[10][10], COMPLEX16 cd23[10][10],
	  COMPLEX16 cd31[10][10][10], COMPLEX16 cd32[10][10][10], COMPLEX16 cd33[10][10][10],
	  COMPLEX16 cd41[8][8][8][8], COMPLEX16 cd42[8][8][8][8],
	  COMPLEX16 cd51[5][5][5][5][5], COMPLEX16 cd52[5][5][5][5][5],
	  COMPLEX16 cd61[5][3][3][3][3][2], COMPLEX16 cd62[5][3][3][3][3][2],
	  COMPLEX8 ce11[10], COMPLEX8 ce12[10], COMPLEX8 ce13[10],
	  COMPLEX8 *ces1, COMPLEX8 *ces2, COMPLEX8 *ces3,
	  COMPLEX8 ce21[10][10], COMPLEX8 ce22[10][10], COMPLEX8 ce23[10][10],
	  COMPLEX8 ce31[10][10][10], COMPLEX8 ce32[10][10][10], COMPLEX8 ce33[10][10][10],
	  COMPLEX8 ce41[8][8][8][8], COMPLEX8 ce42[8][8][8][8],
	  COMPLEX8 ce51[5][5][5][5][5], COMPLEX8 ce52[5][5][5][5][5],
	  COMPLEX8 ce61[5][3][3][3][3][2], COMPLEX8 ce62[5][3][3][3][3][2]);
int INITIL(long int i11[10], long int i12[10], long int i13[10],
	   long int *IS1, long int *IS2, long int *IS3,
	   long int i21[10][10], long int i22[10][10], long int i23[10][10],
	   long int i31[10][10][10], long int i32[10][10][10], long int i33[10][10][10],
	   long int i41[8][8][8][8], long int i42[8][8][8][8],
	   long int i51[5][5][5][5][5], long int i52[5][5][5][5][5],
	   long int i61[5][3][3][3][3][2], long int i62[5][3][3][3][3][2],
	   unsigned long int l11[10], unsigned long int l12[10], unsigned long int l13[10],
	   unsigned long int *LS1, unsigned long int *LS2, unsigned long int *LS3,
	   unsigned long int l21[10][10], unsigned long int l22[10][10], unsigned long int l23[10][10],
	   unsigned long int l31[10][10][10], unsigned long int l32[10][10][10], unsigned long int l33[10][10][10],
	   unsigned long int l41[8][8][8][8], unsigned long int l42[8][8][8][8],
	   unsigned long int l51[5][5][5][5][5], unsigned long int l52[5][5][5][5][5],
	   unsigned long int l61[5][3][3][3][3][2], unsigned long int l62[5][3][3][3][3][2]);
int main()
{
	double DS1,DS2,DS3;
	float ES1,ES2,ES3;
	...
	long int N=2,I,J,K,L;
	long int I1,I2,I3,I4;
	INITR(d11,d12,d13,&DS1,&DS2,&DS3,d21,d22,d23,d31,d32,d33,d41,d42,d51,
	    d52,d61,d62,e11,e12,e13,&ES1,&ES2,&ES3,e21,e22,e23,e31,e32,e33,
	    e41,e42,e51,e52,e61,e62);
	INITC(cd11,cd12,cd13,&cds1,&cds2,&cds3,cd21,cd22,cd23,cd31,cd32,cd33,
	    cd41,cd42,cd51,cd52,cd61,cd62,ce11,ce12,ce13,&ces1,&ces2,&ces3,
	    ce21,ce22,ce23,ce31,ce32,ce33,ce41,ce42,ce51,ce52,ce61,ce62);
	INITIL(n11,n12,n13,&NS1,&NS2,&NS3,n21,n22,n23,n31,n32,n33,n41,n42,n51,
	    n52,n61,n62,l11,l12,l13,&LS1,&LS2,&LS3,l21,l22,l23,l31,l32,l33,
	...
	for(I1=1;I1<=10;I1+=N)
	{
		...
		for(I2=1;I2<=4;I2++)
		{
			ces1.real=I1;
			ces1.imag=I2;
			ce21[I2*2-1][I1-1].real=ces1.real+1.0;
			ce21[I2*2-1][I1-1].imag=ces1.imag;
			for(I3=1;I3<=6;I3+=2)
			{
				NS1=ES1*I3-2.;
				for(I4=1;I4<=3;I4++)
				{
					if (!LS1)
					{
						cd41[I1-1][I2-1][I3-1][I4-1].dreal=ces1.real+NS1;
						cd41[I1-1][I2-1][I3-1][I4-1].dimag=ces1.imag;
					}
				}
				N21(I1,I3)=(-NS1*NS1*ces1.imag)/(ces1.real*ces1.real+ces1.imag*ces1.imag);
			}
		}
		L12(I1)=LS1;
	}
	for(I=1;I<=10;I++)
	{
		for(J=1;J<=10;J++)
		{
			printf("ce21[%ld][%ld].real=%f  ,ce21[%ld][%ld].imag=%f\n",
			    I-1,J-1,ce21[I-1][J-1].real,I-1,J-1,ce21[I-1][J-1].imag);
			printf("N21[%ld][%ld]= %ld\n",I,J,N21(I,J));
			for(K=1;K<=8;K++)
			{
				for(L=1;L<=8;L++)
				{
					if(I<9 && J<9)
					{
						printf("cd41.dreal[%ld][%ld][%ld][%ld]= %g  cd41[%ld][%ld][%ld][%ld].dimag= %g\n",
						    I-1,J-1,K-1,L-1,cd41[I-1][J-1][K-1][L-1].dreal,I-1,J-1,K-1,L-1,cd41[I-1][J-1][K-1][L-1].dimag);
					}
				}
			}
		}
	...
	for(I1=2;I1<=8;I1+=2)
	{
		cds1.dreal=(double)(sin((double)(I1)));
		cds1.dimag=(double)(cos((double)(I1)));
		for(I2=1;I2<=4;I2++)
		{
			for(I3=1;I3<=4;I3++)
			{
				...
				{
					NS2=(I1/2 < 4) ? I1/2:4;
					cd41[NS2-1][I2-1][I3-1][I4-1].dreal=cds1.dreal*NS1;
					cd41[NS2-1][I2-1][I3-1][I4-1].dimag=cds1.dimag*NS1;
				}
				D31(I1,I2,I3)=-(cds1.dreal*cds1.dreal-cds1.dimag*cds1.dimag);
				D31(I1+1,I2,I3)=cos((double)(I1*I1));
			}
		}
	}
	for(I=1;I<=10;I++){
		for(J=1;J<=10;J++){
			for(K=1;K<=10;K++){
				printf("D31[%ld][%ld][%ld]= %g\n",I-1,J-1,K-1,D31(I,J,K));
				for(L=1;L<=8;L++){
					if(I<9 && J<9 && K<9)
					{
						printf("cd41.dreal[%ld][%ld][%ld][%ld]= %g  cd41[%ld][%ld][%ld][%ld].dimag= %g\n",
...
#define E61(i,j,k,l,m,n) e61[i-1][j-1][k-1][l-1][m-1][n-1]
#define E62(i,j,k,l,m,n) e62[i-1][j-1][k-1][l-1][m-1][n-1]
int INITR(d11,d12,d13,DS1,DS2,DS3,d21,d22,d23,d31,d32,d33,d41,d42,d51,d52,
d61,d62,e11,e12,e13,ES1,ES2,ES3,e21,e22,e23,e31,e32,e33,e41,e42,
e51,e52,e61,e62)
...
#define CE61(i,j,k,l,m,n) ce61[i-1][j-1][k-1][l-1][m-1][n-1]
#define CE62(i,j,k,l,m,n) ce62[i-1][j-1][k-1][l-1][m-1][n-1]
int INITC(cd11,cd12,cd13,cds1,cds2,cds3,cd21,cd22,cd23,cd31,cd32,cd33,cd41,
cd42,cd51,cd52,cd61,cd62,ce11,ce12,ce13,ces1,ces2,ces3,ce21,ce22,
ce23,ce31,ce32,ce33,ce41,ce42,ce51,ce52,ce61,ce62)
...
COMPLEX8 ce61[5][3][3][3][3][2],ce62[5][3][3][3][3][2];
{
	...
	for(I=1;I<=10;I++)
	{
		...
		for(J=1;J<=10;J++)
		{
			cd21[I-1][J-1].dreal=0;
			cd21[I-1][J-1].dimag=0;
			cd22[I-1][J-1].dreal=0;
			cd22[I-1][J-1].dimag=0;
			cd23[I-1][J-1].dreal=0;
			cd23[I-1][J-1].dimag=0;
			for(K=1;K<=10;K++)
			{
				cd31[I-1][J-1][K-1].dreal=0;
				cd31[I-1][J-1][K-1].dimag=0;
				cd32[I-1][J-1][K-1].dreal=0;
				cd32[I-1][J-1][K-1].dimag=0;
				cd33[I-1][J-1][K-1].dreal=0;
				cd33[I-1][J-1][K-1].dimag=0;
				for(L=1;L<=8;L++)
				{
					if(I<9 && J<9 && K<9)
					{
	...
	for(I1=1;I1<=10;I1++)
	{
		...
		for(I2=2;I2<=10;I2++)
		{
			ce21[I1-1][I2-1].real=(ce11[I1-1].real*I2)/(I2*I2);
			ce21[I1-1][I2-1].imag=(ce11[I1-1].imag*I2)/(I2*I2);
			ce22[I1-1][I2-1].real=0.0;
			ce22[I1-1][I2-1].imag=I2*I1*2.0;
			(*ces1).real=I2/I1-1.0;
			(*ces1).imag=-1.0;
			if (I2 == 10)
			{
			...
			for(I3=1;I3<=10;I3++)
			{
				ce31[I3-1][I2-1][I1-1].real=0.0;
				ce31[I3-1][I2-1][I1-1].imag=0.0;
				ce32[I3-1][I1-1][I2-1].real=3.5;
				ce32[I3-1][I1-1][I2-1].imag=0.0;
				for(I4=1;I4<=4;I4++)
				{
					(*ces2).real=(float)(I3);
					(*ces2).imag=(float)(I4);
					if (I1<=8 && I2<=8 && I3<=8)
					{
						...
						ce42[I1-1][I4+3][I2-1][I3-1].real=((*ces2).real*4.0)/(4.0*4.0);
						ce42[I1-1][I4+3][I2-1][I3-1].imag=((*ces2).imag*4.0)/(4.0*4.0);
					}
					for(I5=1;I5<=5;I5++)
					{
						if (I1<=5 && I2<=5 && I3<=5 && I4<=5)
						{
							...
							ce52[I1-1][I2-1][I3-1][I4-1][I5-1].real=((*ces2).real*2.0)/4.0;
							ce52[I1-1][I2-1][I3-1][I4-1][I5-1].imag=((*ces2).imag*2.0)/4.0;
						}
						for(I6=1;I6<=2;I6++)
						{
							if (I1<=5 && I2<=3 && I3<=3 && I4<=3 && I5<=3)
							{
								ce61[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].real=0.5;
								ce61[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].imag=0.5;
								ce62[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].real=100.5;
								ce62[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].imag=100;
							}
						}
					}
					(*ces2).real=I4/2+sqrt((float)(0.0));
	...
	for(I1=1;I1<=10;I1++)
	{
		...
		for(I2=2;I2<=10;I2++)
		{
			cd21[I1-1][I2-1].dreal=(cd11[I1-1].dreal*I2)/(I2*I2);
			cd21[I1-1][I2-1].dimag=(cd11[I1-1].dimag*I2)/(I2*I2);
			cd22[I1-1][I2-1].dreal=0.0;
			cd22[I1-1][I2-1].dimag=I2*I1*2.0;
			(*cds1).dreal=I2/I1-1.0;
			(*cds1).dimag=-1.0;
			if (I2 == 10)
			{
			...
			for(I3=1;I3<=10;I3++)
			{
				cd31[I3-1][I2-1][I1-1].dreal=0.0;
				cd31[I3-1][I2-1][I1-1].dimag=0.0;
				cd32[I3-1][I1-1][I2-1].dreal=3.5;
				cd32[I3-1][I1-1][I2-1].dimag=0.0;
				for(I4=1;I4<=4;I4++)
				{
					(*cds2).dreal=(double)(I3);
					(*cds2).dimag=(double)(I4);
					if (I1<=8 && I2<=8 && I3<=8)
					{
						cd41[I1-1][I4-1][I3-1][I2-1].dreal=(*cds2).dreal;
						cd41[I1-1][I4-1][I3-1][I2-1].dimag=(*cds2).dimag;
						cd42[I1-1][I4+3][I2-1][I3-1].dreal=((*cds2).dreal*4.0)/(4.0*4.0);               
						cd42[I1-1][I4+3][I2-1][I3-1].dimag=((*cds2).dimag*4.0)/(4.0*4.0);               
					}
					for(I5=1;I5<=5;I5++)
					{
						if (I1<=5 && I2<=5 && I3<=5 && I4<=5)
						{
							...
							cd52[I1-1][I2-1][I3-1][I4-1][I5-1].dreal=((*cds2).dreal*2.0)/4.0;               
							cd52[I1-1][I2-1][I3-1][I4-1][I5-1].dimag=((*cds2).dimag*2.0)/4.0;                 
						}
						for(I6=1;I6<=2;I6++)
						{
							if (I1<=5 && I2<=3 && I3<=3 && I4<=3 && I5<=3)
							{
								cd61[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].dreal=0.5;
								cd61[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].dimag=0.5;
								cd62[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].dreal=100.5;
								cd62[I1-1][I2-1][I3-1][I4-1][I5-1][I6-1].dimag=100;
							}
						}
					}
					(*cds2).dreal=I4/2+sqrt((float)(0.0));
...
#define L61(i,j,k,l,m,n) l61[i-1][j-1][k-1][l-1][m-1][n-1]
#define L62(i,j,k,l,m,n) l62[i-1][j-1][k-1][l-1][m-1][n-1]
int INITIL(i11,i12,i13,IS1,IS2,IS3,i21,i22,i23,i31,i32,i33,i41,i42,i51,i52,
i61,i62,l11,l12,l13,LS1,LS2,LS3,l21,l22,l23,l31,l32,l33,l41,l42,
l51,l52,l61,l62)
