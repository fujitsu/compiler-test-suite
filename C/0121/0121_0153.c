...
LBL_3:
	...
	for(I=1;I<=10;I++)
	{
		...
		for(J=1;J<=5;J++)
		{
			...
			for(K=1;K<=2;K++)
			{
				if (DA3(I,J,K)-10.0<0)       goto LBL_13;
				else if (DA3(I,J,K)-10.0==0) goto LBL_14;
				else goto LBL_15;
LBL_14:
				;
				DB3(I,J,K)=DC3(I,J,K)-DA2(I,J);
				goto LBL_12;
LBL_13:
				;
				DC3(I,J,K)=RB2(I,J)+(double)(IB1(I));
				goto LBL_12;
LBL_15:
				;
	...
	for(I=1;I<=10;I++)
	{
		...
		for(J=1;J<=2;J++)
		{
			for(K=1;K<=2;K++)
			{
				...
				RA2(I,J)=sqrt(fabs(RB2(I,J)))+RA2(I,J)+RA1(I);
				if (LC2(I,J)==1)  DS1 = DS1 + DB2(I,J);
				CA3(I,J,K).real=CA2(I,J).real+CB2(I,J).real;
				CA3(I,J,K).imag=CA2(I,J).imag+CB2(I,J).imag;
LBL_32:
				;
			}
			CA2(I,J).real=(float)(IA1(I))+DA1(I);
