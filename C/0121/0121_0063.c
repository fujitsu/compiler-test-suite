...
int main()
{
	...
	for(I=IM4;I<=-IM4+2;I++){
		...
		DVAR1=(b>0.0)?
		    (double)(int)(b+0.5):(double)(int)(b-0.5);
		for(J=10;J>=-IT6;J--){
...
LBL_20:
		...
		if ( I > 8 )
		{
			...
			DVAR1=(DVAR1>0.0)?(double)(int)(DVAR1+0.5)
			    :(double)(int)(DVAR1-0.5);
		}
...
LBL_41:
			;
			IVAL=(IVAL > ID30(I-1,J)) ? IVAL:ID30(I-1,J);
			IND=I;
LBL_40:
			;
		}
