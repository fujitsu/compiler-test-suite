...
double r8;
 ...
 i1 = svlasta_s8( pg,i1a);
  i2 = svlasta_s16( pg,i2a);
  i4 = svlasta_s32( pg,i4a);
  i8 = svlasta_s64( pg,i8a);
  dummy(i1,	i2,	i4,	i8);
  u1 = svlasta_u8( pg,u1a);
  u2 = svlasta_u16( pg,u2a);
  u4 = svlasta_u32( pg,u4a);
  u8 = svlasta_u64( pg,u8a);
  r4 = svlasta_f32( pg,r4a);
  r8 = svlasta_f64( pg,r8a);
  dummy(u1,	u2,	u4,	u8);
  dummy(r4,r8);
}
void dummy() {}
