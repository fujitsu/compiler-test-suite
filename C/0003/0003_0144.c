...
{
  svint32_t r;
  r = svld1sb_gather_u32base_offset_s32(pg, base, offset);
  dummy(r);
}
void test_u64_s64(svbool_t pg, const svuint64_t base, int64_t offset)
{
  svint64_t r;
  r = svld1sb_gather_u64base_offset_s64(pg, base, offset);
  dummy(r);
}
void test_u32_u32(svbool_t pg, const svuint32_t base, int64_t offset)
{
  svuint32_t r;
  r = svld1sb_gather_u32base_offset_u32(pg, base, offset);
  dummy(r);
}
void test_u64_u64(svbool_t pg, const svuint64_t base, int64_t offset)
{
  svuint64_t r;
  r = svld1sb_gather_u64base_offset_u64(pg, base, offset);
  dummy(r);
}
void dummy() {};
