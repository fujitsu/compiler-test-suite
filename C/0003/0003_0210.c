...
svfloat64_t r8a,r8b,r8c;
  vi1 = svtrn2_s8( i1a,i1b);
  vi2 = svtrn2_s16( i2a,i2b);
  vi4 = svtrn2_s32( i4a,i4b);
  vi8 = svtrn2_s64( i8a,i8b);
  vu1 = svtrn2_u8( u1a,u1b);
  vu2 = svtrn2_u16( u2a,u2b);
  vu4 = svtrn2_u32( u4a,u4b);
  vu8 = svtrn2_u64( u8a,u8b);
  vr4 = svtrn2_f32( r4a,r4b);
  vr8 = svtrn2_f64( r8a,r8b);
...
void test_trn2_p()
{
  svbool_t pg,pga,pgb;
  svbool_t pg1, pg2, pg3, pg4, pg5, pg6;
  pg1 = svtrn2_b8( pga,pgb);
  pg2 = svtrn2_b16( pga,pgb);
  pg3 = svtrn2_b32( pga,pgb);
  pg4 = svtrn2_b64( pga,pgb);
