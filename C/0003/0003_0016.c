...
float r4;
double r8;
  vi4 = svexth_s32_z( pg,i4a); 
  vi8 = svexth_s64_z( pg,i8a);
  dummy(vi4,	vi8);
  vu4 = svexth_u32_z( pg,u4a); 
  vu8 = svexth_u64_z( pg,u8a);
  dummy(vu4,	vu8);
}
void test_exth_m()
{
...
float r4;
double r8;
  vi4 = svexth_s32_m( i4a,pg,i4b); 
  vi8 = svexth_s64_m( i8a,pg,i8b);
  vu4 = svexth_u32_m( u4a,pg,u4b);
  dummy(vi4,	vi8);
  vu8 = svexth_u64_m( u8a,pg,u8b);
  dummy(vu4,	vu8);
}
void test_exth_x()
{
...
float r4;
double r8;
  vi4 = svexth_s32_x( pg,i4a); 
  vi8 = svexth_s64_x( pg,i8a);
  vu4 = svexth_u32_x( pg,u4a); 
  vu8 = svexth_u64_x( pg,u8a);
