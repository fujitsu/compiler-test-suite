...
svfloat64_t r8a,r8b,r8c;
  vi1 = svzip2_s8( i1a,i1b);
  vi2 = svzip2_s16( i2a,i2b);
  vi4 = svzip2_s32( i4a,i4b);
  vi8 = svzip2_s64( i8a,i8b);
  vu1 = svzip2_u8( u1a,u1b);
  vu2 = svzip2_u16( u2a,u2b);
  vu4 = svzip2_u32( u4a,u4b);
  vu8 = svzip2_u64( u8a,u8b);
  vr4 = svzip2_f32( r4a,r4b);
  vr8 = svzip2_f64( r8a,r8b);
...
void test_zip2_p()
{
  ...
  pg1 = svzip2_b8( pga,pgb);
  pg2 = svzip2_b16( pga,pgb);
  pg3 = svzip2_b32( pga,pgb);
  pg4 = svzip2_b64( pga,pgb);
