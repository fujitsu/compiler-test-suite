...
float r4;
double r8;
  vi4 = svrevh_s32_z( pg,i4a); 
  vi8 = svrevh_s64_z( pg,i8a);
  dummy(vi4,	vi8);
  vu4 = svrevh_u32_z( pg,u4a); 
  vu8 = svrevh_u64_z( pg,u8a);
  dummy(vu4,	vu8);
}
void test_revh_m()
{
...
float r4;
double r8;
  vi4 = svrevh_s32_m( i4a,pg,i4b); 
  vi8 = svrevh_s64_m( i8a,pg,i8b);
  vu4 = svrevh_u32_m( u4a,pg,u4b);
  dummy(vi4,	vi8);
  vu8 = svrevh_u64_m( u8a,pg,u8b);
  dummy(vu4,	vu8);
}
void test_revh_x()
{
...
float r4;
double r8;
  vi4 = svrevh_s32_x( pg,i4a); 
  vi8 = svrevh_s64_x( pg,i8a);
  vu4 = svrevh_u32_x( pg,u4a); 
  vu8 = svrevh_u64_x( pg,u8a);
