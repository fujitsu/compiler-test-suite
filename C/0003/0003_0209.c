...
svfloat64_t r8a,r8b,r8c;
  vi1 = svtrn1_s8( i1a,i1b);
  vi2 = svtrn1_s16( i2a,i2b);
  vi4 = svtrn1_s32( i4a,i4b);
  vi8 = svtrn1_s64( i8a,i8b);
  vu1 = svtrn1_u8( u1a,u1b);
  vu2 = svtrn1_u16( u2a,u2b);
  vu4 = svtrn1_u32( u4a,u4b);
  vu8 = svtrn1_u64( u8a,u8b);
  vr4 = svtrn1_f32( r4a,r4b);
  vr8 = svtrn1_f64( r8a,r8b);
...
void test_trn1_p()
{
  ...
  pg1 = svtrn1_b8( pga,pgb);
  pg2 = svtrn1_b16( pga,pgb);
  pg3 = svtrn1_b32( pga,pgb);
  pg4 = svtrn1_b64( pga,pgb);
