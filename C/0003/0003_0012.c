...
float r4;
double r8;
  vu1 = svcls_s8_z( pg,i1a);
  vu2 = svcls_s16_z( pg,i2a);
  vu4 = svcls_s32_z( pg,i4a); 
  vu8 = svcls_s64_z( pg,i8a);
...
float r4;
double r8;
  vu1 = svcls_s8_m( u1a,pg,i1a);
  vu2 = svcls_s16_m( u2a,pg,i2a);
  vu4 = svcls_s32_m( u4a,pg,i4a); 
  vu8 = svcls_s64_m( u8a,pg,i8a);
  dummy( vu1,	  vu2,	  vu4,	  vu8);
}
void test_cls_x()
{
...
float r4;
double r8;
  vu1 = svcls_s8_x( pg,i1a);
  vu2 = svcls_s16_x( pg,i2a);
  vu4 = svcls_s32_x( pg,i4a); 
  vu8 = svcls_s64_x( pg,i8a);
  dummy( vu1,	  vu2,	  vu4,	  vu8);
}
int main()
{
