...
for (i=0;i<10;i++) 
  ...
  ai8[1]        = i8;
                     if (ai8[1]==-1) printf ("** kaimk2003-(01)** OK\n");
                     else                    printf ("** kaimk2003-(01)** NG ai8[1]=%x\n",ai8[1]);
                     pi8=pi8_area;
  *pi8          = i8;         
                     if (*pi8==-1)   printf ("** kaimk2003-(02)** OK\n");
                     else                    printf ("** kaimk2003-(02)** NG *pi8=%x\n",pi8);
                     si8=&si8_area;
for (i=0;i<10;i++) 
  si8->r_ai8[i] = i8;i=0; 
                     if (si8->r_ai8[i]==-1) printf ("** kaimk2003-(03)** OK\n");
                     else                           printf ("** kaimk2003-(03)** NG si8->r_ai8[i]=%x\n",si8->r_ai8[i]);
  au8[1]        = u8;
                     if (au8[1]==-1) printf ("** kaimk2003-(04)** OK\n");
                     else                    printf ("** kaimk2003-(04)** NG au8[1]=%x\n",au8[1]);
                     pu8=pu8_area;
  *pu8          = u8;         
                     if (*pu8==-1)   printf ("** kaimk2003-(05)** OK\n");
                     else                    printf ("** kaimk2003-(05)** NG *pu8=%x\n",pu8);
                     su8=&su8_area;
for (i=0;i<10;i++) 
  su8->r_au8[i] = u8;i=0; 
                     if (su8->r_au8[i]==-1) printf ("** kaimk2003-(06)** OK\n");
                     else                           printf ("** kaimk2003-(05)** NG su8->r_au8[i]=%x\n",su8->r_au8[i]);
exit (0);
}  
