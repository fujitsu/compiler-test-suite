...
r4 = u8;
         if (r4== 5.24288e+5F)
                                  printf("**kaimk2038-(1) ok\n");
  else                            printf("**kaimk2038-(1) ng %x\n",r4);
u8 = subu8c( );
r8 = u8;
         if (r8== 5.62949953421312e+14)
                                  printf("**kaimk2038-(2) ok\n");
  else                            printf("**kaimk2038-(2) ng %x %x\n",
                                          *(int *)&r8,*(((int *)&r8)+1));
u8 = subu8e( );
r16 = u8;
         if (r16==9.223372036854775808e+18L )
                                  printf("**kaimk2038-(3) ok\n");
  else                            printf("**kaimk2038-(3) ng %x %x %x %x\n",
                                          *(int *)&r16,
                                          *(((int *)&r16)+1),
                                          *(((int *)&r16)+2),
                                          *(((int *)&r16)+3));
...
r16 = u8;
         if (r16==1.8446744073709551615e+19L )
                                  printf("**kaimk2038-(4) ok\n");
  else                            printf("**kaimk2038-(4) ng %x %x %x %x\n",
                                          *(int *)&r16,
                                          *(((int *)&r16)+1),
                                          *(((int *)&r16)+2),
                                          *(((int *)&r16)+3));
