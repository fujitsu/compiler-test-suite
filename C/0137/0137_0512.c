...
if ((i=sub1(i8a,i4a,i8b,i4b,i8c,i4c))==60) 
                                       printf("kaimk2045-(1) ok\n");
else                                   printf("kaimk2045-(1) ng %d\n",i);
i8a=i8b=i8c=i2a=i2b=i2c=10;  
if ((i=sub2(i8a,i2a,i8b,i2b,i8c,i2c))==60) 
                                       printf("kaimk2045-(2) ok\n");
else                                   printf("kaimk2045-(2) ng %d\n",i);
i8a=i8b=i8c=i1a=i1b=i1c=10;  
if ((i=sub3(i8a,i1a,i8b,i1b,i8c,i1c))==60) 
                                       printf("kaimk2045-(3) ok\n");
else                                   printf("kaimk2045-(3) ng %d\n",i);
i8a=i8b=i8c=10;
r4a=r4b=r4c=10.0f;  
if ((i=sub4(i8a,r4a,i8b,r4b,i8c,r4c))==60) 
                                       printf("kaimk2045-(4) ok\n");
else                                   printf("kaimk2045-(4) ng %d\n",i);
r8a=r8b=r8c=10.0;  
if ((i=sub5(i8a,r8a,i8b,r8b,i8c,r8c))==60) 
                                       printf("kaimk2045-(5) ok\n");
else                                   printf("kaimk2045-(5) ng %d\n",i);
r16a=r16b=r16c=10.0l;  
if ((i=sub6(i8a,r16a,i8b,r16b,i8c,r16c))==60) 
                                       printf("kaimk2045-(6) ok\n");
else                                   printf("kaimk2045-(6) ng %d\n",i);
u8a=u8b=u8c=i4a=i4b=i4c=10;  
if ((i=sub11(u8a,i4a,u8b,i4b,u8c,i4c))==60) 
                                       printf("kaimk2045-(7) ok\n");
else                                   printf("kaimk2045-(7) ng %d\n",i);
u8a=u8b=u8c=i2a=i2b=i2c=10;  
if ((i=sub12(u8a,i2a,u8b,i2b,u8c,i2c))==60) 
                                       printf("kaimk2045-(8) ok\n");
else                                   printf("kaimk2045-(8) ng %d\n",i);
u8a=u8b=u8c=i1a=i1b=i1c=10;  
if ((i=sub13(u8a,i1a,u8b,i1b,u8c,i1c))==60) 
                                       printf("kaimk2045-(9) ok\n");
else                                   printf("kaimk2045-(9) ng %d\n",i);
u8a=u8b=u8c=10;
r4a=r4b=r4c=10.0f;  
if ((i=sub14(u8a,r4a,u8b,r4b,u8c,r4c))==60) 
                                       printf("kaimk2045-(10) ok\n");
else                                   printf("kaimk2045-(10) ng %d\n",i);
r8a=r8b=r8c=10.0;  
if ((i=sub15(u8a,r8a,u8b,r8b,u8c,r8c))==60) 
                                       printf("kaimk2045-(11) ok\n");
else                                   printf("kaimk2045-(11) ng %d\n",i);
r16a=r16b=r16c=10.0l;  
if ((i=sub16(u8a,r16a,u8b,r16b,u8c,r16c))==60) 
                                       printf("kaimk2045-(12) ok\n");
else                                   printf("kaimk2045-(12) ng %d\n",i);
exit (0);
}
int sub1 (long long int a, int b, long long int c, int d, long long int e, int f)
{ return(a+b+c+d+e+f); }
