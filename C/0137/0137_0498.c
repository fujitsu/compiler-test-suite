...
int main() { 
  ...
  ppp =sublong0( );
  if (ppp== -1) printf("**kaimk2018-(1)** OK\n");
  else        printf("**kaimk2018-(1)** NG p=%d\n",ppp);
  ppp =sublong00( );
  if (ppp== -1) printf("**kaimk2018-(2)** OK\n");
  else        printf("**kaimk2018-(2)** NG p=%d\n",ppp);
  xxxl=sublong1(ppp);
  if (xxxl.a== -1) 
              printf("**kaimk2018-(3)** OK\n");
  else        printf("**kaimk2018-(3)** NG xxxl.a=%d\n",xxxl.a);
  qqq=sublong2(ppp);
  if (qqq.b== -1) 
              printf("**kaimk2018-(4)** OK\n");
  else        printf("**kaimk2018-(4)** NG q.b=%d\n",qqq.b);
  yyyl=sublong3(ppp);
  if (yyyl.a== 10) 
              printf("**kaimk2018-(5)** OK\n");
  else        printf("**kaimk2018-(5)** NG yyyl.a=%d\n",yyyl.a);
  rrr=sublong4(ppp);
  if (rrr.b==-1) 
              printf("**kaimk2018-(6)** OK\n");
  else        printf("**kaimk2018-(6)** NG r.b=%d\n",rrr.b);
exit (0);
}
