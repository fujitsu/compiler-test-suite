...
int main( ) {
  ...
  static unsigned long long int u8=0xffffffffffffffffLL;
  ...
  {
  i8=sub1(u1);
               if (i8 == 255LL)  printf("comk2105 (1) ok   \n");
	       else              printf("comk2105 (1) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  i8=sub2(u2);
               if (i8 == 65535LL)  printf("comk2105 (2) ok   \n");
	       else                printf("comk2105 (2) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  i8=sub3(u4);
               if (i8 == 4294967295LL)  printf("comk2105 (3) ok   \n");
	       else                     printf("comk2105 (3) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  i8=sub4(u8);
               if (i8 == -1LL)  printf("comk2105 (4) ok   \n");
	       else             printf("comk2105 (4) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  i8=sub5(i1);
               if (i8 == -1LL)  printf("comk2105 (5) ok   \n");
	       else             printf("comk2105 (5) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  i8=sub6(i2);
               if (i8 == -1LL)  printf("comk2105 (6) ok   \n");
	       else             printf("comk2105 (6) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  i8=sub7(i4);
               if (i8 == -1LL)  printf("comk2105 (7) ok   \n");
	       else             printf("comk2105 (7) ng %x %x\n"
                                              ,*(int *)&i8,*(((int *)&i8)+1));
  }
exit (0);
}
