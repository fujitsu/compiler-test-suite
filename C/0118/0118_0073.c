...
#define Correct_answer01 1040
#define Correct_answer02 1040
#define Correct_answer03 1040

void sub01(double *a, double *b ,int n)
{
  int i;
  for (i=0; i<n-10; i=i+100) {
    a[i] = a[i] + b[i] + b[i+10];
  }
  return;
}
