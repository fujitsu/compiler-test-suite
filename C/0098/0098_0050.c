...
int main()
{
	...
	a042.f[i1].g[i2]=a042.f[i1].g[i2];
	a043.e[i1].f[i2].g[i3]=a043.e[i1].f[i2].g[i3];
	a044.d[i1].e[i2].f[i3].g[i4]=a044.d[i1].e[i2].f[i3].g[i4];
	a045.c[i1].d[i2].e[i3].f[i4].g[i5]=a045.c[i1].d[i2].e[i3].f[i4].g[i5];
	a046.b[i1].c[i2].d[i3].e[i4].f[i5].g[i6]=a046.b[i1].c[i2].d[i3].e[i4].f[i5].g[i6];
