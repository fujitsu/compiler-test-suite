...
int test_loop_no_escape_pt2_##test_type(test_type flag1, test_type flag2, int *i_data, int lmax, test_type d_val) {\
  ...
  for(j=0; j<LOOP_CONST; j++) {\
    for(i=0;i<LOOP_CONST;i++) {\
      ...
      } else if (d_data[j][i] != (test_type)FALSE_RES) {\
        return FALSE_RES;\
      }\
    }\
  }\
...
int main() {
  int id[LOOP_CONST];
  CALL_TEST_LOOP_NO_ESCAPE(float, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(float, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 2, 3, id, LOOP_CONST, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 1, 1, id, LOOP_CONST, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 2, 3, id, LOOP_CONST, ELSE_RES);

  CALL_TEST_LOOP_NO_ESCAPE(float, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(float, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 2, 3, id, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 1, 1, id, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 2, 3, id, -1, ELSE_RES);
