    ...
    for(j=0; j<LOOP_CONST; j++) {\
      for(i=0; i<LOOP_CONST; i++) {\
        ...
        if (flag1 > k) {\
          ...
          d_data2[k][j][i] = (test_type)ELSEIF1_RES;\
        } else if (flag1 == k) {\
          d_data2[k][j][i] = (test_type)ELSEIF2_RES;\
        }\
      }\
    }\
  }\
    ...
    for(j=0; j<LOOP_CONST; j++) {\
      for(i=0;i<LOOP_CONST;i++) {\
        ...
        if (flag1 > k) {\
          ...
          if (d_data2[k][j][i] != (test_type)ELSEIF1_RES) {\
            return FALSE_RES;\
          }\
        } else if (flag1 == k) {\
          if (d_data2[k][j][i] != (test_type)ELSEIF2_RES) {\
	    return FALSE_RES;\
          }\
	}\
      }\
...
int main() {
  ...
  CALL_TEST_LOOP_NO_ESCAPE(float, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(float, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(double, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(LD, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(char, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(SI, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(int, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(LI, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(UC, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(US, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(UI, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(UL, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 64, 64, LOOP_CONST, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 64, 96, LOOP_CONST, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(float, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(float, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(double, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(LD, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(char, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(SI, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(int, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(LI, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(UC, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(US, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(UI, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(UL, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 64, 96, -1, ELSEIF1_RES);
  ...
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 64, 64, -1, ELSEIF2_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 64, 96, -1, ELSEIF1_RES);
