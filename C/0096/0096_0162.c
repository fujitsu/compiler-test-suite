...
int main() {
  CALL_TEST_LOOP_NO_ESCAPE(float, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(float, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 2, 3, FALSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 1, 1, TRUE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 2, 3, FALSE_RES);
