...
int main() {
  ...
  CALL_TEST_LOOP_NO_ESCAPE(float, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(float, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(double, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LD, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(char, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(SI, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(int, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LI, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(LLI, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UC, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(US, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UI, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(UL, 1, 2, 0, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 2, 1, 0, -1, IF_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 1, 2, 32, -1, ELSE_RES);
  CALL_TEST_LOOP_NO_ESCAPE(ULL, 1, 2, 0, -1, ELSE_RES);
