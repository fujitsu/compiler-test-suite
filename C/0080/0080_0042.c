...
struct PARM_I1 { int i; } ;

void test1(struct PARM_I1 a1,int a2,va_list *args)
{
   printf("%d,%d,",a1.i,a2);
...
void foo1(struct PARM_I1 a1,int a2, ...)
{
   va_list ap;
   va_start(ap,a2);
   test1(a1,a2,&ap);
...
void test2(struct PARM_I1 a1,int a2,va_list *args)
{
   printf("%d,%d,",a1.i,a2);
...
void foo2(struct PARM_I1 a1,int a2, ...)
{
   va_list ap;
   va_start(ap,a2);
   test2(a1,a2,&ap);
...
void test3(struct PARM_I1 a1,int a2,va_list *args)
{
   printf("%d,%d,",a1.i,a2);
...
void foo3(struct PARM_I1 a1,int a2, ...)
{
   va_list ap;
   va_start(ap,a2);
   test3(a1,a2,&ap);
...
int main()
{
   ...
   static struct PARM_I1 prm1 = {1};

   foo1(prm1,2,in15,in16,in17,in18);
   foo2(prm1,2,in25,in26,in27,in28);
   foo3(prm1,2,in35,in36,in37,in38);
   return 0;
}
#endif
