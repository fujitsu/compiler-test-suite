...
struct PARM_4 { char i; short j; float f; double d; } ;

void test1(int x,int y,struct PARM_4 a4,va_list *args)
{
   printf("%d,%d,%d,%d,",(int)a4.i,(int)a4.j,(int)a4.f,(int)a4.d);
...
void test2(int x,int y,struct PARM_4 a4,va_list *args)
{
   printf("%d,%d,%d,%d,",(int)a4.i,(int)a4.j,(int)a4.f,(int)a4.d);
...
void test3(int x,int y,struct PARM_4 a4,va_list *args)
{
   printf("%d,%d,%d,%d,",(int)a4.i,(int)a4.j,(int)a4.f,(int)a4.d);
...
int main()
{
   ...
   static struct PARM_4 prm1234 = {1,2,3,4};
