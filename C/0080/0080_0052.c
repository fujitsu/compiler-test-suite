...
void test1(int x,int y,struct PARM_F1 a1,int a2,int a3,int a4,va_list *args)
{
...
void test2(int x,int y,struct PARM_F1 a1,int a2,int a3,int a4,va_list *args)
{
   printf("%d,%d,%d,%d,",(int)a1.f,a2,a3,a4);
...
void test3(int x,int y,struct PARM_F1 a1,int a2,int a3,int a4,va_list *args)
{
   printf("%d,%d,%d,%d,",(int)a1.f,a2,a3,a4);
