...
void test1(int a1,struct PARM_I1 a2,va_list *args)
{
   printf("%d,%d,",a1,a2.i);
...
void foo1(int a1,struct PARM_I1 a2,...)
{
...
void test2(int a1,struct PARM_I1 a2,va_list *args)
{
   printf("%d,%d,",a1,a2.i);
...
void foo2(int a1,struct PARM_I1 a2,...)
{
...
void test3(int a1,struct PARM_I1 a2,va_list *args)
{
   printf("%d,%d,",a1,a2.i);
...
void foo3(int a1,struct PARM_I1 a2,...)
{
...
int main()
{
   ...
   static struct PARM_I1 prm2 = {2};

   foo1(1,prm2,in15,in16,in17,in18);
   foo2(1,prm2,in25,in26,in27,in28);
   foo3(1,prm2,in35,in36,in37,in38);
   return 0;
}
#endif
