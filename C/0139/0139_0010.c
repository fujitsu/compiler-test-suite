 ...
 int m3edc174()
{
...

   {
     ...
     const struct f2stag1 *f2st1p=NULL;
...
void f7f3(register volatile const unsigned long int a)
{
  if (a == 1ul)
...
void f7f2(register volatile const unsigned int a)
{
  if (a == 1u)
...
void f7f1(register volatile const int a)
{
  if (a == 1)
...
void f7f0(register volatile const int  a)
{
  if (a == 1)
...
void f8f3(volatile unsigned long int a)
{
  if (a == 1ul)
...
void f8f2(volatile unsigned int a)
{
  if (a == 1u)
