...
int sub_float(float k, float j){
  ...
  printf("%s\n",k == 5.0 ? "sub_float:ok":"sub_float:ng");
}
int sub_double(double k, double j){
  ...
  printf("%s\n",k == 5.0 ? "sub_double:ok":"sub_double:ng");
}
int sub_ldouble(long double k, long double j){
  ...
  printf("%s\n",k == 5.0 ? "sub_ldouble:ok":"sub_ldouble:ng");
}
