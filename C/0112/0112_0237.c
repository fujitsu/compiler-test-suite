...
static int i1(void)
{
  ...
  char c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int i2(void)
{
  ...
  short c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int i4(void)
{
  ...
  int c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int i8(void)
{
  ...
  long int c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int u1(void)
{
  ...
  unsigned char c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int u2(void)
{
  ...
  unsigned short c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int u4(void)
{
  ...
  unsigned int c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int u8(void)
{
  ...
  unsigned long int c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int r4(void)
{
  ...
  float c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int r8(void)
{
  ...
  double c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
...
static int r16(void)
{
  ...
  long double c[10]={2,2,2,2,2,2,2,2,2,2},nn=0;
  for(i=0;i<10;i++) {
    nn = i + b[i] + c[i];
  }
