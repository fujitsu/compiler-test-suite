...
#pragma clang loop unroll(disable)
  for(i=0;i<6;i++) {
    str_t.str02[i] = base_str_t.base[i];
  }
...
#pragma clang loop unroll(disable)
  for(i=0;i<6;i++) {
    uni_t.str02[i] = base_str_t.base[i];
  }
