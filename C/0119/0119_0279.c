...
#include  <stdio.h>
 ...
 unsigned long long int ullsic( i )
 signed char                  i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullunc( i )
 unsigned char            i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullssi( i )
 signed short int i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullusi( i )
 unsigned short int       i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullsli( i )
 signed long int i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ulluli( i )
 unsigned long  int       i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullsll( i )
 signed long long int i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullull( i )
 unsigned long long int i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ullfla( i )
 float                    i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ulldub( i )
 double                   i ;
 {
 unsigned long long int k; k=i; return k;
 }
 unsigned long long int ulllgd( i )
 long double                  i ;
 {
 unsigned long long int k; k=i; return k;
 }
