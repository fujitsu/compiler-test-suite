...
#include <math.h>
#include  <stdio.h>
 unsigned char            uncsic( i )
 signed char                  i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncunc( i )
 unsigned char            i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncssi( i )
 signed short int i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncusi( i )
 unsigned short int       i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncsli( i )
 signed long int i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            unculi( i )
 unsigned long  int       i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncsll( i )
 signed long long int i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncull( i )
 unsigned long long int i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncfla( i )
 float                    i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            uncdub( i )
 double                   i ;
 {
 unsigned char           k;  k=i; return k;
 }
 unsigned char            unclgd( i )
 long double                  i ;
 {
 unsigned char           k;  k=i; return k;
 }
