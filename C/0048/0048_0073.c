...
int main()
{
       ...
       if ( li1 != li2 )
            ...
            printf(" ***  TEST-4 NG +LO.IN  ***\n");

       else

            printf(" ***  TEST-4 OK +LO.IN  ***\n");
       ...
       if ( sin1 != sin2 )
            ...
            printf(" ***  TEST-9 NG +S.INT  ***\n");

       else

            printf(" ***  TEST-9 OK +S.INT  ***\n");
       ...
       if ( sli1 != sli2 )
            ...
            printf(" ***  TEST-12 NG +S.LO.IN ***\n");

       else

            printf(" ***  TEST-12 OK +S.LO.IN ***\n");
