...
int func5 (void)
{
    ...
    char                   ce    = 4294967295;
    short int              sie   = -4294957295;
    long int               lie   = 4294967293;
#ifndef nollint
    int                    ie    = 4294967296LL;
    long long int          lli   = 4294967294;
    long long int          llie  = 4294967296LL;
    signed long long int   sllie = 4294967296LL;
    unsigned long int      ulie  = 4294967296LL;
#else
    int                    ie    = 4294967295;
    unsigned long int      ulie  = 4294967295;
#endif
    float                  flte  = 4.29497e+9;
    double                 dble  = 4294967293000e-3;
    long double            ldble = 4294967294.;
