...
int main()
{
   ...
   printf("\n***  ****  END  ***\n");
          ...
          double  f1dl2=20.0;
          double  f1dl3=30.0;
     long double lf1dl1=100.0;
     long double lf1dl2=200.0;
     long double lf1dl3=300.0;
...
m3grtn03 (void) {
     ...
     int    d1;
          ...
          float   f1f1(),f1f2(),f1f3();
          double  f1f4(),f1f5(),f1f6();
     long double  f1f7(),f1f8(),f1f9();
          void    f1f10();

  printf("M3GRTN03 TEST-START \n");

     a1=f1f1();
     if(a1==1.0)
        printf("M3GRTN03 1-1 TEST -O  K- \n");
     else
        printf("M3GRTN03 1-1 TEST - NG - \n");

     a2=f1f2();
     if(a2==10.0)
        printf("M3GRTN03 1-2 TEST -O  K- \n");
     else
        printf("M3GRTN03 1-2 TEST - NG - \n");

     a3=f1f3();
     if(a3==100.0)
        printf("M3GRTN03 1-3 TEST -O  K- \n");
     else
        printf("M3GRTN03 1-3 TEST - NG - \n");

     b1=f1f4();
     if(b1==2.0)
        printf("M3GRTN03 2-1 TEST -O  K- \n");
     else
        printf("M3GRTN03 2-1 TEST - NG - \n");

     b2=f1f5();
     if(b2==20.0)
        printf("M3GRTN03 2-2 TEST -O  K- \n");
     else
        printf("M3GRTN03 2-2 TEST - NG - \n");

     b3=f1f6();
     if(b3==200.0)
        printf("M3GRTN03 2-3 TEST -O  K- \n");
     else
        printf("M3GRTN03 2-3 TEST - NG - \n");

     c1=f1f7();
     if(c1==3.0)
        printf("M3GRTN03 3-1 TEST -O  K- \n");
     else
        printf("M3GRTN03 3-1 TEST - NG - \n");

     c2=f1f8();
     if(c2==30.0)
        printf("M3GRTN03 3-2 TEST -O  K- \n");
     else
        printf("M3GRTN03 3-2 TEST - NG - \n");

     c3=f1f9();
     if(c3==300.0)
        printf("M3GRTN03 3-3 TEST -O  K- \n");
     else
        printf("M3GRTN03 3-3 TEST - NG - \n");

     f1f10();
        printf("M3GRTN03 4-1 TEST -O  K- \n");

  printf("M3GRTN03 TEST-END \n");
}
...
m3gswh17 (void)  {
  ...
  if(a1==10)
    printf("M3GSWH17 1-1 TEST -O  K- \n");
  else
    printf("M3GSWH17 1-1 TEST - NG - \n");
  ...
  if(a2==0)
    printf("M3GSWH17 1-2 TEST -O  K- \n");
  else
    printf("M3GSWH17 1-2 TEST - NG - \n");
  ...
  if(a3==3)
    printf("M3GSWH17 1-3 TEST -O  K- \n");
  else
    printf("M3GSWH17 1-3 TEST - NG - \n");
  ...
  if(a4==0)
    printf("M3GSWH17 1-4 TEST -O  K- \n");
  else
    printf("M3GSWH17 1-4 TEST - NG - \n");
  ...
  if(b1==10)
    printf("M3GSWH17 2-1 TEST -O  K- \n");
  else
    printf("M3GSWH17 2-1 TEST - NG - \n");
  ...
  if(b2==0)
    printf("M3GSWH17 2-2 TEST -O  K- \n");
  else
    printf("M3GSWH17 2-2 TEST - NG - \n");
  ...
  if(b3==3)
    printf("M3GSWH17 2-3 TEST -O  K- \n");
  else
    printf("M3GSWH17 2-3 TEST - NG - \n");
  ...
  if(b4==0)
    printf("M3GSWH17 2-4 TEST -O  K- \n");
  else
    printf("M3GSWH17 2-4 TEST - NG - \n");
  ...
  if(x1==10)
    printf("M3GSWH17 3-1 TEST -O  K- \n");
  else
    printf("M3GSWH17 3-1 TEST - NG - \n");
  ...
  if(x2==0)
    printf("M3GSWH17 3-2 TEST -O  K- \n");
  else
    printf("M3GSWH17 3-2 TEST - NG - \n");
  ...
  if(b3==3)
    printf("M3GSWH17 3-3 TEST -O  K- \n");
  else
    printf("M3GSWH17 3-3 TEST - NG - \n");
  ...
  if(x4==0)
    printf("M3GSWH17 3-4 TEST -O  K- \n");
  else
    printf("M3GSWH17 3-4 TEST - NG - \n");
  ...
  if(y1==10)
    printf("M3GSWH17 4-1 TEST -O  K- \n");
  else
    printf("M3GSWH17 4-1 TEST - NG - \n");
  ...
  if(y2==0)
    printf("M3GSWH17 4-2 TEST -O  K- \n");
  else
    printf("M3GSWH17 4-2 TEST - NG - \n");
  ...
  if(y3==5)
    printf("M3GSWH17 4-3 TEST -O  K- \n");
  else
    printf("M3GSWH17 4-3 TEST - NG - \n");
  ...
  if(y4==10)
    printf("M3GSWH17 4-4 TEST -O  K- \n");
  else
    printf("M3GSWH17 4-4 TEST - NG - \n");

  printf("M3GSWH17 TEST-END \n");
...
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijb   ==   1
      printf(" *** O K (01-05) ***  \n");
   #else
      printf(" === N G (01-05) ===  \n");
   #endif
...
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefgha                 240
...
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghi                 239
...
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefgha           \
                        -                         \
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghijabcdefghij\
abcdefghijabcdefghijabcdefghijabcdefghi            == 1
...
#define  human  1234
   if (!memcmp(y('a'human'b') , "'a'1234'b'" , 10))
      printf(" *** O K (01-08) ***  \n");
   else
      printf(" === N G (01-08) ===  \n");

#define  abcdefgh  10101
   if (!memcmp(y("abc"abcdefgh"abc") , "\"abc\"10101\"abc\"" , 15))
      printf(" *** O K (01-09) ***  \n");
   else
      printf(" === N G (01-09) ===  \n");


#define  abcddcba  ababa
   if (!memcmp(y(\nabcddcba\t) , "\nababa\t" , 7))
      printf(" *** O K (01-11) ***  \n");
   else
      printf(" === N G (01-11) ===  \n");
...
int chk(struct t1 *ptr)
{
   ...
   if(ptr->aaa >= 0 && ptr->aaa < 3){
      if(rdata[ptr->aaa] == ptr->b) {
         printf(" ** OK *** t1.aaa = %d *** \n",ptr->aaa);
         printf(" ** OK *** t1.b = %c *** \n",ptr->b);
         return(0);
      } else {
