...
test8 (void)
 ...
 struct taga st = { 4, 5 };
     ...
     if (a1 != 6 || st.a != 1 || st.b != 2)
         printf(" *** TEST  TEST8-1 NG ***\n");
     }

 if (a1 != 5 || st.a != 4 || st.b != 5)
     printf(" *** TEST  TEST8-2 NG ***\n");
 }
