...
void 
arctan (int c[k100], int p, int q, int flag)
{
       int d,e;
       int a[k100];
       int b[k100];
...
prmul (int a[k100], int d)
 {
       ...
       for( i=k100-1;i>=0;i--) {
         ...
         if( s >= 1000 ) {
           ...
           carry=s/1000;
           if( s >=  1000000 ) {
             printf("error occer in mul s=%d",s);
             exit(1);
           }
         }
         else  {
...
void 
prdiv (int b[k100], int a[k100], int d)
{
       int i,s,h,j;
       i=0;
       h=a[i];
