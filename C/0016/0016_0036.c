...
void sub(double _Complex a[], double c)
{
  ...
  if ((creal(d[0]) == 100.0 && cimag(d[0]) == 30.0) &&
      (creal(d[1]) == 120.0 && cimag(d[1]) == 30.0) &&
      (creal(d[2]) == 140.0 && cimag(d[2]) == 30.0) &&
      (creal(d[3]) == 160.0 && cimag(d[3]) == 30.0) &&
      (creal(d[4]) == 180.0 && cimag(d[4]) == 30.0)) {
    printf("OK\n");
  }else{
