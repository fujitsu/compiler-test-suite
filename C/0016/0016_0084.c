...
int main()
{
  ...
  if ((crealf(*b) == 25.0f && cimagf(*b) == 3.0f) &&
      (crealf(*(b+1)) == 27.0f && cimagf(*(b+1)) == 3.0f) &&
      (crealf(*(b+2)) == 29.0f && cimagf(*(b+2)) == 3.0f) &&
      (crealf(*(b+3)) == 31.0f && cimagf(*(b+3)) == 3.0f) &&
      (crealf(*(b+4)) == 33.0f && cimagf(*(b+4)) == 3.0f)) {
    printf("OK\n");
  }else{
