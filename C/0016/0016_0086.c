...
int main()
{
  ...
  if ((crealf(*b) == 150.0f && cimagf(*b) == 45.0f) &&
      (crealf(*(b+1)) == 180.0f && cimagf(*(b+1)) == 45.0f) &&
      (crealf(*(b+2)) == 210.0f && cimagf(*(b+2)) == 45.0f) &&
      (crealf(*(b+3)) == 240.0f && cimagf(*(b+3)) == 45.0f) &&
      (crealf(*(b+4)) == 270.0f && cimagf(*(b+4)) == 45.0f)) {
    printf("OK\n");
  }else{
