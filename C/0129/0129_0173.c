...
{
  if (
    lfunc(cfunc(cfunc(1,1,1LL,1.,1.),
		sfunc(2,2,2LL,2.,2.),
		lfunc(3,3,3LL,3.,3.),
		ffunc(4,4,4LL,4.,4.),
		dfunc(5,5,5LL,5.,5.)),
	  sfunc(cfunc(1,1,1LL,1.,1.), 
		sfunc(2,2,2LL,2.,2.),
		lfunc(3,3,3LL,3.,3.),
		ffunc(4,4,4LL,4.,4.),
		dfunc(5,5,5LL,5.,5.)),
	  lfunc(cfunc(1,1,1LL,1.,1.), 
		sfunc(2,2,2LL,2.,2.),
		lfunc(3,3,3LL,3.,3.),
		ffunc(4,4,4LL,4.,4.),
		dfunc(5,5,5LL,5.,5.)),
	  ffunc(cfunc(1,1,1LL,1.,1.), 
		sfunc(2,2,2LL,2.,2.),
		lfunc(3,3,3LL,3.,3.),
		ffunc(4,4,4LL,4.,4.),
		dfunc(5,5,5LL,5.,5.)),
	  dfunc(cfunc(1,1,1LL,1.,1.), 
		sfunc(2,2,2LL,2.,2.),
		lfunc(3,3,3LL,3.,3.),
		ffunc(4,4,4LL,4.,4.),
		dfunc(5,5,5LL,5.,5.))) ==
    sfunc(cfunc(cfunc(1,2,3LL,4.,5.),
		sfunc(2,3,4LL,5.,1.),
		lfunc(3,4,5LL,1.,2.),
		ffunc(4,5,1LL,2.,3.),
		dfunc(5,1,2LL,3.,4.)),
          sfunc(cfunc(1,2,3LL,4.,5.),
		sfunc(2,3,4LL,5.,1.),
		lfunc(3,4,5LL,1.,2.),
		ffunc(4,5,1LL,2.,3.),
		dfunc(5,1,2LL,3.,4.)),
          lfunc(cfunc(1,2,3LL,4.,5.),
		sfunc(2,3,4LL,5.,1.),
		lfunc(3,4,5LL,1.,2.),
		ffunc(4,5,1LL,2.,3.),
		dfunc(5,1,2LL,3.,4.)),
          ffunc(cfunc(1,2,3LL,4.,5.),
		sfunc(2,3,4LL,5.,1.),
		lfunc(3,4,5LL,1.,2.),
		ffunc(4,5,1LL,2.,3.),
		dfunc(5,1,2LL,3.,4.)),
          dfunc(cfunc(1,2,3LL,4.,5.),
		sfunc(2,3,4LL,5.,1.),
		lfunc(3,4,5LL,1.,2.),
		ffunc(4,5,1LL,2.,3.),
		dfunc(5,1,2LL,3.,4.))))
