...
= {{1.0,0.0},{ 2.0,0.0},{ 3.0,0.0},{ 4.0,0.0},{ 5.0,0.0},{ 6.0,0.0},{ 7.0,0.0},{ 8.0,0.0},{ 9.0,0.0},{10.0,0.0},
   ...
   {71.0,0.0},{72.0,0.0},{73.0,0.0},{74.0,0.0},{75.0,0.0},{76.0,0.0},{77.0,0.0},{78.0,0.0},{79.0,0.0},{80.0,0.0},
   {81.0,0.0},{82.0,0.0},{83.0,0.0},{84.0,0.0},{85.0,0.0},{86.0,0.0},{87.0,0.0},{88.0,0.0},{89.0,0.0},{90.0,0.0},
   {91.0,0.0},{92.0,0.0},{93.0,0.0},{94.0,0.0},{95.0,0.0},{96.0,0.0},{97.0,0.0},{98.0,0.0},{99.0,0.0},{100.0,0.0}};

void sub(struct str * a)
{
  int i;
  for (i=1; i<N; ++i) {
    a[i].r1 = a[i].r1 + s[i].r1;
    a[i].r2 = a[i].r2 + s[i].r2;
  }
}
