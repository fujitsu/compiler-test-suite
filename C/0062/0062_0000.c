...
void calc_c8(float _Complex * restrict c8x, float _Complex c8y, float r4x, float r4y)
{
  *c8x = c8y + ((float _Complex)r4x + (float _Complex)r4y);
}

void calc_c16(double _Complex * restrict c16x, double _Complex c16y, double r8x, double r8y)
{
  *c16x = c16y + ((double _Complex)r8x + (double _Complex)r8y);
}
