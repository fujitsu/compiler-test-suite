...
void init(unsigned long long * dest, float * src1, unsigned int *dummy) {
  int i;
...
void test(unsigned long long * restrict dest, float * restrict src1, unsigned int * restrict dummy) {
  int i;
  for(i = 0;i < N;i++ ) {
