#include <stdio.h>
 ...
 unsigned short int       usisic( signed char i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usiunc( unsigned char i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usissi( signed short int i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usiusi(  unsigned short int i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usisli(  signed long int i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usiuli( unsigned long int i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usisll( signed long long int i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usiull( unsigned long long int i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usifla( float i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usidub( double i )
 {
 unsigned short int      k;  k=i; return k;
 }
 unsigned short int       usilgd( long double i )
 {
 unsigned short int      k;  k=i; return k;
 }
int main()
