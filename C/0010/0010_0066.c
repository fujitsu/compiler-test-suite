#include <stdio.h>
 ...
 unsigned long  int       ulisic( signed char i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       uliunc( unsigned char i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       ulissi(  signed short int i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       uliusi( unsigned short int i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       ulisli(  signed long int i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       uliuli( unsigned long  int i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       ulisll( signed long long int i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       uliull( unsigned long long int i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       ulifla( float i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       ulidub( double i )
 {
 unsigned long  int      k;  k=i; return k;
 }
 unsigned long  int       ulilgd( long double i )
 {
 unsigned long  int      k;  k=i; return k;
 }
int main()
