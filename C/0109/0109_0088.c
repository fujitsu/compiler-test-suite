...
i1  s_i1, input_i1[N], result_i1 =  0x80;
...
{
  long i;
#pragma omp simd reduction(min:s_i1)
  for(i=0;i<N;i++) {
    if (input_i1[i] < s_i1) {
      s_i1 = input_i1[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_i2)
  for(i=0;i<N;i++) {
    if (input_i2[i] < s_i2) {
      s_i2 = input_i2[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_i4)
  for(i=0;i<N;i++) {
    if (input_i4[i] < s_i4) {
      s_i4 = input_i4[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_i8)
  for(i=0;i<N;i++) {
    if (input_i8[i] < s_i8) {
      s_i8 = input_i8[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_u1)
  for(i=0;i<N;i++) {
    if (input_u1[i] < s_u1) {
      s_u1 = input_u1[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_u2)
  for(i=0;i<N;i++) {
    if (input_u2[i] < s_u2) {
      s_u2 = input_u2[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_u4)
  for(i=0;i<N;i++) {
    if (input_u4[i] < s_u4) {
      s_u4 = input_u4[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_u8)
  for(i=0;i<N;i++) {
    if (input_u8[i] < s_u8) {
      s_u8 = input_u8[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_r4)
  for(i=0;i<N;i++) {
    if (input_r4[i] < s_r4) {
      s_r4 = input_r4[i];
    }
...
{
  long i;
#pragma omp simd reduction(min:s_r8)
  for(i=0;i<N;i++) {
    if (input_r8[i] < s_r8) {
      s_r8 = input_r8[i];
    }
