...
int main()
{
   ...
   float                     fsub1(float f, signed char sch),fsub2(float f, short sh),
                             fsub3(float f, long int li),fsub4(float f, long long int lli),
                             fsub5(float f, unsigned char uch),fsub6(float f, unsigned short ush),
                             fsub7(float f, unsigned long int uli),fsub8(float f, unsigned long long int ulli),
                             fsub9(float f, double d),fsub10(float f, long double ld),f;
   double                    d;
