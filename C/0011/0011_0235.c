...
struct  TAG setst(BOOL p_sw);
BOOL chkst(struct TAG *chk_st_p, BOOL p_sw);
void prst256(struct  TAG *pr_st_p);
int main()
{
    struct TAG st256;
...
#endif
    printf("st256.i4 = %8lx  ", pr_st_p->i4);
    printf("st256.u4 = %8lx\n", pr_st_p->u4);
    for (i = 0; i < SIZE4; i++){
        printf("st256.ia4 = %8lx  ", pr_st_p->ia4[i]);
        printf("st256.ua4 = %8lx\n", pr_st_p->ua4[i]);
    }
