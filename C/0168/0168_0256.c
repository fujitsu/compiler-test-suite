...
void sub(DATA1 *strdata1, DATA2 *strdata2, STRDATA *strdata, DATAint *strintdata, DATAuint *struintdata, DATAlong *strlongdata, DATAulong *strulongdata, DATAshort *strshortdata, DATAushort *strushortdata, DATAfloat *strfloatdata, DATAdouble *strdoubledata, DATAldouble *strldoubledata, DATAchar *strchardata, DATAuchar *struchardata, DATAschar *strschardata){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strintdata->intdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (struintdata->uintdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strlongdata->longdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strulongdata->ulongdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strshortdata->shortdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strushortdata->ushortdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strfloatdata->floatdata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strdoubledata->doubledata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (strldoubledata->ldoubledata == 5)){
    ...
    if((strcmp(&(strschardata->schardata),"abcd") == 0) && (struchardata->uchardata == 5)){
...
int main(){
    ...
    strdata1 = (DATA1 *)work;
    strdata2 = (DATA2 *)work;
    strdata =  (STRDATA *)work;
    strintdata = (DATAint *)work;
    struintdata = (DATAuint *)work;
    strlongdata = (DATAlong *)work;
    strulongdata = (DATAulong *)work;
    strshortdata = (DATAshort *)work;
    strushortdata = (DATAushort *)work;
    strfloatdata = (DATAfloat *)work;
    strdoubledata = (DATAdouble *)work;
    strldoubledata = (DATAldouble *)work;
    strchardata = (DATAchar *)work;
    struchardata = (DATAuchar *)work;
    strschardata = (DATAschar *)work;

    sub(strdata1, strdata2, strdata, strintdata, struintdata, strlongdata, strulongdata, strshortdata, strushortdata, strfloatdata, strdoubledata, strldoubledata, strchardata, struchardata, strschardata);
