...
void sub(DATA1 *strdata1, DATA2 *strdata2, STRDATA *strdata, DATAint *strintdata, DATAuint *struintdata, DATAlong *strlongdata, DATAulong *strulongdata, DATAshort *strshortdata, DATAushort *strushortdata, DATAfloat *strfloatdata, DATAdouble *strdoubledata, DATAldouble *strldoubledata, DATAchar *strchardata, DATAuchar *struchardata, DATAschar *strschardata){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strintdata->intdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (struintdata->uintdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strlongdata->longdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strulongdata->ulongdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strshortdata->shortdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strushortdata->ushortdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strfloatdata->floatdata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strdoubledata->doubledata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (strldoubledata->ldoubledata == 5)){
    ...
    if((strcmp(&(strchardata->chardata),"abcd") == 0) && (struchardata->uchardata == 5)){
