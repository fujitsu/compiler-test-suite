...
void test_basic_msub_r4(float * restrict a, float * restrict b, 
...
void test_basic_msub_r8(double * restrict a, double * restrict b, 
...
int main(void) {
  ...
  test_basic_msub_r4(fa, fb, fc, fd, 10);
  test_basic_msub_r8(da, db, dc, dd, 10);
