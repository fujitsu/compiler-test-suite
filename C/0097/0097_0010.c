...
void sub(double a[][N], const double b[][N], const double c[][N], const double d[][N],
	 ...
	 const unsigned int m1[][N], const unsigned int m2[][N], const unsigned int m3[][N])
{
  int i,j;
...
int main(void) 
{
  ...
  sub((double (*)[N])a,(const double (*)[N])b,(const double (*)[N])c,(const double (*)[N])d,
      ...
      (const unsigned int (*)[N])m1,(const unsigned int (*)[N])m2,(const unsigned int (*)[N])m3);
