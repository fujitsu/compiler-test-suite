...
int main()
{
   struct { int i; char c; } st1[2][2]={0};
   union  { signed s; unsigned u; } un1[2][2]={0};
   enum   { en01, en02 } en1[2][2]={en01};
 
   struct { int i; char c; } volatile st2[2][2]={0};
   union  { signed s; unsigned u; } volatile un2[2][2]={0};
   enum   { en03, en04 } volatile en2[2][2]={en03};
 
   struct { int i; char c; } const st3[2][2]={0};
   union  { signed s; unsigned u; } const un3[2][2]={0};
   enum   { en05, en06 } const en3[2][2]={en05};
   ...
   ip[2] = (int *)&en3[1][0];
   ip[3] = (int *)&en3[1][1];
   if (en3[0][0]!=*ip[0] || en3[0][1]!=*ip[1] ||
       en3[1][0]!=*ip[2] || en3[1][1]!=*ip[3] ||
       en05!=0 || en06!=1)
