...
int main()
{
   ...
   struct sttag1 *st1p;
   struct sttag1 { int i; char c; } st1={0};
   union  untag1 *un1p;
   union  untag1 { signed s; unsigned u; } un1={0};
 
   struct sttag2 *st2p;
   struct sttag2 { int i; char c; } st2[2][2]={0};
   union  untag2 *un2p;
   union  untag2 { signed s; unsigned u; } un2[2][2]={0};
 
   struct sttag3 *st3p;
   struct sttag3 { int i; char c; } st3[2][2][2]={0};
   union  untag3 *un3p;
   union  untag3 { signed s; unsigned u; } un3[2][2][2]={0};
 
   struct sttag4 *st4p2;
   struct sttag4 { int i; char c; } *st4p,st4={0};
   union  untag4 *un4p2;
