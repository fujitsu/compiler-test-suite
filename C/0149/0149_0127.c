...
int main()
{
   struct { int i; char c; } st1[2][2][2]={0};
   union  { signed s; unsigned u; } un1[2][2][2]={0};
   enum   { en01, en02 } en1[2][2][2]={en01};
 
   struct { int i; char c; } volatile st2[2][2][2]={0};
   union  { signed s; unsigned u; } volatile un2[2][2][2]={0};
   enum   { en03, en04 } volatile en2[2][2][2]={en03};
 
   struct { int i; char c; } const st3[2][2][2]={0};
   union  { signed s; unsigned u; } const un3[2][2][2]={0};
   enum   { en05, en06 } const en3[2][2][2]={en05};
 
   struct { int i; char c; } typedef sttype[2][2][2];
   union  { signed s; unsigned u; } typedef untype[2][2][2];
   enum   { en07, en08 } typedef entype[2][2][2];
   sttype  st4={0};
   untype  un4={0};
   entype  en4={en07};
   ...
   st1[0][1][0].i = 0;  st1[0][0][0].c = 0;
   st1[1][1][1].i = 0;  st1[1][0][0].c = 0;
   ...
   st2[0][0][1].i = -1;  st2[0][0][1].c = 127;
   st2[1][1][0].i = 1;   st2[1][1][0].c = 2;
   st2[0][0][0] = st2[0][0][1];
   st2[1][1][1] = st2[1][1][0];
   st2[1][0][1] = st2[0][1][0];
   if (st2[0][0][0].i!=-1 || st2[0][0][0].c!=127 ||
       st2[0][0][1].i!=-1 || st2[0][0][1].c!=127 ||
       st2[1][1][0].i!=1  || st2[1][1][0].c!=2 ||
       st2[1][1][1].i!=1  || st2[1][1][1].c!=2 ||
       st2[1][0][1].i!=st2[0][1][0].i ||
       st2[1][0][1].c!=st2[0][1][0].c)
   ...
   if (un2[0][0][1].s!=-1 || un2[0][0][1].u!=4294967295 ||
       ...
       un2[0][0][0].s!=un2[1][1][1].s ||
       un2[0][0][0].u!=un2[1][1][1].u)
   ...
   ip[0] = (int *)&st3[0][0][0].i;
   ip[1] = (int *)&st3[0][1][1].i;
   ip[2] = (int *)&st3[1][0][0].i;
   ip[3] = (int *)&st3[1][1][1].i;
   cp[0] = (char *)&st3[0][0][0].c;
   cp[1] = (char *)&st3[0][1][1].c;
   cp[2] = (char *)&st3[1][0][0].c;
   cp[3] = (char *)&st3[1][1][1].c;
   if (st3[0][0][0].i!=*ip[0] ||
       st3[0][0][0].c!=*cp[0] ||
       st3[0][1][1].i!=*ip[1] ||
       st3[0][1][1].c!=*cp[1] ||
   ...
   sp[0] = (int *)&un3[0][0][1].s;
   sp[1] = (int *)&un3[0][1][1].s;
   sp[2] = (int *)&un3[1][0][1].s;
   sp[3] = (int *)&un3[1][1][1].s;
   if (un3[0][0][1].s!=*sp[0] ||
       un3[0][0][1].u!=(unsigned)*sp[0] ||
       un3[0][1][1].s!=*sp[1] ||
       un3[0][1][1].u!=(unsigned)*sp[1] ||
       un3[1][0][1].s!=*sp[2] ||
       un3[1][0][1].u!=(unsigned)*sp[2] ||
       un3[1][1][1].s!=*sp[3] ||
       un3[1][1][1].u!=(unsigned)*sp[3])
   ...
   if (st4[0][0][0].i!=-1 || st4[0][0][0].c!=127 ||
       ...
       st4[1][1][0].i!=st4[0][1][1].i ||
       st4[1][1][0].c!=st4[0][1][1].c)
   ...
   if (un4[0][0][0].s!=-1 || un4[0][0][0].u!=4294967295 ||
       ...
       un4[1][0][1].s!=un4[1][0][0].s ||
       un4[1][0][1].u!=un4[1][0][0].u)
