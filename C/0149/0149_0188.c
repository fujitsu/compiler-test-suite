...
#include <math.h>
 ...
 struct { int i; char c; } static st1[2][2][2];
 union  { signed s; unsigned u; } static un1[2][2][2];
 enum   { en01, en02 } static en1[2][2][2];
 
 struct { int i; char c; } volatile st2[2][2][2];
 union  { signed s; unsigned u; } volatile un2[2][2][2];
 enum   { en03, en04 } volatile en2[2][2][2];
 
 struct { int i; char c; } const st3[2][2][2];
 union  { signed s; unsigned u; } const un3[2][2][2];
