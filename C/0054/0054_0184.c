...
int main()  {
  ...
  if(a5==0)
    printf("02 1-5 TEST -O  K- \n");
  else
    printf("02 1-5 TEST - NG - \n");
  ...
  if(a6==0)
    printf("02 1-6 TEST -O  K- \n");
  else
    printf("02 1-6 TEST - NG - \n");
  ...
  if(a7==0)
    printf("02 1-7 TEST -O  K- \n");
  else
    printf("02 1-7 TEST - NG - \n");
  ...
  if(a8==10)
    printf("02 1-8 TEST -O  K- \n");
  else
    printf("02 1-8 TEST - NG - \n");

   switch((unsigned short)1)  {
     case (char)5:
       b1=5;
       break;
     case (char)1:
  ...
  if(b5==10)
    printf("02 2-5 TEST -O  K- \n");
  else
    printf("02 2-5 TEST - NG - \n");
  ...
  if(b6==10)
    printf("02 2-6 TEST -O  K- \n");
  else
    printf("02 2-6 TEST - NG - \n");

   switch((unsigned short)5)  {
     case (long int)5:
       b7=5;
       break;
     case (long int)1:
  ...
  if(b7==5)
    printf("02 2-7 TEST -O  K- \n");
  else
    printf("02 2-7 TEST - NG - \n");

   switch((unsigned short)2)  {
     case (unsigned long int)5:
       b8=5;
       break;
     case (unsigned long int)1:
  ...
  if(b8==0)
    printf("02 2-8 TEST -O  K- \n");
  else
    printf("02 2-8 TEST - NG - \n");
