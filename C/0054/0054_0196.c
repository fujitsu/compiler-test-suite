...
int main()  {
  ...
  if(a1==10)
    printf("14 1-1 TEST -O  K- \n");
  else
    printf("14 1-1 TEST - NG - \n");
  ...
  if(a2==0)
    printf("14 1-2 TEST -O  K- \n");
  else
    printf("14 1-2 TEST - NG - \n");
  ...
  if(a3==0)
    printf("14 1-3 TEST -O  K- \n");
  else
    printf("14 1-3 TEST - NG - \n");
  ...
  if(a4==0)
    printf("14 1-4 TEST -O  K- \n");
  else
    printf("14 1-4 TEST - NG - \n");
  ...
  if(a5==5)
    printf("14 1-5 TEST -O  K- \n");
  else
    printf("14 1-5 TEST - NG - \n");
  ...
  if(a6==0)
    printf("14 1-6 TEST -O  K- \n");
  else
    printf("14 1-6 TEST - NG - \n");
  ...
  if(a7==10)
    printf("14 1-7 TEST -O  K- \n");
  else
    printf("14 1-7 TEST - NG - \n");
  ...
  if(a8==0)
    printf("14 1-8 TEST -O  K- \n");
  else
    printf("14 1-8 TEST - NG - \n");
  ...
  if(b1==10)
    printf("14 2-1 TEST -O  K- \n");
  else
    printf("14 2-1 TEST - NG - \n");
  ...
  if(b2==0)
    printf("14 2-2 TEST -O  K- \n");
  else
    printf("14 2-2 TEST - NG - \n");
  ...
  if(b3==0)
    printf("14 2-3 TEST -O  K- \n");
  else
    printf("14 2-3 TEST - NG - \n");
  ...
  if(b4==0)
    printf("14 2-4 TEST -O  K- \n");
  else
    printf("14 2-4 TEST - NG - \n");
  ...
  if(b5==5)
    printf("14 2-5 TEST -O  K- \n");
  else
    printf("14 2-5 TEST - NG - \n");
  ...
  if(b6==0)
    printf("14 2-6 TEST -O  K- \n");
  else
    printf("14 2-6 TEST - NG - \n");
  ...
  if(b7==10)
    printf("14 2-7 TEST -O  K- \n");
  else
    printf("14 2-7 TEST - NG - \n");
  ...
  if(b8==0)
    printf("14 2-8 TEST -O  K- \n");
  else
    printf("14 2-8 TEST - NG - \n");
