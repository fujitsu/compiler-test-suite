...
else printf(" caka0006 ng 1\n");

t.b=t.bb=t.bbb=t.c=t.cc=t.ccc=t.u=t.f=1;
r.f=r.u=r.ccc=r.cc=r.c=r.bbb=r.bb=r.b=1;
if(t.b==r.b && (t.bb+r.bb)==0 && (t.bbb+r.bbb)==0 && t.c==r.c && t.cc==r.cc && t.ccc==r.ccc && t.u==r.u && t.f==r.f); else printf(" caka0006 ng 2\n");

t.b=t.bb=t.bbb=t.c=t.cc=t.ccc=t.u=t.f=255;
r.f=r.u=r.ccc=r.cc=r.c=r.bbb=r.bb=r.b=255;
if(t.b==r.b && r.f==1); else printf(" caka0006 ng3\n");
printf(" end caka0006\n");
}
