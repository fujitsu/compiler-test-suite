...
void sub01(double (*aa)[ELM_MAX2][ELM_MAX3],int,int,int,int,int,int,int,int,int);
...
void sub01(double (*aa)[ELM_MAX2][ELM_MAX3],int is,int ie,int iinc,
...
#pragma omp parallel
    {
#pragma omp for collapse(3) lastprivate(i,j,k)
