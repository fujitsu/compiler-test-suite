...
int main()
{
   ...
   struct { int i; char c; } st2[2][2]={{0,0},{0,0}};
   union  { signed s; unsigned u; } un2[2][2]={0};
   enum   { en03, en04 } en2[2][2];

   struct { int i; char c; } st3[2][2][2]={{{0,0},{0,0}},{{0,0},{0,0}}};
   union  { signed s; unsigned u; } un3[2][2][2]={0};
   enum   { en05, en06 } en3[2][2][2];

   struct { int i; char c; } *st4p=NULL, st4={0,0};
