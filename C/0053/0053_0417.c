...
int main()
{
   ...
   struct sttag1 *st1p;
   struct sttag1 { int i; unsigned char c; } st1;
   union  untag1 *un1p;
   union  untag1 { signed s; unsigned u; } un1;

   struct sttag2 *st2p;
   static struct sttag2 { int i; char c; } st2[2][2];
   union  untag2 *un2p;
   static union  untag2 { signed s; unsigned u; } un2[2][2];

   struct sttag3 *st3p;
   static struct sttag3 { int i; char c; } st3[2][2][2];
   union  untag3 *un3p;
   static union  untag3 { signed s; unsigned u; } un3[2][2][2];

   struct sttag4 *st4p2;
   struct sttag4 { int i; char c; } *st4p=NULL, st4={0,0};
   union  untag4 *un4p2;
   union  untag4 { signed s; unsigned u; } *un4p=NULL, un4={0};
   ...
   st1p = &st1;
   st1.i = -1;  st1.c = 255;
   if (st1.i!=-1 || st1.c!=255 || st1p->i!=-1 || st1p->c!=255 )
       printf(" *** \n");
   else
       printf(" *** \n");
