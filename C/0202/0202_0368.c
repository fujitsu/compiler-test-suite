#include <stdio.h>
  ...
  long double comp20_1_4[10] = {1.0};
  long double *comp20_1_5 = &comp20_1_1;
  typedef long double C20_1_6 ;
  C20_1_6 comp20_1_6 = {1.0};
  long double comp20_1_7[] = {1.0};

  long double comp20_2_0 = {1.0};
  const long double comp20_2_1 = {1.0};
  struct C20_2_2 {
  ...
  const long double comp20_2_4[10] = {1.0};
  const long double *comp20_2_5 = &comp20_2_1;
  typedef long double C20_2_6 ;
  const C20_2_6 comp20_2_6 = {1.0};
  const long double comp20_2_7[] = {1.0};

  volatile long double comp20_3_1 = {1.0};
  struct C20_3_2 {
  ...
  volatile long double comp20_3_4[10] = {1.0};
  volatile long double *comp20_3_5 = &comp20_3_1;
  typedef long double C20_3_6 ;
  volatile C20_3_6 comp20_3_6 = {1.0};
  volatile long double comp20_3_7[] = {1.0};

  long double comp20_4_0 = {1.0};
  const volatile long double comp20_4_1 = {1.0};
  struct C20_4_2 {
  ...
  const volatile long double comp20_4_4[10] = {1.0};
  const volatile long double *comp20_4_5 = &comp20_4_1;
  typedef long double C20_4_6 ;
  const volatile C20_4_6 comp20_4_6 = {1.0};
  const volatile long double comp20_4_7[] = {1.0};

#if defined (__STDC_VERSION__) && __STDC_VERSION__ >= 199901L
  long double comp20_5_0 = {1.0};
  long double * restrict comp20_5_1 = &comp20_5_0;
  struct C20_5_2 {
  ...
  long double * restrict comp20_5_4[10] = {&comp20_5_0};
  long double * restrict comp20_5_5 = &comp20_5_0;
  typedef long double C20_5_6 ;
  C20_5_6 * restrict comp20_5_6 = &comp20_5_0;
  long double * restrict comp20_5_7[] = {&comp20_5_0};
#endif

void sub_1()
{
  extern long double comp20_1_1;

  extern struct C20_1_2 comp20_1_2;
  extern union C20_1_3 comp20_1_3;
  extern long double comp20_1_4[10] ;
  extern long double *comp20_1_5;
  typedef long double C20_1_6 ;
  extern C20_1_6 comp20_1_6;
  extern long double comp20_1_7[];
...
void sub_2()
{
  extern long double comp20_2_0;
  extern const long double comp20_2_1;
  extern struct C20_2_2 comp20_2_2;
  extern union C20_2_3 comp20_2_3;
  extern const long double comp20_2_4[10];
  extern const long double *comp20_2_5;
  typedef long double C20_2_6 ;
  extern const C20_2_6 comp20_2_6;
  extern const long double comp20_2_7[];
...
void sub_3()
{
  extern volatile long double comp20_3_1;
  extern struct C20_3_2 comp20_3_2;
  extern union C20_3_3 comp20_3_3;
  extern volatile long double comp20_3_4[10];
  extern volatile long double *comp20_3_5;
  typedef long double C20_3_6 ;
  extern volatile C20_3_6 comp20_3_6;
  extern volatile long double comp20_3_7[];
...
void sub_4()
{
  extern long double comp20_4_0;
  extern const volatile long double comp20_4_1;
  extern struct C20_4_2 comp20_4_2;
  extern union C20_4_3 comp20_4_3;
  extern const volatile long double comp20_4_4[10];
  extern const volatile long double *comp20_4_5;
  typedef long double C20_4_6 ;
  extern const volatile C20_4_6 comp20_4_6;
  extern const volatile long double comp20_4_7[];
...
void sub_5()
{
  extern long double comp20_5_0;
  extern long double * restrict comp20_5_1;
  extern struct C20_5_2 comp20_5_2;
  extern union C20_5_3 comp20_5_3;
  extern long double * restrict comp20_5_4[10];
  extern long double * restrict comp20_5_5;
  typedef long double C20_5_6 ;
  extern C20_5_6 * restrict comp20_5_6;
  extern long double * restrict comp20_5_7[];
