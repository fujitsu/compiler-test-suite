...
int main()
{
  ...
  for(i=0;i<10;i++)
    {
      r4x[i] = crealf(c8a[i]) + cimagf(c8b[i]) + c8a[i];
      r4y[i] = cimagf(c8a[i]) + crealf(c8b[i]) * c8b[i];
    }
  ...
  for(i=0;i<10;i++)
    {
      r8x[i] = creal(c16a[i]) + cimag(c16b[i]) + c16a[i];
      r8y[i] = cimag(c16a[i]) + creal(c16b[i]) * c16b[i];
    }
  ...
  for(i=0;i<10;i++)
    {
      c16b[i] = c16a[i] + c16d[i] - (2.0+7.0I) ;
      c16d[i] = c16a[i] + c16b[i];
      r8y[i] = c16b[i];
    }
  ...
  for(i=0;i<10;i++)
    {
      c16b[i] = c16a[i] + c16d[i];
      c16d[i] = c16c[i] + c16b[i];
      r8x[i] = c16b[i];
      r8y[i] = c16d[i];
    }
