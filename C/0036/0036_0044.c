...
int main()
{
  ...
  for(i=0;i<10;i++)
    {
      c8d[i] = conj(c8b[i])+(2.0+3.0I);
      c8a[i] = crealf(c8d[i])+2;
    }
  ...
  for(i=0;i<10;i++)
    {
      c16d[i] = (c16b[i])+c16c[i];
      c16a[i] = 3 + c16d[i] - (4+6.0I);
    }
  ...
  for(i=0;i<10;i++)
    {
      c16d[i] = conj(c16b[i])+(2.0+3.0I);
      c16a[i] = creal(c16d[i])+2;
    }
  ...
  for(i=0;i<10;i++)
    {
      c16d[i] = (c16b[i]) + (2+3.0I);
      c16a[i] = conj(c16d[i])-(2+3.3I);
    }
