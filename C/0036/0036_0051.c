...
int main()
{
  ...
  for(i=0;i<10;i++)
    {
      c8a[i] = r4x[i] + r4y[i]*I;
      c8d[i] = crealf(c8b[i]) + cimagf(c8d[i])*I+c8d[i];
    }
  ...
  for(i=0;i<10;i++)
    {
      c8a[i] = cimagf(c8e[i]) + (cimagf(c8a[i])+r4x[i]*I)*I-3.0I;
      c8d[i] = cimagf(c8b[i]) + crealf(c8d[i])*I+c8d[i];
    }
  ...
  for(i=0;i<10;i++)
    {
      c8a[i] = crealf(c8e[i]*i) + cimagf(c8a[i]*I)+r4x[i]-i*I;
      c8d[i] = crealf(c8b[i]) * crealf(c8d[i])*I+c8d[i]*I;
    }
