...
integer, parameter :: var_size1(4)  = transfer(default_var, (/1/))
integer, parameter :: var_size2(2)  = transfer(ty1(ty0(2),1), (/1/))
integer, parameter :: var_size3(4)  = transfer((/default_var/), (/1/))
integer, parameter :: var_size4(2)  = transfer((/ty1(ty0(2),1)/), (/1/))
