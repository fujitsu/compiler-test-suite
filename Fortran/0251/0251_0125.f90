...
type(ty2),target :: bobj,bobj2(2,3)
...
if(same_type_as(ty2(2,4),mobj) .neqv. .false.) print*,113
if(extends_type_of(ty2(2,4),mobj) .neqv. .false.) print*,114
...
if(same_type_as(ty2(2,4),mobj2) .neqv. .false.) print*,113
if(extends_type_of(ty2(2,4),mobj2) .neqv. .false.) print*,114
