     ...
     type(t2):: v21,v22
      v21%x21=11
      allocate(v21%x22_alc(2))
      allocate(v22%x22_alc(2))
      v21%x21=14
      v21%x22_alc(1)%x11=12
      v21%x22_alc(2)%x11=13
      v21%x22_alc(1)%cmp_base%x12=15
      v21%x22_alc(2)%cmp_base%x12=16
      ...
      if (v22%x22_alc(1)%x11/=112)print *,202,v22%x22_alc(1)%x11
      if (v22%x22_alc(1)%cmp_base%x12/=115)print *,203,v22%x22_alc(1)%cmp_base%x12
      if (v22%x22_alc(2)%x11/=113)print *,204,v22%x22_alc(2)%x11
      if (v22%x22_alc(2)%cmp_base%x12/=116)print *,205,v22%x22_alc(2)%cmp_base%x12
