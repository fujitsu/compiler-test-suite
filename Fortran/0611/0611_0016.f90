...
SUBROUTINE s1
  ...
  obj%v22(1)=obj%v21(1)
  obj%v22(2)=obj%v21(2)
  IF (obj%v22(2)%x21 .EQ. 12)PRINT *,'pass1/3'
  IF (obj%v22(1)%x22%x11(1,1,3) .EQ. 103)PRINT *,'pass2/3'
  IF (obj%v22(2)%x22%x11(1,1,3) .EQ. 130)PRINT *,'pass3/3'
END SUBROUTINE
END
