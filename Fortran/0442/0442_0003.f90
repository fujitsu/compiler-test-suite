...
SUBROUTINE s1
  ...
  ALLOCATE(obj%v22(3)%x22%x11(2,1,3))
  ALLOCATE(obj%v22(4)%x22%x11(2,1,3))
  ...
  IF (obj%v21(1)%x22%x11(1,1,3) .NE. 3)PRINT *,'pass2/3a'
  IF (obj%v21(2)%x22%x11(1,1,3) .NE. 30)PRINT *,'pass3/3a'
  obj%v22(3:4)=obj%v21(1:2)
  IF (obj%v22(4)%x21 .NE. 12)PRINT *,'pass1/3'
  IF (obj%v22(3)%x22%x11(1,1,3) .NE. 103)PRINT *,'pass2/3'
  IF (obj%v22(4)%x22%x11(1,1,3) .NE. 130)PRINT *,'pass3/3'
END SUBROUTINE
END
