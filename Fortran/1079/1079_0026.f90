...
implicit none
  ...
  allocate(t1)
  read(unit=136,'(DT(2,3))'),t1
write(144,*)k1,k2,k4,k3,z,"'",zz,"'"
k1=0;k2=0;k3=0;z=0;zz='';k4=0
  allocate(ty2::t2)
  read(unit=137,'(DT(2,3))'),t2
write(144,*)k1,k2,k4,k3,z,"'",zz,"'"
  allocate(t1)
  read(unit=138)t1
write(145,*)k1,k2,k3,z
k1=0;k2=0;k3=0;z=0
  allocate(ty2::t2)
  read(unit=139)t2
write(146,*)k1,k2,k3,z
  ...
  allocate(t1)
    open(unit=140, form='FORMATTED')
  write(unit=140,'(DT(2,3))'),t1
  allocate(t2)
    open(unit=141, form='FORMATTED')
  write(unit=141,'(DT(2,3))'),t2
  allocate(t1)
  write(unit=142)t1
  allocate(ty2::t2)
  write(unit=143)t2
