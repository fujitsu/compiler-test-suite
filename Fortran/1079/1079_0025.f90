...
implicit none
  ...
  allocate(t1)
  read(unit=125,'(DT(2,3))'),t1
write(133,*)k1,k2,k4,k3,z,"'",zz,"'"
k1=0;k2=0;k3=0;z=0;zz='';k4=0
  allocate(ty2::t2)
  read(unit=126,'(DT(2,3))'),t2
write(133,*)k1,k2,k4,k3,z,"'",zz,"'"
  allocate(t1)
  read(unit=127)t1
write(134,*)k1,k2,k3,z
k1=0;k2=0;k3=0;z=0
  allocate(ty2::t2)
  read(unit=128)t2
write(135,*)k1,k2,k3,z

  allocate(t1)
    open(unit=129, form='FORMATTED')
  write(unit=129,'(DT(2,3))'),t1
  allocate(t2)
    open(unit=130, form='FORMATTED')
  write(unit=130,'(DT(2,3))'),t2
  allocate(t1)
  write(unit=131)t1
  allocate(ty2::t2)
  write(unit=132)t2
