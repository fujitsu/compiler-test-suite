     ...
     + 61,62,63/))
      ...
      parameter(i1a=ibclr(i1x,i1y))
      parameter(i2a=ibclr(i2x,i2y))
      parameter(i4a=ibclr(i4x,i4y))
      parameter(i8a=ibclr(i8x,i8y))

      do i=1,8
        call checki1(i1a(i),ibclr(i1x(i),i1y(i)))
      enddo
      do i=1,16
        call checki2(i2a(i),ibclr(i2x(i),i2y(i)))
      enddo
      do i=1,32
        call checki4(i4a(i),ibclr(i4x(i),i4y(i)))
      enddo
      do i=1,64
        call checki8(i8a(i),ibclr(i8x(i),i8y(i)))
      enddo
      print *,'*** ok ***'
      end
