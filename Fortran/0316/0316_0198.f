      ...
      do i=1,5
        call checki1(m1(i),and(i1(i),j1(i)))
        call checki2(m2(i),and(i2(i),j2(i)))
        call checki4(m4(i),and(i4(i),j4(i)))
        call checki8(m8(i),and(i8(i),j8(i)))
        call checki8(n8(i),and(k8(i),l8(i)))
      enddo
      print *,'*** ok ***'
      end
