      ...
      parameter (i1x=1,i1p=4,i1l=0)
      parameter (i2x=1,i2p=4,i2l=0)
      parameter (i4x=1,i4p=4,i4l=0)
      parameter (i8x=1,i8p=4,i8l=0)
      ...
      call checki1(i1a,ibits(i1x,i1p,i1l))
      call checki2(i2a,ibits(i2x,i2p,i2l))
      call checki4(i4a,ibits(i4x,i4p,i4l))
