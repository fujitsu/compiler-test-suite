      ...
      integer*1,   dimension(5),parameter ::i1a=0
      integer*2,   dimension(5),parameter ::i2a=0
      integer*4,   dimension(5),parameter ::i4a=0
      integer*8,   dimension(5),parameter ::i8a=0
      real*4,      dimension(5),parameter ::r4a=0.0
      real*8,      dimension(5),parameter ::r8a=0.0
      real*16,     dimension(5),parameter ::r16a=0.0
      complex*8,   dimension(5),parameter ::c8a=(0.0,0.0)
      complex*16,  dimension(5),parameter ::c16a=(0.0,0.0)
      complex*32,  dimension(5),parameter ::c32a=(0.0,0.0)
      logical*1,   dimension(5),parameter ::L1a=.true.
      logical*4,   dimension(5),parameter ::L4a=.false.
      character*1, dimension(5),parameter ::cha='a'
      integer*1   i1b(5)
      integer*2   i2b(5)
      integer*4   i4b(5)
      integer*8   i8b(5)
