      ...
      parameter(m1=iand(i1,j1))
      parameter(m2=iand(i2,j2))
      parameter(m4=iand(i4,j4))
      parameter(m8=iand(i8,j8))
      parameter(n8=iand(k8,l8))

      do i=1,5
        call checki1(m1(i),iand(i1(i),j1(i)))
        call checki2(m2(i),iand(i2(i),j2(i)))
        call checki4(m4(i),iand(i4(i),j4(i)))
        call checki8(m8(i),iand(i8(i),j8(i)))
        call checki8(n8(i),iand(k8(i),l8(i)))
      enddo
      print *,'*** ok ***'
      end
