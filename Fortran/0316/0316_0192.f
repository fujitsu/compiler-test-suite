      ...
      parameter(m1=ior(i1,j1))
      parameter(m2=ior(i2,j2))
      parameter(m4=ior(i4,j4))
      parameter(m8=ior(i8,j8))
      parameter(n8=ior(k8,l8))

      do i=1,5
        call checki1(m1(i),ior(i1(i),j1(i)))
        call checki2(m2(i),ior(i2(i),j2(i)))
        call checki4(m4(i),ior(i4(i),j4(i)))
        call checki8(m8(i),ior(i8(i),j8(i)))
        call checki8(n8(i),ior(k8(i),l8(i)))
      enddo
      print *,'*** ok ***'
      end
