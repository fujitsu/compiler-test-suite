      ...
      parameter(m1=ieor(i1,j1))
      parameter(m2=ieor(i2,j2))
      parameter(m4=ieor(i4,j4))
      parameter(m8=ieor(i8,j8))
      parameter(n8=ieor(k8,l8))

      do i=1,5
        call checki1(m1(i),ieor(i1(i),j1(i)))
        call checki2(m2(i),ieor(i2(i),j2(i)))
        call checki4(m4(i),ieor(i4(i),j4(i)))
        call checki8(m8(i),ieor(i8(i),j8(i)))
        call checki8(n8(i),ieor(k8(i),l8(i)))
      enddo
      print *,'*** ok ***'
      end
