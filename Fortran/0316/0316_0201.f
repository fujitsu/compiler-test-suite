      ...
      parameter(m1=or(i1,j1))
      parameter(m2=or(i2,j2))
      parameter(m4=or(i4,j4))
      parameter(m8=or(i8,j8))
      parameter(n8=or(k8,l8))

      do i=1,5
        call checki1(m1(i),or(i1(i),j1(i)))
        call checki2(m2(i),or(i2(i),j2(i)))
        call checki4(m4(i),or(i4(i),j4(i)))
        call checki8(m8(i),or(i8(i),j8(i)))
        call checki8(n8(i),or(k8(i),l8(i)))
      enddo
      print *,'*** ok ***'
      end
