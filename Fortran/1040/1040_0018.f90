...
contains
  ...
  pure function f3(y1,y2,xxx) result(fa)
    ...
    integer,intent(in) :: y1(y2)
    integer,intent(in) :: xxx(:)
    integer :: fa(-0+size(array=+(0)+xxx,dim=1))
    do i=1,size(xxx) ; fa(i)=i ; enddo
  end function
  ...
  pure function f5(y1,y2,xxx) result(fa)
    ...
    integer,intent(in) :: y1(y2)
    integer,intent(in) :: xxx(:)
    integer :: fa(-0+size(dim=1,array=+(0)+xxx))
    do i=1,size(xxx) ; fa(i)=i ; enddo
  end function
end
subroutine subc()
...
contains
  ...
  pure function f3(y1,y2,xxx) result(fa)
    ...
    integer,intent(in) :: y1(y2)
    integer,intent(in) :: xxx(:)
    integer :: fa(-0+size(array=+(((((xxx))))),dim=1))
    do i=1,size(xxx) ; fa(i)=i ; enddo
  end function
  pure function f4(y1,y2,xxx) result(fa)
    integer,intent(in) :: y2
  ...
  pure function f5(y1,y2,xxx) result(fa)
    ...
    integer,intent(in) :: y1(y2)
    integer,intent(in) :: xxx(:)
    integer :: fa(-0+size(dim=1,array=+(((((xxx)))))))
    do i=1,size(xxx) ; fa(i)=i ; enddo
  end function
end
subroutine subb()
...
contains
  ...
  pure function f3(y1,y2,xxx) result(fa)
    ...
    integer,intent(in) :: y1(y2)
    integer,intent(in) :: xxx(:)
    integer :: fa(-0+size(array=(((((xxx)+0)))),dim=1))
    do i=1,size(xxx) ; fa(i)=i ; enddo
  end function
  pure function f4(y1,y2,xxx) result(fa)
    integer,intent(in) :: y2
