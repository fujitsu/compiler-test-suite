...
j1=-1;j2=10000
if (any(lbound(f1(a(j1:j2),b))/=1))print *,'error-1'
if (any(ubound(f1(a(j1:j2),b))/=10002))print *,'error-2'
if (size(f1(a(j1:j2),b))/=10002)print *,'error-3'
if (any(f1(a(j1:j2),b)/=20))print *,'error-4'
c=f1(a(j1:j2),b)
if (any(c/=20))print *,'error-5'
end do
print *,'pass'
end
