...
subroutine d1pc1b2a2p
use m
call alloc(d1p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1p(ii1,ii2,ii3)%c1(j1,j2,j3)%b2%a2p=1
end do; end do; end do
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1p(i1,i2,i3)%c1(ii1,ii2,ii3)%b2%a2p=1
end do; end do; end do
d1p(i1,i2,i3)%c1(j1,j2,j3)%b2%a2p=1
d1p(i1,i2,i3)%c1(j1,j2,j3)%b2%a2p=1
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1p(ii1,ii2,ii3)%c1(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (   (d1p(i1,i2,i3)%c1(ii1,ii2,ii3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
if (any(d1p(i1,i2,i3)%c1(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (any(d1p(i1,i2,i3)%c1(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
subroutine d2pc1b2a2p
use m
call alloc(d2p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
d2p%c1(j1,j2,j3)%b2%a2p=1
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d2p%c1(ii1,ii2,ii3)%b2%a2p=1
end do; end do; end do
d2p%c1(j1,j2,j3)%b2%a2p=1
d2p%c1(j1,j2,j3)%b2%a2p=1
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
if (   (d2p%c1(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d2p%c1(ii1,ii2,ii3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
if (any(d2p%c1(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (any(d2p%c1(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
subroutine d1pc2b2a2p
use m
call alloc(d1p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1p(ii1,ii2,ii3)%c2%b2%a2p=1
end do; end do; end do
d1p(i1,i2,i3)%c2%b2%a2p=1
d1p(i1,i2,i3)%c2%b2%a2p=1
d1p(i1,i2,i3)%c2%b2%a2p=1
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1p(ii1,ii2,ii3)%c2%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
if (   (d1p(i1,i2,i3)%c2%b2%a2p/=1))write(6,*) "NG"
if (any(d1p(i1,i2,i3)%c2%b2%a2p/=1))write(6,*) "NG"
if (any(d1p(i1,i2,i3)%c2%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
if (   (d2p%c2%b2%a2p/=1))write(6,*) "NG"
if (   (d2p%c2%b2%a2p/=1))write(6,*) "NG"
if (any(d2p%c2%b2%a2p/=1))write(6,*) "NG"
if (any(d2p%c2%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1(ii1,ii2,ii3)%c1p(j1,j2,j3)%b2%a2p=1
end do;end do;end do
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1(i1,i2,i3)%c1p(ii1,ii2,ii3)%b2%a2p=1
end do;end do;end do
d1(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p=1
d1(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p=1
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1(ii1,ii2,ii3)%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do;end do;end do
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1(i1,i2,i3)%c1p(ii1,ii2,ii3)%b2%a2p/=1))write(6,*) "NG"
end do;end do;end do
if (any(d1(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (any(d1(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
subroutine d2c1pb2a2p
use m
call alloc(d2%c1p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
d2%c1p(j1,j2,j3)%b2%a2p=1
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d2%c1p(ii1,ii2,ii3)%b2%a2p=1
end do; end do; end do
d2%c1p(j1,j2,j3)%b2%a2p=1
d2%c1p(j1,j2,j3)%b2%a2p=1
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
if (   (d2%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d2%c1p(ii1,ii2,ii3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
if (any(d2%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (any(d2%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1(ii1,ii2,ii3)%c2p%b2%a2p=1
end do;end do;end do
d1(i1,i2,i3)%c2p%b2%a2p=1
d1(i1,i2,i3)%c2p%b2%a2p=1
d1(i1,i2,i3)%c2p%b2%a2p=1
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1(ii1,ii2,ii3)%c2p%b2%a2p/=1))write(6,*) "NG"
end do;end do;end do
if (   (d1(i1,i2,i3)%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d1(i1,i2,i3)%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d1(i1,i2,i3)%c2p%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
if (   (d2%c2p%b2%a2p/=1))write(6,*) "NG"
if (   (d2%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d2%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d2%c2p%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
subroutine d1pc1pb2a2p
use m
call alloc(d1p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1p(ii1,ii2,ii3)%c1p(j1,j2,j3)%b2%a2p=1
d1p(i1,i2,i3)%c1p(ii1,ii2,ii3)%b2%a2p=1
end do;end do;end do
d1p(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p=1
d1p(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p=1
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1p(ii1,ii2,ii3)%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (   (d1p(i1,i2,i3)%c1p(ii1,ii2,ii3)%b2%a2p/=1))write(6,*) "NG"
end do;end do;end do
if (any(d1p(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (any(d1p(i1,i2,i3)%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
subroutine d2pc1pb2a2p
use m
call alloc(d2p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
d2p%c1p(j1,j2,j3)%b2%a2p=1
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d2p%c1p(ii1,ii2,ii3)%b2%a2p=1
end do; end do; end do
d2p%c1p(j1,j2,j3)%b2%a2p=1
d2p%c1p(j1,j2,j3)%b2%a2p=1
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
if (   (d2p%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d2p%c1p(ii1,ii2,ii3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
if (any(d2p%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
if (any(d2p%c1p(j1,j2,j3)%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
subroutine d1pc2pb2a2p
use m
call alloc(d1p)
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
d1p(ii1,ii2,ii3)%c2p%b2%a2p=1
end do; end do; end do
d1p(i1,i2,i3)%c2p%b2%a2p=1
d1p(i1,i2,i3)%c2p%b2%a2p=1
d1p(i1,i2,i3)%c2p%b2%a2p=1
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
do ii1=m1,m2;do ii2=m1,m2;do ii3=m1,m2
if (   (d1p(ii1,ii2,ii3)%c2p%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
if (   (d1p(i1,i2,i3)%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d1p(i1,i2,i3)%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d1p(i1,i2,i3)%c2p%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
...
do i1=m1,m2;do i2=m1,m2;do i3=m1,m2; do j1=m1,m2;do j2=m1,m2;do j3=m1,m2; do k1=m1,m2;do k2=m1,m2;do k3=m1,m2; do n1=m1,m2;do n2=m1,m2;do n3=m1,m2
if (   (d2p%c2p%b2%a2p/=1))write(6,*) "NG"
if (   (d2p%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d2p%c2p%b2%a2p/=1))write(6,*) "NG"
if (any(d2p%c2p%b2%a2p/=1))write(6,*) "NG"
end do; end do; end do
end do; end do; end do
end do; end do; end do
