...
subroutine sub(i1)
 use m1
integer::b1(0,0),b3(i1,i1)
integer,allocatable::b2(:,:)
allocate(b2(0,0))
if (any(f1(b1,b1,b1,b1,b1,b1,b1)/=2))write(6,*) "NG"
if (any(lbound(f1(b1,b1,b1,b1,b1,b1,b1))/=0))write(6,*) "NG"
if (any(ubound(f1(b1,b1,b1,b1,b1,b1,b1))/=0))write(6,*) "NG"
if (any(shape (f1(b1,b1,b1,b1,b1,b1,b1))/=1))write(6,*) "NG"
if (   (size  (f1(b1,b1,b1,b1,b1,b1,b1))/=1))write(6,*) "NG"
if (any(f1(b2,b2,b2,b2,b2,b2,b2)/=2))write(6,*) "NG"
if (any(lbound(f1(b2,b2,b2,b2,b2,b2,b2))/=0))write(6,*) "NG"
if (any(ubound(f1(b2,b2,b2,b2,b2,b2,b2))/=0))write(6,*) "NG"
if (any(shape (f1(b2,b2,b2,b2,b2,b2,b2))/=1))write(6,*) "NG"
if (   (size  (f1(b2,b2,b2,b2,b2,b2,b2))/=1))write(6,*) "NG"
if (any(f1(b3,b3,b3,b3,b3,b3,b3)/=2))write(6,*) "NG"
if (any(lbound(f1(b3,b3,b3,b3,b3,b3,b3))/=0))write(6,*) "NG"
if (any(ubound(f1(b3,b3,b3,b3,b3,b3,b3))/=0))write(6,*) "NG"
if (any(shape (f1(b3,b3,b3,b3,b3,b3,b3))/=1))write(6,*) "NG"
if (   (size  (f1(b3,b3,b3,b3,b3,b3,b3))/=1))write(6,*) "NG"
