  ...
  program main
    ...
    complex,allocatable :: l1(:)
    character(0),allocatable :: l4(:,:,:,:)
    character(2),allocatable :: l3(:,:,:)
    ...
    if (ubound(mv1%e2,2).ne.1) error = error+1
    if (ubound(mv1%e3,3).ne.1) error = error+1
    if (ubound(mv1%e4,4).ne.1) error = error+1

    if (any(mv1%e1 .ne.1))       error = error+1
    if (any(mv1%e2 .ne.(1.,0.))) error = error+1
    if (any(mv1%e3 .ne.""))      error = error+1
    if (any(mv1%e4 .ne."  "))    error = error+1
    ...
    if (ubound(mv2(2,1)%e2,2).ne.1) error = error+1
    if (ubound(mv2(1,2)%e3,3).ne.1) error = error+1
    if (ubound(mv2(1,1)%e4,4).ne.1) error = error+1

    if (any(mv2(1,2)%e1 .ne.1))       error = error+1
    if (any(mv2(1,1)%e2 .ne.(1.,0.))) error = error+1
    if (any(mv2(2,2)%e3 .ne.""))      error = error+1
    if (any(mv2(2,1)%e4 .ne."  "))    error = error+1
    ...
    if (ubound(mv3(2,1)%e2,2).ne.1) error = error+1
    if (ubound(mv3(1,2)%e3,3).ne.1) error = error+1
    if (ubound(mv3(1,1)%e4,4).ne.1) error = error+1

    if (any(mv3(1,2)%e1 .ne.1))       error = error+1
    if (any(mv3(1,1)%e2 .ne.(1.,0.))) error = error+1
    if (any(mv3(2,2)%e3 .ne.""))      error = error+1
    if (any(mv3(2,1)%e4 .ne."  "))    error = error+1
    ...
    if (lbound(mv4(1,2)%e2,2).ne.1) error = error+1
    if (lbound(mv4(2,1)%e3,3).ne.1) error = error+1
    if (lbound(mv4(2,2)%e4,4).ne.1) error = error+1

    if (ubound(mv4(2,2)%e1,1).ne.1) error = error+1
    if (ubound(mv4(2,1)%e2,2).ne.1) error = error+1
    if (ubound(mv4(1,2)%e3,3).ne.1) error = error+1
    if (ubound(mv4(1,1)%e4,4).ne.1) error = error+1

    if (any(mv4(1,2)%e1 .ne.1))       error = error+1
    if (any(mv4(1,1)%e2 .ne.(1.,0.))) error = error+1
    if (any(mv4(2,2)%e3 .ne.""))      error = error+1
    if (any(mv4(2,1)%e4 .ne."  "))    error = error+1
    ...
    if (lbound(mv5(1,2)%e2,2).ne.1) error = error+1
    if (lbound(mv5(2,1)%e3,3).ne.1) error = error+1
    if (lbound(mv5(2,2)%e4,4).ne.1) error = error+1

    if (ubound(mv5(2,2)%e1,1).ne.1) error = error+1
    if (ubound(mv5(2,1)%e2,2).ne.1) error = error+1
    if (ubound(mv5(1,2)%e3,3).ne.1) error = error+1
    if (ubound(mv5(1,1)%e4,4).ne.1) error = error+1

    if (any(mv5(1,2)%e1 .ne.1))       error = error+1
    if (any(mv5(1,1)%e2 .ne.(1.,0.))) error = error+1
    if (any(mv5(2,2)%e3 .ne.""))      error = error+1
    if (any(mv5(2,1)%e4 .ne."  "))    error = error+1
