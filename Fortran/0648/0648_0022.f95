  ...
  program main
    ...
    subroutine extsub(aa,item)
      use typ
      type(xxx),intent(in) :: aa
      integer,intent(in) :: item
    end subroutine

    function extfun(aa,item)
      use typ
      integer :: extfun
      type(xxx),intent(in) :: aa
      integer,intent(in) :: item
    ...
    call extsub(xxx(ai,ax,ac0,ac2),1)
    call extsub(xxx(funi(1),funx(1),func0(1),func2(1)),1)
    call extsub(xxx(.false._1+.false._1,.false._2+.false._2, &
        &       .false._4+.false._4,.false._8+.false._8),1)
    call extsub(aa,1)
    call extsub(funa(1),1)
    call extsub("0"+"0",1)

    allocate(ai(1:1),ax(2:2),ac0(4:4),ac2(8:8))
    ai = 1 ; ax = (1.,1.) ; ac0 = 'abcdefg' ; ac2="AL"
    call extsub(xxx(ai,ax,ac0,ac2),2)
    call extsub(xxx(funi(2),funx(2),func0(2),func2(2)),2)
    call extsub(xxx(.false._1+.true._1,.false._2+.true._2, &
    ...
    ai = 1 ; ax = (1.,1.) ; ac0 = 'abcdefg' ; ac2="AL"
    call extsub(xxx(ai,ax,ac0,ac2),3)
    call extsub(xxx(funi(3),funx(3),func0(3),func2(3)),3)
    call extsub(xxx(.true._1+.false._1,.true._2+.false._2, &
        &       .true._4+.false._4,.true._8+.false._8),3)
    allocate(aa%ai(-1:0),aa%ax(-2:-1),aa%ac0(-4:-3),aa%ac2(-8:-7))
    aa%ai = 1 ; aa%ax = (1.,1.) ; aa%ac0 = 'abcdefg' ; aa%ac2="AL"
    call extsub(aa,3)
    call extsub(funa(3),3)
    call extsub("1"+"0",3)
    ...
    allocate(ai(1:0),ax(2:-1),ac0(4:-3),ac2(8:-7))
    ai = 1 ; ax = (1.,1.) ; ac0 = 'abcdefg' ; ac2="AL"
    call extsub(xxx(ai,ax,ac0,ac2),4)
    call extsub(xxx(funi(4),funx(4),func0(4),func2(4)),4)
    call extsub(xxx(.true._1+.true._1,.true._2+.true._2, &
        &       .true._4+.true._4,.true._8+.true._8),4)
    allocate(aa%ai(1:0),aa%ax(2:-1),aa%ac0(4:-3),aa%ac2(8:-7))
    aa%ai = 1 ; aa%ax = (1.,1.) ; aa%ac0 = 'abcdefg' ; aa%ac2="AL"
    call extsub(aa,4)
    call extsub(funa(4),4)
    call extsub("1"+"1",4)

    deallocate(ai,ax,ac0,ac2)
    deallocate(aa%ai,aa%ax,aa%ac0,aa%ac2)

    res = extfun(xxx(ai,ax,ac0,ac2),1)
    res = extfun(xxx(funi(1),funx(1),func0(1),func2(1)),1)
    ...
    allocate(ai(1:1),ax(2:2),ac0(4:4),ac2(8:8))
    ai = 1 ; ax = (1.,1.) ; ac0 = 'abcdefg' ; ac2="AL"
    res = extfun(xxx(ai,ax,ac0,ac2),2)
    res = extfun(xxx(funi(2),funx(2),func0(2),func2(2)),2)
    res = extfun(xxx(.false._1+.true._1,.false._2+.true._2, &
        &       .false._4+.true._4,.false._8+.true._8),2)
    allocate(aa%ai(1:1),aa%ax(2:2),aa%ac0(4:4),aa%ac2(8:8))
    aa%ai = 1 ; aa%ax = (1.,1.) ; aa%ac0 = 'abcdefg' ; aa%ac2="AL"
    res = extfun(aa,2)
    ...
    allocate(ai(-1:0),ax(-2:-1),ac0(-4:-3),ac2(-8:-7))
    ai = 1 ; ax = (1.,1.) ; ac0 = 'abcdefg' ; ac2="AL"
    res = extfun(xxx(ai,ax,ac0,ac2),3)
    res = extfun(xxx(funi(3),funx(3),func0(3),func2(3)),3)
    res = extfun(xxx(.true._1+.false._1,.true._2+.false._2, &
        &       .true._4+.false._4,.true._8+.false._8),3)
    allocate(aa%ai(-1:0),aa%ax(-2:-1),aa%ac0(-4:-3),aa%ac2(-8:-7))
    aa%ai = 1 ; aa%ax = (1.,1.) ; aa%ac0 = 'abcdefg' ; aa%ac2="AL"
    res = extfun(aa,3)
    ...
    allocate(ai(1:0),ax(2:-1),ac0(4:-3),ac2(8:-7))
    ai = 1 ; ax = (1.,1.) ; ac0 = 'abcdefg' ; ac2="AL"
    res = extfun(xxx(ai,ax,ac0,ac2),4)
    res = extfun(xxx(funi(4),funx(4),func0(4),func2(4)),4)
    res = extfun(xxx(.true._1+.true._1,.true._2+.true._2, &
        &       .true._4+.true._4,.true._8+.true._8),4)
    allocate(aa%ai(1:0),aa%ax(2:-1),aa%ac0(4:-3),aa%ac2(8:-7))
    aa%ai = 1 ; aa%ax = (1.,1.) ; aa%ac0 = 'abcdefg' ; aa%ac2="AL"
    res = extfun(aa,4)
