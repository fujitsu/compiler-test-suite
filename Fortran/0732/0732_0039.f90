...
complex(16),allocatable,dimension(:,:)::P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
...
P8(1:N2,1:N3) = TRANSPOSE( reshape((/(cmplx(i,i,16),i=1,6)/),(/3,2/)))
P9(1:N2,1:N3) = TRANSPOSE( reshape((/(1._16,1.),(2.,2._16),(3.,3._16),(4.,4._16),(5.,5._16),(6.,6._16)/),(/3,2/)))
PA(1:N2,1:N3) = TRANSPOSE( reshape((/POP(1:N3,1:N2)/),(/3,2/)))
PB(1:N2,1:N3) = TRANSPOSE( reshape((/POP(1:N3,1:N2)+POP(VN3,VN2)-POP(:,:)/),(/3,2/)))
PC(1:N2,1:N3) = TRANSPOSE( cmplx(reshape((/(cmplx(i,i,16),i=1,6)/),(/N3,N2/))))
PD(1:N2,1:N3) = TRANSPOSE( reshape((/(1._16,1.),(2.,2._16),(3.,3._16),(4.,4._16),(5.,5._16),(6.,6._16)/),(/N3,N2/)))
...
call s(TRANSPOSE( (reshape((/(cmplx(i,i,16),i=1,6)/),(/3,2/)))))
call s(TRANSPOSE( reshape((/(1._16,1.),(2.,2._16),(3.,3._16),(4.,4._16),(5.,5._16),(6.,6._16)/),(/3,2/))))
call s( TRANSPOSE( reshape((/POP(1:N3,1:N2)/),(/3,2/))))
call s(TRANSPOSE( reshape((/POP(1:N3,1:N2)+POP(VN3,VN2)-POP(:,:)/),(/3,2/))))
call s( TRANSPOSE( (reshape((/(cmplx(i,i,16),i=1,6)/),(/N3,N2/)))))
call s( TRANSPOSE( reshape((/(1._16,1.),(2.,2._16),(3.,3._16),(4.,4._16),(5.,5._16),(6.,6._16)/),(/N3,N2/))))
