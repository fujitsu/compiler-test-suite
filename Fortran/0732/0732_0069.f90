...
type uu
logical(2),pointer,dimension(:,:,:,:)::POP
end type
type (uu) ::u2(3,2)
logical,allocatable,dimension(:,:)::P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
...
P8(1:N2,1:N3) = TRANSPOSE( (reshape((/w,z,w,z,w,z/),(/3,2/))))
P9(1:N2,1:N3) = TRANSPOSE( reshape((/w,z,w,z,w,z/),(/3,2/)))
PA(1:N2,1:N3) = TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,4)/),(/3,2/)))
PB(1:N2,1:N3) = TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,4).and.u2(3,2)%POP(1,VN3,VN2,4).and.u2(3,2)%POP(1,:,:,4)/),(/3,2/)))
PC(1:N2,1:N3) = TRANSPOSE( (reshape((/w,z,w,z,w,z/),(/N3,N2/))))
PD(1:N2,1:N3) = TRANSPOSE( reshape((/w,z,w,z,w,z/),(/N3,N2/)))
PE(1:N2,1:N3) = TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,4)/),(/N3,N2/)))
PF(1:N2,1:N3) = TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,4).and.u2(3,2)%POP(1,VN3,VN2,4).and.u2(3,2)%POP(1,:,:,4)/),(/N3,N2/)))
...
call s(TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,N4).and.u2(3,2)%POP(1,VN3,VN2,N4).and.u2(3,2)%POP(1,:,:,4)/),(/3,2/))))
call s( TRANSPOSE( (reshape((/w,z,w,z,w,z/),(/N3,N2/)))))
call s( TRANSPOSE( reshape((/w,z,w,z,w,z/),(/N3,N2/))))
call s( TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,N4)/),(/N3,N2/))))
call s( TRANSPOSE( reshape((/u2(N3,N2)%POP(N1,1:N3,1:N2,N4).and.u2(3,2)%POP(1,VN3,VN2,4).and.u2(3,2)%POP(1,:,:,4)/),(/N3,N2/))))
