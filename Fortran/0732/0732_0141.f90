...
matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1))),matmul(matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1)),&
matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1)))))
write(47,*)(matmul(matmul(matmul(b,c),matmul(b,c)),matmul(matmul(b,c),matmul(b,c))))
write(47,*)(matmul(matmul(matmul(b(i1:i3,i1:i3),c(i1:i3,i1:i3)),matmul(b(i1:i3,i1:i3),c(i1:i3,i1:i3))),matmul(matmul(b(i1:i3,i1:i3),c(i1:i3,i1:i3)),matmul(b(i1:i3,i1:i3),c(i1:i3,i1:i3)))))
write(47,*)(matmul(matmul(matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1)),&
matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1))),matmul(matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1)),&
matmul(b(i3-i2:i1+i2,i4-i3:i4-i1),c(i3-i2:i1+i2,i4-i3:i4-i1)))))
rewind 47
do ix=1,3
read(47,*) a;call chk(a)
end do
print *,'pass'
contains
 subroutine chk(b)
