...
write(1,*)matmul(bbb(:,:,1,1,1,1)+bbb(:,:,1,1,1,1)-b,ccc(1,1,1,1,:,c4)-c(:,c4)+ccc(1,1,1,1,:,c4))
...
write(1,*)matmul(bbb(b1:b2,b3:b4,1,1,1,1),ccc(1,1,1,1,x,c4))
 ...
 real,dimension(:,:,:,:,:,:)::bbb,ccc
write(1,*)matmul(bbb(:,:,1,1,1,1)+bbb(:,:,1,1,1,1)-bbb(:,:,1,1,1,1),ccc(1,1,1,1,:,c4)-c(:,c4)+ccc(1,1,1,1,:,c4))
 end subroutine
end
