...
write(1,*) (/ (/ ( (1, 2 ,I=1,1), 3 , 4 ,I2=IU4V,1 ) /), 5 /)
write(11,*) (/ (/ ( (1, 2 ,I=1,2), 3 , 4 ,I2=IU4V,1 ) /), 5 /)
write(2,*) (/ (/ ( (1, 2 ,I=1,2), 3 , 4 ,I2=IU4V,2 ) /), 5 /)
write(2,*) (/ (/ ( (1, 2 ,I=K1,2), 3 , 4 ,I2=IU4V,2 ) /), 5 /)
write(2,*) (/ (/ ( (V1, V2 ,I=K1,K2), V3 , V4 ,I2=KK1,KK2 ) /), V5 /)
write(3,*) (/ (/ ( (V1, V2 ,V3,I=K1,K2), V4 , V5 ,I2=KK1,KK2 ) /), V6 /)
...
if (kk/=5)write(6,*) "NG"
rewind 1
read(1,*) r(:5);if (any(r(:5)/=(/1,2,3,4,5/)))write(6,*) "NG"
rewind 11
read(11,*) r(:7);if (any(r(:7)/=(/1,2,1,2,3,4,5/)))write(6,*) "NG"
rewind 2
read(2,*) r(:13);if (any(r(:13)/=(/1,2,1,2,3,4,1,2,1,2,3,4,5/)))write(6,*) "NG"
read(2,*) r(:13);if (any(r(:13)/=(/1,2,1,2,3,4,1,2,1,2,3,4,5/)))write(6,*) "NG"
read(2,*) r(:13);if (any(r(:13)/=(/1,2,1,2,3,4,1,2,1,2,3,4,5/)))write(6,*) "NG"
rewind 3
read(3,*) r(:17);if (any(r(:17)/=(/1,2,3,1,2,3,4,5,1,2,3,1,2,3,4,5,6/)))write(6,*) "NG"
print *,'pass'
end
