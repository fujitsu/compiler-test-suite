logical(4),parameter::w=.true.,z=.false.
logical(4),allocatable,dimension(:,:)::POP
logical(4),allocatable,dimension(:,:)::P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
...
call s(TRANSPOSE( logical(reshape((/w,z,w,z,w,z/),(/3,2/)),4)))
...
call s( TRANSPOSE( logical(reshape((/w,z,w,z,w,z/),(/N3,N2/)),4)))
