...
i1=-1;i2=-2;i3=-3;i4=-4
write(42,*)matmul( matmul(xyz(b),xyz(c)) , matmul(xyz(d),xyz(e)) )
...
write(42,*)(matmul( matmul(xyz(b),xyz(c))+matmul(xyz(b),xyz(c))-matmul(xyz(b),xyz(c)) ,&
 matmul(xyz(d),xyz(e))+matmul(xyz(d),xyz(e))-matmul(xyz(d),xyz(e)) )+ matmul( matmul(xyz(b),xyz(c)) ,&
 matmul(xyz(d),xyz(e)) ) -matmul( matmul(xyz(b),xyz(c)) , matmul(xyz(d),xyz(e)) ))
write(42,*)matmul( matmul(xyz(b(i3:i1:-i1,i2:i1:-i1)),xyz(c(i2:i1:-i1,i4:i1:-i1))) , matmul(xyz(d(i4:i1:-i1,i3:i1:-i1)),xyz(e(i3:i1:-i1,i2:i1:-i1))) )
...
matmul( matmul(xyz(b(i3:i1:-i1,i2:i1:-i1)),xyz(c(i2:i1:-i1,i4:i1:-i1))) ,&
 matmul(xyz(d(i4:i1:-i1,i3:i1:-i1)),xyz(e(i3:i1:-i1,i2:i1:-i1))) ))
write(42,*)(matmul( matmul(xyz(b(i3:i1:-i1,i2:i1:-i1)),xyz(c(i2:i1:-i1,i4:i1:-i1)))+matmul(xyz(b(i3:i1:-i1,i2:i1:-i1)),xyz(c(i2:i1:-i1,i4:i1:-i1)))-&
