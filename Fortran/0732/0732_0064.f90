type uu
integer(2),dimension(1,3,2,4:4)::POP
end type
type (uu) ::u2(3,2)
integer,dimension(2,3)::P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
integer::VN2(2),VN3(3)
VN2=(/1,2/);VN3=(/1,2,3/)
...
P8(1:N2,1:N3) = TRANSPOSE( (reshape((/(i,i=1,6)/),(/3,2/))))
P9(1:N2,1:N3) = TRANSPOSE( reshape((/1_2,2_2,3_2,4_2,5_2,6_2/),(/3,2/)))
...
PC(1:N2,1:N3) = TRANSPOSE( (reshape((/(i,i=1,6)/),(/N3,N2/))))
PD(1:N2,1:N3) = TRANSPOSE( reshape((/1_2,2_2,3_2,4_2,5_2,6_2/),(/N3,N2/)))
...
call s(TRANSPOSE( (reshape((/(int(i,2),i=1,6)/),(/3,2/)))))
call s(TRANSPOSE( reshape((/1_2,2_2,3_2,4_2,5_2,6_2/),(/3,2/))))
...
call s( TRANSPOSE( (reshape((/(int(i,2),i=1,6)/),(/N3,N2/)))))
call s( TRANSPOSE( reshape((/1_2,2_2,3_2,4_2,5_2,6_2/),(/N3,N2/))))
