...
Allocate(obj0(k)%obj1(2),obj0(k)%obj2(2),obj0(k)%obj3(2))
 do m=1,2
Allocate(obj0(k)%obj1(m)%ii1,obj0(k)%obj1(m)%rr1,obj0(k)%obj1(m)%cmp1,obj0(k)%obj1(m)%ll1)
Allocate(obj0(k)%obj2(m)%ii2,obj0(k)%obj2(m)%rr2,obj0(k)%obj2(m)%cmp2,obj0(k)%obj2(m)%ll2)
Allocate(obj0(k)%obj3(m)%ii3,obj0(k)%obj3(m)%rr3,obj0(k)%obj3(m)%cmp3,obj0(k)%obj3(m)%ll3)
Allocate(character(len=2)::obj0(k)%obj1(m)%ch1,obj0(k)%obj2(m)%ch2,obj0(k)%obj3(m)%ch3)
...
print *,201
 ...
 if(obj0(k)%obj1(m)%ii1 .ne. 20) print *,202, obj0(k)%obj1(m)%ii1
 if(obj0(k)%obj1(m)%rr1.ne. 20.0) print *,203, obj0(k)%obj1(m)%rr1
 if(obj0(k)%obj1(m)%ch1.ne. '20') print *,204, obj0(k)%obj1(m)%ch1
 if(obj0(k)%obj1(m)%cmp1 .ne. (20.0,20.0)) print *,205, obj0(k)%obj1(m)%cmp1
 if(obj0(k)%obj1(m)%ll1 .neqv. .TRUE.) print *,206, obj0(k)%obj1(m)%ll1
end if
...
print *,301
 ...
 if(obj0(k)%obj2(m)%ii2 .ne. 20) print *,302, obj0(k)%obj2(m)%ii2
 if(obj0(k)%obj2(m)%rr2 .ne. 20.0) print *,303, obj0(k)%obj2(m)%rr2
 if(obj0(k)%obj2(m)%ch2 .ne. '20') print *,304, obj0(k)%obj2(m)%ch2
 if(obj0(k)%obj2(m)%cmp2 .ne. (20.0,20.0)) print *,305, obj0(k)%obj2(m)%cmp2
 if(obj0(k)%obj2(m)%ll2 .neqv. .TRUE.) print *,306, obj0(k)%obj2(m)%ll2
end if
...
print *,401
 ...
 if(obj0(k)%obj3(m)%ii3 .ne. 20) print *,402, obj0(k)%obj3(m)%ii3
 if(obj0(k)%obj3(m)%rr3 .ne. 20.0) print *,403, obj0(k)%obj3(m)%rr3
 if(obj0(k)%obj3(m)%ch3 .ne. '20') print *,404, obj0(k)%obj3(m)%ch3
 if(obj0(k)%obj3(m)%cmp3 .ne. (20.0,20.0)) print *,405, obj0(k)%obj3(m)%cmp3
 if(obj0(k)%obj3(m)%ll3 .neqv. .TRUE.) print *,406, obj0(k)%obj3(m)%ll3
end if
  end do
end do
...
do k=1,2
  do m=1,2
    ...
    dmy(k)%obj2(m)%ii2 = 40
    dmy(k)%obj3(m)%ii3 = 40
    dmy(k)%obj1(m)%rr1 = 40.0
    dmy(k)%obj2(m)%rr2 = 40.0
    dmy(k)%obj3(m)%rr3 = 40.0
    dmy(k)%obj1(m)%ch1 = '40'
    dmy(k)%obj2(m)%ch2 = '40'
    dmy(k)%obj3(m)%ch3 = '40'
    dmy(k)%obj1(m)%cmp1 = (40.0,40.0)
    dmy(k)%obj2(m)%cmp2 = (40.0,40.0)
    dmy(k)%obj3(m)%cmp3 = (40.0,40.0)
    dmy(k)%obj1(m)%ll1 = .FALSE.
    dmy(k)%obj2(m)%ll2 = .FALSE.
    dmy(k)%obj3(m)%ll3 = .FALSE.
