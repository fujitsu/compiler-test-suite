...
call s1(obj0(1:3:2,2),obj0(2,1:3:2))
...
print *,201
 ...
 if(obj0(k,j)%obj1%ii1 .ne. 20+k) print *,202, obj0(k,j)%obj1%ii1
 if(obj0(k,j)%obj1%rr1.ne. 20.0+k) print *,203, obj0(k,j)%obj1%rr1
...
print *,301
 ...
 if(obj0(k,j)%obj2%ii2 .ne. 20+k) print *,302, obj0(k,j)%obj2%ii2
 if(obj0(k,j)%obj2%rr2 .ne. 20.0+k) print *,303, obj0(k,j)%obj2%rr2
...
print *,401
 ...
 if(obj0(k,j)%obj3%ii3 .ne. 20+k) print *,402, obj0(k,j)%obj3%ii3
 if(obj0(k,j)%obj3%rr3 .ne. 20.0+k) print *,403, obj0(k,j)%obj3%rr3
