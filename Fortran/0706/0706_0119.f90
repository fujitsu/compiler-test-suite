...
c
     ...
     1 j=i1+i1,i1+i1,i1+i1)/)))
      character::x07(ubound((/(c2(j1(i1):j1(i2):j1(i1))(:),
     1 j=i1+i1,i1+i1,i1+i1)/),dim=1))
      character::x08(ubound((/(c3(j1(i1):j1(i2):j1(i1))(:),
     1 j=i1+i1,i1+i1,i1+i1)/),dim=1))
      character::x09(ubound((/(c4(j1(i1):j1(i2):j1(i1))(:),
     1 j=i1+i1,i1+i1,i1+i1)/),dim=1))
      character::x10(ubound((/(c5(j1(i1):j1(i2):j1(i1))(:),
     1 j=i1+i1,i1+i1,i1+i1)/),dim=1))
      character::x11(ubound((/(c6(j1(i1):j1(i2):j1(i1))(:),
     1 j=i1+i1,i1+i1,i1+i1)/),dim=1))
      k=2
