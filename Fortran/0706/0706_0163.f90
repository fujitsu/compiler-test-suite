     ...
     1 reshape((/ichar('1'),ichar('2'),ichar('3'),ichar('4')/),(/2,2/))
      integer ::v(2)=(/1,2/)
      call s(char(ichar(char(m(v,v)))-
     1 index(char(m(v,v)),char(m(v,v)))+1)//
     1       a(v,v)(i:3)//b(v,v)(i:3),
     1       (/'12323','26767','3bcbc','4fgfg'/),5)
      call s(a(v,v)(i:3)//
     1   char(ichar(char(m(v,v)))-
     1  index(char(m(v,v)),char(m(v,v)))+1)//b(v,v)(i:3),
     1       (/'23123','67267','bc3bc','fg4fg'/),5)
      call s(a(v,v)(i:3)//b(v,v)(i:3)//
     1   char(ichar(char(m(v,v)))-index(char(m(v,v)),char(m(v,v)))+1),
     ...
     1       (/'1123','2267','33bc','44fg'/),4)
      call s(char(ichar(char(m(v,v)))-
     1  index(char(m(v,v)),char(m(v,v)))+1)//
     1      a(v,v)(i:3)//char(ichar(char(m(v,v)))-
     1  index(char(m(v,v)),char(m(v,v)))+1),
