      ...
      LOGICAL AC
      DO 2 I=R,C11(1)
 2    IF(AC( E11(I)*A11(I+1),E11(I)**A11(I+1),&
            E11(I)*B11(I+1),E11(I)**B11(I+1),&
            E11(I)*C11(I+1),E11(I)**C11(I+1),&
            E11(I)*D11(I+1),E11(I)**D11(I+1),&
            E11(I)*E11(I+1),E11(I)**E11(I+1),&
            E11(I)*F11(I+1),E11(I)**F11(I+1),&
            E11(I)*G11(I+1),E11(I)**G11(I+1),&
            E11(I)*H11(I+1),E11(I)**H11(I+1),&
            E11(I)*I11(I+1),E11(I)**I11(I+1),&
            E11(I)*J11(I+1),E11(I)**J11(I+1)))PRINT *,'FAIL'

      END
      FUNCTION AC(IA1,IA2,IB1,IB2,IC1,IC2,ID1,ID2,IE1,IE2,IF1,IF2, &
                 IG1,IG2,IH1,IH2,II1,II2,IJ1,IJ2)
      LOGICAL  AC
      REAL   *4   IA1,IA2,RA1,RA2
      REAL   *4   IB1,IB2,RB1,RB2
      REAL   *4   IC1,IC2,RC1,RC2
      REAL   *4   ID1,ID2,RD1,RD2
