 ...
 subroutine s1
 use m1,j1=>n1,k1=>i1,k2=>i2
  type (y1) :: i3
  namelist /n2/k1,k2,i3
 call ss1
  k1=101
  k2=y1(201,'202',x1(203,'204'))
  write(21,j1) 
  k1=0
  k2=y1(0,'0',x1(0,'0'))
  rewind 21;read(21,j1) 
  if (k1/=101)print *,'fail'
  if (k2/=y1(201,'202',x1(203,'204')))print *,'fail'
  k1=901
  k2=y1(801,'802',x1(803,'804'))
  i3=y1(301,'302',x1(303,'304'))
  write(22,n2) 
      k1=0
      k2=y1(0,'0',x1(0,'0'))
      ...
      if (k1/=901)print *,'fail'
      if (k2/=y1(801,'802',x1(803,'804')))print *,'fail'
      if (i3/=y1(301,'302',x1(303,'304')))print *,'fail'
      call ss21
      contains
       subroutine ss21
        type (y1) :: i4
        namelist /n3/k1,k2,i3,i4
        k1=401
        k2=y1(501,'502',x1(503,'504'))
        i3=y1(601,'602',x1(603,'604'))
        i4=y1(701,'702',x1(703,'704'))
        write(23,n3)
        k1=0
        ...
        if (k1/=401)print *,'fail'
        if (k2/=y1(501,'502',x1(503,'504')))print *,'fail'
        if (i3/=y1(601,'602',x1(603,'604')))print *,'fail'
        if (i4/=y1(701,'702',x1(703,'704')))print *,'fail'
       end subroutine
    end subroutine
