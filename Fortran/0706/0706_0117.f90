...
c
      ...
      call       s12(i1,i2,c1,c2,c3,c4,c5,c6)
      call       s13(i1,i2,c1,c2,c3,c4,c5,c6)
      end
      subroutine s11(i1,i2,c1,c2,c3,c4,c5,c6)
      entry      s12(i1,i2,c1,c2,c3,c4,c5,c6)
      entry      s13(i1,i2,c1,c2,c3,c4,c5,c6)
      integer i1,i2
      ...
      character*( 2),dimension(i1:i2)::c6
      integer ::v(2)=(/1,2/)
      character::x01(len((/(c1(:),j=1,i1)/)))
      character::x02(len((/(c2(v(:))(:),j=1,i1)/)))
      character::x03(len((/(c3(v(:))(:),j=1,i1)/)))
      character::x04(len((/(c4(v(:))(:),j=1,i1)/)))
      character::x05(len((/(c5(v(:))(:),j=1,i1)/)))
      character::x06(len((/(c6(v(:))(:),j=1,i1)/)))
      character::x07(ubound((/(c2(v(:))(:),j=1,i1)/),dim=1))
      character::x08(ubound((/(c3(v(:))(:),j=1,i1)/),dim=1))
      character::x09(ubound((/(c4(v(:))(:),j=1,i1)/),dim=1))
      character::x10(ubound((/(c5(v(:))(:),j=1,i1)/),dim=1))
      character::x11(ubound((/(c6(v(:))(:),j=1,i1)/),dim=1))
      k=2
