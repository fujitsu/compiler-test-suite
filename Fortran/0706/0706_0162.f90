     ...
     1 reshape((/ichar('1'),ichar('2'),ichar('3'),ichar('4')/),(/2,2/))
      integer v(2)/1,2/
      call s(char(m(v,v))//a(v,v)(i:3)//b(v,v)(i:3),
     1       (/'12323','26767','3bcbc','4fgfg'/),5)
      call s(a(v,v)(i:3)//char(m(v,v))//b(v,v)(i:3),
     1       (/'23123','67267','bc3bc','fg4fg'/),5)
      call s(a(v,v)(i:3)//b(v,v)(i:3)//char(m(v,v)),
     1       (/'23231','67672','bcbc3','fgfg4'/),5)
      call s(a(v,v)(i:3)//b(v,v)(i:3),
     1       (/'2323','6767','bcbc','fgfg'/),4)
      call s(char(m(v,v))//char(m(v,v))//b(v,v)(i:3),
     1       (/'1123','2267','33bc','44fg'/),4)
      call s(char(m(v,v))//a(v,v)(i:3)//char(m(v,v)),
     1       (/'1231','2672','3bc3','4fg4'/),4)
      call s(char(m(v,v))//char(m(v,v))//char(m(v,v)),
     1       (/'111','222','333','444'/),3)
      call s(a(v,v)(i:3)//char(m(v,v))//char(m(v,v)),
