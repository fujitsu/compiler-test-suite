...
i=index(a,b)
j=index(a,'abx')
k=index('a pencil','pen')
m=index('a eraser','a',.true.)
write(23,*)i,j,k,m
write(23,*) index(a,b), index(a,'abx'), index('a pencil','pen'), index('a eraser','a',.true.)
rewind 23
read (23,*)i,j,k,m
...
if (   (k1/=3))print *,'fail'
if (   (m1/=5))print *,'fail'
call ss41(a,b,i,j,k,m)
 contains
    subroutine ss41(a,b,i,j,k,m)
 character(len=*) ::a(:,:)
 character(len=*) ::b(:,:)
...
m=index('a eraser','a',.true.)
write(22,*)i,j,k,m
write(22,*) index(a,b), index(a,'abx'), index('a pencil','pen'), index('a eraser','a',.true.)
rewind 22
read (22,*)i,j,k,m
if (any(i/=6))print *,'fail'
if (any(j/=0))print *,'fail'
...
if (   (k1/=3))print *,'fail'
if (   (m1/=5))print *,'fail'
call ss44(index(a,b), index(a,'abx'))
    end subroutine
    subroutine ss44(i,j)
...
m=index('a eraser','a',.true.)
write(13,*)i,j,k,m
write(13,*) index(a,b), index(a,'abx'), index('a pencil','pen'), index('a eraser','a',.true.)
rewind 13
read (13,*)i,j,k,m
if (any((/i,j,k,m/)/=(/6,0,3,5/)))print *,'fail'
read (13,*)i,j,k,m
if (any((/i,j,k,m/)/=(/6,0,3,5/)))print *,'fail'
call ss31(a,b,i,j,k,m)
 contains
    subroutine ss31(a,b,i,j,k,m)
 character(len=*) ::a
 character(len=*) ::b
i=index(a,b)
j=index(a,'abx')
...
m=index('a eraser','a',.true.)
write(12,*)i,j,k,m
write(12,*) index(a,b), index(a,'abx'), index('a pencil','pen'), index('a eraser','a',.true.)
rewind 12
read (12,*)i,j,k,m
if (any((/i,j,k,m/)/=(/6,0,3,5/)))print *,'fail'
read (12,*)i,j,k,m
...
m=index('a eraser','a',.true.)
write(11,*)i,j,k,m
write(11,*) index(a,b), index(a,'abx'), index('a pencil','pen'), index('a eraser','a',.true.)
rewind 11
read (11,*)i,j,k,m
if (any((/i,j,k,m/)/=(/6,0,3,5/)))print *,'fail'
read (11,*)i,j,k,m
