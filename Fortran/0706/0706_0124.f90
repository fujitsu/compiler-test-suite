...
c
     ...
     1    reshape((/'1','2','3','4','5','6'/),(/3,2/))
       interface
        subroutine ss21(a1,a2,j1,c,d,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,j2)
        character*(j1)::a1(j2*j1:); character*(j1)::a2(j2*j1:,j2*j1:)
     ...
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm
      call ent11
      call ent12
      call ent13
      call ss21(x1,x2,j1,x2(1,1),x1,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,2)
      call ss22(x1,x2,j1,x2(1,1),x1,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,2)
      call ss23(x1,x2,j1,x2(1,1),x1,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,2)
      call ent21
      call ent22
      call ent23
      ...
      entry      ent12
      entry      ent13
      character*(j1)::a1(j2*j1:)
      character*(j1)::a2(j2*j1:,j2*j1:)
      character*(j1)::b3(ubound(a1,dim=1))
      character*(j1)::b4(ubound(a2,dim=1))
      character*(j1)::b5(ubound(a2,dim=2))
      character*(j1)::b6(size  (a1,dim=1))
      ...
      character*(*) c,d(*)
      return
      entry      ss21(a1,a2,j1,c,d,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,j2)
      entry      ss22(a1,a2,j1,c,d,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,j2)
      entry      ss23(a1,a2,j1,c,d,
     1 b3,b4,b5,b6,b7,b8,b9,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,j2)
