     ...
     1 ch5_pa=(/ 1_'abcde', 1_'fghij' /)
      type (cd),parameter::cd01=cd( cd_ps ,cd_ps )
      type (c8),parameter::c801=c8( c8_ps ,c8_ps )
      type (r8),parameter::r801=r8( r8_ps ,r8_ps )
      type (r4),parameter::r401=r4( r4_ps ,r4_ps )
      type (i4),parameter::i401=i4( i4_ps ,i4_ps )
      type (l4),parameter::l401=l4( l4_ps ,l4_ps )
      type (i2),parameter::i201=i2( i2_ps ,i2_ps )
