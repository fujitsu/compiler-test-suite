...
c
      ...
      subroutine s1
      integer,parameter::       v211=2,v121=3,v221=4,
     1                   v112=5,v212=6,v122=7,v222=8
      integer,parameter,dimension(2)::f1=(/2,1/)
      integer,parameter,dimension(2)::f2=(/1,2/)
      integer,parameter,dimension(3)::sh=(/2,2,2/)
      integer,parameter,dimension(8)::v=(/1,2,3,4,5,6,7,8/)
      integer,parameter,dimension(2,2,2)::a=reshape(v,sh)
      integer,parameter,dimension(2,2):: j01=a(f1,1:2   ,2)
      integer,parameter,dimension(2,2):: j02=a(f1,2:1:-1,2)
      integer,parameter,dimension(2,2):: j03=a(f1, :    ,2)
      integer,parameter,dimension(2,2):: j04=a(f1, : :1 ,2)
      integer,parameter,dimension(2,2):: j05=a(f1,1: :1 ,2)
      integer,parameter,dimension(2,2):: j06=a(f1, :2:1 ,2)
      integer,parameter,dimension(2,2):: j11=a(1:2   ,2,f1)
      integer,parameter,dimension(2,2):: j12=a(2:1:-1,2,f1)
      integer,parameter,dimension(2,2):: j13=a( :    ,2,f1)
      integer,parameter,dimension(2,2):: j14=a( : :1 ,2,f1)
      integer,parameter,dimension(2,2):: j15=a(1: :1 ,2,f1)
      integer,parameter,dimension(2,2):: j16=a( :2:1 ,2,f1)
      integer,parameter,dimension(2,2):: j21=a(2,f1,1:2   )
      integer,parameter,dimension(2,2):: j22=a(2,f1,2:1:-1)
      integer,parameter,dimension(2,2):: j23=a(2,f1, :    )
      integer,parameter,dimension(2,2):: j24=a(2,f1, : : 1)
      integer,parameter,dimension(2,2):: j25=a(2,f1,1: : 1)
      integer,parameter,dimension(2,2):: j26=a(2,f1, :2: 1)
      integer,parameter,dimension(2,2):: j31=a(2,f1,f2)
      integer,parameter,dimension(2,2):: j32=a(2,f1,f1)
      integer,parameter,dimension(2,2):: j33=a(f2,2,f1)
      integer,parameter,dimension(2,2):: j34=a(f1,2,f1)
      integer,parameter,dimension(2,2):: j35=a(f1,f2,2)
      integer,parameter,dimension(2,2):: j36=a(f1,f1,2)
      integer,parameter,dimension(2,2):: j41=a(2:1:-1,1:2   ,2)
      integer,parameter,dimension(2,2):: j42=a(2:1:-1,2:1:-1,2)
      integer,parameter,dimension(2,2):: j43=a(2:1:-1, :    ,2)
      integer,parameter,dimension(2,2):: j44=a(2:1:-1, : :1 ,2)
      integer,parameter,dimension(2,2):: j45=a(2:1:-1,1: :1 ,2)
      integer,parameter,dimension(2,2):: j46=a(2:1:-1, :2:1 ,2)
      integer,parameter,dimension(2,2):: j51=a(1:2   ,2,2:1:-1)
      integer,parameter,dimension(2,2):: j52=a(2:1:-1,2,2:1:-1)
      integer,parameter,dimension(2,2):: j53=a( :    ,2,2:1:-1)
      integer,parameter,dimension(2,2):: j54=a( : :1 ,2,2:1:-1)
