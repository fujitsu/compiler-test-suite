...
c
     ...
     1  (/ (st2(st3p1),st2(st3p2), m=2,2) /)
      ...
      if (any(st4p1(-1)%st23(-2)%st11/=st1p3))print *,'fail'
      write(91,*) merge(st4p1,st4p1,mask)
      write(92,*)       st4p1
      write(u,*) merge(st4p1,st4p1,mask); rewind u; read (u,*) st2_x1
      ...
      write(u,*) merge((/st4p1/),(/st4p1/),mask); rewind u; 
      read (u,*) st2_x1
      if (any(st2_x1(-2)%st23(-2)%st11/=st1p1))print *,'fail'
      if (any(st2_x1(-2)%st23(-1)%st11/=st1p2))print *,'fail'
      if (any(st2_x1(-1)%st23(-2)%st11/=st1p3))print *,'fail'
      ...
      write(u,*) merge(st4p1(z),st4p1(-2),mask)
      rewind u; read (u,*) st2_x1(z)
      ...
      write(u,*) merge((/st4p1(-2)/),(/st4p1(z)/),.not.mask(1))
      rewind u; read (u,*) st2_x1(z)
      if (any(st2_x1(z)%st23(-2)%st11/=st1p3))print *,'fail'
      if (any(st2_x1(z)%st23(-1)%st11/=st1p4))print *,'fail'
      if (any(st2_x1(z)%st23(-2)%st12/=st2p3))print *,'fail'
      ...
      write(u,*) merge( st2_fun(st4p1),st2_fun(st4p1) , mask)
      rewind u; read (u,*) st2_x1
      if (any(st2_x1(-2)%st23(-2)%st11/=st1p1))print *,'fail'
      if (any(st2_x1(-2)%st23(-1)%st11/=st1p2))print *,'fail'
      if (any(st2_x1(-1)%st23(-2)%st11/=st1p3))print *,'fail'
      if (any(st2_x1(-1)%st23(-1)%st11/=st1p4))print *,'fail'
      ...
      write(u,*) merge(st4p1(z)%st23,st4p1(z)%st23,mask)
      rewind u; read (u,*) st1_x1
      ...
      write(u,*) merge(st4p1%st23(z),st4p1%st23(z),mask)
      rewind u; read (u,*) st1_x1
      ...
      write(u,*) merge(st4p1(z)%st23(z),st4p1(z)%st23(z),mask)
      rewind u; read (u,*) st1_x1(z)
      if (any(st1_x1(z)%st11/=st1p4))print *,'fail'
      if (any(st1_x1(z)%st12/=st2p4))print *,'fail'
      u=26;open (u,delim='quote')
      write(u,*) merge((/ st4p1(z)%st23(z)/),(/ st4p1(z)%st23(z)/),
     1 mask(2))
      rewind u; read (u,*) st1_x1(-2)
      if (any(st1_x1(-2)%st11/=st1p4))print *,'fail'
      if (any(st1_x1(-2)%st12/=st2p4))print *,'fail'
      u=27;open (u,delim='quote')
      write(u,*) merge(st1_fun(st4p1(z)%st23),st1_fun(st4p1(z)%st23),
     1           mask)
      rewind u; read (u,*) st1_x1
      if (any(st1_x1(-2)%st11/=st1p3))print *,'fail'
      if (any(st1_x1(-1)%st11/=st1p4))print *,'fail'
      ...
      write(u,*) merge(st1_fun((/st4p1(z)%st23/)),
     1                 st1_fun((/st4p1(z)%st23/)),mask)
      rewind u; read (u,*) st1_x1
      if (any(st1_x1(-2)%st11/=st1p3))print *,'fail'
      if (any(st1_x1(-1)%st11/=st1p4))print *,'fail'
      if (any(st1_x1(-2)%st12/=st2p3))print *,'fail'
      ...
      write(u,*) merge(st1_fun(st4p1%st23(z)),
     1           st1_fun(st4p1%st23(z)),mask)
      rewind u; read (u,*) st1_x1
      if (any(st1_x1(-2)%st11/=st1p2))print *,'fail'
      if (any(st1_x1(-1)%st11/=st1p4))print *,'fail'
      if (any(st1_x1(-2)%st12/=st2p2))print *,'fail'
