...
module m1
 ...
 integer ,target::tt_am(9,6,9)
 complex ,target::tt_bm(9,6,9)
 character ,target::tt_cm(9,6,9)
 type(st) ,target::tt_dm(9,6,9)
 integer ,target::tt_a(9,6,9)
 complex ,target::tt_b(9,6,9)
 character ,target::tt_c(9,6,9)
 type(st) ,target::tt_d(9,6,9)
 integer ,target::tt_a1(9,9)
 complex ,target::tt_b1(9,9)
 character,target::tt_c1(9,9)
 type(st) ,target::tt_d1(9,9)
 integer ,target::tt_v2(6),tt_v3(9)
...
am=>tt_am(2::3,2::3,2::3)
bm=>tt_bm(2::3,2::3,2::3)
cm=>tt_cm(2::3,2::3,2::3)
dm=>tt_dm(2::3,2::3,2::3)
a =>tt_a (2::3,2::3,2::3)
b =>tt_b (2::3,2::3,2::3)
c =>tt_c (2::3,2::3,2::3)
d =>tt_d (2::3,2::3,2::3)
