...
c
      ...
      contains
      subroutine s110()
       character,dimension(i2,i2)::a1
       character,dimension(1:2,1:i2)::a2
       character,dimension(i1:i2,i1:i2)::a3
       character,dimension(i2,2)::a4
       character,dimension(i2-i1:i2,-i2+i1:i2)::a5
       character,dimension(i1:i2)::a6
       character,dimension(1:i2)::a7
       character,dimension(i1:i2)::a8
       character,dimension(2:i2)::a9
       character,dimension(i2-i1:i2)::aa
       entry s111(a1)
       entry s112(a2)
       entry s113(a3)
       entry s114(a4)
      ...
      subroutine s120(a1,a2,a3,a4,a5,a6,a7,a8,a9,aa)
       character,dimension(i2:i2,1:i2)::a1
       character,dimension(1:i2,1:i2)::a2
       character,dimension(i1:i2,i1:i2)::a3
       character,dimension(2:i2,2:i2)::a4
       character,dimension(i2-i1:i2,-i2+i1:i2)::a5
       character,dimension(i1:i2)::a6
       character,dimension(1:i2)::a7
       character,dimension(i1:i2)::a8
      ...
      subroutine s130()
       character,dimension(i2:i2,i1:i2)::a1
       character,dimension(1:i2,1:i2)::a2
       character,dimension(i1:i2,i1:i2)::a3
       character,dimension(2:i2,2:i2)::a4
       character,dimension(i2-i1:i2,-i2+i1:i2)::a5
