...
c     integer,parameter,dimension(2,2,2)::a=reshape(v,sh)
     ...
     1    j51(w,2)/=v121 .or. j51(2,2)/=v221)print *,'fail'
      if (j52(w,1)/=v222 .or. j52(2,1)/=v122 .or.
     1    j52(w,2)/=v221 .or. j52(2,2)/=v121)print *,'fail'
      if (j53(w,1)/=v122 .or. j53(2,1)/=v222 .or.
     1    j53(w,2)/=v121 .or. j53(2,2)/=v221)print *,'fail'
      if (j54(w,1)/=v122 .or. j54(2,1)/=v222 .or.
     1    j54(w,2)/=v121 .or. j54(2,2)/=v221)print *,'fail'
