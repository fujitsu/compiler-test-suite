 ...
 module m1
 integer(1),pointer::i1s,i1a(:),j1s,j1a(:)
 integer(2),pointer::i2s,i2a(:),j2s,j2a(:)
 integer(4),pointer::i4s,i4a(:),j4s,j4a(:)
 integer(8),pointer::i8s,i8a(:),j8s,j8a(:)
 real   (4),pointer::r4s,r4a(:),w4s,w4a(:)
 real   (8),pointer::r8s,r8a(:),w8s,w8a(:)
 real  (16),pointer::rxs,rxa(:),wxs,wxa(:)
 interface ci1s
