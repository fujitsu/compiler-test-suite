module m1
integer,target:: t(-3:3)=[1,2,3,4,5,6,7]
integer,pointer::p(:)
type x1
 integer:: t(-3:3)
end type
...
subroutine s1
allocate(pt(3))
pt(3)%z(3)%t=[1,2,3,4,5,6,7]
p=>pt(3)%z(3)%t
if (lbound(p,1)/=-3) print *,121
call chk(pt(3)%z(3)%t,5)
p=>pt(3)%z(3)%t(:)
if (lbound(p,1)/= 1) print *,122
call chk(pt(3)%z(3)%t(:),6)
allocate(tt(3))
tt(3)%z(3)%t=[1,2,3,4,5,6,7]
p=>tt(3)%z(3)%t
if (lbound(p,1)/=-3) print *,111
call chk(tt(3)%z(3)%t,3)
p=>tt(3)%z(3)%t(:)
if (lbound(p,1)/= 1) print *,112
call chk(tt(3)%z(3)%t(:),4)
p=>t
