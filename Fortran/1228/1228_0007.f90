...
SUBROUTINE s1
  ...
  ALLOCATE(t1::v21%x22(1,1))
      ...
      select type(p=>v21%x22)
        type is(t1)
      if (v21%x22(1,1)%x11/=3) print *,12873
      if (v22%x22(1,1)%x11/=3) print *,12874
      v22%x22(1,1)%x11=4
      if (v21%x22(1,1)%x11/=3) print *,12875
      k=1
      end select
      if (k/=1) print *,1735
      deallocate(v21%x22)
      ...
      select type(p=>v21%x22)
        type is(t1)
      if (v21%x22(1,1)%x11/=2) print *,22873
      if (v22%x22(1,1)%x11/=4) print *,22874
      v22%x22(1,1)%x11=4
      if (v21%x22(1,1)%x11/=2) print *,12875
      k=1
      end select
      if (k/=1) print *,2735
