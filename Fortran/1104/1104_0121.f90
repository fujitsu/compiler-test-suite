     module mod
       ...
       type :: b
          integer(8)::d3
          class(*   ),allocatable::ba
       end type
       type, extends(b) :: e
          integer(8)::d4
          class(*   ),allocatable::bame
       end type
         class(*), allocatable:: var,v2,v3,v4
     contains

       subroutine s1(value)
         class(b), intent(in) :: value
         allocate(var, v2, v3,v4,source=value,stat=n)
         if (n==0 ) print *,5001
       end subroutine s1
     end module mod
...
subroutine ss
     ...
     call s1(value) 
     if (.not.allocated(v3)) print *,5002
     if (     allocated(v4)) print *,5052
     k=0
     select type(var)
      type is(e)
