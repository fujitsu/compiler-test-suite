...
if (lbound(assumed_shape,1)/=2-1) print *,21001
if (ubound(assumed_shape,1)/=3-1) print *,21002
...
do n2=1,3
  do n1=2,3
    if (assumed_shape(n1-1,n2)/=1) print *,4102
  end do
end do
    end subroutine
    subroutine base_proc(this, assumed_shape,assumed_size,k)
...
if (lbound(assumed_shape,1)/=2-1) print *,20001
if (ubound(assumed_shape,1)/=3-1) print *,20002
...
do n2=1,3
  do n1=2,3
    if (assumed_shape(n1-1,n2)/=1) print *,4002
  end do
end do
    end subroutine
