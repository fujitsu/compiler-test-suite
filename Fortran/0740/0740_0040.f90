...
character(3),target,allocatable,dimension(:)::ch1,ch2,ch3
  ...
  if (.not.allocated(a(1,1,1)%ya(1)%zc)) write(6,*) "NG"
  if (     allocated(a(1,1,1)%ya(2)%zc)) write(6,*) "NG"
  if (.not.allocated(a(1,1,1)%ya(3)%zc)) write(6,*) "NG"
  if (.not.allocated(a(1,1,1)%yb(1)%zi)) write(6,*) "NG"
  if (     allocated(a(1,1,1)%yb(1)%zc)) write(6,*) "NG"
  if (     allocated(a(1,1,2)%ya(1)%zi)) write(6,*) "NG"
  if (     allocated(a(1,1,2)%ya(2)%zi)) write(6,*) "NG"
  if (     allocated(a(1,1,2)%ya(3)%zi)) write(6,*) "NG"
  if (     allocated(a(1,1,2)%ya(1)%zc)) write(6,*) "NG"
  if (.not.allocated(a(1,1,2)%ya(2)%zc)) write(6,*) "NG"
  if (     allocated(a(1,1,2)%ya(3)%zc)) write(6,*) "NG"
  if (.not.allocated(a(1,1,2)%yb(1)%zi)) write(6,*) "NG"
  if (     allocated(a(1,1,2)%yb(1)%zc)) write(6,*) "NG"
  if (any(a(1,1,1)%ya(1)%zi/=(/1,2,3/))) write(6,*) "NG"
  if (any(a(1,1,1)%ya(2)%zi/=(/4,5,6/))) write(6,*) "NG"
  if (any(a(1,1,1)%ya(3)%zi/=(/7,8,9/))) write(6,*) "NG"
  if (any(a(1,1,1)%ya(1)%zc/=(/'ABC','abc'/))) write(6,*) "NG"
  if (any(a(1,1,1)%ya(3)%zc/=(/'GHI','ghi'/))) write(6,*) "NG"

  if (any(a(1,1,2)%ya(2)%zc/=(/'DEF','def'/))) write(6,*) "NG"

  if (any(a(1,1,1)%yb(1)%zi/=(/11/))) write(6,*) "NG"
  if (any(a(1,1,2)%yb(1)%zi/=(/12/))) write(6,*) "NG"
