...
type(y),allocatable,dimension(:,:,:)::a
  ...
  if (any(a(1,1,1)%ya(1)%zr/=(/1.0,2.0/))) write(6,*) "NG"
  if (any(a(1,1,1)%ya(2)%zr/=(/3.0,4.0/))) write(6,*) "NG"
  if (any(a(1,1,1)%ya(3)%zr/=(/5.0,6.0/))) write(6,*) "NG"
