...
w2=v2
w3=v3
if (w1%a1/=21)write(6,*) "NG"
if (any(w1%a2/=(/111,112,113/)))write(6,*) "NG"
if (allocated(w1%a3))write(6,*) "NG"
if (.not.allocated(w1%a4))write(6,*) "NG"
if (any(w1%a5/=(/'123','456','789'/)))write(6,*) "NG"
if (associated(w1%a6))write(6,*) "NG"
if (any(w1%a4%a1/=21))write(6,*) "NG"
if (any(w1%a4%a2(1)/='ab'))write(6,*) "NG"
if (any(w1%a4%a2(2)/='cd'))write(6,*) "NG"
do k=1,is
if (w2(k)%a1/=21)write(6,*) "NG"
if (any(w2(k)%a2/=(/111,112,113/)))write(6,*) "NG"
if (allocated(w2(k)%a3))write(6,*) "NG"
if (.not.allocated(w2(k)%a4))write(6,*) "NG"
if (any(w2(k)%a5/=(/'123','456','789'/)))write(6,*) "NG"
if (associated(w2(k)%a6))write(6,*) "NG"
if (any(w2(k)%a4%a1/=21))write(6,*) "NG"
if (any(w2(k)%a4%a2(1)/='ab'))write(6,*) "NG"
if (any(w2(k)%a4%a2(2)/='cd'))write(6,*) "NG"
end do
do k=1,is
if (w3(k)%a1/=21)write(6,*) "NG"
if (any(w3(k)%a2/=(/111,112,113/)))write(6,*) "NG"
if (allocated(w3(k)%a3))write(6,*) "NG"
if (.not.allocated(w3(k)%a4))write(6,*) "NG"
if (any(w3(k)%a5/=(/'123','456','789'/)))write(6,*) "NG"
if (associated(w3(k)%a6))write(6,*) "NG"
if (any(w3(k)%a4%a1/=21))write(6,*) "NG"
if (any(w3(k)%a4%a2(1)/='ab'))write(6,*) "NG"
if (any(w3(k)%a4%a2(2)/='cd'))write(6,*) "NG"
end do
end
