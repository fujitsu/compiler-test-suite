...
implicit none
  ...
  allocate(t1)
  read(unit=801,'(DT(2,3))'),t1
write(2801,*)k1,k2,k4,k3,z,"'",zz,"'"
k1=0;k2=0;k3=0;z=0;zz='';k4=0
  allocate(ty2::t2)
  read(unit=802,'(DT(2,3))'),t2
write(2801,*)k1,k2,k4,k3,z,"'",zz,"'"
  allocate(t1)
  read(unit=601)t1
write(3801,*)k1,k2,k3,z
k1=0;k2=0;k3=0;z=0
  allocate(ty2::t2)
  read(unit=602)t2
write(3802,*)k1,k2,k3,z
  ...
  allocate(t1)
    open(unit=1801, form='FORMATTED')
  write(unit=1801,'(DT(2,3))'),t1
  allocate(t2)
    open(unit=1301, form='FORMATTED')
  write(unit=1301,'(DT(2,3))'),t2
  allocate(t1)
  write(unit=7801)t1
  allocate(ty2::t2)
  write(unit=7802)t2
