...
use m
implicit none
 private::write(unformatted),read(unformatted)
 private::write(formatted),read(formatted)
public::sub1
  interface
...
write(3804,*)k1,k2,k3,z
  ...
  allocate(t1)
    open(1803, form='FORMATTED')
  write(1803,'(DT(2,3))')t1
  allocate(t2)
    open(1303, form='FORMATTED')
  write(1303,'(DT(2,3))')t2
  allocate(t1)
  write(7803)t1
  allocate(ty2::t2)
  write(7804)t2
