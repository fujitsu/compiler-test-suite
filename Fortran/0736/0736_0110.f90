   ...
   type a1
    type(a2),allocatable,dimension(:)::z41
    type(a2),allocatable,dimension(:)::z42
    type(a2),allocatable,dimension(:)::z43
    type(a2),allocatable,dimension(:)::z44
    type(a2),allocatable,dimension(:)::z45
    type(a2),allocatable,dimension(:)::z46
   end type
   type z
    integer::z1
    integer,allocatable,dimension(:)::z2
