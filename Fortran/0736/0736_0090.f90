...
do i=n2-n1,n1*n2
allocate(x1a(i)%x2(n2+n1),x1a(i)%x3(n2+n1),x2a(i)%x2(n2+n1),x3a(i)%x2(n2+n1),x2a(i)%x3(n2+n1))
do j=1,3
if (allocated(x1a(i)%x2(j)%y2))write(6,*) "NG"
if (allocated(x2a(i)%x2(j)%y2))write(6,*) "NG"
if (allocated(x3a(i)%x2(j)%y2))write(6,*) "NG"
allocate(x1a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2a(i)%x2(j)%y4(n2*n1+n2,n1+n1))
do k2=n2-n1,n1*n2
do k1=1,4
...
do i=n2-n1,n1*n2
allocate(x1b(i)%x3(n2+n1),x1b(i)%x2(n2+n1),x2b(i)%x2(n2+n1),x3b(i)%x2(n2+n1))
do j=1,3
if (allocated(x1b(i)%x2(j)%y2))write(6,*) "NG"
if (allocated(x2b(i)%x2(j)%y2))write(6,*) "NG"
if (allocated(x3b(i)%x2(j)%y2))write(6,*) "NG"
allocate(x1b(i)%x2(j)%y4(n2*n1+n2,n1+n1),x1b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3b(i)%x2(j)%y4(n2*n1+n2,n1+n1))
do k2=n2-n1,n1*n2
do k1=1,4
...
allocate(y1a(i)%x2(j)%y3(n2*n1+n2,n1+n1),y2a(i)%x2(j)%y3(n2*n1+n2,n1+n1),y1a(i)%x2(j)%y4(n2*n1+n2,n1+n1),y2a(i)%x2(j)%y4(n2*n1+n2,n1+n1),y3a(i)%x2(j)%y3(n2*n1+n2,n1+n1))
do k2=n2-n1,n1*n2
do k1=1,4
...
do i=n2-n1,n1*n2
allocate(y1b(i)%x2(n2+n1),y2b(i)%x3(n2+n1),y3b(i)%x3(n2+n1),y1b(i)%x3(n2+n1),y2b(i)%x2(n2+n1),y3b(i)%x2(n2+n1))
do j=1,3
