...
subroutine s1(x1b,x2b,x3b,y1b,y2b,y3b,n2,n1)
   ...
   integer kk(n2+n1)
do i=n2-n1,n1*n2
allocate(x1a(i)%x2(n2+n1),x1a(i)%x3(n2+n1),x2a(i)%x2(n2+n1),x3a(i)%x2(n2+n1),x2a(i)%x3(n2+n1),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate(x1a(i)%x2(n2+n1),x1a(i)%x3(n2+n1),x2a(i)%x2(n2+n1),x3a(i)%x2(n2+n1),x2a(i)%x3(n2+n1),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do j=1,3
...
allocate(x1a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2a(i)%x2(j)%y4(n2*n1+n2,n1+n1),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate(x1a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3a(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2a(i)%x2(j)%y4(n2*n1+n2,n1+n1),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do k2=n2-n1,n1*n2
...
do i=n2-n1,n1*n2
allocate(x1b(i)%x3(n2+n1),x1b(i)%x2(n2+n1),x2b(i)%x2(n2+n1),x3b(i)%x2(n2+n1),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate(x1b(i)%x3(n2+n1),x1b(i)%x2(n2+n1),x2b(i)%x2(n2+n1),x3b(i)%x2(n2+n1),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do j=1,3
...
allocate(x1b(i)%x2(j)%y4(n2*n1+n2,n1+n1),x1b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3b(i)%x2(j)%y4(n2*n1+n2,n1+n1),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate(x1b(i)%x2(j)%y4(n2*n1+n2,n1+n1),x1b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x2b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3b(i)%x2(j)%y3(n2*n1+n2,n1+n1),x3b(i)%x2(j)%y4(n2*n1+n2,n1+n1),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do k2=n2-n1,n1*n2
...
allocate (y1a(2),y2a(2),y3a(2),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate (y1a(2),y2a(2),y3a(2),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do i=n2-n1,n1*n2
...
allocate(y1a(i)%x2(j)%y3(n2*n1+n2,n1+n1),y2a(i)%x2(j)%y3(n2*n1+n2,n1+n1),y1a(i)%x2(j)%y4(n2*n1+n2,n1+n1),y2a(i)%x2(j)%y4(n2*n1+n2,n1+n1),y3a(i)%x2(j)%y3(n2*n1+n2,n1+n1),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate(y1a(i)%x2(j)%y3(n2*n1+n2,n1+n1),y2a(i)%x2(j)%y3(n2*n1+n2,n1+n1),y1a(i)%x2(j)%y4(n2*n1+n2,n1+n1),y2a(i)%x2(j)%y4(n2*n1+n2,n1+n1),y3a(i)%x2(j)%y3(n2*n1+n2,n1+n1),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do k2=n2-n1,n1*n2
...
allocate (y1b(2),y2b(2),y3b(2),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate (y1b(2),y2b(2),y3b(2),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do i=n2-n1,n1*n2
allocate(y1b(i)%x2(n2+n1),y2b(i)%x3(n2+n1),y3b(i)%x3(n2+n1),y1b(i)%x3(n2+n1),y2b(i)%x2(n2+n1),y3b(i)%x2(n2+n1),stat=kk(n2+n1))
if (kk(n2+n1)/=0)write(6,*) "NG"
allocate(y1b(i)%x2(n2+n1),y2b(i)%x3(n2+n1),y3b(i)%x3(n2+n1),y1b(i)%x3(n2+n1),y2b(i)%x2(n2+n1),y3b(i)%x2(n2+n1),stat=kk(n2+n1))
if (kk(n2+n1)==0)write(6,*) "NG"
do j=1,3
