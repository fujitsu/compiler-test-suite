 ...
 xv(k1,k2)%y013(2)=1
   do kk=1,4
    ...
    if (allocated(xv(k1,k2)%y012(kk)%x014%z011))write(6,*) "NG"
    allocate(xv(k1,k2)%y012(kk)%x014%z011(2))
    xv(k1,k2)%y012(kk)%x014%z011(2)=6
    if (allocated(xv(k1,k2)%y012(kk)%x014%z012))write(6,*) "NG"
    allocate(xv(k1,k2)%y012(kk)%x014%z012(2))
    xv(k1,k2)%y012(kk)%x014%z012(2)=5
   end do
 end do
 end do
 ...
 if (xv(2,3)%y012(2)%x014%z011(2)/=6)write(6,*) "NG"
 if (xv(2,3)%y012(2)%x014%z012(2)/=5)write(6,*) "NG"
 end
 call sub
 call sub
 call sub
