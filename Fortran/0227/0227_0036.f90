...
!$omp threadprivate(nn )
  contains
    ...
    real var(n:n+1,nn:nn+1)   
    real var2(n:n+1,nn:nn+1)   
    real var3(lbound(var,1):ubound(var,1),lbound(var,2):ubound(var2,2))   
    real r   (lbound(var,1):n+1,nn:ubound(var3,2))   
    real var4(n:n+1,nn:nn+1)   
    real var5(n:n+1,nn:nn+1)   
    real var6(n:n+1,nn:nn+1)   
    ...
    if (any(lbound(var4)/=n)) print *,3001
    if (any(ubound(var4)/=n+1)) print *,3002
    if (any(lbound(var5)/=n)) print *,3001
    if (any(ubound(var6)/=n+1)) print *,3002
