...
real(8),pointer :: m1(:),m2(:)
do j=1,n
   do i=1,n
      if (m1(1).gt.0._8) then
         if (m2(2).gt.0._8) then
            a(i,j) = a(i,j) + b(i,j)
         endif
      endif
   enddo
...
integer n,i,j
real(8),dimension(1:n,1:n) :: a,b
real(8),pointer :: m1(:),m2(:),m3(:),m4(:),m5(:)
do j=1,n
   do i=1,n
      if (m1(1).gt.0._8) then
         if (m2(2).gt.0._8) then
            if (m3(3).gt.0._8) then
               if (m4(4).gt.0._8) then
                  if (m5(5).gt.0._8) then
                     a(i,j) = a(i,j) + b(i,j)
                  endif
               endif
            endif
...
real(8),dimension(1:n,1:n) :: a,b
real(8),dimension(1:n),target :: am1,am2,am3,am4,am5
real(8),pointer :: m1(:),m2(:),m3(:),m4(:),m5(:)
