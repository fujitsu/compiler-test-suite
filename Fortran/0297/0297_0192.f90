...
real(4),volatile ::  a4,b4,r4,q4
real(4),parameter :: error4=0.0_4
real(8),volatile ::  a8,b8,r8,q8
real(8),parameter :: error8=0.0_8
real(16),volatile ::  a16,b16,r16,q16
...
if (abs(a4+b4-r4-q4) .le. error4) then
  print *,"c8: ok"
else
  print *,"c8: ng ", real(a8), "!=", (r4 + q4)
endif
if (abs(a8+b8-r8-q8) .le. error8) then
  print *,"c16: ok"
else
  print *,"c16: ng ", real(a16), "!=", (r8 + q8)
endif
if (abs(a16+b16-r16-q16) .le. error16) then
  print *,"c32: ok"
else
  print *,"c32: ng ", real(a16+b16), "!=", (r16 + q16)
endif
end program
