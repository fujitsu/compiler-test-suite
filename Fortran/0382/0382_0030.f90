integer::q(1,1,6)
q(:,:,2::2)=reshape([1,2,3],[1,1,3])
call s1(q(:,:,2::2),q(:,:,2::2))
print *,'pass'
contains
subroutine s1(q,qq)
integer,target::c(1,1,2:4)=reshape([1,2,3],[1,1,3])
integer,parameter::d(1,1,2:4)=reshape([1,2,3],[1,1,3])
integer,pointer::a(:,:,:)
integer,allocatable::b(:,:,:),bb(:,:,:)
...
if (any([v(2)%b]/=[1,2,3]))print *,3011,v(2)%bb
