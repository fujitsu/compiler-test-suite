...
x4='123'
n1=1;n2=1
call c1([character(2)::x1,(x2,x3,kk=n1,n2),x4],1,2,8)
call c1([character(2)::x1//x1,(x2//x2,x3//x3,kk=n1,n2),x1//x4],2,2,8)
call c1([character(2)::x1//x1//x4,(x2//x2//x4,x3//x3//x4,kk=n1,n2),x1//x4//x4],2,2,8)
call c1([character(3)::x1,(x2,x3,kk=n1,n2),x4],3,3,8)
call c1([character(3)::x1//x1,(x2//x2,x3//x3,kk=n1,n2),x1//x4],4,3,8)
call c1([character(3)::x1//x1//x4,(x2//x2//x4,x3//x3//x4,kk=n1,n2),x1//x4//x4],5,3,8)
k2=2
call c1([character(k2)::x1,(x2,x3,kk=n1,n2),x4],1,2,8)
call c1([character(k2)::x1//x1,(x2//x2,x3//x3,kk=n1,n2),x1//x4],2,2,8)
call c1([character(k2)::x1//x1//x4,(x2//x2//x4,x3//x3//x4,kk=n1,n2),x1//x4//x4],2,2,8)
k3=3
call c1([character(k3)::x1,(x2,x3,kk=n1,n2),x4],3,3,8)
call c1([character(k3)::x1//x1,(x2//x2,x3//x3,kk=n1,n2),x1//x4],4,3,8)
call c1([character(k3)::x1//x1//x4,(x2//x2//x4,x3//x3//x4,kk=n1,n2),x1//x4//x4],5,3,8)
k1=1
call c1([character(k1+1)::x1,(x2,x3,kk=n1,n2),x4],1,2,8)
call c1([character(k1+1)::x1//x1,(x2//x2,x3//x3,kk=n1,n2),x1//x4],2,2,8)
call c1([character(k1+1)::x1//x1//x4,(x2//x2//x4,x3//x3//x4,kk=n1,n2),x1//x4//x4],2,2,8)
call c1([character(k2+1)::x1,(x2,x3,kk=n1,n2),x4],3,3,8)
call c1([character(k2+1)::x1//x1,(x2//x2,x3//x3,kk=n1,n2),x1//x4],4,3,8)
call c1([character(k2+1)::x1//x1//x4,(x2//x2//x4,x3//x3//x4,kk=n1,n2),x1//x4//x4],5,3,8)
contains
