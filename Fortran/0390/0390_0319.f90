...
if (k1==1) then
   if (.not.present(a1)) print *,101,a1,999
   if (any(a1/=c)) print *,700001
else
   if (     present(a1)) print *,102
endif
if (k2==1) then
   if (.not.present(a2)) print *,111
   if (any(a2/=c)) print *,700001
else
   if (     present(a2)) print *,112
endif
if (k3==1) then
   if (.not.present(a3)) print *,121
   if (any(a3/=c)) print *,700001
else
...
allocate(p1(3),source=c)
call s1(p1=p1,p2=x2,p3=x3,kk1=1,kk2=0,kk3=0)
if (any(p1/=c)) print *,301
allocate(p2(3),source=c)
call s1(p1=x1,p3=x3,p2=p2      ,kk1=0,kk2=1,kk3=0)
if (any(p2/=c)) print *,301
allocate(p3(3),source=c)
call s1(p1=x1,p2=x2,p3=p3      ,kk1=0,kk2=0,kk3=1)
