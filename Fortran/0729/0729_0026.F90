...
d2=.true.
d3=.true.
write(78,*)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
write(79)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
rewind 78
rewind 79
call tt1
call tt2
...
equivalence(d2,m(n*11:))
equivalence(d3,m(n*12:))
read(79)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
call ss1(a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3)
 if (abs(a1+a2+a3+b1+b2+b3+c1+c2+c3-(6+(3,3)))>0.0001)write(6,*) "NG"
end
subroutine tt1
...
equivalence(d2,m(n*11:))
equivalence(d3,m(n*12:))
read(78,*)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
call ss1(a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3)
 if (abs(a1+a2+a3+b1+b2+b3+c1+c2+c3-(6+(3,3)))>0.0001)write(6,*) "NG"
end
