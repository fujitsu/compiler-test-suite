 ...
 logical(x), dimension(4,3,2,2,2,2,2) :: mask
 integer(x), dimension(4,2,2,2,2,2) :: v
 integer(x), dimension(4,3,2,2,2,2,2) :: arr
 mask=.true.
 arr=5
 arr(4,2,2,2,2,2,2)=9
 ...
 v=maxval(arr,2,mask)
 if (v(4,2,2,2,2,2)/=9)write(6,*) "NG"
 v=maxloc(arr,2,mask)
 if (v(4,2,2,2,2,2)/=2)write(6,*) "NG"
