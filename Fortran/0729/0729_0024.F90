...
d2=.true.
d3=.true.
write(74,*)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
write(75)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
rewind 74
rewind 75
call tt1
call tt2
...
equivalence(d2,m(n*11:))
equivalence(d3,m(n*12:))
read(75)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
call ss1(a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3)
end
subroutine tt1
character*1000 m
...
equivalence(d2,m(n*11:))
equivalence(d3,m(n*12:))
read(74,*)a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3
call ss1(a1,a2,a3,b1,b2,b3,c1,c2,c3,d1,d2,d3)
end
