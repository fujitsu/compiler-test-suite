subroutine test1()
   ...
   type :: cap_parameters
    ...
    allocate(ptr_array(5),ptr_array_2(5),source=cap_parameters( i1=1,set_services=root_set_services,i2=2,set_services2=root_set_services_2))
...
subroutine test2()
  ...
  type :: cap_parameters_wrapper
   ...
   allocate(wrapper%ptr(2),wrapper%ptr_2(1),source=cap_parameters( i3=3,set_services=root_set_services_2))
if (wrapper%ptr(1)%i3.ne.3) print *,'err'
  r= wrapper%ptr(1)%set_services()
if (r.ne.2) print *,'err1'
  r= wrapper%ptr_2(1)%set_services()
if (r.ne.2) print *,'err1'
contains
  function   set_services_interface()
   set_services_interface=1
