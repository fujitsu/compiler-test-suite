subroutine test1()
   ...
   call isub(cap_parameters( i2=2, i1=1,set_services=root_set_services ,set_services2=root_set_services_2))
...
subroutine test2()
  ...
  type :: cap_parameters_wrapper
   ...
   call isub(cap_parameters( i3=3,set_services=root_set_services_2))
