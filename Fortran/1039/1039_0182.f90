...
program main
  ...
  call foo(p,max(idum1,idum2(idum1)),2,p,max(idum1,idum2))
  call foo(p,max(grid%idum(v%v(2,2,2)%v(2,2,:)),idum2),3,p,max(grid%idum,idum2))
  call foo(p,max(grid%idum(idum1),idum2),3,p,max(grid%idum(n:3),idum2))  
