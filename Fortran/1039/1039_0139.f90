...
sx2=Z_TYPE(sy2,t2,y2,16,(/25,26/))
 ...
 s1(2)%x2%s2=3
 s1(2)%x2%s3(2)=4
if (p1(2)%x2%p2/=1)print *,"Error-101*:" 
if (p1(2)%x2%p3(2)/=2)print *,"Error-103*:" 
if (p1(2)%x2%s2/=3)print *,"Error-111*:" 
if (p1(2)%x2%s3(2)/=4)print *,"Error-113*:" 
if (s1(2)%x2%p2/=1)print *,"Error-121*:" 
if (s1(2)%x2%p3(2)/=2)print *,"Error-123*:" 
if (s1(2)%x2%s2/=3)print *,"Error-131*:" 
if (s1(2)%x2%s3(2)/=4)print *,"Error-133*:" 
 p1(2)=sx1
 s1(2)=sx2
