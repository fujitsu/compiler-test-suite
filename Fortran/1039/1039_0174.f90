...
subroutine init
  ...
  p(:,:,:) = 0.0d0
  write(23,'(a,"0x",z16.16)') 'init: loc(p) = ', loc(p)
  grid%idum=>t1(::2)
   grid%idum=(/21,22,23/)
  return
end subroutine init
...
subroutine foo(a,idum,k,aa,jdum)
  ...
  write(23,'(a,"0x",z16.16,1x,"0x",z16.16)') ' foo: loc(a) = ', loc(a),loc(aa)
  select case(k)
  case(1)
    m=0
  case(2)
...
subroutine bar(a,b,aa,bb)
  ...
  write(23,'(a,"0x",z16.16)') ' bar: loc(a) = ', loc(a)
  write(23,'(a,"0x",z16.16)') ' bar: loc(aa) = ', loc(aa)
  return
end subroutine bar
