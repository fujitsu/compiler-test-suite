...
associate (a1=>1,a2=>2,a3=>3,n2 =>int(1) )
 block
 integer ,dimension(1:n2 ) :: p1a
 integer ,dimension(n2 :2) ::p2a
 integer ,dimension(1:n2 ,10) :: p3a
 integer ,dimension(n2 :2,10) ::p4a
 integer ,dimension(20,1:n2 ,10) :: p5a
 integer ,dimension(30,n2 :2,10) ::p6a
