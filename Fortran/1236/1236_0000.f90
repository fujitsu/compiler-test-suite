...
associate (n1 =>rr(1) )
 ...
 block
  integer ::p1a (1:n1%x1(1) )
  integer ::p2a (n1%x1(1) :2)
  character :: cha*(n1%x1(1) )
  character(n1%x1(1) ) :: chb
...
associate (n2 =>r(1) )
 block
 integer ,dimension(1:n2%x1(1) ) :: p1a
 integer ,dimension(n2%x1(1) :2) ::p2a
 integer ,dimension(1:n2%x1(1) ,10) :: p3a
 integer ,dimension(n2%x1(1) :2,10) ::p4a
 integer ,dimension(20,1:n2%x1(1) ,10) :: p5a
 integer ,dimension(30,n2%x1(1) :2,10) ::p6a
