...
allocate(v2(n1,n2,n3),v11(n2+n3))
do k=1,2
...
allocate( v11(n2+n3)%v1 ,source=v2(n1,:,n3)) 

kk=1
do k3=1,n3
do k2=1,n2
do k1=1,n1
if (v11(n2+n3)%v1(1)%x02(k1,k2,k3)/=kk) print *,101,kk
if (v11(n2+n3)%v1(2)%x02(k1,k2,k3)/=kk*2) print *,102,kk
...
if (v11(n2+n3)%v1(1)%x02(k1,k2,k3)/=kk) print *,201,k
if (v11(n2+n3)%v1(2)%x02(k1,k2,k3)/=kk*2) print *,202,k
...
do k2=1,n2
do k1=1,n1
if (v11(n2+n3)%v1(1)%x02(k1,k2,k3)/=kk) print *,304,k
if (v11(n2+n3)%v1(2)%x02(k1,k2,k3)/=kk*2) print *,305,k
kk=kk+1
end do
end do
end do
...
do k=1,2
deallocate (v11(n2+n3)%v1(k)%x02)
if (allocated(v11(n2+n3)%v1(k)%x02)) print *,401,k
end do
