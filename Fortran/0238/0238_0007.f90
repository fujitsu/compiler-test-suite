program main
 ...
 real(16)          ,dimension(2,2,2:1) ::a = 1
 real(16),parameter,dimension(2,2,2:1) ::b = 1
 real(16),parameter,dimension(2,0)::b1 = maxval(b,dim=1)
 real(16),parameter,dimension(2,0)::b2 = maxval(b,dim=2)
 real(16),parameter,dimension(2,2)::b3 = maxval(b,dim=3)
