...
nmk=9
allocate( v1(n2) ,source=w%v2(n1,n2,n3),stat=nmk) 
if (nmk/=0) print *,1230
...
do k2=1,n2
do k1=1,n1
w%v2(n1,1,n3)%x02(k1,k2,k3)=kk*4
w%v2(n1,2,n3)%x02(k1,k2,k3)=kk*8
if (v1(1)%x02(k1,k2,k3)/=kk*2) print *,201,k
if (v1(2)%x02(k1,k2,k3)/=kk*2) print *,202,k
if (w%v2(n1,1,n3)%x02(k1,k2,k3)/=kk*4) print *,203,k
if (w%v2(n1,2,n3)%x02(k1,k2,k3)/=kk*8) print *,204,k
kk=kk+1
end do
end do
end do
