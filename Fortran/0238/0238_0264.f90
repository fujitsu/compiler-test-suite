...
nmk=9
allocate( v1 ,source=w%v2(n1:n3:n2),stat=nmk )
if (nmk/=0) print *,1230
...
do k=1,3,2
if (k==3) then
if (v1(2)%x02(k1,k2,k3)/=kk) print *,101,k
else
...
if (k==3) then
if (v1(2)%x02(k1,k2,k3)/=kk) print *,201,k
else
...
do k1=1,n1
if (k==3) then
if (v1(2)%x02(k1,k2,k3)/=kk) print *,302,k
else
...
if (k==3) then
deallocate (v1(2)%x02)
if (allocated(v1(2)%x02)) print *,401,k
else
deallocate (v1(k)%x02)
