...
contains
subroutine s1(vv1,vv2,stat)
type (w1),allocatable:: vv1(:)
type (w2),allocatable   :: vv2(:)
integer stat
...
allocate( vv1(1)%v1 ,stat=stat,source=vv2(2)%v2) 
if (stat/=0) print *,9876
