...
allocate( v11(n3,n2)%v1 ,source=v2) 
...
do k1=1,n1
do k=1,2
if (v11(n3,n2)%v1(k)%x02(k1,k2,k3)/=kk) print *,101,k
...
if (v11(n3,n2)%v1(k)%x02(k1,k2,k3)/=kk) print *,201,k
...
do k2=1,n2
do k1=1,n1
if (v11(n3,n2)%v1(k)%x02(k1,k2,k3)/=kk) print *,302,k
kk=kk+1
end do
end do
end do
...
deallocate (v11(n3,n2)%v1(k)%x02)
if (allocated(v11(n3,n2)%v1(k)%x02)) print *,401,k
end do
