...
do k2=1,n2
do k1=1,n1
w(n3)%v2(n1,1,n3)%x02(k1,k2,k3)='1'
w(n3)%v2(n1,2,n3)%x02(k1,k2,k3)='2'
...
w(n3)%v2(n1,1,n3)%xc2(k1,k2,k3)='12345678'
w(n3)%v2(n1,2,n3)%xc2(k1,k2,k3)='23456789'
kk=kk+1
end do
end do
end do

allocate( v11(n2)%v1(n2) ,source=w(n3)%v2(n1,n2,n3),stat=nmk(nx,nx)) 
if (nmk(2,2)/=0) print *,1230

kk=1
do k3=1,n3
do k2=1,n2
do k1=1,n1
if (v11(n2)%v1(1)%x02(k1,k2,k3)/='2') print *,1101,kk
if (v11(n2)%v1(2)%x02(k1,k2,k3)/='2') print *,102,kk
if (w(n3)%v2(n1,1,n3)%x02(k1,k2,k3)/='1') print *,103,k
if (w(n3)%v2(n1,2,n3)%x02(k1,k2,k3)/='2') print *,104,k
...
if (v11(n2)%v1(1)%xc2(k1,k2,k3)/='23456789') print *,2101,kk
if (v11(n2)%v1(2)%xc2(k1,k2,k3)/='23456789') print *,102,kk
if (w(n3)%v2(n1,1,n3)%xc2(k1,k2,k3)/='12345678') print *,103,k
if (w(n3)%v2(n1,2,n3)%xc2(k1,k2,k3)/='23456789') print *,104,k
kk=kk+1
end do
end do
end do
...
do k2=1,n2
do k1=1,n1
w(n3)%v2(n1,1,n3)%x02(k1,k2,k3)='4'
w(n3)%v2(n1,2,n3)%x02(k1,k2,k3)='8'
if (v11(n2)%v1(1)%x02(k1,k2,k3)/='2') print *,201,k
if (v11(n2)%v1(2)%x02(k1,k2,k3)/='2') print *,202,k
if (w(n3)%v2(n1,1,n3)%x02(k1,k2,k3)/='4') print *,203,k
if (w(n3)%v2(n1,2,n3)%x02(k1,k2,k3)/='8') print *,204,k
...
w(n3)%v2(n1,1,n3)%xc2(k1,k2,k3)='44444444'
w(n3)%v2(n1,2,n3)%xc2(k1,k2,k3)='88888888'
if (v11(n2)%v1(1)%xc2(k1,k2,k3)/='23456789') print *,201,k
if (v11(n2)%v1(2)%xc2(k1,k2,k3)/='23456789') print *,202,k
if (w(n3)%v2(n1,1,n3)%xc2(k1,k2,k3)/='44444444') print *,203,k
if (w(n3)%v2(n1,2,n3)%xc2(k1,k2,k3)/='88888888') print *,204,k
kk=kk+1
end do
end do
end do
...
do k2=1,n2
do k1=1,n1
if (v11(n2)%v1(1)%x02(k1,k2,k3)/='2') print *,304,k
if (v11(n2)%v1(2)%x02(k1,k2,k3)/='2') print *,305,k
...
if (v11(n2)%v1(1)%xc2(k1,k2,k3)/='23456789') print *,304,k
if (v11(n2)%v1(2)%xc2(k1,k2,k3)/='23456789') print *,305,k
kk=kk+1
end do
end do
end do
