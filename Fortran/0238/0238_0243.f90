...
allocate( v1 ,source=v2(n1,:,n3),stat=nmk) 
if (nmk/=0) print *,1230
...
if (allocated(v2(n1,1,n3)%x12)) print *,311,k
if (allocated(v2(n1,2,n3)%x12)) print *,312,k
if (allocated(v2(n1,1,n3)%x22)) print *,321,k
if (allocated(v2(n1,2,n3)%x22)) print *,322,k
kk=1
do k3=1,n3
do k2=1,n2
do k1=1,n1
...
if (allocated(v1(k)%x12)) print *,411,k
if (allocated(v1(k)%x22)) print *,421,k
end do
