...
classis (yy)
  ...
  if (p(1)%xx3/=1+k+1000) print *,330110
  if (p(2)%xx3/=2+k+1000) print *,330120
class default
 print *,90991
end select
p=>         v2(k)%x02
...
classis (yy)
  ...
  if (p(1)%xx3/=1+k+1000) print *,331111
  if (p(2)%xx3/=2+k+1000) print *,331121
class default
 print *,90992
end select
end do
...
classis (yy)
  ...
  if (p(1)%xx3/=1+k+1000) print *,332111
  if (p(2)%xx3/=2+k+1000) print *,332121
class default
 print *,90994
end select
p=>         v2(k)%x02
...
classis (yy)
  ...
  if (p(1)%xx3/=11+k+1000) print *,333111
  if (p(2)%xx3/=12+k+1000) print *,333122
class default
 print *,90992
end select
...
classis (yy)
  ...
  if (p(1)%xx3/=1+k+1000) print *,334111
  if (p(2)%xx3/=2+k+1000) print *,334122
class default
 print *,90995
end select
