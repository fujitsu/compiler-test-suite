...
contains
subroutine s1(vv1,vv2,n)
type (w1):: vv1(n)
type (w2)  :: vv2(n)


allocate(vv2(2)%v2(2),stat=kkkk)
do k=1,2
allocate(vv2(2)%v2(k)%x02(2),stat=kkkk)
vv2(2)%v2(k)%x02(1)=1
vv2(2)%v2(k)%x02(2)=2
allocate(vv2(2)%v2(k)%x92(2),stat=kkkk)
vv2(2)%v2(k)%x92(1)=-1
vv2(2)%v2(k)%x92(2)=-2
allocate(vv2(2)%v2(k)%x52(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(1)%x11(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(1)%x12(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(1)%x13(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(1)%x13(2)%yy(3),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(1)%x14(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(2)%x11(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(2)%x12(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(2)%x13(2),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(2)%x13(2)%yy(3),stat=kkkk)
allocate(vv2(2)%v2(k)%x52(2)%x14(2),stat=kkkk)
...
allocate( vv1(1)%v1 ,stat=kkkk,source=vv2(2)%v2) 
