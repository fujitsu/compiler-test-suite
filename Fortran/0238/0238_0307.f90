...
allocate( v1(2) ,source=v2(2)) 
if (v1(1)%x02(1)/='abc') print *,2001
if (v1(1)%x02(2)/='def') print *,2002
if (len(v1(1)%x02)/=3) print *,2003
...
deallocate(v2)
if (v1(1)%x02(1)/='abc') print *,4001
if (v1(1)%x02(2)/='def') print *,4002
if (len(v1(1)%x02)/=3) print *,4003
