     module m1
       ...
       type,extends(c)::ce
         ...
         class (d),pointer:: ced(:)
         class (e),pointer:: cee(:)
         character(:),pointer::cea(:)
       end type
       type :: d
         integer(8):: d1(2)
         class (e),pointer:: de(:)
         character(:),pointer::da(:)
       end type
       type,extends(d)::de
         integer(8):: d2(4)
         character(:),pointer::dea(:)
         class (e),pointer:: dee(:)
       end type
       type :: e
         integer(8):: e1(2)
         character(:),pointer::ea(:)
       end type
       type,extends(e)::ee
         integer(8):: e2(4)
         character(:),pointer::eea(:)
       end type
...
select type(p=>d)
 type is(ee)
  ...
  kk=kk+1
  if (p(2)%ea(2)/='ab')print *,4983,kk,p(2)%ea(2)
  if (p(2)%eea(2)/='ab')print *,4984
  k=1
 class default
  print *,41981
end select
...
select type(p=>x)
 type is(de)
  ...
  kk=kk+1
  if (p(2)%da(2)/='ab')print *,4903,kk,p(2)%da(2)
  if (p(2)%dea(2)/='ab')print *,4904
...
select type(p=>d)
 type is(ce)
  ...
  kk=kk+1
  if (p(2)%ca(2)/='ab')print *,4003,kk,p(2)%ca(2)
  if (p(2)%cea(2)/='ab')print *,4004
...
select type(p=>d)
 type is(be)
  ...
  kk=kk+1
  if (p(2)%ba(2)/='ab')print *,5003
  if (p(2)%bea(2)/='ab')print *,5004
