...
select type(p=>d)
 type is(ee)
  ...
  kk=kk+1
  if (p%ea/='ab')print *,4983,kk,p%ea
  if (p%eea/='ab')print *,4984
  k=1
 class default
  print *,41981
end select
...
select type(p=>x)
 type is(de)
  ...
  kk=kk+1
  if (p%da/='ab')print *,4903,kk,p%da
  if (p%dea/='ab')print *,4904
  call chk_e(p%de,kk)
  call chk_e(p%dee,kk)
  k=1
 class default
...
select type(p=>d)
 type is(ce)
  ...
  kk=kk+1
  if (p%ca/='ab')print *,4003,kk,p%ca
  if (p%cea/='ab')print *,4004
  call chk_d(p%cd,kk)
  call chk_d(p%ced,kk)
  call chk_e(p%ce,kk)
  call chk_e(p%cee,kk)
...
select type(p=>d)
 type is(be)
  ...
  kk=kk+1
  if (p%ba/='ab')print *,5003
  if (p%bea/='ab')print *,5004
  call chk_c(p%bc,kk)
  call chk_c(p%bec,kk)
  call chk_d(p%bd,kk)
  call chk_d(p%bed,kk)
