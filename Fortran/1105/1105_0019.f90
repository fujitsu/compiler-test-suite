...
!print '(1hy,z16.16)',loc(p%cce)
     ...
     select type(d=>v1(n1))
      type is(ce)
       if (   (d     %cce(1)/=2)) print *,5001
       if (   (d     %cce(2)/=2)) print *,50011
       if (d     %d4/=2) print *,5003
     end select
     select type(p=>v1(n1)%cc(n4))
      type is(be)
       if (   (p%bbe(1) /=22)) print *,5031
       if (   (p%bbe(2) /=22)) print *,50311
       if (p%d3/=22) print *,5041
     end select
     select type(p=>v1(n1)%cc(n2)%bb(n5))
      type is(ce)
       if (   (p %cce(1)/=222)) print *,5051
       if (   (p %cce(2)/=222)) print *,50511
       if (p%d4/=222) print *,5061
     end select
     select type(p=>v1(n1)%cc(n2)%bb(n3)%cc(n4))
      type is(be)
       if (   (p%bbe(1) /=2222)) print *,5071
       if (   (p%bbe(2) /=2222)) print *,50711
       if (p%d3/=2222) print *,5081
     end select
     select type(p=>v1(n1)%cc(n2)%bb(n3)%cc(n4)%bb(n5))
      type is(ce)
!print '(1hx,z16.16)',loc(p%cce)
       if (   (p%cce(1) /=22222)) print *,5082
       if (   (p%cce(2) /=22222)) print *,50821
