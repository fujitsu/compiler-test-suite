...
CONTAINS
    SUBROUTINE final_ty(dmy)
        ...
        IF ( dmy%ii .EQ. (100*counter) ) THEN
           PRINT*, counter,' final_ty call PASS ', dmy%ii
        ELSE
           PRINT*, counter,' final_ty call FAIL ', dmy%ii
        END IF
    END SUBROUTINE
    ...
    SUBROUTINE final_ty1(dmy)
        ...
        IF ( dmy(1)%jj .EQ. (100*counter) ) THEN
           PRINT*, counter,' final_ty1 call PASS ', dmy%jj
        ELSE
           PRINT*, counter,' final_ty1 call FAIL ', dmy%jj
        END IF
    END SUBROUTINE
    SUBROUTINE final_ty2(dmy)
        ...
        IF ( dmy%kk .EQ. (100*counter) ) THEN
           PRINT*, counter,' final_ty2 call PASS ', dmy%kk
        ELSE
           PRINT*, counter,' final_ty2 call FAIL ', dmy%kk
        END IF
    END SUBROUTINE
    SUBROUTINE final_ty3(dmy)
        ...
        IF ( dmy(1,1)%ll .EQ. (100*counter) ) THEN
           PRINT*, counter,' final_ty3 call PASS ', dmy(1,1)%ll
        ELSE
           PRINT*, counter,' final_ty3 call FAIL ', dmy(1,1)%ll
        END IF
    END SUBROUTINE
END MODULE
