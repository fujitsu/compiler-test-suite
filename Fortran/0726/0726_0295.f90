...
subroutine ss1
 ...
 write(1,*) associated(ap(i2,i3)%ap(i2,i3)%ap)
 write(1,*) associated(ap(i2,i3)%ap(i2,i3)%ap,at(1::i2,1::i2))
 write(1,*) associated(ap(i2,i3)%ap(i2,i3)%ap)
 ...
 write(1,*) associated(ap(i2,i3)%ap(i2,i3)%ap(i2,i3)%ap)
 write(1,*) associated(ap(i2,i3)%ap(i2,i3)%ap(i2,i3)%ap,at(1::i2,1::i2))
 write(1,*) associated(ap(i2,i3)%ap(i2,i3)%ap(i2,i3)%ap)
