 ...
 module m1
  ...
  subroutine ss1(xs2,xa2,xs7,xa7)
    interface
      function xs7(i)
       character*(3),pointer:: xs7
      end function
      function xa7(i)
      character*(3),pointer,dimension(:,:,:,:,:,:,:):: xa7
      end function
    end interface
  ...
  type(xx),target::xst,xat(1,1,1,1,1,1,2)
    interface
      function xs5(i)
       character*(3),pointer:: xs5
      end function
      function xs6(i)
       character*(3),pointer:: xs6
      end function
      function xa5(i)
      character*(3),pointer,dimension(:,:,:,:,:,:,:):: xa5
      end function
      function xa6(i)
      character*(3),pointer,dimension(:,:,:,:,:,:,:):: xa6
      end function
    end interface
  ...
  call chkxs( chks(null(xs3(3)) ))
  call chkxa( chka(null(xa3(3)) ))
  call chkxs( chks(null(xs4(3)) ))
  call chkxa( chka(null(xa4(3)) ))
  call chkxs( chks(null(xs5(3)) ))
  call chkxa( chka(null(xa5(3)) ))
  call chkxs( chks(null(xs6(3)) ))
  call chkxa( chka(null(xa6(3)) ))
  call chkxs( chks(null(xs7(3)) ))
  call chkxa( chka(null(xa7(3)) ))
 end subroutine
  function xs3(i)
   character*(3),pointer:: xs3
   character*(3),pointer:: xs4
  entry xs4(i)
   xs3=>null()
  end function
  function xa3(i)
  entry xa4(i)
  character*(3),pointer,dimension(:,:,:,:,:,:,:):: xa3,xa4
   xa3=>null()
  end function
 end
  function xs5(i)
  ...
  function xa5(i)
  entry xa6(i)
  character*(3),pointer,dimension(:,:,:,:,:,:,:):: xa5,xa6
   xa5=>null()
  end function
 subroutine s1
  use m1
