...
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 204'
x=2
!$omp end task
...
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 304'
x=2
!$omp end task
...
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 404'
x=2
!$omp end task
...
b=1
x=1
!$omp task if(a==0) final(b==1) shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 502'
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 503'
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 504'
x=2
!$omp end task
...
integer :: x
x=1
!$omp task if(.false.) final(.true.) shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 602'
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 603'
!$omp task shared(x) mergeable
if (.not. omp_in_final()) print *, 'error 604'
x=2
!$omp end task
