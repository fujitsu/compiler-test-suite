   ...
   10 FORMAT(I10 )
      ...
      WRITE(6,20)
      IP=IP+1
   20 FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,'ERROR =================' )
  500 READ(8,10) J11
      BACK SPACE 8
      READ(8,10) J12
      ...
      WRITE(6,510)
      IP=IP+1
  510 FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,'ERROR ====================')
 1000 READ(8,10 ,END=1500 ) K1,K2
      WRITE(6,1010) K1,K2
      IP=IP+1
 10100FORMAT(1H0,20X,'==TEST==',3X,'NG',5X, 'ERROR =============' /40X,
     E   I10,3H ' , I10)
 1500 RETURN
      E N D
   ...
   10 FORMAT(I10)
      ...
      WRITE(6,20) I10,I11
      IP=IP+1
   200FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,'ERROR ================' /40X
     E     I10, 3H ' ,I10  )
  500 READ(20,10) J11
      BACK SPACE 20
      READ(20,10) J12
      ...
      WRITE(6,510) J11,J12
      IP=IP+1
  5100FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,'ERROR ===================='
     E   /40X, I10, 3H '  I10   )
 1000 READ(20,10,END=1500) L1,L2
      WRITE(6,1010) L1,L2
      IP=IP+1
 10100FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,'ERROR ================='
     E   /40X, I10, 3H ' , I10 )
 1500 RETURN
      E N D
 ...
 1500 RETURN
      ...
      DATA  IU1/ 10 /,I10,I20,I30/ 10  ,20  ,30   /
   ...
   10 FORMAT(I10)
      ...
      WRITE(6,20)  I10,I11
      IP=IP+1
   200FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,'ERROR ================='
     E   /40X, I10,  3H '  , I10  )
  500 READ(IU,10) I21
      BACK SPACE  IU
      READ(IU,10) I22
 ...
 1500 RETURN
      ...
      DATA IU1,S101,S201,S301  /  9, '1234','2345','3456' /
      END
 ...
 1500 RETURN
   ...
   200FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,I4,'ERROR ================='
     *   ,
  ...
  5100FORMAT(1H0,20X,'==TEST==   NG',5X,I4,'ERROR ====================='
     *   ,
     E  '==='  / 40X,  D17.10, 5X, D17.10  )
 ...
 10100FORMAT(1H0,20X,'==TEST==',3X,'NG',5X,I4,'ERROR ================='
     *   ,
     E  '=====' /40X,  D17.10,  5X, D17.10  )
 1500 CONTINUE
      RETURN
