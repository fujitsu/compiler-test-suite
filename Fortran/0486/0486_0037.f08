...
yy= yv(:)
if (any(ubound(yy)/=3)) print *,801, ubound(yy)
if (any(lbound(yy)/=1)) print *,811, lbound(yy)
yz= y( y1=2 , x1=1) 
zz= yz(:)
if (any(ubound(zz)/=3)) print *,701, ubound(zz)
if (any(lbound(zz)/=1)) print *,711, lbound(zz)
end
call s1
print *,'pass'
end
