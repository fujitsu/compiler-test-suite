...
k=1
allocate(v(1))
allocate(v(k)% z0    ,source=-100)
allocate(v(k)% z1(10),source=-100)
allocate(v(k)% z2(10),source=-100)
allocate(v(k)% z3(10),source=-100)
allocate(v(k)% z4(10),source=-100)
allocate(v(k)% z5(10),source=-100)
do k=1,3
