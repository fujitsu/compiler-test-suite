...
if (n==1) then
if (any(w/=7-3) ) print *,1003,w,n
else if (n==2) then 
if (any(w/=[3,7]) ) print *,1004,w,n
else if (n==3) then 
if (any(w/=[7,27]-3) ) print *,1004,w,n
else if (n==4) then 
if (any(w/=[11,23]-3) ) print *,1005,w,n
endif
end subroutine
end
subroutine s1
use m0
call sx01( iparity( b,dim=1 ),[1] ,1)
call sx01( iparity( b,dim=2 ),[2] ,2)
call sx01( iparity( c,dim=1 ),[2] ,3)
call sx01( iparity( c,dim=2 ),[2] ,4)
end
call s1
print *,'pass'
end
