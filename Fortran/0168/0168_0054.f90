...
subroutine ss ( z1,z2,z3,z4,z5,z6,z7,z8,z9)
use m1
real,dimension(9) :: z1,z2,z3,z4,z5,z6,z7,z8,z9
if (k1/=loc(z9))  print *,901
if (k2/=loc(z1))  print *,902
if (k3/=loc(z2))  print *,903
if (k4/=loc(z3))  print *,904
if (k5/=loc(z4))  print *,905
if (k6/=loc(z5))  print *,906
if (k7/=loc(z6))  print *,907
if (k8/=loc(z7))  print *,908
if (k9/=loc(z8))  print *,909
write(1,*)z1
