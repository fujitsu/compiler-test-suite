...
CONTAINS
  SUBROUTINE write_formatted (dtv,unit,iotype,vlist,iostat,iomsg)
    ...
    CHARACTER (LEN=*), INTENT(INOUT) :: iomsg
       WRITE(unit, FMT=*     , IOSTAT=iostat) dtv%w1
       WRITE(unit, FMT=*     , IOSTAT=iostat) dtv%class_ina%iina
       WRITE(unit, FMT=*     , IOSTAT=iostat) dtv%w2
