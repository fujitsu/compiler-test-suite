...
kk=0
allocate(  c1s ,source= '11'(:2),stat=kk)
if (kk==0) print *,111,kk
kk=0
allocate(  c2s ,source= '11'(:2),stat=kk)
if (kk==0) print *,112,kk
kk=0
allocate(  c1a(2) ,source= '11'(:2),stat=kk)
if (kk==0) print *,113,kk
kk=0
allocate(  c2a(2) ,source= '11'(:2),stat=kk)
if (kk==0) print *,114,kk
kk=0
allocate(  c1s ,source= '11'(:n2),stat=kk)
if (kk==0) print *,121,kk
kk=0
allocate(  c2s ,source= '11'(:n2),stat=kk)
if (kk==0) print *,122,kk
kk=0
allocate(  c3s ,source= '11'(:n2),stat=kk)
if (kk==0) print *,126,kk
kk=0
allocate(  c1a(2) ,source= '11'(:n2),stat=kk)
if (kk==0) print *,123,kk
kk=0
allocate(  c2a(2) ,source= '11'(:n2),stat=kk)
if (kk==0) print *,124,kk
kk=0
allocate(  c3a(2) ,source= '11'(:n2),stat=kk)
if (kk==0) print *,125,kk
kk=0
allocate(  c4a(2) ,source= '11'(:n2),stat=kk)
if (kk/=0) print *,201,kk
kk=0
allocate(  c4a(2) ,source= '11'(:2),stat=kk)
if (kk/=0) print *,202,kk
kk=0
allocate(  c4s    ,source= '11'(:n2),stat=kk)
if (kk/=0) print *,203,kk
kk=0
allocate(  c4s    ,source= '11'(: 2),stat=kk)
