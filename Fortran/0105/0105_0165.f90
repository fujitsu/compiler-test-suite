subroutine sub(K,N,NN,DX,HtLbt,HtLap,HtVbt,Y,DY)
complex(8):: DX(NN),HtLbt(1:NN),HtLap(1:NN,1:NN),Y(NN),HtVbt(NN,NN),DY(NN)
DX(1:K)=HtLbt(1:K)+DY(1:K)+&
...
DX=-1.
DY=-2.
call sub(K,N,NN,DX,HtLbt,HtLap,HtVbt,Y,DY)
if (any(abs((/DX/)-(/&
