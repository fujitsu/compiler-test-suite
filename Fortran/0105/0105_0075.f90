...
if (any(abs((/r8/)-(13,24)-(/(-2724,3632),(-2832,3776),(-2940,3920),(-3048,4064)/))>10.))print *,2
r8=(13,24)
r8=r8+matmul(transpose(r83),r82)
if (any(abs((/r8/)-(13,24)-(/(-2382,3176),(-2706,3608),(-3030,4040),(-3354,4472)/))>10.))print *,3
end subroutine
subroutine s21(r81,r82,r83,r8)
complex(4)::r81(:,:),r82(:),r83(:,:)
complex(4)::r8(:)
r8=r8+matmul(r81,r82)
if (any(abs((/r8/)-(13,24)-(/(-2724,3632),(-2832,3776),(-2940,3920),(-3048,4064)/))>10.))print *,4
r8=(13,24)
r8=r8+matmul(transpose(r83),r82)
if (any(abs((/r8/)-(13,24)-(/(-2382,3176),(-2706,3608),(-3030,4040),(-3354,4472)/))>10.))print *,5
end subroutine
subroutine s2a
