...
complex(8)::m1(4,8),m2(4,3),r(2,3),v(2,3)
r=matmul(m1(::2,::2),m2)+r+v
end subroutine
end
use x1
complex(8),target,dimension(5:15,15:25,5:35,5:45)::m1,m2,r,v
complex(8),pointer::p(:,:)
m1(14,24,26:29:1,21:28:1)=reshape((/(i,i=11,42)/),(/4,8/))
...
call s(m1(14,24,26:29:1,21:28:1),&
       m2(14,24,21:28:2,11:16:2),&
        r(14,24,26:28:2,36:40:2),&
        v(14,24,26:28:2,36:40:2))
p=>r(14,24,26:28:2,36:40:2)
if (any(abs((/p/)-(/2182,2364,2554,2768,2926,3172/))>0.00001_8))print *,'error-1'
print *,'pass'
end
