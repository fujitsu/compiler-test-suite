...
complex(8)::m1(4,4),m2(4,3),r(2,3),v(2,3)
...
complex(8),pointer::p(:,:)
m1(14,24,26:29:1,21:28:2)=reshape((/(i,i=11,26)/),(/4,4/))
...
call s(m1(14,24,26:29:1,21:28:2),&
       m2(14,24,21:28:2,11:16:2),&
        r(14,24,26:28:2,36:40:2),&
        v(14,24,26:28:2,36:40:2))
p=>r(14,24,26:28:2,36:40:2)
if (any(abs((/p/)-(/1622,1804,1898,2112,2174,2420/))>0.00001_8))print *,'error-1'
print *,'pass'
end
