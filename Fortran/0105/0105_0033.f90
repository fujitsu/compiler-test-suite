...
if (any(abs((/r8/)-cx-2*(/(-2724,3632),(-2832,3776),(-2940,3920),(-3048,4064)/))>10.))print *,201
end
subroutine s11
complex(8)::r81(3),r82(3,4),r83(4,3)
complex(8)::r8(4)
...
r8=cx
r8=2.0*matmul(r81,r82)+r8
if (any(abs((/r8/)-cx-2*(/(-2381,3176),(-2706,3608),(-3030,4040),(-3354,4472)/))>10.))print *,111
r8=cx
r8=2.*matmul(r81,transpose(r83))+r8
if (any(abs((/r8/)-cx-2*(/(-2724,3632),(-2832,3776),(-2940,3920),(-3048,4064)/))>10.))print *,211
end
subroutine s21
complex(4)::r81(3),r82(3,4),r83(4,3)
complex(4)::r8(4)
