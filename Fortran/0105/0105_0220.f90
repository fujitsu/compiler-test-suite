...
complex(8):: POP1(i5),POP(i10,i5),Y(i10),Poj1(6:6,5)
Poj1(NY*(L-1)+M,1:N5)=POP1(1:N1)*2._8+MATMUL(TRANSPOSE(POP(1:N2,1:N3)),Y(K1+1:K2+N4))
end
...
complex(8):: POP1(i5),POP(i10,i5),Y(i10),Poj1(6:6,5)
r=2.0
Poj1(NY*(L-1)+M,1:N5)=POP1(1:N1)-r+MATMUL(TRANSPOSE(POP(1:N2,1:N3)),Y(K1+1:K2+N4))
end
...
if (any(abs(poj1(6,:)-(/407,959,1511,2063,2615/))>0.01))print *,'error-2'
poj1=5
call sub03(i5,i10,n1,n2,n3,n4,k1,k2,pop1,pop,y,ny,L,M,n5,poj1)
if (any(abs(poj1(6,:)-(/-759,-1858,-2957,-4056,-5155/))>0.01))print *,'error-3'
poj1=5
call sub04(i5,i10,n1,n2,n3,n4,k1,k2,pop1,pop,y,ny,L,M,n5,poj1)
if (any(abs(poj1(6,:)-(/-759,-1858,-2957,-4056,-5155/))>0.01))print *,'error-4'
poj1=5
call sub05(i5,i10,n1,n2,n3,n4,k1,k2,pop1,pop,y,ny,L,M,n5,poj1)
if (any(abs(poj1(6,:)-(/394,945,1496,2047,2598/))>0.01))print *,'error-5'
print *,'pass'
end
