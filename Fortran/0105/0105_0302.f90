...
complex(8)::m1(2,4),m2(4,6),r(2,3),v(2,3)
...
m2(14,24,21:28:2,11:16:1)=reshape((/(i,i=21,44)/),(/4,6/))
...
call s(m1(14,24,26:28:2,21:28:2),&
       m2(14,24,21:28:2,11:16:1),&
        r(14,24,26:28:2,36:40:2),&
        v(14,24,26:28:2,36:40:2))
p=>r(14,24,26:28:2,36:40:2)
if (any(abs((/p/)-(/1342,1434,1794,1918,2246,2402/))>0.00001_8))print *,'error-1'
print *,'pass'
end
