...
complex(8)::m1(2,4),m2(8,3),r(2,3),v(2,3)
...
m2(14,24,21:28:1,11:16:2)=reshape((/(i,i=21,44)/),(/8,3/))
...
call s(m1(14,24,26:28:2,21:28:2),&
       m2(14,24,21:28:1,11:16:2),&
        r(14,24,26:28:2,36:40:2),&
        v(14,24,26:28:2,36:40:2))
p=>r(14,24,26:28:2,36:40:2)
if (any(abs((/p/)-(/1436,1534,1888,2018,2340,2502/))>0.00001_8))print *,'error-1'
print *,'pass'
end
