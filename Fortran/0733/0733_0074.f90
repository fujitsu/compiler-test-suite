...
v1=reshape((/'1','2','3','4','5','6'/),(/2,3/)); w1=v1;z1=v1;r1=v1
 ...
 write(37,*)   (plus3(z1(:,1)))
 write(37,*)   (plus3(z1(:,:)))
 t3(:,:)=   (plus3(r1(:,:)));write(37,*)t3
 w3(:,:)=   (plus3(w1(:,:)));write(37,*)w3
 v3(:,:)=   (plus3(v1(:,:)));write(37,*)v3
 r3(:,1)=   (plus3(r1(:,1)));write(37,*)r3(:,1)
 r3(:,:)=   (plus3(r1(:,:)));write(37,*)r3
 z3(:,1)=   (plus3(z1(:,1)));write(37,*)z3(:,1)
 z3(:,:)=   (plus3(z1(:,:)));write(37,*)z3
 end
character*50 r
call sub(2)
rewind 37
read(37,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(37,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(37,'(a)') r;if (r/=' 1    2')print *,'error-1'
read(37,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(37,'(a)') r;if (r/=' 1    2')print *,'error-1'
read(37,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(37,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
