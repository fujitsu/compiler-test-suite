...
write(61,*)' lbound, ubound(pt_in) ', lbound(pt_in),ubound(pt_in)
write(61,*)' lbound, ubound(varmaille%vhydro%in) ', &
...
write(61,*) ' all lines should be : i  i  '
do i=ndeb, nfin
   write(61,*) i, varmaille%vhydro(i)%in
enddo

write(61,*) ' same here, since pt_in(1:nfin-ndeb+1) should be '
write(61,*) ' identical to varmaille%vhydro(ndeb:nfin)%in '
do i=1, nfin-ndeb+1
   write(61,*) ndeb-1+i, pt_in(i)
enddo

write(61,*) ' fin du test : type_derive'
rewind 61
call chk
print *,'pass'
end program main
...
do kk=3,10
read(61,*) i,j;if (i/=kk)print *,'error-4',kk;if (j/=kk)print *,'error-5',kk
end do
read(61,'(a)') r
...
do kk=3,10
read(61,*) i,j;if (i/=kk)print *,'error-7',kk;if (j/=kk)print *,'error-8',kk
end do
read(61,'(a)') r
