...
v1=reshape((/'1','2','3','4','5','6'/),(/2,3/)); w1=v1;z1=v1;r1=v1
 ...
 write(36,*)   (plus3(z1(:,1)))
 write(36,*)   (plus3(z1(:,:)))
 w3(:,:)=   (plus3(w1(:,:)));write(36,*)w3
 v3(:,:)=   (plus3(v1(:,:)));write(36,*)v3
 r3(:,1)=   (plus3(r1(:,1)));write(36,*)r3(:,1)
 r3(:,:)=   (plus3(r1(:,:)));write(36,*)r3
 z3(:,1)=   (plus3(z1(:,1)));write(36,*)z3(:,1)
 z3(:,:)=   (plus3(z1(:,:)));write(36,*)z3
 end
character*50 r
call sub(2)
rewind 36
read(36,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(36,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(36,'(a)') r;if (r/=' 1    2')print *,'error-1'
read(36,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(36,'(a)') r;if (r/=' 1    2')print *,'error-1'
read(36,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
read(36,'(a)') r;if (r/=' 1    2    3    4    5    6')print *,'error-1'
