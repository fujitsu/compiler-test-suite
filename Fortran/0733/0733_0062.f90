...
logical(r),parameter::w=.true.,z=w
logical(r),allocatable,dimension(:,:)::POP
logical(r),allocatable,dimension(:,:)::P1,P2,P3,P4,P5,P6,P7,P8,P9,PA,PB,PC,PD,PE,PF,PG,PH
...
PH(1:N2,1:N3) = TRANSPOSE( POP(1:3:N3-N2,1:N2:N3-N2) )
 ...
 call s(TRANSPOSE( logical(reshape((/w,z,w,z,w,z/),(/3,2/)),r)))
 ...
 call s( TRANSPOSE( logical(reshape((/w,z,w,z,w,z/),(/N3,N2/)),r)))
