...
subroutine sub(d1, d2, d3)
  ...
  character(kind=4,len=ABS(n+2-2)),value, optional :: d3(:,:,:)
end subroutine
end interface
...
subroutine sub(d1, d2, d3)
  ...
  character(kind=4,len=n),value, optional :: d1(:,:)
  character(kind=4,len=*),value, optional :: d2(:,:)
  character(kind=4,len=(ABS(n+2-2)-2)),value, optional :: d3(:,:,:)
