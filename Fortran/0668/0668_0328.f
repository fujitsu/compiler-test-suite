   ...
   20   continue
          ...
          z(i1)=(3.0,3.0)
   30   continue
      call sub1(a,b,c,d,w,x,y,z)
      call sub2(a,b,c,d,w,x,y,z,4,16)
      call sub3(a,b,c,d,w,x,y,z,1)
      stop
      end
      subroutine sub1(a,b,c,d,w,x,y,z)
      real*8      a(4,4,4,4,4,4,4),b(4,4,4,4,4,4,4)
   ...
   30 continue
      ...
      subroutine sub2(a,b,c,d,w,x,y,z,n,m)
      real*8      a(4,4,4,4,4,4,4),b(4,4,4,4,4,4,4)
      real*8      c(16,16),d(16)
      complex*16  w(4,4,4,4,4,4,4),x(4,4,4,4,4,4,4)
      complex*16  y(16,16),z(16)
   ...
   99 continue
      ...
      subroutine sub3(a,b,c,d,w,x,y,z,n)
      real*8      a(4,4,4,4,4,4,4),b(4,4,4,4,4,4,4)
      real*8      c(16,16),d(16),s
      complex*16  w(4,4,4,4,4,4,4),x(4,4,4,4,4,4,4)
      complex*16  y(16,16),z(16),t
      ...
      do 10 i6=1,n
      do 10 i7=1,4
       s = b(i1,i2,i3,i4,i5,i6,i7)**c(i1,i2)
