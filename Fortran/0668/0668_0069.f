      program main
      real*4     a(4096),aa(4096),b(4096),c(4096),ans(4096),d
      data       a/4096*0.0e0/
      data       aa/4096*0.0e0/
      data       d/0.0e0/
      integer*4  fl,max(13)
  ...
  200 format(1h ,'=== test ok ===')
      ...
      integer *4  max1
      real*4      a1(max1),a11(max1),b1(max1)
      do 40 i = 1,max1
   40     b1(i) = atan2(a1(i),a11(i))
      return
      end
      subroutine sub2(a1,a11,c1,max1)
      integer *4  max1
      real*4      a1(max1),a11(max1),c1(max1)
      do 50 i = 1,max1
   50     c1(i) = atan2(a1(i),a11(i))
      return
      end
