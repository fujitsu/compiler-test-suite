   ...
   11     continue
          ...
          do 12 j=1,n
            ...
            r4001(3) = i4a+mod(i4a,i4001(idx(j)))
   12     continue
        endif
        r4max = r4001(1)
        r4min = r4001(1)
   ...
   10 continue
      ...
      subroutine sub(i4a,i4003)
      integer   i400x(10)/10*0/
      integer   i4003(10)
      integer   i4004(10)/10*2/
      integer   i4005(10)/101,100,99,80,100,70,60,50,40,100/
      integer   idx1(10)/10,3,9,8,4,7,2,2,4,5/
      n1=10
      n2=2
      do 50 i=1,n1
        if(i4005(i).lt.100) then
          i4a = i4004(i)+i
          i400x(i) = i4a+i4004(i)
          i400x(3) = i4003(idx1(i))+i
          i4a = i4003(3)-1
        endif
   50 continue
      write(6,*) i4003
