      program main
      complex*16 b(100,100)
      real*8     a(100,100),aa(100,100)
      integer*4  fl/0/
      integer*4  basem(10)
      logical*4  mask(100,100)
      data       b/10000*(0.0d0,0.0d0)/
      data       a/10000*0.0d0/,aa/10000*0.0d0/
   ...
   15 i=i+1
      if(i.gt.100) goto 17
      b(i,j)=dsin(dfloat(i*j))*i*j
      b(i,j)=cdsqrt(b(i,j))*(i-50)*(j-50)
   ...
   30 continue
      ...
      stop
  100 format(1h ,'** cdabs ng (',i3,',',i3,') ***',
     *           ' nil=',z16,' vil=',z16)
  200 format(1h ,' === cdabs ok ===')
      end
