      program main
      real*4     a(4096),b1(4096),c1(4096),ans1(4096),d
      real*4     b2(4096),c2(4096),ans2(4096)
      data       a/4096*0.0e0/
      data       d/0.0e0/
      integer*4  fl,max(13)
   ...
   10 continue
      ...
      do 20 j = 1,13
        ...
        do 30 i = 1,max(j)
          ans1(i) = b1(i) - c1(i)
          ans2(i) = b2(i) - c2(i)
          if(ans1(i).ne.0.0e0.or.ans2(i).ne.0.0e0) then
            write(6,100)
  ...
  200 format(1h ,'=== test ok ===')
      ...
      integer *4  max1
      real*4      a1(max1),bb1(max1),bb2(max1)
      do 40 i = 1,max1
          bb1(i) = sin(a1(i))
   40     bb2(i) = cos(a1(i))
      return
      ...
      integer *4  max1
      real*4      a1(max1),cc1(max1),cc2(max1)
      do 50 i = 1,max1
          cc1(i) = sin(a1(i))
   50     cc2(i) = cos(a1(i))
      return
