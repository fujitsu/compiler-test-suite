...
!$    thread = OMP_GET_MAX_THREADS()
      ...
      ty1%ty2%mrr8 = 0.
      ty1%ty2%mrr16 = 0.
      ty1%ty2%mcc = cmplx(0.,0.)
      ty1%ty2%mcc16 = cmplx(0.,0.)
      ty1%ty2%mcc32 = cmplx(0.,0.)
      ty1%ty2%mss = ' '
      ty1%ty2%mll1 = .false.
      ty1%ty2%mll2 = .false.
      ty1%ty2%mll = .false.
...
!
      ...
      if(ty1%ty2%mii1.ne.1) ier=ier+1
      if(ty1%ty2%mii2.ne.1) ier=ier+1
      if(ty1%ty2%mii.ne.1) ier=ier+1
      if(ty1%ty2%mii8.ne.1) ier=ier+1
      if(ty1%ty2%mrr.ne.1.) ier=ier+1
      if(ty1%ty2%mrr8.ne.1.) ier=ier+1
      if(ty1%ty2%mrr16.ne.1.) ier=ier+1
      if(ty1%ty2%mcc.ne.(1.,1.)) ier=ier+1
      if(ty1%ty2%mcc16.ne.(1.,1.)) ier=ier+1
      if(ty1%ty2%mcc32.ne.(1.,1.)) ier=ier+1
      if(ty1%ty2%mss.ne.'0001') ier=ier+1
      if(ty1%ty2%mll1.neqv..true.) ier=ier+1
      if(ty1%ty2%mll2.neqv..true.) ier=ier+1
      if(ty1%ty2%mll.neqv..true.) ier=ier+1
      if(ty1%ty2%mll8.neqv..true.) ier=ier+1
      write(*,*) "----- TEST --"
      ...
      if(ier.eq.0) then
         ...
         write(*,*) "     ty1%ty2%mii1=",ty1%ty2%mii1
         write(*,*) "     ty1%ty2%mii2=",ty1%ty2%mii2
         write(*,*) "     ty1%ty2%mii=",ty1%ty2%mii
         write(*,*) "     ty1%ty2%mii8=",ty1%ty2%mii8
         write(*,*) "     ty1%ty2%mrr=",ty1%ty2%mrr
         write(*,*) "     ty1%ty2%mrr8=",ty1%ty2%mrr8
         write(*,*) "     ty1%ty2%mrr16=",ty1%ty2%mrr16
         write(*,*) "     ty1%ty2%mcc=",ty1%ty2%mcc
         write(*,*) "     ty1%ty2%mcc16=",ty1%ty2%mcc16
         write(*,*) "     ty1%ty2%mcc32=",ty1%ty2%mcc32
         write(*,*) "     ty1%ty2%mss=",ty1%ty2%mss
         write(*,*) "     ty1%ty2%mll1=",ty1%ty2%mll1
         write(*,*) "     ty1%ty2%mll2=",ty1%ty2%mll2
         write(*,*) "     ty1%ty2%mll=",ty1%ty2%mll
         write(*,*) "     ty1%ty2%mll8=",ty1%ty2%mll8
         write(*,*) "     ier=",ier
      endif
      stop
      end
