...
jj = findloc(arr,7,1,KIND = 2,BACK = .TRUE.)

kk = findloc(arr1,'B',1,KIND = 4,BACK = .TRUE.)
ll = findloc(arr2,4.4,2,KIND = 8,BACK = .TRUE.)
...
if(nn(3) /= 0)print*, 117
if(nn(4) /= 1)print*, 118
if(kind(findloc(arr,7,1,KIND = 2,BACK = .TRUE.)) /= 2)print*, 119
if(kind(findloc(arr1,'B',1,KIND = 2,BACK = .TRUE.)) /= 2)print*, 120
if(kind(findloc(arr2,4.4,2,KIND = 2,BACK = .TRUE.)) /= 2)print*, 121
if(kind(findloc(arr4,(3,3),1,KIND = 1,BACK = .TRUE.)) /= 1)print*, 123
print*, "pass"
end 
