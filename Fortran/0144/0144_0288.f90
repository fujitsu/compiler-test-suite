...
forall (n0=1:k1)
  a(:n1+n2     ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:1   ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:1_1 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:1_2 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:1_4 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:1_8 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:n3  ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:n1+n2:min(1,n0),:,n0+1)=a(:,:,n0)+(n0+n2)
end forall
