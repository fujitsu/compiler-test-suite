...
forall (n0=1:k1)
  a(n0+1,1:,:)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::1)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::1_1)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::1_2)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::1_4)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::1_8)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::n3)=a(n0,:,:)+(n0+n2)
  a(n0+1,1:,::min(1,n0))=a(n0,:,:)+(n0+n2)
end forall
