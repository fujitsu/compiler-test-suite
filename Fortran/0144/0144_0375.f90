...
forall (n2=1:k1,n3=2:k3)
  z%a(n2,:,n3,:)=z%a(n2,:,n3,:)+reshape([(z%a(n2,:,n3-1,:),nn=k1,k2+1)],[k2,k1])+f(n2,n3,k2,k1)
  z%a(n2,:,n3,:)=z%a(n2,:,n3,:)+reshape([(z%a(n2,:,n3-1,:),nn=k1,k2+1)],[k2,k1])+f(n2,n3,k2,k1)
end forall
deallocate(xxx)
allocate(xxx(10))
if (ip/=loc(xxx)) then
  write(28,'(z16.16)') ip,loc(xxx)
endif
end subroutine
...
do      n3=2,k3
do      n2=1,k1
  c(n2,:,n3,:)=z%b(n2,:,n3,:)+reshape([(z%b(n2,:,n3-1,:),nn=k1,k2+1)],[k2,k1])+f(n3,n2,k2,k1)
end do
end do
do      n3=2,k3
do      n2=1,k1
