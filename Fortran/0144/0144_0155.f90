...
forall (n1=1:k2,n2=1:k3)
  a(: , n1, n2+1 ,len(w%mx(1,1,1,k1-k2+k3+n0)):)=a(: , n1 , n2 ,len(w%mx(1,1,1,k1-k2+k3+n0)):)+(n1+n2)
end forall
...
do      n2=1,k3
do      n1=1,k2
  c(: , n1 , n2,len(w%mx(1,1,1,k1-k2+k3+n0)):)=b(:, n1 , n2,len(w%mx(1,1,1,k1-k2+k3+n0)):  )+(n1+n2)
end do
end do
do      n2=1,k3
do      n1=1,k2
  b(: , n1 , n2+1,len(w%mx(1,1,1,k1-k2+k3+n0)):)=c(:, n1 , n2,len(w%mx(1,1,1,k1-k2+k3+n0)): )
end do
end do
end subroutine
end
