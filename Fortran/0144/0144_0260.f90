...
forall (n0=1:k1)
  ...
  z%a(n0,:,::1,2)=z%a(n0,:,::1,2)+z%a(n0,:,:,2)+(n0+n2)
  z%a(n0,:,:,2)=z%a(n0,:,:,2)+z%a(n0,:,::1_8,2)+(n0+n2)
  z%a(n0,:,::1_8,2)=z%a(n0,:,::1,2)+z%a(n0,:,:,2)+(n0+n2)
  z%a(n0,:,:,2)=z%a(n0,:,:,2)+z%a(n0,:,::n3,2)+(n0+n2)
  z%a(n0,:,::n3,2)=z%a(n0,:,::n3,2)+z%a(n0,:,:,2)+(n0+n2)
  z%a(n0,:,::min(1,n0),2)=z%a(n0,:,::min(1,n0),2)+z%a(n0,:,:,2)+(n0+n2)
end forall
