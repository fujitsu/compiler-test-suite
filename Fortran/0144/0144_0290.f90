...
d=a
forall (n0=1:k1)
  d(:n1+n2     ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:1   ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:1_1 ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:1_2 ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:1_4 ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:1_8 ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:n3  ,:,n0+1)=d(:,:,n0)+(n0+n2)
  d(:n1+n2:min(1,n0),:,n0+1)=d(:,:,n0)+(n0+n2)
end forall
a=d
end subroutine
