...
forall (n0=1:k1,n0<k2)
  d(2:n1+n2:2   ,:,n0+1)=d(2::2,:,n0)+(n0+n2)
  d(2:n1+n2:2_1 ,:,n0+1)=d(2::2,:,n0)+(n0+n2)
  d(2:n1+n2:2_2 ,:,n0+1)=d(2::2,:,n0)+(n0+n2)
  d(2:n1+n2:2_4 ,:,n0+1)=d(2::2,:,n0)+(n0+n2)
  d(2:n1+n2:2_8 ,:,n0+1)=d(2::2,:,n0)+(n0+n2)
  d(2:n1+n2:n3*2  ,:,n0+1)=d(2::2,:,n0)+(n0+n2)
  d(2:n1+n2:min(1,n0)+1,:,n0+1)=d(2::2,:,n0)+(n0+n2)
end forall
a=d
end subroutine
