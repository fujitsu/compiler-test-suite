...
forall (n0=1:k1)
  z%a(n0+1,:,1:)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::1)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::1_1)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::1_2)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::1_4)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::1_8)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::n3)=z%a(n0,:,:)+(n0+n2)
  z%a(n0+1,:,1::min(1,n0))=z%a(n0,:,:)+(n0+n2)
end forall
