...
d=a
forall (n0=1:k1)
  d(2_8:4     ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:1   ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:1_1 ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:1_2 ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:1_4 ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:1_8 ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:n3  ,:,n0+1)=d(2_8:,:,n0)+(n0+n2)
  d(2_8:4:min(1,n0),:,n0+1)=d(2_8:,:,n0)+(n0+n2)
end forall
a=d
end subroutine
