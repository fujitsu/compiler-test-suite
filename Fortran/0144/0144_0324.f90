...
forall (n0=1:k1,n0>=n1-n3)
  a(2:4     ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:1   ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:1_1 ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:1_2 ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:1_4 ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:1_8 ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:n3  ,:,n0+1)=a(2:,:,n0)+(n0+n2)
  a(2:4:min(1,n0),:,n0+1)=a(2:,:,n0)+(n0+n2)
end forall
