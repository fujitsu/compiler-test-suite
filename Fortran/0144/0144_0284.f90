...
forall (n0=1:k1)
  a(:4     ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:1   ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:1_1 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:1_2 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:1_4 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:1_8 ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:n3  ,:,n0+1)=a(:,:,n0)+(n0+n2)
  a(:4:min(1,n0),:,n0+1)=a(:,:,n0)+(n0+n2)
end forall
