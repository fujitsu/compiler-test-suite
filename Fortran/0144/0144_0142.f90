...
forall (n0=0:k1-2,n1=1:k2,n2=1:k3)
  z%a(: , n1, n2+1 ,mx(1,1,1,k1-k2+k3+n0):)=z%a(: , n1 , n2 ,mx(1,1,1,k1-k2+k3+n0):)+(n1+n2)
end forall
...
do      n1=1,k2
do      n0=0,k1-2
  c(: , n1 , n2,mx(1,1,1,k1-k2+k3+n0):)=z%b(:, n1 , n2,mx(1,1,1,k1-k2+k3+n0):  )+(n1+n2)
end do
end do
end do
do      n2=1,k3
do      n1=1,k2
do      n0=0,k1-2
  z%b(: , n1 , n2+1,mx(1,1,1,k1-k2+k3+n0):)=c(:, n1 , n2,mx(1,1,1,k1-k2+k3+n0): )
end do
end do
end do
end subroutine
