...
a=f(p2(),n1,n2  ,n3,n4,n5,n6,0,   &
    ...
    p1()      ,n1,n2,n3,n4,n5,n6,0)
if (a/=n2*n4*n6  + & 
       n2*n4*n6  + &
       n2*n4*n6  ) print *,102,a,n2*n4*n6*2 + n2*n4*n6
end do
end subroutine
function p1() result(kp)
integer,pointer   ,dimension(:,:,:):: kp
kp=>p(:,:,:)
end function
function p2() result(kp)
integer,pointer   ,dimension(:,:,:):: kp
kp=>p(:,:,:)
end function
function p3() result(kp)
integer,pointer   ,dimension(:,:,:):: kp
kp=>p
end function
end 
