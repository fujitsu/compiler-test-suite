...
if ( ii1(1) == 65 .and. kk1(1) == 2 .and. &
     ...
     iachar  (cc1(1),2) == 65 .and. kind(iachar  (cc1(1),2)) == 2 .and. &
     iachar  (cc1(2),2) == 66 .and. kind(iachar  (cc1(2),2)) == 2 .and. &
     iachar  (cc1(3),2) == 67 .and. kind(iachar  (cc1(3),2)) == 2 .and. &
     ichar   (cc2(1),2) == 65 .and. kind(ichar   (cc2(1),2)) == 2 .and. &
     ichar   (cc2(2),2) == 66 .and. kind(ichar   (cc2(2),2)) == 2 .and. &
     ichar   (cc2(3),2) == 67 .and. kind(ichar   (cc2(3),2)) == 2 .and. &
     len     (cc3(1),2) == 10 .and. kind(len     (cc3(1),2)) == 2 .and. &
     len     (cc3(2),2) == 10 .and. kind(len     (cc3(2),2)) == 2 .and. &
     len     (cc3(3),2) == 10 .and. kind(len     (cc3(3),2)) == 2 .and. &
     len_trim(cc4(1),2) ==  2 .and. kind(len_trim(cc4(1),2)) == 2 .and. &
     len_trim(cc4(2),2) ==  3 .and. kind(len_trim(cc4(2),2)) == 2 .and. &
     len_trim(cc4(3),2) ==  4 .and. kind(len_trim(cc4(3),2)) == 2 ) then
  print *,'pass'
else
  print *,'ng'
