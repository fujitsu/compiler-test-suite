...
if ( ii1 == 65             .and. kk1 == 4 .and. &
     ...
     ii4 ==  3             .and. kk4 == 4 .and. &
     iachar  (cc1,4) == 65 .and. kind(iachar  (cc1,4)) == 4 .and. &
     ichar   (cc2,4) == 66 .and. kind(ichar   (cc2,4)) == 4 .and. &
     len     (cc3,4) == 10 .and. kind(len     (cc3,4)) == 4 .and. &
     len_trim(cc4,4) ==  3 .and. kind(len_trim(cc4,4)) == 4 ) then
  print *,'pass'
else
  print *,'ng'
