...
subroutine sub01()
integer,dimension(10,2,1,1,1,2) :: a01,a02,a03,a04,a05
integer,dimension(10,2,1,2,1,1) :: b01,b02,b03,b04,b05
integer,dimension(10,2,1,1,2,1) :: c01,c02,c03,c04,c05
...
if (any(a02(:,:,1,1,1,1).ne.200)) print *,'err2a'
if (any(a02(:,:,1,1,1,2).ne.2)) print *,'err2a'
