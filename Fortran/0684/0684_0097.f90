...
!$omp end parallel
 ...
 subroutine ss1(mm)
      ...
      character*3 a(5,3),aa(5,3)
      character*3 c(5,3),cc(5,3)
!$omp parallel default(private) shared(mm,k1)
      ...
      if (any(a(:,:)(k1:2)/=b(:,:)(1:2)))print *,"fail"
      if (any(aa(:,:)(k1:2)/=b(:,:)(1:2)))print *,"fail"
      if (any(c(:,:)(k1:2)/=b(:,:)(1:2)))print *,"fail"
      if (any(cc(:,:)(k1:2)/=b(:,:)(1:2)))print *,"fail"
!$omp end parallel
      end subroutine
...
!$omp parallel default(private) shared(mm,k1,a,aa,b,c,cc)
      b=reshape((/(mm(ii),ii=1,15)/),(/5,3/))
      i1=1;i5=5
...
!$omp end parallel
 ...
 subroutine ss3(i3,i5,mm,a,aa,b,c,cc)
      ...
      character*(*) a(:,:),aa(:,:)
      character*(*) c(:,:),cc(:,:)
!$omp parallel default(private) shared(mm,k1,a,aa,b,c,cc,i3,i5)
      b=reshape((/(mm(ii),ii=1,15)/),(/5,3/))
      i1=1
