CALL OMP_SET_NUM_THREADS(1)
 ...
 subroutine s1
  ...
  logical,dimension(6,4)::x1=reshape((/(t,f,f,f,f,f,i=1,4)/),(/6,4/))
  logical,dimension(6,4)::x2=reshape((/(t,t,f,f,f,f,i=1,4)/),(/6 ,4/))
  logical,dimension(6,4)::x3=reshape((/(t,t,t,f,f,f,i=1,4)/),(/6 ,4/))
  logical,dimension(6,4)::x6=reshape((/(t,t,t,t,t,t,i=1,4)/),(/6 ,4/))
    integer,dimension(6,4)::y,yy,yy1,yy2,yy3,yy6
    logical,dimension(6,4)::x11,x12,x13,x14,x15
    logical,dimension(6,4)::x21,x22,x23,x24,x25
    logical,dimension(6,4)::x31,x32,x33,x34,x35
    logical,dimension(6,4)::x61,x62,x63,x64,x65
!$omp parallel default(private)
  x1=reshape((/(t,f,f,f,f,f,i=1,4)/),(/6,4/))
  x2=reshape((/(t,t,f,f,f,f,i=1,4)/),(/6 ,4/))
  x3=reshape((/(t,t,t,f,f,f,i=1,4)/),(/6 ,4/))
  x6=reshape((/(t,t,t,t,t,t,i=1,4)/),(/6 ,4/))
        x11=f;x12=f;x13=f;x14=f;x15=f
    x21=f;x22=f;x23=f;x24=f;x25=f
    x31=f;x32=f;x33=f;x34=f;x35=f
    x61=f;x62=f;x63=f;x64=f;x65=f
  ...
  if (any((/y/)/=(/&
    ...
    61,61,62,15,25,35,61,61,65/)))print *,"fail"
  if (any(yy1/=reshape((/(i,-1,-1,-1,-1,-1,i=10,12),15,-1,-1,-1,-1,-1/),(/6,4/))))print *,"fail"
  if (any(yy2/=reshape((/(-1,i,-1,-1,-1,-1,i=20,22),-1,25,-1,-1,-1,-1/),(/6,4/))))print *,"fail"
  if (any(yy3/=reshape((/(-1,-1,i,-1,-1,-1,i=30,32),-1,-1,35,-1,-1,-1/),(/6,4/))))print *,"fail"
  if (any(yy6/=reshape((/-1,-1,-1,61,61,60,-1,-1,-1,&
     61,61,61,-1,-1,-1,61,61,62,-1,-1,-1,61,61,65/),(/6,4/))))print *,"fail"
!$omp end parallel
  contains
