     ...
     E           220*.TRUE.,440*.FALSE.,220*.TRUE./
         ...
         DATA  A,B,C,X/2200*1.D0,2200*2.D0,2200*3.D0,2200*4.D0/
         DATA  L1/1000*.FALSE.,200*.TRUE.,1000*.FALSE./
         DATA  L2/500*.FALSE.,700*.TRUE.,1000*.FALSE./
 ...
 11       CONTINUE
          ...
          DO 10 I = 1 , 2200
            N = I + 10
            A(I) = I + 10
            IF( L(I) ) L1(I) = A(I) .LT. B(I)
            IF( L1(I) ) THEN
              C(I) = I + M - 5
            ENDIF
            IF( L(I) ) L2(I) = A(I) .LT. B(I)
