     ...
     *             ID50(50,50),ID60(50,50),ID70(-100:0)
      ...
      DATA    IT1/1/,IT2/2/,IT3/3/       ,IT5/10/,IT6/20/,IT7/40/
      IVAL1 = 100
      IVAL2 = 1
      DO 5 I=1,100
        ID10(I) = I
 ...
 10   CONTINUE
      ...
      WRITE(6,*) (DA10(K),K=1,50)
      WRITE(6,*) (DA30(K),K=1,100,2)
      WRITE(6,*) (DA20(K),K=100,50,-1)
      WRITE(6,*) (ID20(K),K=100,51,-1)
      WRITE(6,*) (ID30(K),K=2,100,2)
      WRITE(6,*) (ID40(K),K=3,53)
 ...
 20   CONTINUE
      WRITE(6,*) (DA10(K),K=2,30)
      WRITE(6,*) (DA20(K),K=2,30)
      WRITE(6,*) (DA40(K),K=4,60,2)
      WRITE(6,*) (LD20(K),K=2,30)
      WRITE(6,*) ((DB10(I,J),I=49,21,-1),J=30,47)
      WRITE(6,*) ((DB30(I,J),I=2,30),J=40,6,-2)
      WRITE(6,*) ((DB40(I,J),I=2,30),J=20,3,-1)
 ...
 30   CONTINUE
      WRITE(6,*) (ID20(K),K=3,20)
      WRITE(6,*) (ID30(K),K=5,22)
      WRITE(6,*) ((ID50(I,J),I=6,23),J=3,20)
      WRITE(6,*) ((ID60(I,J),I=3,20),J=6,23)
      WRITE(6,*) (ID70(K),K=-2,-19,-1)
