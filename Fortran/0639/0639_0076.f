     ...
     E      50*(5.0,5.0),50*(6.0,6.0) /
           ...
           DO 10 I = 1 , 10
               ...
               A2(I) = ( R2(I) +RD(2)+C1(1))   + ( D2(I) + RD(1)+SI)
               A3(I) = ( R3(I) +SR8+C2(2))   + ( D3(I) + SR8+CD1(8) )
               A4(I) = ( R4(I) +SC8+SR8  )   + ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) + RD(3)+C5(7))
               A6(I) = ( R6(I) +RD(3)+CD2(7))+(D6(I)+DD(2)+1 )
               A7(I) = ( R1(I) +C3(8)+1.0D0)   + (D2(I)+C4(8)+IA(5) )
 10        CONTINUE

           DO 20 I = 11 , 20
             IF( I .LE. 15 ) THEN
               A1(I) = ( R1(I) +1.0+SR8  )   + ( D1(I) + SR4+SR8)
               A2(I) = ( R2(I) +RD(2)+C5(8))   + ( D2(I) + RD(1)+SI)
               A3(I) = ( R3(I) +SR8+C6(7))   + ( D3(I) + SR8+CD4(5) )
               A4(I) = ( R4(I) +SC8+SR8  )   + ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) + RD(3)+(2.0,0.0))
               A6(I) = ( R6(I) +RD(3)+CD3(2))+(D6(I)+DD(2)+1 )
 ...
 20        CONTINUE
           ...
           DO 30 I = 41 , 50
             IF( I .LE. 15 ) THEN
               ...
               A4(I) = ( R4(I) +SC8+SR8  )   + ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) + RD(3)+(2.0,0.0))
               A6(I) = ( R6(I) +RD(3)+CD5(10))+(D6(I)+DD(2)+1 )
               A7(I) = ( R1(I) +SC8+1.0D0)   + (D2(I)+SC8+IA(5) )
             ELSE
               A1(I) = ( R1(I) +1.0+SR8  )   - ( D1(I) + 2.0+SR8)
               A2(I) = ( R2(I) +RD(2)+SC8)   - ( D2(I) + RD(1)+SI)
               ...
               A4(I) = ( R4(I) +SC8+SR8  )   - ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) - RD(3)+(2.0,0.0))
               A6(I) = ( R6(I) +RD(3)+CD6(15))-(D6(I)+DD(2)+1 )
               A7(I) = ( R1(I) +SC8+1.0D0)   - (D2(I)+SC8+IA(5) )
             ENDIF
 30        CONTINUE
