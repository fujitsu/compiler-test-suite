     ...
     E      50*(5.0,5.0),50*(6.0,6.0) /
           ...
           DO 10 I = 1 , 10
               A1(I) = ( R1(I) *1.0  )   * ( D1(I) * 2.0)
               A2(I) = ( R2(I) *RD(2))   * ( D2(I) * RD(1))
               A3(I) = ( R3(I) *S1   )   * ( D3(I) * S2 )
               A4(I) = ( R4(I) *1.0  )   * ( D4(I) * S1 )
               A5(I) = ( R5(I) *S2   )   * ( D5(I) * RD(3) )
               A6(I) = ( R6(I) *RD(3))   * ( D6(I) * DD(2) )
               A7(I) = ( R1(I) *10   )   * ( D2(I) * IA(5) )
 10        CONTINUE

           DO 20 I = 11 , 20
               A1(I) = ( R1(I) *1.0  )   / ( C1(I) * 2.0)
               A2(I) = ( R2(I) *RD(2))   / ( C2(I) * RD(1))
               A3(I) = ( R3(I) *S1   )   / ( C3(I) * S2 )
               A4(I) = ( R4(I) *1.0  )   / ( C4(I) * S1 )
               A5(I) = ( R5(I) *S2   )   / ( C5(I) * RD(3) )
               A6(I) = ( R6(I) *RD(3))   / ( C6(I) * DD(2) )
               A7(I) = ( R6(I) *M    )   / ( C6(I) * IA(5) )
 20        CONTINUE

           DO 30 I = 21 , 30
               A1(I) = ( R1(I) /1.0  )   * ( CD1(I) / 2.0)
               A2(I) = ( R2(I) /RD(2))   * ( CD2(I) / RD(1))
               A3(I) = ( R3(I) /S1   )   * ( CD3(I) / S2 )
               A4(I) = ( R4(I) /1.0  )   * ( CD4(I) / S1 )
               A5(I) = ( R5(I) /S2   )   * ( CD5(I) / RD(3) )
               A6(I) = ( R6(I) /RD(3))   * ( CD6(I) / DD(2) )
               A7(I) = ( R6(I) /10   )   * ( CD6(I) / IA(5) )
 30        CONTINUE
