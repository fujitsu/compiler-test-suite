          ...
          DO 10 J= 1,2
          DO 10 I = 1 , 10
            IF(D(N) .LE. 4.0 ) S1(I)   = R1(I,J) + R2(I,J)
            IF(D(N) .LT. 5.0 ) S1(I)   = R3(I,J) + 10.0
            IF(D(N) .LE. 4.0 ) R4(I,J) = R1(I,J) + R2(I,J)
 10       CONTINUE
            PRINT *,R4
          ...
          N = J
          DO 20 I = 1 , 10
            IF(D(N) .LE. 4.0 ) S2(I)   = R8(I,J) + R5(I,J)
            IF(D(N) .LT. 5.0 ) S2(I)   = R6(I,J) + 100.
            IF(D(N) .LE. 4.0 ) R7(I,J) = R8(I,J) + R5(I,J)
 20       CONTINUE
            PRINT *,R7
          ...
          N = J
          DO 30 I = 1 , 10
            IF(ID(N) .LE. 4   ) IS1(I)    = IR1(I,J) + IR2(I,J)
            IF(ID(N) .LT. 5   ) IS1(I)    = IR3(I,J) + 10
            IF(ID(N) .LE. 4   ) IR4(I,J)  = IR1(I,J) + IR2(I,J)
 30       CONTINUE
            PRINT *,IR4
            END
