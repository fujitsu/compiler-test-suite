     ...
     5            X,Y,Z
           ...
           DATA A/20*3.0,30*2.0/
           DATA B/30*2.0,20*3.0/
           DATA C/10*2.0,40*1.0/
           DATA D/40*2.0,10*1.0/
           DATA A1,A2,A3/50*1.0,50*1.0,50*1.0/
           DATA A4,A5,A6/50*1.0,50*1.0,50*1.0/
           DATA A7,A8,A9/50*1.0,50*1.0,50*1.0/
           DATA AA,AB/50*1.0,50*1.0/
           DATA E/2,4,6,8,10/
           DATA X,Y,Z/3*2.0/
