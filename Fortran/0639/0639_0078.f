           REAL*4     A1(50),A2(50),A3(50),A4(50),A5(50),A6(50),A7(50)
     ...
     E      50*(5.0,5.0),50*(6.0,6.0) /
           ...
           DO 10 I = 1 , 10
               ...
               A2(I) = ( R2(I) +RD(J)+C1(1))   + ( D2(I) + RD(1)+SI)
               A3(I) = ( R3(I) +SR8+C2(J))   + ( D3(I) + SR8+CD1(J) )
               A4(I) = ( R4(I) +SC8+SR8  )   + ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) + RD(3)+C5(J))
               A6(I) = ( R6(I) +RD(3)+CD2(J))+(D6(I)+DD(2)+1 )
               A7(I) = ( R1(I) +C3(J)+1.0D0)   + (D2(I)+C4(J)+IA(5) )
 10        CONTINUE
           ...
           DO 20 I = 11 , 20
             IF( I .LE. 15 ) THEN
               ...
               A2(I) = ( R2(I) +RD(J)+C5(8))   + ( D2(I) + RD(1)+SI)
               A3(I) = ( R3(I) +SR8+C6(J))   + ( D3(I) + SR8+CD4(J) )
               A4(I) = ( R4(I) +SC8+SR8  )   + ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) + RD(3)+(2.0,0.0))
               A6(I) = ( R6(I) +RD(3)+CD3(J))+(D6(I)+DD(2)+1 )
               A7(I) = ( R1(I) +SC8+1.0D0)   + (D2(I)+SC8+IA(J) )
             ENDIF
 20        CONTINUE

           DO 30 J = 41 , 50
           DO 30 I = 41 , 50
             IF( I .LE. 15 .OR. J .GT. 45 ) THEN
               A1(I) = ( R1(I) +1.0+SR8  )   + ( D1(I) + 2.0+SR8)
               A2(I) = ( R2(I) +RD(J)+SC8)   + ( D2(I) + RD(J)+SI)
               A3(I) = ( R3(I) +SR8+SC8  )   + ( D3(I) + SR8+SC16 )
               A4(I) = ( R4(I) +SC8+SR8  )   + ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) + RD(3)+(2.0,0.0))
               A6(I) = ( R6(I) +RD(J)+CD5(10))+(D6(I)+DD(J)+1 )
             ...
             ELSE
               ...
               A4(I) = ( R4(I) +SC8+SR8  )   - ( D4(I) + SR8+SI )
               A5(I) = ( R5(I) +S2+1.0D0)+ ( D5(I) - RD(3)+(2.0,0.0))
               A6(I) = ( R6(I) +RD(J)+CD6(J))-(D6(I)+DD(2)+J )
               A7(I) = ( R1(I) +SC8+1.0D0)   - (D2(I)+SC8+IA(J) )
             ENDIF
 30        CONTINUE
