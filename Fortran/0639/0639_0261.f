     ...
     5         QQ(50),RR(50),SS(50),TT(50),UU(50)
       ...
       DO 20 I = 1 , 50
         ...
         A(I)=B(I)/V/C(I)/AY(1)/CT(2)*D(I)*W*E(I)*AY(3)
         F(I)=X/G(I)/AY(4)/H(I)/CT(5)*Y*K(I)*AY(1)*L(I)
         M(I)=AY(2)/Z/N(I)/CT(3)/O(I)*Q(I)*V*P(I)*CT(4)
         R(I)=T(3)/CT(5)/S(I)/W/AY(2)*CT(2)*U(I)*X*AY(3)
