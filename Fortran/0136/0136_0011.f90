...
if(any(r**3_1/=r*r*r)) print *,'err3'
if(any(r**4_1/=r*r*r*r)) print *,'err4'
if(any(r**5_1/=r*r*r*r*r)) print *,'err5'
...
if(any(r**3_2/=r*r*r)) print *,'err13'
if(any(r**4_2/=r*r*r*r)) print *,'err14'
if(any(r**5_2/=r*r*r*r*r)) print *,'err15'
...
if(any(r**5_4/=r*r*r*r*r)) print *,'err25'
