...
logical(4)::l1(5)
logical(8)::l2(5)
call ieee_get_flag(ieee_invalid,l1(1))
call ieee_get_flag(ieee_invalid,l2(1))
call ieee_get_flag(ieee_overflow,l1(2))
call ieee_get_flag(ieee_overflow,l2(2))
call ieee_get_flag(ieee_divide_by_zero,l1(3))
call ieee_get_flag(ieee_divide_by_zero,l2(3))
call ieee_get_flag(ieee_underflow,l1(4))
call ieee_get_flag(ieee_underflow,l2(4))
call ieee_get_flag(ieee_inexact,l1(5))
call ieee_get_flag(ieee_inexact,l2(5))
