...
if(EQUAL_CHECK_WITH_MARGIN(r**(-4_1),1/r**4_1)) print *,'err4'
if(EQUAL_CHECK_WITH_MARGIN(r**(-5_1),1/r**5_1)) print *,'err5'
if(d**(-1_1)/=1/d**1_1) print *,'err6'
if(d**(-2_1)/=1/d**2_1) print *,'err7'
if(EQUAL_CHECK_WITH_MARGIN(d**(-3_1),1/d**3_1)) print *,'err8'
...
if(EQUAL_CHECK_WITH_MARGIN(r**(-4_2),1/r**4_2)) print *,'err14'
if(EQUAL_CHECK_WITH_MARGIN(r**(-5_2),1/r**5_2)) print *,'err15'
if(d**(-1_2)/=1/d**1_2) print *,'err16'
if(d**(-2_2)/=1/d**2_2) print *,'err17'
if(EQUAL_CHECK_WITH_MARGIN(d**(-3_2),1/d**3_2)) print *,'err18'
...
if(EQUAL_CHECK_WITH_MARGIN(r**(-3_4),1/r**3)) print *,'err23'
if(EQUAL_CHECK_WITH_MARGIN(r**(-4_4),1/r**4)) print *,'err24'
if(EQUAL_CHECK_WITH_MARGIN(r**(-5_4),1/r**5)) print *,'err25'
if(d**(-1_4)/=1/d**1) print *,'err26'
if(d**(-2_4)/=1/d**2) print *,'err27'
if(EQUAL_CHECK_WITH_MARGIN(d**(-3_4),1/d**3)) print *,'err28'
