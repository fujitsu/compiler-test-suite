...
contains
subroutine s2
type(e2),parameter::p07=e2(2,3,3)
type(e2),parameter::p08=e2(e1a=3,ba=2)
type(e2),parameter::p09=e2(ba=2,e1a=3)
type(e2),parameter::p10=e2(   2,e1a=3)
type(e2),parameter::p11=e2(b(2),3)
type(e2),parameter::p12=e2(e1a=3,b=b(2))
type(e2),parameter::p13=e2(b=b(2),e1a=3)
type(e2),parameter::p14=e2(b(ba=2),e1a=3)
type(e2),parameter::p15=e2(b(ba=2),3)
type(e2),parameter::p16=e2(e1a=3,b=b(ba=2))
type(e2),parameter::p17=e2(b=b(ba=2),e1a=3)
type(e2),parameter::p18=e2(b(ba=2),e1a=3)
...
if (d1%e2a/=5)print *,1105
if (d1%e2b/=6)print *,1106
...
if (d1%e2a/=5)print *,2106
if (d1%e2b/=6)print *,2107
...
subroutine s1
use m1
type(e2),parameter::p01=e2(2)
type(e2),parameter::p02=e2(ba=2)
type(e2),parameter::p03=e2(bA=2)
type(e2),parameter::p04=e2(b(2))
type(e2),parameter::p05=e2(b=b(2))
type(e2),parameter::p06=e2(B=B(2))
