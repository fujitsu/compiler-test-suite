...
real(k),parameter::a01=1.234567_4
...
real(k),parameter::a11=a01**7_1
real(k),parameter::a12=a01**7_2
real(k),parameter::a13=a01**7_4
real(k),parameter::a14=a01**7_8
real(k),parameter::a15=a01**a0m
real(k),parameter::a16=a01**b0m
real(k),parameter::a17=a01**c0m
real(k),parameter::a18=a01**d0m
real(k),parameter::a19=a01**e0m
real(k),parameter::a20=a01**f0m
...
real(k)::x02
real(8)::x03
real(kind=8),parameter :: diff=1.0E-5_8
if (abs(x01-real(x02**x03,k)) .ge. diff)print *,302,x01,x02,x03,real(x02**x03,k),diff
end subroutine
...
real(4)::x03
real(kind=8),parameter :: diff=1.0E-5_8
if (abs(x01-x02**x03) .ge. diff)print *,301,x01,x02,x03,x02**x03,diff
end subroutine
