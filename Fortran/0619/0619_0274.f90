...
parameter (a11=a01**16_1)
parameter (a12=a01**16_2)
parameter (a13=a01**16_4)
parameter (a14=a01**16_8)
...
call chk(a11,a01,16_1)
call chk(a12,a01,16_2)
call chk(a13,a01,16_4)
call chk(a14,a01,16_8)
...
real(4)::x02
complex(16)::x03
if (x01/=real(x02**x03,4))print *,403,x01,x02,x03,real(x02**x03,4)
end subroutine
...
real(4)::x02
real(16)::x03
if (x01/=real(x02**x03,4))print *,303,x01,x02,x03,real(x02**x03,4)
end subroutine
