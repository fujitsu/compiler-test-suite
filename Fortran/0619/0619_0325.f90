...
type(e2)          ::d1,d2
if (any(d1%ba/=2))print *,1101
if (any(d1%e1a/=1))print *,1102
if (any(d1%e1%e1a/=1))print *,1102
if (any(d1%bb/=3))print *,1103
if (any(d1%b%bb/=3))print *,1103
if (any(d1%e1b/=4))print *,1104
if (any(d1%e2a/=15))print *,1105
if (any(d1%e2b/=16))print *,1106
if (any(d2%ba/=2))print *,1201
if (any(d2%e1a/=1))print *,1202
if (any(d2%ba/=2))print *,1201
if (any(d2%e1a/=1))print *,1202
if (any(d2%e1%e1a/=1))print *,1202
if (any(d2%bb/=3))print *,1203
if (any(d2%b%bb/=3))print *,1203
if (any(d2%e1b/=4))print *,1204
if (any(d2%e2a/=5))print *,1205
if (any(d2%e2b/=6))print *,1206
end subroutine
...
if (any(d2%e2a/=5))print *,2106
if (any(d2%e2b/=6))print *,2107
end subroutine
end
subroutine s1
use m1
...
v01=e2(2)
if (any(p01%ba/=2))print *,101
if (any(v01%ba/=2))print *,201
call chk(p01,v01)
v02=e2(ba=2)
if (any(p02%ba/=2))print *,102
if (any(v02%ba/=2))print *,202
call chk(p02,v02)
v03=e2(bA=2)
if (any(p03%ba/=2))print *,103
if (any(v03%ba/=2))print *,203
call chk(p03,v03)
v04=e2(b(2))
if (any(p04%ba/=2))print *,104
if (any(v04%ba/=2))print *,204
call chk(p04,v04)
v05=e2(b=b(2))
if (any(p05%ba/=2))print *,105
if (any(v05%ba/=2))print *,205
call chk(p05,v05)
v06=e2(B=B(2))
if (any(p06%ba/=2))print *,106
if (any(v06%ba/=2))print *,205
call chk(p06,v06)
end
use m1
call s1
