...
real(4),parameter::a0m=7_4
real(8),parameter::b0m=7_4
real(16),parameter::c0m=7_4
complex(4),parameter::d0m=7_4
complex(8),parameter::e0m=7_4
complex(16),parameter::f0m=7_4
parameter (b01=1.2345678901234_8)
parameter (c01=1.2345678901234567890123456789012345678901_16)
parameter (d01=(1.234567_4,1.234567_4))
parameter (e01=(b01,b01))
parameter (f01=(c01,c01))
complex(k),parameter::a01=d01
complex(k),parameter::a11=a01**7_1
complex(k),parameter::a12=a01**7_2
complex(k),parameter::a13=a01**7_4
complex(k),parameter::a14=a01**7_8
complex(k),parameter::a15=a01**a0m
complex(k),parameter::a16=a01**b0m
complex(k),parameter::a17=a01**c0m
complex(k),parameter::a18=a01**d0m
complex(k),parameter::a19=a01**e0m
complex(k),parameter::a20=a01**f0m

call chk(a11,a01,7_1)
call chk(a12,a01,7_2)
call chk(a13,a01,7_4)
call chk(a14,a01,7_8)
...
complex(k)::x02
complex(16)::x03
if (x01/=cmplx(x02**x03,kind=k))print *,403,x01,x02,x03,cmplx(x02**x03,kind=k)
end subroutine
...
complex(k)::x02
complex(4)::x03
if (EQUAL_CHECK(x01,cmplx(x02**x03)))print *,401,x01,x02,x03,cmplx(x02**x03)
end subroutine
subroutine r16(x01,x02,x03)
complex(k)::x01
complex(k)::x02
real(16)::x03
if (x01/=cmplx(x02**x03,kind=k))print *,303,x01,x02,x03,cmplx(x02**x03,kind=k)
end subroutine
