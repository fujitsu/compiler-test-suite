...
k=0
call chk2(v(2)%cy1)
    if (v(2)%cy1(1)%ix1/=11)print *,13201
    if (v(2)%cy1(2)%ix1/=12)print *,13202
    if (v(2)%cy1(3)%ix1/=13)print *,13203
    if (v(2)%cy1(4)%ix1/=14)print *,13203
    if (size(v(2)%cy1)/= 4)print *,13204
...
k=0
call chk1(v(2)%cz1)
    if (v(2)%cy1(1)%ix1/=11)print *,13301
    if (v(2)%cy1(2)%ix1/=12)print *,13302
    if (v(2)%cy1(3)%ix1/=13)print *,13303
    if (v(2)%cy1(4)%ix1/=14)print *,13303
    if (size(v(2)%cy1)/= 4)print *,13304
end
call s1
print *,'pass'
end
