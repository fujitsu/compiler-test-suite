...
integer(1)::k(2,2)
k=100
allocate(a1(2),a2(3),a3(4),stat=k(2,2))
write(1,*)101,k(2,2)
if (k(2,2)/=0)print *,101
...
allocate(a4(10),a2(13),a3(14),stat=k(2,2))
write(1,*)111,k(2,2)
if (k(2,2)==0)print *,111
...
k(2,2)=100
allocate(b1(2),b2(3),b3(4),stat=k(2,2),errmsg=x)
if (k(2,2)/=0)print *,201
write(1,*)201,k(2,2)
...
allocate(b4(10),b2(13),b3(14),stat=k(2,2))
if (k(2,2)==0)print *,211
write(1,*)211,k(2,2)
...
write(1,*)k(2,2)
allocate(c1(2),stat=k(2,2))
if (k(2,2)/=0)print *,301
if (any(ubound(c1)/=2))print *,3121
allocate(c1(3),stat=k(2,2))
if (k(2,2)==0)print *,401
