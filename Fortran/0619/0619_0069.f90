...
allocate(v1(1)%cy3,source=v1(2)%cy3)
allocate(v1(1)%cy2,source=v1(2)%cy3)
allocate(v1(1)%cy1,source=v1(2)%cy2)
!
...
allocate(v1(3)%cy3,source=v1(2)%cy3)
allocate(v1(3)%cy2,source=v1(2)%cy3)
allocate(v1(3)%cy1,source=v1(2)%cy2)
!
