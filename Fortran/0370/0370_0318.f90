...
subroutine scr
  ...
  character(kind=1),pointer :: pc
  character(kind=1,len=3),pointer :: ps
...
subroutine ary
  ...
  character(kind=1),pointer :: pc1(:)
  character(kind=1),pointer :: pc2
  character(kind=1),pointer :: pc3(:)
  character(kind=1),pointer :: pc4(:)
  data pc1 /c1/
  data pc2 /c1(2)/
  data pc3 /c1(2:3)/
  data pc4 /c1(3:1:-1)/
  ...
  character(kind=1,len=3),pointer :: ps1(:)
  character(kind=1,len=3),pointer :: ps2
  character(kind=1,len=3),pointer :: ps3(:)
  character(kind=1,len=3),pointer :: ps4(:)
  data ps1 /s1/
  data ps2 /s1(2)/
  data ps3 /s1(2:3)/
  data ps4 /s1(3:1:-1)/
...
subroutine mary
  ...
  character(kind=1),pointer :: pc2
  character(kind=1),pointer :: pc3(:,:)
  character(kind=1),pointer :: pc3a(:)
  character(kind=1),pointer :: pc3b(:)
  character(kind=1),pointer :: pc4(:,:)
  data pc1  /c1/
  data pc2  /c1(2,2)/
  data pc3  /c1(2:3,1:2)/
  ...
  character(kind=1,len=3),pointer :: ps2
  character(kind=1,len=3),pointer :: ps3(:,:)
  character(kind=1,len=3),pointer :: ps3a(:)
  character(kind=1,len=3),pointer :: ps3b(:)
  character(kind=1,len=3),pointer :: ps4(:,:)
  data ps1  /s1/
  data ps2  /s1(2,2)/
  data ps3  /s1(2:3,1:2)/
