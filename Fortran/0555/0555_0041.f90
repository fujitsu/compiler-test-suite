...
call s(ch,ch2,ch3,ch4,ch5%t4obj%t3obj%t2obj%tgt)
if(stat==1) print*,'PASS7'
end subroutine

subroutine s(unlim,unlim2,unlim3,unlim4,unlim5)
class(*) :: unlim2(:,:),unlim
class(*) :: unlim3(:,:,:)
class(*) :: unlim4(:,:,:)
class(*) :: unlim5
...
function fun(dmy,dmy2,dmy3,dmy4,dmy5)
 ...
 if(sizeof(dmy) /= 4) print*,'201','dmy',sizeof(dmy)
