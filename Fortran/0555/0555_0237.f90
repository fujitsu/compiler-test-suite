...
allocate(obj_cha%arr_deriv(4,4))
...
obj_cha%arr_deriv(3,4)%real1=10
obj_cha%arr_deriv(3,4)%int1=20
obj_cha%arr_deriv(3,4)%int2=30
obj_cha%arr_deriv(3,4)%real2=40
 
obj_tata%arrptr_base=>obj_cha%arr_deriv
