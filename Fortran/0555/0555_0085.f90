...
ch5%i4=4
ch5%t4obj%t3obj%t2obj%tgt=''

allocate(character(len=n)::unlim)
allocate(character(len=5)::unlim2(3,4))
allocate(character(len=5)::unlim3(4,4,4))
allocate(logical::unlim4(5,5,5))
