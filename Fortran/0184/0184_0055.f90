module m1
type xx( k1,k2,k3,k4,k5,k6)
  integer,kind:: k1,k2,k3,k4,k5,k6
  integer::aa(k1,k2,k3,k4,k5,k6)
end type
integer :: a1(1,1)
...
type yy( i1,i2,i3,i4,i5,i6)
  integer,kind:: i1,i2,i3,i4,i5,i6
  integer::aa(i1,i2,i3,i4,i5,i6)
end type
integer :: b1(1,1)
...
n=n-1
 ...
 if (k2/=n) print *,201,k2
 if (k3/=n) print *,201,k3
 if (k4/=n) print *,201,k4
 if (k5/=n) print *,201,k5
 if (k6/=n) print *,201,k6
nk=0
call s11(nk)
contains
...
if (b3(1)/=1) print *,103
 ...
 if (n<3)call s11(n)
n=n-1
 if (i1/=n) print *,211,i1
 if (i2/=n) print *,221,i2
 if (i3/=n) print *,231,i3
 if (i4/=n) print *,241,i4
 if (i5/=n) print *,251,i5
 if (i6/=n) print *,261,i6
end subroutine
end subroutine
