...
integer,parameter::y1=2,y2=1,y3=2
contains
function       sub(a1,a2,a3,k2,k4,k6,k,ik1,ik2,ik3)
integer,dimension(k2,k4,k6/y1),intent(inout),optional:: a1
integer,dimension(k2,k4,k6/y2),intent(inout),optional:: a2
integer,dimension(k2,k4,k6/y3),intent(inout),optional:: a3
...
k3=0
if (y3==2)k3=1
 cal= sub(v%p1,v%p2,v%p3,n2,n4,n6,a,k1,k2,k3)
