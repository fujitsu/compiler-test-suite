module m1
integer,parameter:: k1=3,k2=4,k3=5,k4=5
...
real   (8)::r(k2,k1)
r=cmplx(n2+n3,n2+n3,8)
end function
subroutine s1(k1,k2,k3,k4)
forall (n2=1:k1,n3=1:k3)
  a(n2,:,n3+1,:)=real(a(n2,:,n3,:))+reshape([(n,n=1,k2*k4)],[k2,k4])+f(n2,n3,k2,k4,1)
  a(n2,:,n3+1,:)=real(a(n2,:,n3,:))+reshape([(n,n=1,k2*k4)],[k2,k4])+f(n2,n3,k2,k4,2)
end forall
end subroutine
