...
real   (8)::r(k2,k1)
r=cmplx(n2+n3,n3+n2,8)
!call subcheck(r(1,1),k)
end function
subroutine s1(k1,k2,k3,k4)
forall (n2=1:k1,n3=1:k3)
  a(n2,:,n3+1,:)=real(a(n2,:,n3,:))+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4]),8)+f(n2,n3,k2,k4,1)
  a(n2,:,n3+1,:)=real(a(n2,:,n3,:))+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4]),8)+f(n2,n3,k2,k4,2)
end forall
end subroutine
...
do      n3=1,k3
do      n2=1,k1
  c(n2,:,n3,:)=real(b(n2,:,n3,:))+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4])) +f(n2,n3,k2,k4,0)
end do
end do
do      n3=1,k3
do      n2=1,k1
...
call s1(k1,k2,k3,k4)
call s2(k1,k2,k3,k4)
if (any(abs(a-b)>0.000000001)) then
print *,101
print *,a
print *,b
endif
