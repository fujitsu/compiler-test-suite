module m1
integer,parameter:: k1=3,k2=4,k3=5,k4=10
type x
...
forall (n2=1:k1,n3=1:k3)
  z%a(n2,:,n3+1,:)=real(z%a(n2,:,n3,:))+reshape([(n,n=1,k2*k4)],[k2,k4])+f(n2,n3,k2,k4,1)
  z%a(n2,:,n3+1,:)=real(z%a(n2,:,n3,:))+reshape([(n,n=1,k2*k4)],[k2,k4])+f(n2,n3,k2,k4,2)
end forall
end subroutine
...
do      n3=1,k3
do      n2=1,k1
  c(n2,:,n3,:)=real(z%b(n2,:,n3,:))+reshape([(n,n=1,k2*k4)],[k2,k4]) +f(n2,n3,k2,k4,0)
end do
end do
do      n3=1,k3
do      n2=1,k1
...
call s1(k1,k2,k3,k4)
call s2(k1,k2,k3,k4)
if (any(abs(z%a-z%b)>0.000001)) then
print *,101
print *,z%a
print *,z%b
endif
