...
forall (n2=1:k1,n3=1:k3)
  a(n2,:,n3,:)=real(a(n2,:,n3,:))+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4]))+f(n2,n3,k2,k4,1)
  a(n2,:,n3,:)=real(a(n2,:,n3,:))+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4]))+f(n2,n3,k2,k4,2)
end forall
end subroutine
