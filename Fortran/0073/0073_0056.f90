...
forall (n2=1:k1,n3=1:k3)
  a(n2,:,n3+1,:)=a(n2,:,n3,:)+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4]),8)+f(n2,n3,k2,k4,1)
  a(n2,:,n3+1,:)=a(n2,:,n3,:)+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4]),8)+f(n2,n3,k2,k4,2)
end forall
end subroutine
...
do      n3=1,k3
do      n2=1,k1
  c(n2,:,n3,:)=b(n2,:,n3,:)+cmplx(reshape([(n,n=1,k2*k4)],[k2,k4]),reshape([(n,n=1,k2*k4)],[k2,k4])) +f(n2,n3,k2,k4,0)
end do
end do
do      n3=1,k3
do      n2=1,k1
