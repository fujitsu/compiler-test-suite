  ...
  subroutine test01()
    character,parameter,dimension(3) :: a = (/"1",'3',"5"/)
    character          ,dimension(3) :: aa = (/"1",'3',"5"/)
    ...
    if(b6 /= lbound((aa//(aa)),1)) error = error+1
    if(c1 /= lbound(aa,1)) error = error+1
    if(c2 /= lbound((aa),1)) error = error+1
    if(c3 /= lbound(((aa)),1)) error = error+1
    if(c4 /= lbound(aa//aa,1)) error = error+1
    if(c5 /= lbound((aa//""),1)) error = error+1
    if(c6 /= lbound((aa//(aa)),1)) error = error+1

    if (error /= 0) print *, " +++ test item 1 : ng +++ ",error
  end subroutine test01

  subroutine test02()
    character,parameter,dimension(2:4) :: a = (/"1",'3',"5"/)
    character          ,dimension(2:4) :: aa = (/"1",'3',"5"/)
  ...
  subroutine test03()
    character,parameter,dimension(-1:1) :: a = (/"1",'3',"5"/)
    character          ,dimension(-1:1) :: aa = (/"1",'3',"5"/)
  ...
  subroutine test04()
    character,parameter,dimension(1:0) :: a = "999"
    character          ,dimension(1:0) :: aa = "999"
  ...
  subroutine test05()
    type typ ; sequence ; character :: e1 ; endtype
