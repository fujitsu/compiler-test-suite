  ...
  subroutine test01()
    ...
    if(b4 /= ubound(+aa,1)) error = error+1
    if(b5 /= ubound((+aa),1)) error = error+1
    if(b6 /= ubound(((+aa)),1)) error = error+1
    if(b7 /= ubound((+(aa)),1)) error = error+1
    if(b8 /= ubound(aa+0,1)) error = error+1
    if(b9 /= ubound(((aa)+0),1)) error = error+1
    if(c1 /= ubound(aa,1)) error = error+1
    if(c2 /= ubound((aa),1)) error = error+1
    if(c3 /= ubound(((aa)),1)) error = error+1
    if(c4 /= ubound(+aa,1)) error = error+1
    if(c5 /= ubound((+aa),1)) error = error+1
    if(c6 /= ubound(((+aa)),1)) error = error+1
    if(c7 /= ubound((+(aa)),1)) error = error+1
    if(c8 /= ubound(aa+0,1)) error = error+1
    if(c9 /= ubound(((aa)+0),1)) error = error+1
  ...
  subroutine test09()
    ...
    if(b4 /= ubound(+aa%e1,1)) error = error+1
    if(b5 /= ubound((+aa%e1),1)) error = error+1
    if(b6 /= ubound(((+aa%e1)),1)) error = error+1
    if(b7 /= ubound((+(aa%e1)),1)) error = error+1
    if(b8 /= ubound(aa%e1+0,1)) error = error+1
    if(b9 /= ubound(((aa%e1)+0),1)) error = error+1
    if(c1 /= ubound(aa%e1,1)) error = error+1
    if(c2 /= ubound((aa%e1),1)) error = error+1
    if(c3 /= ubound(((aa%e1)),1)) error = error+1
    if(c4 /= ubound(+aa%e1,1)) error = error+1
    if(c5 /= ubound((+aa%e1),1)) error = error+1
    if(c6 /= ubound(((+aa%e1)),1)) error = error+1
    if(c7 /= ubound((+(aa%e1)),1)) error = error+1
    if(c8 /= ubound(aa%e1+0,1)) error = error+1
    if(c9 /= ubound(((aa%e1)+0),1)) error = error+1
