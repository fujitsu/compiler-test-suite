  ...
  subroutine test01()
    ...
    if(b4 /= lbound(+a,1)) error = error+1
    if(b5 /= lbound((+a),1)) error = error+1
    if(b6 /= lbound(((+a)),1)) error = error+1
    if(b7 /= lbound((+(a)),1)) error = error+1
    if(b8 /= lbound(a+0,1)) error = error+1
    if(b9 /= lbound(((a)+0),1)) error = error+1
    if(c1 /= lbound(a,1)) error = error+1
    if(c2 /= lbound((a),1)) error = error+1
    if(c3 /= lbound(((a)),1)) error = error+1
    if(c4 /= lbound(+a,1)) error = error+1
    if(c5 /= lbound((+a),1)) error = error+1
    if(c6 /= lbound(((+a)),1)) error = error+1
    if(c7 /= lbound((+(a)),1)) error = error+1
    if(c8 /= lbound(a+0,1)) error = error+1
    if(c9 /= lbound(((a)+0),1)) error = error+1
  ...
  subroutine test09()
    ...
    if(b4 /= lbound(+a%e1,1)) error = error+1
    if(b5 /= lbound((+a%e1),1)) error = error+1
    if(b6 /= lbound(((+a%e1)),1)) error = error+1
    if(b7 /= lbound((+(a%e1)),1)) error = error+1
    if(b8 /= lbound(a%e1+0,1)) error = error+1
    if(b9 /= lbound(((a%e1)+0),1)) error = error+1
    if(c1 /= lbound(a%e1,1)) error = error+1
    if(c2 /= lbound((a%e1),1)) error = error+1
    if(c3 /= lbound(((a%e1)),1)) error = error+1
    if(c4 /= lbound(+a%e1,1)) error = error+1
    if(c5 /= lbound((+a%e1),1)) error = error+1
    if(c6 /= lbound(((+a%e1)),1)) error = error+1
    if(c7 /= lbound((+(a%e1)),1)) error = error+1
    if(c8 /= lbound(a%e1+0,1)) error = error+1
    if(c9 /= lbound(((a%e1)+0),1)) error = error+1
