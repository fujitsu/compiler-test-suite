...
contains
  subroutine mod_sub01()
    ...
    allocate(struct01%struct02(1)%int02)
  end subroutine
  subroutine mod_sub02()
    deallocate(struct01%struct02(1)%int02)
  ...
  if (struct01%struct02(1)%int02 == 1) then
    print *,"pass01"
  else
    print *,"ng01"
  end if
  call sub02(struct01%struct02(1)%int02)
  if (struct01%struct02(1)%int02 == 2) then
    print *,"pass02"
  else
    print *,"ng02"
  end if
