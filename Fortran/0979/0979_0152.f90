...
subroutine test01(i)
 ...
 call get_environment_variable('onetwothreefourfivesixseveneightninetenileventwelbe', val2, len3, sta3, t_name)
 if (val2.ne.'') write(6,*) "NG"
 if (len3.ne.len_trim(val2)) write(6,*) "NG"
 if (sta3.ne.1) write(6,*) "NG"

 call get_environment_variable('te-rette-tetetete-tetete,tetetete-te-te-', val2)
 if (val2.ne.'') write(6,*) "NG"
 if (len3.ne.len_trim(val2)) write(6,*) "NG"

 call get_environment_variable('tetetetetete-te-tetetetetetetete-tetetete-te-te-te-', val2, len3)
 if (val2.ne.'') write(6,*) "NG"
 if (len3.ne.len_trim(val2)) write(6,*) "NG"

  call get_environment_variable('ABCABCABCABCABCABCABCABCABCABCABCABCABC', val2, len3, sta3)
 if (val2.ne.'') write(6,*) "NG"
 if (len3.ne.len_trim(val2)) write(6,*) "NG"
 if (sta3.ne.1) write(6,*) "NG"

 call get_environment_variable('XYZXYZXYZXYZXYZXYZXYZXYZXYZXYZXYZXYZXYZXY', val2, len3, sta3, t_name2)
 if (val2.ne.'') write(6,*) "NG"
 if (len3.ne.len_trim(val2)) write(6,*) "NG"
 if (sta3.ne.1) write(6,*) "NG"
