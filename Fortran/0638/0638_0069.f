         ...
         DO 10 I=1,100,4
           ...
           IF(I.LE.99) THEN
             ...
             R4D(I+1)=16     + R4D(I)  +    1
           IF(I.LE.98) THEN
             R1A(I+2)=1      + R1A(I+1)  +   16
             R1B(I+2)=2      + R1B(I+1)  +   15
             R1C(I+2)=3      + R1C(I+1)  +   14
             R1D(I+2)=4      + R1D(I+1)  +   13
             R2A(I+2)=5      + R2A(I+1)  +   12
             R2B(I+2)=6      + R2B(I+1)  +   11
             R2C(I+2)=7      + R2C(I+1)  +   10
             R2D(I+2)=8      + R2D(I+1)  +    9
             R3A(I+2)=9      + R3A(I+1)  +    8
             R3B(I+2)=10     + R3B(I+1)  +    7
             R3C(I+2)=11     + R3C(I+1)  +    6
             R3D(I+2)=12     + R3D(I+1)  +    5
...
10         CONTINUE
           ...
           DO 20 I=1,10
            R1A(I)=R1D(10)+R1D(10)-(R1D(10)*R1D(10)+R1A(I)) 
             R1B(I)=R1D(I)+R1D(10)+(R1C(I)**R1D(10))
             R1C(I)=-R1D(10)+R1B(I)+R1C(I)
             R1D(I)=R1C(I)+R1D(I)+R1D(10)+R1D(100)
20           CONTINUE
           DO 30 I=10,30
             IF(I.GT.20) THEN
