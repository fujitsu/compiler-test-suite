...
40     CONTINUE
       ...
       DO 50 J=1,10
         ...
         ED3=CD3(3,J)*(2.0,1.0)
         ED4=CD4(4,J)*(2.0,1.0)
         ED5=ED1+ED2+ED3+ED4+ED6**CD1(1,J)
         I=J
...
50     CONTINUE
       ...
       FD6=(0.0,0.0)
       DO 60 J=1,10
         FD1=(CQ1(1,J)*(2.0,1.0))/CQ1(2,J)
         I=J
         CQ4(1,J)=CQ1(1,I)+CQ2(2,I)+CQ3(3,J)+CQ4(4,I)+FD1+FD5+FD6
60     CONTINUE
       WRITE(6,9999) R4,D4,Q4
       do 999 j=1,10
       do 999 i=1,10
 999   WRITE(6,9999) real(C4(i,j)),imag(c4(i,j)),real(CD4(i,j))
     * ,imag(cd4(i,j)),real(CQ4(i,j)),imag(cq4(i,j))
9999   format(10g20.6)
       STOP
       END
       BLOCK DATA
