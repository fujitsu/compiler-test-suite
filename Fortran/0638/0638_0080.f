         ...
         INTEGER*4 R1A(1024),R1B(1024),R1C(1024),R1D(1024)
         INTEGER*4 R2A(1024),R2B(1024),R2C(1024),R2D(1024)
         INTEGER*4 R3A(1024),R3B(1024),R3C(1024),R3D(1024)
         INTEGER*4 R4A(1024),R4B(1024),R4C(1024),R4D(1024)
         INTEGER*4 N/100/ ,K/1/
...
110         CONTINUE
           ...
           IF(N.EQ.100.OR.J.EQ.1) THEN
             ...
             R2B(I+1)=R1A(I+2)**I
           ELSE
           IF(R1A(I+2).LE.0.0) GOTO 9873
             R2B(I+2)=R1A(I+2)**R1A(I+2)
             R2C(I)=R1A(I+3)+1
             R2C(I+1)=R1A(I+2)**K
9873         R2C(I+2)=R1A(I+2)**I
           ENDIF
           R2D(I)=R1A(I+3)+1
           R2D(I+1)=R1A(I+2)+1
           R2D(I+2)=R1A(I+2)+1
...
140         CONTINUE
         ...
         INTEGER*4 R3A(1024),R3B(1024),R3C(1024),R3D(1024)
         INTEGER*4 R4A(1024),R4B(1024),R4C(1024),R4D(1024)
      DATA R1A/1024*1/,R1B/1024*2/,R1C/1024*1/,R1D/512*1,512*2/ 
      DATA R2A/1024*1/,R2B/1024*2/,R2C/1024*1/,R2D/512*1,512*2/ 
      DATA R3A/1024*1/,R3B/1024*2/,R3C/1024*1/,R3D/512*1,512*2/ 
      DATA R4A/1024*1/,R4B/1024*2/,R4C/1024*1/,R4D/512*1,512*2/ 
         END
