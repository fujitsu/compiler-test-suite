...
interface
 ...
 function func3() result(rst)
  procedure(integer), pointer :: rst
 end function
 function func4() result(rst)
  intrinsic iabs
  procedure(iabs), pointer :: rst
 end function
 function func5(i, j) result(rst)
  integer :: i, j, rst
 end function
end interface
...
use mod017a,only:ty6,ty5,ty4,ty3,ty2,ty1,ty7
end
module mod018
use mod017b
private::ty8
...
use mod018a,only:ty6,ty5,ty4,ty3,ty2,ty1,ty7,ty8
end
subroutine s1
use mod018b
use mod00
...
ttt%ty44(1) = ty4(ty3(ty2(ty1(func1), isign)))
ttt%ty44(2) = ty4(ty3(ty2(ty1(func1), mod  )))
call ttt%mod011ax()
call ttt%mod012ax()
call ttt%mod013ax()
call ttt%mod014ax()
