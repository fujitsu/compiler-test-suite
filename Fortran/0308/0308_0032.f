      ...
      INTEGER*4 N1,N2,N3,K,L,M,H1,H2
     ...
     .,5.0,0.0,5.0,0.0,5.0,0.0,5.0,0.0,5.0,0.0,5.0,0.0,5.0,0.0,JJ1*0.0/ 
      ...
      N1=5                                                              
      CALL SUB(RC,N1,N2,N3,H1,H2)                                       
      RA(H1:N1+N3:2,H1:N1+N3,1:4:2)=RC(H1:N2+N2:2,H2:N2+N3:1,2:5:2)     
   ...
   30 STOP                                                              
      ...
      SUBROUTINE SUB(RC,N1,N2,N3,H1,H2)                                 
      PARAMETER (J=10,JJ=J*J)                                           
      INTEGER*4 N1,N2,N3,H1,H2                                          
