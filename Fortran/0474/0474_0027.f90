...
select type (p)
 class is(y)
    ...
    if (any(p%pp(:)/=1)) print *,10001 
    if (any(p%nn(:)/=1)) print *,10001 
    if (any(p%aa(:)/=1)) print *,10001
kk=1
end select
if (kk/=1) print *,901
...
select type (a)
 class is(y)
    ...
    if (any(a%pp(:)/=1)) print *,10001 
    if (any(a%nn(:)/=1)) print *,10001 
    if (any(a%aa(:)/=1)) print *,10001
kk=1
end select
if (kk/=1) print *,901
...
select type (n)
 class is(y)
    ...
    if (any(n%pp(:)/=1)) print *,10001 
    if (any(n%nn(:)/=1)) print *,10001 
    if (any(n%aa(:)/=1)) print *,10001
kk=1
end select
if (kk/=1) print *,901
allocate(n%p(k))
