...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
   ...
   call zz(ij,+minval(b1,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+(/(i,i=-1,ik,-1)/))
   call zz(ij,+minval(b2,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+(/(i,i=-1,ik,-1)/))
   call zz(ij,+minval(b3,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+(/(i,i=-1,ik,-1)/))
   call zz(ij,+minval(b1,mask=reshape((/a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))/),(/1,1,1,1,k2,k3/)))+(/(i,i=-1,ik,-1)/))
