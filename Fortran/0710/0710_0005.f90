...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=reshape((/a2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=reshape((/a2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=reshape((/a2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
 end do; end do
