...
!
   ...
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2(:,:,:,:,:,:),mask=a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3(:,:,:,:,:,:),mask=a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1,mask=a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2,mask=a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=a2(:,:,:,:,v1,v2)))
 end do; end do
