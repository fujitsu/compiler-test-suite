...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1        ))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2        ))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3        ))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1        (:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2        (:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3        (:,:,:,:,:,:)))
   ...
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
