...
!
   ...
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1*k1,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2*k1,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1(:,:,:,:,:,:)*k1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2(:,:,:,:,:,:)*k1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3(:,:,:,:,:,:)*k1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b1(:,:,:,:,v1,v2)*k1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b2(:,:,:,:,v1,v2)*k1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=-1,ik,-1)/),(/k1,1,1,-ik/))+minval(b3(:,:,:,:,v1,v2)*k1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
 end do; end do
