...
do i=1,n-17,k
  a(c(i)) = a(c(i)) + b(c(i)) + b(c(i+1)) + b(c(i+10)) + b(c(i+17))
enddo
end subroutine
...
integer,dimension(1:n) :: c
do i=1,n-33,k
  a(c(i)) = a(c(i)) + b(c(i+33)) + b(c(i+20)) + b(c(i+1)) + b(c(i))
enddo
end subroutine
...
integer,dimension(1:n) :: c
do i=1,n-65,k
  a(c(i)) = a(c(i)) + b(c(i)) + b(c(i+65)) + b(c(i+40)) + b(c(i+1))
enddo
end subroutine

program main
integer,parameter :: n=1000
integer,parameter :: ians01=1264
integer,parameter :: ians02=1264
integer,parameter :: ians03=1256
