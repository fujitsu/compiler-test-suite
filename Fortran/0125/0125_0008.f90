...
integer(8),dimension(1:n,1:n) :: a,b,c
...
integer(8),dimension(1:n,1:n,1:n) :: a,b,c
...
integer(8),dimension(1:n) :: a,b,c
integer(8),dimension(1:n2,1:n2) :: a2,b2,c2
integer(8),dimension(1:n3,1:n3,1:n3) :: a3,b3,c3
