...
call sub(b(1:2,:,1),12)
call sub(c(1:2,:,1),3)
call sub(v%a(1:2,:,1),4)
call sub(v%b(1:2,:,1),15)
call sub(v%c(1:2,:,1),6)
...
call sub(b(:,1:3,1),12)
call sub(c(:,1:3,1),13)
call sub(v%a(:,1:3,1),14)
call sub(v%b(:,1:3,1),15)
call sub(v%c(:,1:3,1),6)
if (any(a(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
if (any(b(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
if (any(c(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
if (any(v%a(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
...
call clear(v%b,5)
call clear(v%c,6)
call sub(a(1:2,1:3,1),1)
call sub(b(1:2,1:3,1),12)
call sub(c(1:2,1:3,1),3)
call sub(v%a(1:2,1:3,1),4)
call sub(v%b(1:2,1:3,1),15)
call sub(v%c(1:2,1:3,1),6)
if (any(a(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
if (any(b(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
if (any(c(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
if (any(v%a(:,:,1)/=reshape((/1,2,3,4,5,6/),(/2,3/))))write(6,*) "NG"
...
call sub1(b(:,:,1:4),12)
call sub1(c(:,:,1:4),13)
call sub1(v%a(:,:,1:4),14)
call sub1(v%b(:,:,1:4),15)
call sub1(v%c(:,:,1:4),6)
if (any(a(:,:,:)/=r))write(6,*) "NG"
if (any(b(:,:,:)/=r))write(6,*) "NG"
if (any(c(:,:,:)/=r))write(6,*) "NG"
...
call clear(v%b,5)
call clear(v%c,6)
call sub1(a(1:2,1:3,:),1)
call sub1(b(1:2,1:3,:),12)
call sub1(c(1:2,1:3,:),3)
call sub1(v%a(1:2,1:3,:),4)
call sub1(v%b(1:2,1:3,:),15)
call sub1(v%c(1:2,1:3,:),6)
if (any(a(:,:,:)/=r))write(6,*) "NG"
if (any(b(:,:,:)/=r))write(6,*) "NG"
if (any(c(:,:,:)/=r))write(6,*) "NG"
if (any(v%a(:,:,:)/=r))write(6,*) "NG"
...
call clear(v%b,5)
call clear(v%c,6)
call sub1(a(1:2,:,1:4),1)
call sub1(b(1:2,:,1:4),12)
call sub1(c(1:2,:,1:4),3)
call sub1(v%a(1:2,:,1:4),4)
call sub1(v%b(1:2,:,1:4),15)
call sub1(v%c(1:2,:,1:4),6)
if (any(a(:,:,:)/=r))write(6,*) "NG"
if (any(b(:,:,:)/=r))write(6,*) "NG"
if (any(c(:,:,:)/=r))write(6,*) "NG"
if (any(v%a(:,:,:)/=r))write(6,*) "NG"
...
call clear(v%b,5)
call clear(v%c,6)
call sub1(a(:,1:3,1:4),1)
call sub1(b(:,1:3,1:4),12)
call sub1(c(:,1:3,1:4),3)
call sub1(v%a(:,1:3,1:4),4)
call sub1(v%b(:,1:3,1:4),15)
call sub1(v%c(:,1:3,1:4),6)
if (any(a(:,:,:)/=r))write(6,*) "NG"
if (any(b(:,:,:)/=r))write(6,*) "NG"
if (any(c(:,:,:)/=r))write(6,*) "NG"
if (any(v%a(:,:,:)/=r))write(6,*) "NG"
...
call clear(v%b,5)
call clear(v%c,6)
call sub1(a(1:2,1:3,1:4),1)
call sub1(b(1:2,1:3,1:4),12)
call sub1(c(1:2,1:3,1:4),3)
call sub1(v%a(1:2,1:3,1:4),4)
call sub1(v%b(1:2,1:3,1:4),15)
call sub1(v%c(1:2,1:3,1:4),6)
if (any(a(:,:,:)/=r))write(6,*) "NG"
if (any(b(:,:,:)/=r))write(6,*) "NG"
if (any(c(:,:,:)/=r))write(6,*) "NG"
if (any(v%a(:,:,:)/=r))write(6,*) "NG"
