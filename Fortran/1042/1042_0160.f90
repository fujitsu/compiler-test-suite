...
allocate(v%a(4,3,2))
allocate(v%c(4,3,2))
call sub0(a(1,1,1:2),1)
call sub0(b(1,1,1:2),2)
call sub0(c(1,1,1:2),3)
call sub0(v%a(1,1,1:2),4)
call sub0(v%b(1,1,1:2),5)
call sub0(v%c(1,1,1:2),6)
...
call sub(b(1,1:3,:),2)
call sub(c(1,1:3,:),3)
call sub(v%a(1,1:3,:),4)
call sub(v%b(1,1:3,:),5)
call sub(v%c(1,1:3,:),6)
...
call sub(b(1,:,1:2),2)
call sub(c(1,:,1:2),3)
call sub(v%a(1,:,1:2),4)
call sub(v%b(1,:,1:2),5)
call sub(v%c(1,:,1:2),6)
if (any(a(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
if (any(b(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
if (any(c(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
if (any(v%a(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
...
call clear(v%b,5)
call clear(v%c,6)
call sub(a(1,1:3,1:2),1)
call sub(b(1,1:3,1:2),2)
call sub(c(1,1:3,1:2),3)
call sub(v%a(1,1:3,1:2),4)
call sub(v%b(1,1:3,1:2),5)
call sub(v%c(1,1:3,1:2),6)
if (any(a(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
if (any(b(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
if (any(c(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
if (any(v%a(1,:,:)/=reshape((/1,2,3,4,5,6/),(/3,2/))))write(6,*) "NG"
