...
#define VAR_NAME vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv

subroutine sub_test(ans,r,s)
  integer(kind=4)::i,VAR_NAME
  DATA_TYPE,dimension(N,N)::ans,r,s

  do VAR_NAME=1,N
     do i =1,N
        ans(i,VAR_NAME) = r(i,VAR_NAME) + s(i,VAR_NAME)
     end do
  end do
