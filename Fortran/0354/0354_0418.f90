...
subroutine sub(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,x20,x21,x22,x23,x24,x25,x26,x27,x28,x29,x30,x31,x32,n)
  ...
  do i=2,n
     xxx(1) = x1(i)+x2(i)+x3(i)+x4(i)+x5(i)+x6(i)+x7(i)+x8(i)+x9(i)+x10(i)+x11(i)+x12(i)+x13(i)+x14(i)+x15(i)+x16(i)+x17(i)+x18(i)+x19(i)+x20(i)+x21(i)+x22(i)+x23(i)+x24(i)+x25(i)+x26(i)+x27(i)+x28(i)+x29(i)+x30(i)+x31(i)+x32(i)
  end do
  if (xxx(1) .eq. 32) then
     print *,"OK"
  else
