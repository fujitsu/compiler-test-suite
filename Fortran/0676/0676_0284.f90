...
function test_integer_1(flag1, flag2, d_val1, lmax, d_data)
   integer(kind=1) :: flag1, flag2
   integer(kind=1) :: d_val1, d_zero
...
function test_integer_2(flag1, flag2, d_val1, lmax, d_data)
   integer(kind=2) :: flag1, flag2
   integer(kind=2) :: d_val1, d_zero
...
function test_integer_4(flag1, flag2, d_val1, lmax, d_data)
   integer(kind=4) :: flag1, flag2
   integer(kind=4) :: d_val1, d_zero
...
function test_integer_8(flag1, flag2, d_val1, lmax, d_data)
   integer(kind=8) :: flag1, flag2
   integer(kind=8) :: d_val1, d_zero
...
function test_real_4(flag1, flag2, d_val1, lmax, d_data)
   real(kind=4) :: flag1, flag2
   real(kind=4) :: d_val1, d_zero
...
function test_real_8(flag1, flag2, d_val1, lmax, d_data)
   real(kind=8) :: flag1, flag2
   real(kind=8) :: d_val1, d_zero
...
function test_real_16(flag1, flag2, d_val1, lmax, d_data)
   real(kind=16) :: flag1, flag2
   real(kind=16) :: d_val1, d_zero
