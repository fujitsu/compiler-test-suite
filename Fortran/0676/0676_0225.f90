...
subroutine test_execute_integer_1
   ...
   flag1 = 1; flag2 = 1; d_val = 1; lmax = 64
   ...
   flag1 = 2; flag2 = 3; d_val = 4; lmax = 64
   call init_data_integer_1(data); result = test_pt1_integer_1(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt2_integer_1(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
...
function test_pt1_logical_1(flag1, flag2, lmax, d_val, d_data)
   logical(kind=1) :: flag1, flag2
   logical(kind=1) :: d_val
   logical(kind=1) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (flag1 .eqv. flag2) then
               d_data(k, j, i) = 1
            else
               d_data(k, j, i) = 4
            end if
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt1_logical_1=0
               return
            end if
         end do
      end do
   end do
   test_pt1_logical_1=1
   return
end function test_pt1_logical_1

function test_pt2_logical_1(flag1, flag2, lmax, d_val, d_data)
   logical(kind=1) :: flag1, flag2
   logical(kind=1) :: d_val
   logical(kind=1) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt2_logical_1=0
               return
            end if
         end do
      end do
   end do
   test_pt2_logical_1=1
   return
end function test_pt2_logical_1

subroutine init_data_logical_1(data)
   logical(kind=1) , dimension(64, 64, 64) :: data
   do i=1, 64
      do j=1, 64
         do k=1, 64
            data(k, j, i) = 0
...
end subroutine init_data_logical_1

subroutine test_execute_logical_1
   logical(kind=1) , dimension(64, 64, 64) :: data
   logical(kind=1) :: flag1, flag2, d_val
   integer(kind=4) :: lmax

   flag1 = 1; flag2 = 1; d_val = 1; lmax = 64
   call init_data_logical_1(data); result = test_pt1_logical_1(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 1 NG'
   call init_data_logical_1(data); result = test_pt2_logical_1(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 1 NG'
   ...
   d_val = 0
   call init_data_logical_1(data); result = test_pt2_logical_1(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 1 NG'
end subroutine test_execute_logical_1

function test_pt1_logical_2(flag1, flag2, lmax, d_val, d_data)
   logical(kind=2) :: flag1, flag2
   logical(kind=2) :: d_val
   logical(kind=2) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   do i=1, 64
      do j=1, 64
         do k=1, 64
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt1_logical_2=0
               return
            end if
         end do
      end do
   end do
   test_pt1_logical_2=1
   return
end function test_pt1_logical_2

function test_pt2_logical_2(flag1, flag2, lmax, d_val, d_data)
   logical(kind=2) :: flag1, flag2
   logical(kind=2) :: d_val
   logical(kind=2) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt2_logical_2=0
               return
            end if
         end do
      end do
   end do
   test_pt2_logical_2=1
   return
end function test_pt2_logical_2

subroutine init_data_logical_2(data)
   logical(kind=2) , dimension(64, 64, 64) :: data
   do i=1, 64
      do j=1, 64
         do k=1, 64
            data(k, j, i) = 0
...
end subroutine init_data_logical_2

subroutine test_execute_logical_2
   logical(kind=2) , dimension(64, 64, 64) :: data
   logical(kind=2) :: flag1, flag2, d_val
   integer(kind=4) :: lmax

   flag1 = 1; flag2 = 1; d_val = 1; lmax = 64
   call init_data_logical_2(data); result = test_pt1_logical_2(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 2 NG'
   call init_data_logical_2(data); result = test_pt2_logical_2(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 2 NG'
   ...
   d_val = 0
   call init_data_logical_2(data); result = test_pt2_logical_2(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 2 NG'
end subroutine test_execute_logical_2

function test_pt1_logical_4(flag1, flag2, lmax, d_val, d_data)
   logical(kind=4) :: flag1, flag2
   logical(kind=4) :: d_val
   logical(kind=4) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   do i=1, 64
      do j=1, 64
         do k=1, 64
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt1_logical_4=0
               return
            end if
         end do
      end do
   end do
   test_pt1_logical_4=1
   return
end function test_pt1_logical_4

function test_pt2_logical_4(flag1, flag2, lmax, d_val, d_data)
   logical(kind=4) :: flag1, flag2
   logical(kind=4) :: d_val
   logical(kind=4) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt2_logical_4=0
               return
            end if
         end do
      end do
   end do
   test_pt2_logical_4=1
   return
end function test_pt2_logical_4

subroutine init_data_logical_4(data)
   logical(kind=4) , dimension(64, 64, 64) :: data
   do i=1, 64
      do j=1, 64
         do k=1, 64
            data(k, j, i) = 0
...
end subroutine init_data_logical_4

subroutine test_execute_logical_4
   logical(kind=4) , dimension(64, 64, 64) :: data
   logical(kind=4) :: flag1, flag2, d_val
   integer(kind=4) :: lmax

   flag1 = 1; flag2 = 1; d_val = 1; lmax = 64
   call init_data_logical_4(data); result = test_pt1_logical_4(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 4 NG'
   call init_data_logical_4(data); result = test_pt2_logical_4(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 4 NG'
   ...
   d_val = 0
   call init_data_logical_4(data); result = test_pt2_logical_4(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 4 NG'
end subroutine test_execute_logical_4

function test_pt1_logical_8(flag1, flag2, lmax, d_val, d_data)
   logical(kind=8) :: flag1, flag2
   logical(kind=8) :: d_val
   logical(kind=8) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   do i=1, 64
      do j=1, 64
         do k=1, 64
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt1_logical_8=0
               return
            end if
         end do
      end do
   end do
   test_pt1_logical_8=1
   return
end function test_pt1_logical_8

function test_pt2_logical_8(flag1, flag2, lmax, d_val, d_data)
   logical(kind=8) :: flag1, flag2
   logical(kind=8) :: d_val
   logical(kind=8) , dimension(64, 64, 64) :: d_data
   integer(kind=4) :: lmax
   ...
   do i=1, 64
      do j=1, 64
         do k=1, 64
            if (d_data(k, j, i) .neqv. d_val) then
               test_pt2_logical_8=0
               return
            end if
         end do
      end do
   end do
   test_pt2_logical_8=1
   return
end function test_pt2_logical_8

subroutine init_data_logical_8(data)
   logical(kind=8) , dimension(64, 64, 64) :: data
   do i=1, 64
      do j=1, 64
         do k=1, 64
            data(k, j, i) = 0
...
end subroutine init_data_logical_8

subroutine test_execute_logical_8
   logical(kind=8) , dimension(64, 64, 64) :: data
   logical(kind=8) :: flag1, flag2, d_val
   integer(kind=4) :: lmax

   flag1 = 1; flag2 = 1; d_val = 1; lmax = 64
   call init_data_logical_8(data); result = test_pt1_logical_8(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 8 NG'
   call init_data_logical_8(data); result = test_pt2_logical_8(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 8 NG'
   ...
   d_val = 0
   call init_data_logical_8(data); result = test_pt2_logical_8(flag1, flag2, lmax, d_val, data); if ( result .eq. 0) print *, 'logical 8 NG'
end subroutine test_execute_logical_8
...
program main
   ...
   call test_execute_logical_1
   call test_execute_logical_2
   call test_execute_logical_4
   call test_execute_logical_8
