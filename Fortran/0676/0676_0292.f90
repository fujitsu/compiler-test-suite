...
function test_integer_1(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_integer_1
   integer(kind=1) , dimension(256) :: data1, data2
   integer(kind=1) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_integer_1(data1, data2); result = test_integer_1(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 1 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0;
   call init_data_integer_1(data1, data2); result = test_integer_1(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 1 NG'
end subroutine test_execute_integer_1

function test_integer_2(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_integer_2
   integer(kind=2) , dimension(256) :: data1, data2
   integer(kind=2) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_integer_2(data1, data2); result = test_integer_2(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 2 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0;
   call init_data_integer_2(data1, data2); result = test_integer_2(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 2 NG'
end subroutine test_execute_integer_2

function test_integer_4(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_integer_4
   integer(kind=4) , dimension(256) :: data1, data2
   integer(kind=4) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_integer_4(data1, data2); result = test_integer_4(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 4 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0;
   call init_data_integer_4(data1, data2); result = test_integer_4(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 4 NG'
end subroutine test_execute_integer_4

function test_integer_8(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_integer_8
   integer(kind=8) , dimension(256) :: data1, data2
   integer(kind=8) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_integer_8(data1, data2); result = test_integer_8(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 8 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0;
   call init_data_integer_8(data1, data2); result = test_integer_8(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'integer 8 NG'
end subroutine test_execute_integer_8

function test_real_4(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_real_4
   real(kind=4) , dimension(256) :: data1, data2
   real(kind=4) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_real_4(data1, data2); result = test_real_4(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'real 4 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0;
   call init_data_real_4(data1, data2); result = test_real_4(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'real 4 NG'
end subroutine test_execute_real_4

function test_real_8(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_real_8
   real(kind=8) , dimension(256) :: data1, data2
   real(kind=8) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_real_8(data1, data2); result = test_real_8(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'real 8 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0;
   call init_data_real_8(data1, data2); result = test_real_8(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'real 8 NG'
end subroutine test_execute_real_8

function test_real_16(flag1, flag2, d_val1, d_val2, lmax, d_data1, d_data2)
...
subroutine test_execute_real_16
   real(kind=16) , dimension(256) :: data1, data2
   real(kind=16) :: flag1, flag2, d_val1, d_val2

   flag1 = 1; flag2 = 1; d_val1 = 1; d_val2 = 1
   call init_data_real_16(data1, data2); result = test_real_16(flag1, flag2, d_val1, d_val2, 256, data1, data2); if ( result .eq. 0) print *, 'real 16 NG'
