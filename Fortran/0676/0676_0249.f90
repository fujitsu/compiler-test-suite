...
subroutine test_execute_integer_1
   ...
   call init_data_integer_1(data1, data2);
   result = test_integer_1(flag1, flag2, d_val, data1, data2)
...
subroutine test_execute_integer_2
   ...
   flag1 = 1; flag2 = 1; d_val = 1
   call init_data_integer_2(data1, data2);
   result = test_integer_2(flag1, flag2, d_val, data1, data2)
...
subroutine test_execute_integer_4
   ...
   flag1 = 1; flag2 = 1; d_val = 1
   call init_data_integer_4(data1, data2);
   result = test_integer_4(flag1, flag2, d_val, data1, data2)
...
subroutine test_execute_integer_8
   ...
   flag1 = 1; flag2 = 1; d_val = 1
   call init_data_integer_8(data1, data2);
   result = test_integer_8(flag1, flag2, d_val, data1, data2)
...
subroutine test_execute_real_4
   ...
   flag1 = 1; flag2 = 1; d_val = 1
   call init_data_real_4(data1, data2);
   result = test_real_4(flag1, flag2, d_val, data1, data2)
...
subroutine test_execute_real_8
   ...
   flag1 = 1; flag2 = 1; d_val = 1
   call init_data_real_8(data1, data2);
   result = test_real_8(flag1, flag2, d_val, data1, data2)
...
subroutine test_execute_real_16
   ...
   flag1 = 1; flag2 = 1; d_val = 1
   call init_data_real_16(data1, data2);
   result = test_real_16(flag1, flag2, d_val, data1, data2)
