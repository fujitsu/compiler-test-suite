...
subroutine test_execute_integer_1
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_integer_1(data1, data2); result = test_integer_1(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'integer 1 NG'

   flag1 = 2; flag2 = 3; d_val1 = 0; d_val2 = 0
   call init_data_integer_1(data1, data2); result = test_integer_1(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'integer 1 NG'
...
subroutine test_execute_integer_2
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_integer_2(data1, data2); result = test_integer_2(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'integer 2 NG'
...
subroutine test_execute_integer_4
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_integer_4(data1, data2); result = test_integer_4(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'integer 4 NG'
...
subroutine test_execute_integer_8
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_integer_8(data1, data2); result = test_integer_8(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'integer 8 NG'
...
subroutine test_execute_real_4
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_real_4(data1, data2); result = test_real_4(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'real 4 NG'
...
subroutine test_execute_real_8
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_real_8(data1, data2); result = test_real_8(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'real 8 NG'
...
subroutine test_execute_real_16
   ...
   flag1 = 1; flag2 = 1; d_val1 = 0; d_val2 = 0
   call init_data_real_16(data1, data2); result = test_real_16(flag1, flag2, d_val1, d_val2, 0, data1, data2); if ( result .eq. 0) print *, 'real 16 NG'
