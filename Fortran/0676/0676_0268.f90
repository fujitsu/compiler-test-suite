...
function test_pt5_integer_1(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=1) :: flag1, flag2, flag3
   integer(kind=1) :: d_val, calc_d_val
   integer(kind=1) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_integer_1(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=1) :: flag1, flag2, flag3
   integer(kind=1) :: d_val, calc_d_val
   integer(kind=1) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_integer_1
   ...
   call init_data_integer_1(data); result = test_pt3_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt4_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt5_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt6_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   ...
   flag1 = 0; flag2 = 0; flag3 = 32; d_val = 4; lmax = 256
   call init_data_integer_1(data); result = test_pt1_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt2_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt3_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt4_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   ...
   flag1 = 0; flag2 = 0; flag3 = 0; d_val = 4; lmax = 256
   call init_data_integer_1(data); result = test_pt1_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt2_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt3_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
   call init_data_integer_1(data); result = test_pt4_integer_1(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 1 NG'
...
function test_pt5_integer_2(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=2) :: flag1, flag2, flag3
   integer(kind=2) :: d_val, calc_d_val
   integer(kind=2) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_integer_2(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=2) :: flag1, flag2, flag3
   integer(kind=2) :: d_val, calc_d_val
   integer(kind=2) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_integer_2
   ...
   call init_data_integer_2(data); result = test_pt3_integer_2(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 2 NG'
   call init_data_integer_2(data); result = test_pt4_integer_2(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 2 NG'
   call init_data_integer_2(data); result = test_pt5_integer_2(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 2 NG'
   call init_data_integer_2(data); result = test_pt6_integer_2(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 2 NG'
...
function test_pt5_integer_4(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=4) :: flag1, flag2, flag3
   integer(kind=4) :: d_val, calc_d_val
   integer(kind=4) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_integer_4(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=4) :: flag1, flag2, flag3
   integer(kind=4) :: d_val, calc_d_val
   integer(kind=4) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_integer_4
   ...
   call init_data_integer_4(data); result = test_pt3_integer_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 4 NG'
   call init_data_integer_4(data); result = test_pt4_integer_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 4 NG'
   call init_data_integer_4(data); result = test_pt5_integer_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 4 NG'
   call init_data_integer_4(data); result = test_pt6_integer_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 4 NG'
...
function test_pt5_integer_8(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=8) :: flag1, flag2, flag3
   integer(kind=8) :: d_val, calc_d_val
   integer(kind=8) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_integer_8(flag1, flag2, flag3, lmax, d_val, d_data)
   integer(kind=8) :: flag1, flag2, flag3
   integer(kind=8) :: d_val, calc_d_val
   integer(kind=8) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_integer_8
   ...
   call init_data_integer_8(data); result = test_pt3_integer_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 8 NG'
   call init_data_integer_8(data); result = test_pt4_integer_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 8 NG'
   call init_data_integer_8(data); result = test_pt5_integer_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 8 NG'
   call init_data_integer_8(data); result = test_pt6_integer_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'integer 8 NG'
...
function test_pt5_real_4(flag1, flag2, flag3, lmax, d_val, d_data)
   real(kind=4) :: flag1, flag2, flag3
   real(kind=4) :: d_val, calc_d_val
   real(kind=4) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_real_4(flag1, flag2, flag3, lmax, d_val, d_data)
   real(kind=4) :: flag1, flag2, flag3
   real(kind=4) :: d_val, calc_d_val
   real(kind=4) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_real_4
   ...
   call init_data_real_4(data); result = test_pt3_real_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 4 NG'
   call init_data_real_4(data); result = test_pt4_real_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 4 NG'
   call init_data_real_4(data); result = test_pt5_real_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 4 NG'
   call init_data_real_4(data); result = test_pt6_real_4(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 4 NG'
...
function test_pt5_real_8(flag1, flag2, flag3, lmax, d_val, d_data)
   real(kind=8) :: flag1, flag2, flag3
   real(kind=8) :: d_val, calc_d_val
   real(kind=8) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_real_8(flag1, flag2, flag3, lmax, d_val, d_data)
   real(kind=8) :: flag1, flag2, flag3
   real(kind=8) :: d_val, calc_d_val
   real(kind=8) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_real_8
   ...
   call init_data_real_8(data); result = test_pt3_real_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 8 NG'
   call init_data_real_8(data); result = test_pt4_real_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 8 NG'
   call init_data_real_8(data); result = test_pt5_real_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 8 NG'
   call init_data_real_8(data); result = test_pt6_real_8(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 8 NG'
...
function test_pt5_real_16(flag1, flag2, flag3, lmax, d_val, d_data)
   real(kind=16) :: flag1, flag2, flag3
   real(kind=16) :: d_val, calc_d_val
   real(kind=16) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
function test_pt6_real_16(flag1, flag2, flag3, lmax, d_val, d_data)
   real(kind=16) :: flag1, flag2, flag3
   real(kind=16) :: d_val, calc_d_val
   real(kind=16) , dimension(256) :: d_data
   integer(kind=4) :: lmax
...
subroutine test_execute_real_16
   ...
   call init_data_real_16(data); result = test_pt3_real_16(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 16 NG'
   call init_data_real_16(data); result = test_pt4_real_16(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 16 NG'
   call init_data_real_16(data); result = test_pt5_real_16(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 16 NG'
   call init_data_real_16(data); result = test_pt6_real_16(flag1, flag2, flag3, lmax, d_val, data); if ( result .eq. 0) print *, 'real 16 NG'
