...
imax = -1
call func_ge(-1_1, imax)
itest = itest + imax

imax = -1
call func_ge(0_1, imax)
itest = itest + imax
...
imax = -1
call func_gt(-1_1, imax)
itest = itest + imax

imax = -1
call func_gt(0_1, imax)
itest = itest + imax
...
imax = -1
call func_le(-1_1, imax)
itest = itest + imax

imax = -1
call func_le(0_1, imax)
itest = itest + imax
...
imax = -1
call func_lt(-1_1, imax)
itest = itest + imax

imax = -1
call func_lt(0_1, imax)
itest = itest + imax
...
imax = -1
call func_eq(-1_1, imax)
itest = itest + imax

imax = -1
call func_eq(0_1, imax)
itest = itest + imax
...
imax = -1
call func_ne(-1_1, imax)
itest = itest + imax

imax = -1
call func_ne(0_1, imax)
itest = itest + imax
