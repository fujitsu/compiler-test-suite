...
imax = i4_max
call func_ge(i4_min, imax)
itest = itest + imax

imax = i4_min
call func_ge(i4_max, imax)
itest = itest + imax
...
imax = i4_max
call func_gt(i4_min, imax)
itest = itest + imax

imax = i4_min
call func_gt(i4_max, imax)
itest = itest + imax
...
imax = i4_max
call func_le(i4_min, imax)
itest = itest + imax

imax = i4_min
call func_le(i4_max, imax)
itest = itest + imax
...
imax = i4_max
call func_lt(i4_min, imax)
itest = itest + imax

imax = i4_min
call func_lt(i4_max, imax)
itest = itest + imax
...
imax = i4_max
call func_eq(i4_min, imax)
itest = itest + imax

imax = i4_min
call func_eq(i4_max, imax)
itest = itest + imax
...
imax = i4_max
call func_ne(i4_min, imax)
itest = itest + imax

imax = i4_min
call func_ne(i4_max, imax)
itest = itest + imax
...
integer(kind=4) itest_func_ge
integer(kind=4) itest_func_gt
integer(kind=4) itest_func_le
integer(kind=4) itest_func_lt
integer(kind=4) itest_func_ne
integer(kind=4) itest_func_eq
itest = 0
