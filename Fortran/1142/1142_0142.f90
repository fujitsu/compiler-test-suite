module base_mod
 ...
 contains
    subroutine base_proc(this, a01,a02,n,k,m)
      ...
      real :: a01(n+1,n+m+1,m+1:*),a02(n+1,n+m+1  ,m+1:*)
write(1,*) 1
...
if (lbound(a01,1)/=1) print *,30001
if (ubound(a01,1)/=2) print *,30002
if (lbound(a01,2)/=1) print *,30011
if (ubound(a01,2)/=2) print *,30012
if (lbound(a01,3)/=1) print *,30003
if (any(a01(:,:,:3)/=1)) print *,30006
if (lbound(a02,1)/=1) print *,31001
if (ubound(a02,1)/=2) print *,31002
