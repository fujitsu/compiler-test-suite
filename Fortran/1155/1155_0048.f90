...
rewind 41
do kk=1,6
read(41,*)n;if(n/=2)print *,101
read(41,*)n;if(n/=3)print *,101
read(41,*)n;if(n/=4)print *,101
end do
do kk=1,6
read(41,*)n;if(n/=5)print *,1011
end do
read(41,*)n;if(n/=5)print *,2011
read(41,*,end=9)n;if(n/=3)print *,101
9 continue
print *,'sngg557n : pass'
end
