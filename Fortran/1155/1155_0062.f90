...
use mod
  ...
  call aaa%set(val4)
rewind 42
read(42,*)n;if(n/=2)print *,101
read(42,*)n;if(n/=3)print *,101
read(42,*)n;if(n/=6)print *,101
read(42,*)n;if(n/=5)print *,101
read(42,*,end=9)n;if(n/=3)print *,101
9 continue
print *,'sngg571n : pass'
end
