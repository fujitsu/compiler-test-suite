...
rewind 39
do kk=1,6
read(39,*)n;if(n/=2)print *,101
read(39,*)n;if(n/=3)print *,101
read(39,*)n;if(n/=4)print *,101
end do
do kk=1,6
read(39,*)n;if(n/=5)print *,1011
end do
read(39,*)n;if(n/=5)print *,2011
read(39,*,end=9)n;if(n/=3)print *,101
9 continue
print *,'sngg555n : pass'
end
