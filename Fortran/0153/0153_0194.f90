...
module m13
use m1,only:z2=>x2,z1=>x1
integer,private:: x2,x1
!$omp threadprivate (x1,x2)
contains
subroutine m13p
integer omp_get_thread_num
if (z1/=omp_get_thread_num()+10) print *,121,z1
if (z2/=omp_get_thread_num()+20) print *,122,z2
...
subroutine m15p
integer omp_get_thread_num
if (x1/=omp_get_thread_num()+10) print *,151,x1
if (x2/=omp_get_thread_num()+20) print *,152,x2
end subroutine
end
subroutine s1
use m1
...
call m13p
call m15p
if (y1/=omp_get_thread_num()+10) print *,163,y1
if (y2/=omp_get_thread_num()+20) print *,164,y2
if (z1/=omp_get_thread_num()+10) print *,165,z1
if (z2/=omp_get_thread_num()+20) print *,166,z2
!$omp end parallel
end
call s1
print *,'pass'
