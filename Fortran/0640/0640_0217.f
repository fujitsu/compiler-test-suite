     ...
     &            L61             ,L62)                                 
      ...
      DO 10 I1=1,10                                                     
       LS1=I1.GT.NS1                                                    
       DO 20 I2=1,10                                                    
        L22(I1,I2)=L22(I1,I2).AND.LS1                                   
        DO 30 I3=1,10                                                   
         IS2=N21(I1,I2)                                                 
         IF(LS1)  THEN                                                  
           IF(L22(I1,I2).EQV..FALSE.) D31(I1,I2,I3)=DS1/IS2             
         ENDIF                                                          
 30     CONTINUE                                                        
 20    CONTINUE                                                         
       IF (LS1) E11(I1)=I1/3+E12(I2)                                    
 10   CONTINUE                                                          
      WRITE(6,*) L22,D31,E11,IS2                                        

      DO 110 I1=1,10                                                    
       CES1=CMPLX(DFLOAT(I1),DFLOAT(-I1))                               
       DO 120 I2=1,N+8                                                  
        CE21(I1,I2)=CES1                                                
        DO 130 I3=1,10                                                  
         D31(I1,I2,I3)=-CES1*CMPLX(REAL(CDS1),IMAG(CDS1))               
130     CONTINUE                                                        
120    CONTINUE                                                         
110   CONTINUE                                                          
