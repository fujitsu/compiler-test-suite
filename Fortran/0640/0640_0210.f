      ...
      REAL*4      E31(10,10,10)/1000*0./,E32(10,10,10),E33(10,10,10)    
      ...
      DO 10 I1=1,N                                                      
       ...
       DO 20 I2=1,5                                                     
        DO 30 I3=1,N                                                    
         DO 40 I4=1,5                                                   
          DO 50 I5=1,5                                                  
           CD51(I1,I2,I3,I4,I5)=CMPLX(FLOAT((NS1+I5)**3),               
     &                                REAL(CD51(I1,I2,I3,I4,I5)))       
 50       CONTINUE                                                      
 40      CONTINUE                                                       
 30     CONTINUE                                                        
        N22(I2,I1)=I5-NS1                                               
 ...
 10   CONTINUE                                                          
      ...
      DO 110 I1=1,10                                                    
       ...
       DO 120 I2=1,5                                                    
        N21(I2,I1)=I3*3.5                                               
        DO 130 I3=1,N/2+3                                               
         NS2=N31(I1,I2,I3)/(-1)**MAX(N32(I2,I3,I1),1)                   
         DO 140 I4=1,5                                                  
          DO 150 I5=I4,5                                                
           E51(I4,I5,I3,I2,(I1+1)/2)=REAL(CDS1)+IMAG(CDS1)*NS2          
150       CONTINUE                                                      
140      CONTINUE                                                       
         E31(I1,I2,I3)=CDS1/12.5                                        
130     CONTINUE                                                        
120    CONTINUE                                                         
        N11(I1)=N21(I2,I1)-10                                           
110   CONTINUE                                                          
