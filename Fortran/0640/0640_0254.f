       ...
       DO 10 J=II,N4                                                    
        DO 10 K=2,N3                                                    
         DO 10 I=2,N3                                                   
           ...
           DB10(J,K,I) = DB10(N4,N3,I)*DB20(II,2,I)                     
  ...
  10  CONTINUE                                                          
      ...
      DO 20 I=N2,10                                                     
       DO 20 J=2,N3                                                     
        DO 20 K=2,NN                                                    
          DA10(I,K) = DA30(K-N1,I) - DA20(K,I-1)                        
          DA20(I,K) = DA20(NN-K+1,I) * DA30(K,NN-I)                     
          DA30(I,K) = DA10(N2,2) + DA10(K,I)                            
  20  CONTINUE                                                          
      DO 30 I1=1,20                                                     
       DO 30 II=1,N2                                                    
       DO 30 I2=1,19
        DO 30 I3=1,20                                                   
         DA20(I1,I2) = DA20(I1,I2) + DA10(I1,I3)                        
         DA10(I1,I3) = DA10(I1,I3) - DA20(I1,I2+1)                      
         DB30(I2,I3,I1) = DB30(I1,I1,I3)*2.D0-DB20(I1,I2,I3)            
