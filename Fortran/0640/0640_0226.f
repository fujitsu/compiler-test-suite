     ...
     &            L61             ,L62)
      ...
      DO 10 I1=1,10
       ...
       DO 20 I2=1,10,2
        ...
        DO 30 I3=1,10
         NS1=ES1*I3-2.
         IF(.NOT.LS1) CD31(I1,I2,I3)=CDS1+NS1
         N31(I1,I2,I3)=IMAG(NS1*NS1/CDS1)
 30     CONTINUE
 20    CONTINUE
       L12(I1)=LS1.OR.N21(I1,1).GT.REAL(CDS1)
 10   CONTINUE
      WRITE(6,*) '            ### CD21 ###'
      WRITE(6,90) ((CD21(I,J),I=1,10),J=1,10)
 90   FORMAT(4(3X,E14.7))
      WRITE(6,*) '            ### N31 ###'
      WRITE(6,91) (((N31(I,J,K),I=1,10),J=1,10),K=1,10)
...
110   CONTINUE
      ...
      WRITE(6,*) CDS1
      WRITE(6,*) '            ### N31 ###'
      WRITE(6,99) (((N31(I,J,K),I=1,10),J=1,10),K=1,10)
 99   FORMAT(10(1X,I6  ))
      STOP
      END
