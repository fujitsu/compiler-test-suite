     ...
     &            L61             ,L62)                                 
      ...
      DO 10 I1=N,10                                                     
       ...
       DO 20 I2=1,5                                                     
        CDS1=I2+(I1+N)*(0.,1.)                                          
        CE21(I2*2,I1)=CDS1+(1.,1.5)                                     
        DO 30 I3=1,1                                                    
         CDS1=I3**3                                                     
         NS1=REAL(CDS1)+IMAG(CDS1)                                      
         DO 40 I4=1,3                                                   
           IF (L11(I1).AND.LS1.AND.I1.LE.8)                             
     &         CE41(I3,I1,I2,I4)=CES1+NS1*CDS1                          
           IF (.NOT.L11(I1)) CE42(I1,I2,I3,I4)=CES1+NS1*CDS1            
 40      CONTINUE                                                       
         E21(I1,I3)=IMAG(NS1/CES1-CDS1)                                 
 30     CONTINUE                                                        
 20    CONTINUE                                                         
 10   CONTINUE                                                          
      WRITE(6,*) CE41,LS1,CE42,E21,CE21,CDS1                            

      DO 110 I1=2,8,2                                                   
       CDS1=CMPLX(SIN(FLOAT(I1)),COS(FLOAT(I1)))                        
       DO 120 I2=N,10,2                                                 
        NS1=N21(I2,I1)*4                                                
        DO 130 I3=1,10,2                                                
         NS2=N31(I1,I2,I3)-N32(I2,I3,I1)                                
         DO 140 I4=1,10,N                                               
          IF(I3.LE.8.AND.I4.LE.8.AND.I2.LE.8)                           
     &    N41(I2,I3,I4,I1)=NS1*N42(I1,I2,I3,I4)-NS2                     
140      CONTINUE                                                       
         N31(I1,I2,I3)=NS2-I3                                           
130     CONTINUE                                                        
        NS1=N31(I1,I2,I3-1)                                             
