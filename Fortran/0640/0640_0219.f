      ...
      DO 10 I1=N,N+6
       DO 20 I2=1,8,I1
        ...
        DO 30 I3=1,8
         ...
         DO 40 I4=1,8
          ES1=E11(I3)+E11(I2)
          CD41(I1,I2,I3,I4)=CES1+NS1-ES1
          CES1=CES1+1
 40      CONTINUE
         N21(I1,I3)=IMAG(NS1*NS1/CES1)
 30     CONTINUE
 20    CONTINUE
       L12(I1)=LS1.OR.N21(I1,1).GT.2.
 10   CONTINUE
      WRITE(6,1001) LS1,CE21,L11,ES1,CES1
 1001 FORMAT(' ',(6G13.6))
      WRITE(6,1002) CD41,N21,L12
 1002 FORMAT(' ',(3G23.15))

      DO 110 I1=1,8,2
       CDS1=CMPLX(SIN(DFLOAT(I1)),COS(DFLOAT(I1)))
       DO 120 I2=N,8,2
        CDS1=CMPLX(1.D0,IMAG(CDS1))
        DO 130 I3=1,8,N
         DO 140 I4=1,8
          NS2=MIN(I1/2,4)
