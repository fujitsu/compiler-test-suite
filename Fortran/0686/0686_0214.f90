    module mod
      integer(1),target ,dimension(1,1)::i11=1_1,i13=101_1
      integer(1),target ,dimension(2,1)::i12=10_1
      integer(2),target ,dimension(2,1)::i21=1_2,i23=reshape((/101_2,102_2/),(/2,1/) )
      integer(2),target ,dimension(1,1)::i22=10_2
      integer(4),target ,dimension(1,1)::i41=1_4,i43=101_4
      integer(4),target ,dimension(2,1)::i42=10_4
      integer(8),target ,dimension(2,1)::i81=1_8,i83=reshape((/101_8,102_8/),(/2,1/) )
      integer(8),target ,dimension(1,1)::i82=10_8
    end module mod
    ...
    program abc
     ...
     integer(4),allocatable,dimension(:,:)::p_i4
     integer(8),allocatable,dimension(:,:)::p_i8
      allocate(p_i1(1,1)) ; p_i1=i11
      allocate(p_i2(2,1)) ; p_i2=i21
      allocate(p_i4(1,1)) ; p_i4=i41
      allocate(p_i8(2,1)) ; p_i8=i81
...
!$omp end single copyprivate(p_i1,p_i2,p_i4,p_i8)
      ...
      if (any( p_i2 /= reshape( (/101_2,102_2/),(/2,1/) ) )) print *,"fail"
      if (any( p_i4 /= 101_4 )) print *,"fail"
      if (any( p_i8 /= reshape( (/101_8,102_8/),(/2,1/) ) )) print *,"fail"
      deallocate(p_i1,p_i2,p_i4,p_i8)
!$omp end parallel
    end subroutine sub1
