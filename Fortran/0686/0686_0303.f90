    block data
      real( 4),dimension(2,2,2)::r04=1.0e0
      real( 8),dimension(2,2,2)::r08=1.0d0
      real(16),dimension(2,2,2)::r16=1.0q0
      common /com04/ r04
      common /com08/ r08
      common /com16/ r16
!$omp threadprivate(/com04/,/com08/,/com16/)
    ...
    program ompv2
      real( 4),dimension(2,2,2)::r04
      real( 8),dimension(2,2,2)::r08
      real(16),dimension(2,2,2)::r16
      common /com04/ r04
      common /com08/ r08
      common /com16/ r16
!$omp threadprivate(/com04/,/com08/,/com16/)
