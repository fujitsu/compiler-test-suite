...
!$omp parallel
      if (OMP_GET_THREAD_NUM()==0) then
        deallocate(allo_l1,allo_l2,allo_l4,allo_l8)
      endif
      allocate(allo_l1(2,2,2,2,2))
      allocate(allo_l2(2))
      allocate(allo_l4(4))
      allocate(allo_l8(8))
      allo_l1 = .false.
...
!$omp parallel
      call sub2()
!$omp end parallel
      if (allocated(allo_l1)) print *,"fail"
      if (allocated(allo_l2)) print *,"fail"
      if (allocated(allo_l4)) print *,"fail"
      if (allocated(allo_l8)) print *,"fail"
    end subroutine sub
