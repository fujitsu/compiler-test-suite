      ...
      logical(4),dimension(2)::l4=.true.
      logical(8),dimension(2)::l8=.true.

      call sub1(l1,l2,l4,l8,3,2)
...
!$omp end parallel
    ...
    subroutine sub1(l1,l2,l4,l8,len3,len2)
      logical(1),dimension(len3)::l1
      logical(2),dimension(   3)::l2
      logical(4),dimension(len2)::l4
...
!$omp end parallel
    ...
    subroutine sub2(l1,l2,l4,l8,len3,len2)
      logical(1),dimension(len3)::l1
      logical(2),dimension(   3)::l2
      logical(4),dimension(len2)::l4
      logical(8),dimension(   2)::l8
