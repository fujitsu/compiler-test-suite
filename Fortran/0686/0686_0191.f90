    module mod
      logical(1),dimension(3),target::l11=.true.,l12=.false.,l13=.true.
      logical(2),dimension(3),target::l21=.true.,l22=.false.,l23=.true.
      logical(4),dimension(3),target::l41=.true.,l42=.false.,l43=.true.
      logical(8),dimension(3),target::l81=.true.,l82=.false.,l83=.true.
    end module mod
