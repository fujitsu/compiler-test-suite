    module mod
      complex( 4),target,dimension(3,1,1,2)::c041,c043
      complex( 4),target,dimension(5,1,1,2)::c042
      complex( 8),target,dimension(3,1,1,2)::c081,c083
      complex( 8),target,dimension(5,1,1,2)::c082
      complex(16),target,dimension(3,1,1,2)::c161,c163
      complex(16),target,dimension(5,1,1,2)::c162
     contains
