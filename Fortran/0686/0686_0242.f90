    module mod
      real( 4),dimension(5,1)::r04=1.0e0
      real( 8),dimension(3,1)::r08=1.0d0
      real(16),dimension(1,1)::r16=1.0q0
    end module mod
...
!$omp end parallel
    ...
    subroutine sub_sub(r04,r08,r16)
     real( 4),dimension(5,1)::r04
     real( 8),dimension(3,1)::r08
     real(16),dimension(1,1)::r16
      r04=1.0e2
      r08=1.0d2
      r16=1.0q2
