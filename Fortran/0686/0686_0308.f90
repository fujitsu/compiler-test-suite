    block data
      ...
      common /com/ p_c04,p_c08,p_c16
!$omp threadprivate(  /com/          )
       data p_c04,p_c08,p_c16 /3*null()/
    end block data

    module mod
      complex( 4),target,dimension(2,3,4,5)::c041,c042,c043
      complex( 8),target,dimension(2,3,4)::c081,c082,c083
