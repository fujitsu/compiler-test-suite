    module mod
     ...
     type(aaa),target::st1(3,1)=aaa('OPENMP V2',.true. ,1,1.0e0,(1.0e0,-1.0e0))
     type(aaa),target::st2(3,1)=aaa('openmp v2',.false.,10,1.0e1,(1.0e1,-1.0e1))
     type(aaa),target::st3(3,1)=aaa('OpenMP V2',.true. ,11,1.1e1,(1.1e1,-1.1e1))
    end module mod
