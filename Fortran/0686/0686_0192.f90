    module mod
      integer(1),target,dimension(3) ::i11=1_1,i13=100_1
      integer(1),target,dimension(5) ::i12=10_1
      integer(2),target,dimension(3) ::i21=1_2,i23=100_2
      integer(2),target,dimension(5) ::i22=10_2
      integer(4),target,dimension(3) ::i41=1_4,i43=100_4
      integer(4),target,dimension(5) ::i42=10_4
      integer(8),target,dimension(3) ::i81=1_8,i83=100_8
      integer(8),target,dimension(5) ::i82=10_8
    end module mod
