     program ompv2
      ...
      call sub3(i11,i12,i21,i22,i41,i42,i81,i82,n)
    ...
    subroutine sub1(i1,i2,i4,i8,n)
      ...
      integer(1),dimension(n)::i1
      integer(2),dimension(n)::i2
      integer(4),dimension(n)::i4
      integer(8),dimension(n)::i8
!$omp parallel
!$omp workshare
      i1(:)=(/(j,j=1,n)/)
      i2(1:n:2)=(/(j,j=1,n,2)/)
      i2(2:n-1:2)=(/(j,j=2,n-1,2)/)
      i4(n:1:-2)=(/(j,j=n,1,-2)/)
      i4(n-1:2:-2)=(/(j,j=n-1,2,-2)/)
      i8(i1(1):i1(n):i1(2))=(/(j,j=i1(1),i1(n),i1(2))/)
      i8(i1(2):i1(n-1):i1(2))=(/(j,j=i2(2),i2(n-1),i2(2))/)
!$omp end workshare
!$omp end parallel
    end subroutine
    ...
    subroutine sub3(i11,i12,i21,i22,i41,i42,i81,i82,n)
      integer(2)::n
      integer(1),dimension(n)::i11,i12
      integer(2),dimension(n)::i21,i22
      integer(4),dimension(n)::i41,i42
