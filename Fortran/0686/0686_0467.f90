    program ompv2
     interface
      subroutine sub1(a,b,arr1,arr2,arg1,arg2,alloc,parr,                &
                      c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13)
       integer,dimension(:,:)::a,b,arr1,arr2,arg1,arg2
       integer,dimension(:,:)::c01,c02,c03,c04,c05,c06,c07,c08,c09,c10, &
                               c11,c12,c13
       integer,dimension(:,:),pointer    ::parr
       integer,dimension(:,:),allocatable::alloc
      end subroutine
      subroutine sub2(a,b,arr1,arr2,arg1,arg2,alloc,parr,                &
                      d01,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13)
       integer,dimension(:,:)::a,b,arr1,arr2,arg1,arg2
       integer,dimension(:,:)::d01,d02,d03,d04,d05,d06,d07,d08,d09,d10, &
                               d11,d12,d13
       integer,dimension(:,:),pointer    ::parr
       integer,dimension(:,:),allocatable::alloc
      end subroutine
      ...
      subroutine sub6(c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13, &
       ...
       integer,dimension(:,:)::c01,c02,c03,c04,c05,c06,c07,c08,c09,c10, &
                               c11,c12,c13
       integer,dimension(:,:)::e01,e02,e03,e04,e05,e06,e07
       real(8),dimension(:,:)::e08,e09,e10
      end subroutine
      subroutine sub7(c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13, &
                      f01,f02,f03,f04,f05,f06,f07,f08,f09,f10)
       integer,dimension(:,:)::c01,c02,c03,c04,c05,c06,c07,c08,c09,c10, &
                               c11,c12,c13
       integer,dimension(:,:)::f01,f02,f03,f04,f05,f06,f07
       real(8),dimension(:,:)::f08,f09,f10
      end subroutine
     ...
     integer a(10,10)
     integer b(10,10)
     integer,dimension(10,10)::c01,c02,c03,c04,c05,c06,c07,c08,c09,c10, &
                               c11,c12,c13
     integer,dimension(10,10)::d01,d02,d03,d04,d05,d06,d07,d08,d09,d10, &
                               d11,d12,d13
     ...
     integer,allocatable::alloc(:,:)
      call sub0()
      call sub1(a,b,arr1,arr2,arg1,arg2,alloc,parr,                &
                c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13)
      call sub2(a,b,arr1,arr2,arg1,arg2,alloc,parr,                &
                d01,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13)
     ...
     contains
      subroutine sub0
        allocate(alloc(10,10))
        alloc=reshape( (/(i,i=1,100)/),(/10,10/) )
    ...
    subroutine sub1(a,b,arr1,arr2,arg1,arg2,alloc,parr,                &
                    c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13)
     integer,dimension(:,:)::a,b,arr1,arr2,arg1,arg2
     integer,dimension(:,:)::c01,c02,c03,c04,c05,c06,c07
     integer,dimension(:,:)::c08,c09,c10,c11,c12,c13
     integer,dimension(:,:),pointer    ::parr
     integer,dimension(:,:),allocatable::alloc
      c01=matmul(a,b)
    ...
    subroutine sub2(a,b,arr1,arr2,arg1,arg2,alloc,parr,                &
                    d01,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13)
     integer,dimension(:,:)::a,b,arr1,arr2,arg1,arg2
     integer,dimension(:,:)::d01,d02,d03,d04,d05,d06,d07
     integer,dimension(:,:)::d08,d09,d10,d11,d12,d13
     integer,dimension(:,:),pointer    ::parr
     integer,dimension(:,:),allocatable::alloc
!$omp parallel
!$omp workshare
...
!$omp end parallel
    ...
    subroutine sub3(c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13, &
                    d01,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13)
     integer,dimension(:,:)::c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13
     integer,dimension(:,:)::d01,d02,d03,d04,d05,d06,d07,d08,d09,d10,d11,d12,d13
