      ...
      contains
        ...
        complex( 4),target ,dimension(2)::c042
        complex( 4),target ,dimension(3)::c043
        complex( 8),target ,dimension(1)::c081
        complex( 8),target ,dimension(2)::c082
        complex( 8),target ,dimension(3)::c083
        complex(16),target ,dimension(1)::c161
        complex(16),target ,dimension(2)::c162
        complex(16),target ,dimension(2)::c163
        c041=(1.0e0,-1.0e0)
        c081=(1.0d0,-1.0d0)
        c161=(1.0q0,-1.0q0)
        c042=(/(1.0e1,-1.0e1),(-1.0e1,1.0e1)/)
        c082=(/(1.0d1,-1.0d1),(-1.0d1,1.0d1)/)
        c162=(/(1.0q1,-1.0q1),(-1.0q1,1.0q1)/)
