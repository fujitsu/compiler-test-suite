...
program main
  ...
  integer,dimension(:),pointer::ttt
  integer,pointer      :: a_pointer(:) 
  allocate (a_pointer(4),ttt(100))
  ttt = (/100000,1,2,1,300000,1,40,1,(i,i=1,92)/)
  a_pointer => ttt(1: :2)
  call isub(a_pointer)
 contains
 subroutine isub(a_pointer)
  ...
  x(a_pointer(3))=1
  if (x(42)/=1) print *,'error1'
  if (any(a_pointer(1:4)/=(/100000,400000,42,40/)))print *,'error2'
  print *,'pass'
  call test01()
  call test02()
 end subroutine
