     ...
     +       (16.,-15.),(27.,-16.),(38.,-17.),(49.,-18.),(10.,-19.)/
      data resa/(   72.0,  3.0),(   84.0,  3.0),(   96.0,  3.0),
     + (  118.0,  3.0),(  131.0,  3.0),(   92.0,  3.0),(  104.0,3.0),
     + (  116.0,  3.0),(    0.0,  0.0),(    0.0,  0.0)/
      data resd/(   -9.0,-10.0),(    2.0,-11.0),(   13.0,-12.0),
     + (   34.0,-13.0),(   46.0,-14.0),(6.0,-15.0),(17.0,-16.0),
     + (   28.0,-17.0),(   49.0,-18.0),(   10.0,-19.0)/

      do i=1,8
         d(i) = d(i) - 10
         a(i) = cmplx(real(d(i)),3)+x(i)
      enddo
      do i=1,10
