      ...
      real*4 x(10)/71,72,73,74,75,76,77,78,79,80/
      data d/(1.,-10.),(2.,-11.),(3.,-12.),(4.,-13.),(5.,-14.),
     +       (6.,-15.),(7.,-16.),(8.,-17.),(9.,-18.),(10.,-19.)/
      data resa/8*(61,0.),2*(0.,0.)/
      data resd/(   -1.0,-10.0),(    0.0,-11.0),(    1.0,-12.0),
     + (    2.0,-13.0),(    3.0,-14.0),(    4.0,-15.0),( 5.0,-16.0),
     + (    6.0,-17.0),(    9.0,-18.0),(   10.0,-19.0)/
 ...
 30   continue
      ...
      real*8 x(10)/71,72,73,74,75,76,77,78,79,80/
      data d/(1.,-10.),(2.,-11.),(3.,-12.),(4.,-13.),(5.,-14.),
     +       (6.,-15.),(7.,-16.),(8.,-17.),(9.,-18.),(10.,-19.)/
      data resa/8*(61,0.),2*(0.,0.)/
      data resd/(   -1.0,-10.0),(    0.0,-11.0),(    1.0,-12.0),
