     ...
     +       (16.,-15.),(27.,-16.),(38.,-17.),(49.,-18.),(10.,-19.)/
      data resa/(84.0, -9.0),(85.0,  2.0),(86.0, 13.0),(87.0, 34.0),
     + (88.0, 46.0),(89.0,  6.0),(90, 17.0),(91.0, 28.0),0,0/
      data resd/(-9.0,-10),( 2.0,-11.0),(13.0,-12.0),(34.0,-13.0),
     + (46.0,-14.0),( 6.0,-15.0),(17.0,-16.0),(28.0,-17.0),
     + (49.0,-18.0),(10,-19.0)/

      do i=1,8
         d(i) = d(i) - 10
         a(i) = cmplx(3,real(d(i)))+x(i)
      enddo
      do i=1,10
