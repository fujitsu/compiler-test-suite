...
use m1
 type(x)::z
   ...
   if (any((/z%e1/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%e2/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%e3/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%e4/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%f1/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%f2/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%f3/)/=(/11,11,21,21/)))write(6,*) "NG"
   if (any((/z%f4/)/=(/11,11,21,21/)))write(6,*) "NG"
end
subroutine ss2
use m1
 type(x)::z
