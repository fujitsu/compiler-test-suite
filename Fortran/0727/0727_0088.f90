...
!
 ...
 forall( j=1:2)
 forall (i=1:jx+a(5,1,1,5,5)-jz-a(5,1,1,5,5)+a(5,1,1,5,5))
...
!
 ...
 forall (jx=5:5);forall(jy=jx:5);forall(jz=jx:jy)
 forall( j=1:2)
 forall (i=jz+a(1,1,1,5,5)-jx-a(1,1,1,5,5)+a(1,1,1,5,5):5)
   a(i,1,j,jx,jz)=-i; a(i,2,j,jx,jz)=-i-5
   x%a(i,1,j,jx,jz)=-i; x%a(i,2,j,jx,jz)=-i-5
   aa(i,1,j,jx,jz)=.false.; aa(i,2,j,jx,jz)=.false.
   z%aa(i,1,j,jx,jz)=.false.; z%aa(i,2,j,jx,jz)=.false.
...
!
 ...
 forall (jx=5:5);forall(jy=jx:5);forall(jz=jx:jy)
 forall( j=1:2)
 forall (i=1:5:jx-jz+a(1,1,1,5,5)-a(1,1,1,5,5)+a(1,1,1,5,5))
   a(i,1,j,jx,jz)=-i; a(i,2,j,jx,jz)=-i-5
   x%a(i,1,j,jx,jz)=-i; x%a(i,2,j,jx,jz)=-i-5
   aa(i,1,j,jx,jz)=.false.; aa(i,2,j,jx,jz)=.false.
   z%aa(i,1,j,jx,jz)=.false.; z%aa(i,2,j,jx,jz)=.false.
...
!
 ...
 forall (jx=5:5);forall(jy=jx:5);forall(jz=jx:jy)
 forall( j=1:2)
 forall (i=1:5,jx==jz.and.aa(1,1,1,5,5).and.aa(1,1,1,5,5).and.aa(1,1,1,5,5))
   a(i,1,j,jx,jz)=-i; a(i,2,j,jx,jz)=-i-5
   x%a(i,1,j,jx,jz)=-i; x%a(i,2,j,jx,jz)=-i-5
   aa(i,1,j,jx,jz)=.false.; aa(i,2,j,jx,jz)=.false.
   z%aa(i,1,j,jx,jz)=.false.; z%aa(i,2,j,jx,jz)=.false.
...
!
 ...
 forall (jx=5:5);forall(jy=jx:5);forall(jz=jx:jy)
 forall( j=1:2)
 forall (i=jx-jz+a(1,1,1,5,5)+a(1,1,1,5,5)-a(1,1,1,5,5):&
    a(5,1,1,5,5)-jx+jz+a(5,1,1,5,5)-a(5,1,1,5,5):&
    -jx+jy+a(1,1,1,5,5)-a(1,1,1,5,5)+a(1,1,1,5,5),&
   aa(1,1,1,5,5).and.jx==jy.and.aa(1,1,1,5,5).and.aa(1,1,1,5,5))
   a(i,1,j,jx,jz)=-i; a(i,2,j,jx,jz)=-i-5
   x%a(i,1,j,jx,jz)=-i; x%a(i,2,j,jx,jz)=-i-5
   aa(i,1,j,jx,jz)=.false.; aa(i,2,j,jx,jz)=.false.
   z%aa(i,1,j,jx,jz)=.false.; z%aa(i,2,j,jx,jz)=.false.
