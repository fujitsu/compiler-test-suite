  module define_the_defined_operators
    ...
    contains
      elemental function uni_typ1(arg1,arg2) result(res)
        type(type1),intent(in) :: arg1,arg2
        type(type1) :: res
        res%cmp1=arg1%cmp1+arg2%cmp1
        res%cmp2=arg1%cmp2+arg2%cmp2
      end function
      function chk(a1,a2)
      logical chk
      type(type1),intent(in) :: a1,a2
      chk=.false.
      if (a1%cmp1/=a2%cmp1*2)chk=.true.
      if (any(a1%cmp2/=a2%cmp2*2))chk=.true.
      end function
  end module
