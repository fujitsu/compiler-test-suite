 ...
 call ss1(z1(v1,v2,v3),z2,z1(v1,v2,v3))
 if (any(z2/=m*2))write(6,*) "NG"
 call ss1(z1(v1,v2,v3)+z1(v1,v2,v3),z2,z1(v1,v2,v3)+z1(v1,v2,v3))
 if (any(z2/=m*4))write(6,*) "NG"
 call ss1(z1,z2,z1)
 if (any(z2/=mm*2))write(6,*) "NG"
 call ss1(z1(:,:,:),z2,z1(:,:,:))
 if (any(z2/=mm*2))write(6,*) "NG"
 call ss1(z1(j1:j2:j1,j1:j3,j1:j4:j1),z2,z1(j1:j2:j1,j1:j3,j1:j4:j1))
 if (any(z2/=mm*2))write(6,*) "NG"
 call ss1(z1(j1:j2:j1,j1:j3,j1:j4:j1)+z1,z2,z1+z1(j1:j2:j1,j1:j3,j1:j4:j1))
