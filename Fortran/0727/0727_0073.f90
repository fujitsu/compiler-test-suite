 ...
 forall (i=a(1,1,1,1,1):a(3,1,1,1,1),ii=a(1,1,1,1,1):a(2,1,1,1,1),&
   iii=a(1,1,1,1,1):a(1,1,1,1,1))
   a(i,ii,iii,1,j)=-i
   a(i,ii,iii,2,j)=-i-3
 end forall
 end forall
...
!
 ...
 forall (i=x%a(1,1,1,1,1):x%a(3,1,1,1,1),ii=x%a(1,1,1,1,1):x%a(2,1,1,1,1),&
   iii=x%a(1,1,1,1,1):x%a(1,1,1,1,1))
   x%a(i,ii,iii,1,j)=-i
