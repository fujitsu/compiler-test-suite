      module mod 
       ...
       subroutine proc_31(k)
        n=4
        write(1,*)k
       end subroutine
       subroutine proc_22(dummy_arg)             ! 18)
        real, intent(in) :: dummy_arg
        write(1,*) dummy_arg
        n=5
       end subroutine
      ...
      type, extends(ty_2) :: ty_3               ! 12) 13)
       contains
        ...
        procedure, nopass :: p2=>proc_22        ! 14) 15)
        procedure, nopass :: p3=>proc_31        ! 14) 15)
        generic           :: gen_name => p2     ! 9) 10) 11)
        generic           :: gen_name => p3     ! 9) 10) 11)
      end type
      type(ty_1) :: var1                         ! 16)
      type(ty_2) :: var2                         ! 16)
      type(ty_3) :: var3                         ! 16)
      ...
      if (n/=5) print *,1010
      call var3%gen_name(1)                    ! 17) 18)
      if (n/=4) print *,1011
      call var3%p3      (1)                    ! 17) 18)
      if (n/=4) print *,1012
