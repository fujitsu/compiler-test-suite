...
module b_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
contains
...
module c001_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
use b_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c002_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
use b_mod ,only:b,p1,p2,p3,p4,p5
use c001_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c003_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
use b_mod ,only:b,p1,p2,p3,p4,p5
use c001_mod ,only:b,p1,p2,p3,p4,p5
use c002_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c004_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
...
use c001_mod ,only:b,p1,p2,p3,p4,p5
use c002_mod ,only:b,p1,p2,p3,p4,p5
use c003_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c005_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
...
use c002_mod ,only:b,p1,p2,p3,p4,p5
use c003_mod ,only:b,p1,p2,p3,p4,p5
use c004_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c006_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
...
use c003_mod ,only:b,p1,p2,p3,p4,p5
use c004_mod ,only:b,p1,p2,p3,p4,p5
use c005_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c007_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
...
use c004_mod ,only:b,p1,p2,p3,p4,p5
use c005_mod ,only:b,p1,p2,p3,p4,p5
use c006_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module c008_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
...
use c005_mod ,only:b,p1,p2,p3,p4,p5
use c006_mod ,only:b,p1,p2,p3,p4,p5
use c007_mod ,only:b,p1,p2,p3,p4,p5
  implicit none
end
module z_mod
use a_mod ,only:b,p1,p2,p3,p4,p5
use b_mod ,only:b,p1,p2,p3,p4,p5,b_mod_p
use c001_mod ,only:b,p1,p2,p3,p4,p5
use c002_mod ,only:b,p1,p2,p3,p4,p5
use c003_mod ,only:b,p1,p2,p3,p4,p5
use c004_mod ,only:b,p1,p2,p3,p4,p5
...
use c006_mod ,only:b,p1,p2,p3,p4,p5
use c007_mod ,only:b,p1,p2,p3,p4,p5
use c008_mod,only:b,p1,p2,p3,p4,p5
  implicit none
contains
subroutine z_proc
type(b)::x1a
