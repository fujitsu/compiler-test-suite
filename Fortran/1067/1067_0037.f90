...
type cover
  ...
  obj%t1%x=9
  obj2%t1%x=9
  open(unit=71, file='fort.86',form='FORMATTED')
  write(unit=71,*),obj
close(unit=71)
 open(unit=77, file='fort.86',form='FORMATTED')
read(unit=77,*)obj2
...
type cover
  ...
  obj%t1%x=9
  obj2%t1%x=9
  open(unit=81, file='fort.86',form='FORMATTED')
  write(unit=81,*),obj
close(unit=81)
 open(unit=87, file='fort.86',form='FORMATTED')
read(unit=87,*)obj2
