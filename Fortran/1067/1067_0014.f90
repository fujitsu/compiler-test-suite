...
interface 
  ...
  module subroutine s22
  end
  module subroutine s23
  end
  module subroutine s24
  end
...
interface
  module subroutine s32(z)
  class(ty2),pointer :: z
  end
end interface
contains
module procedure s32
  allocate(z)
end
module procedure  s22
  allocate(q)
  allocate(ty2::q2)
