     ...
     allocate(value%cc%dd%dy%yx%n4,source='11')
     ...
     var%cc%dd%dy%yx%n4='22'
     k7=loc(var%cc%dd%dy%yx%n4)
     end select
     if (k/=1) print *,1002
     ...
     if (value%cc%dd%dy%yx%n4/='11') print *,70451
     k8=loc(value%cc%dd%dy%yx%n4) 
