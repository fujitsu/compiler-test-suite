    ...
    subroutine sss(d)
     ...
     select type(v2)
       type is (b)
         ...
         v2(2)%b1(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b2(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b2(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b3(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b3(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b1(2)%cc(2)%dd(2)%b1(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b1(2)%cc(2)%dd(2)%b1(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b1(2)%cc(2)%dd(2)%b2(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b1(2)%cc(2)%dd(2)%b2(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b1(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b1(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b2(2)%cc(2)%dd(2)%b1(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b2(2)%cc(2)%dd(2)%b1(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b2(2)%cc(2)%dd(2)%b2(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b2(2)%cc(2)%dd(2)%b2(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b2(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b2(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b3(2)%cc(2)%dd(2)%b1(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b3(2)%cc(2)%dd(2)%b1(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b3(2)%cc(2)%dd(2)%b2(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b3(2)%cc(2)%dd(2)%b2(2)%cc(2)%dd(2)%x ='aa'
         v2(2)%b3(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%d1=-1
         v2(2)%b3(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%x ='aa'
     end select
     select type(v1)
       type is (b)
         ...
         if (v1(2)%b3(2)%cc(2)%dd(2)%b3(2)%cc(2)%dd(2)%x(2)/='12') print *,1141
     end select
     deallocate(v1)
     end
