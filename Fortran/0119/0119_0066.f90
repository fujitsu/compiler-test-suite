program main
  real*4   var, max, min
  print *,"r4 ** i4 power inline TEST START"
  var = 1.2345_4
  call sub_200(var)
  call sub_190(var)
  call sub_180(var)
  ...
  min = 1.17549435e-38
  call sub_min(min)
  print *,"r4 ** i4 power inline TEST END"
end program main
