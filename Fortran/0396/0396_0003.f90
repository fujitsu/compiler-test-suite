module m0
  ...
  integer,parameter:: NUMIA_I1=500, NUMFSL1=500
end
module m1
...
contains
 ...
 real(kind=8),allocatable :: ud39(:,:),ud49(:,:),vd39(:,:),vd49(:,:)
 ...
 allocate(u1(NUMIA_I, NUMFSL), u2(NUMIA_I, NUMFSL), u3(NUMIA_I, NUMFSL), u4(NUMIA_I, NUMFSL), &
          ...
          ud39(NUMIA_I1, NUMFSL), ud49(NUMIA_I1, NUMFSL), vd39(NUMIA_I1, NUMFSL), vd49(NUMIA_I1, NUMFSL))
u1=0
u2=0
u3=0
u4=0
