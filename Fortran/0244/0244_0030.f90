...
if(sub(aptr1,aptr2(:),aptr3(2:),aptr4(::2),aptr5,aptr6([2,3,4])) /=1) print*,'fail'
end subroutine

function sub(dptr1,dptr2,dptr3,dptr4,dptr5,dptr6)
integer::dptr1(5),dptr2(5),dptr3(5),dptr4(5),dptr5(5),dptr6(3),sub
