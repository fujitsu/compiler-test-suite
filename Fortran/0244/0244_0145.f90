...
if(is_contiguous(aptr(1:10,1:5,1:10,1:5)) .neqv. .false.) print*,134,'aptr(1:10,1:5,1:10,1:10)'
if(is_contiguous(aptr(1:10,1:10:2,1:10,1:5)) .neqv. .false.) print*,135,'aptr(1:10,1:10:2,1:10,1:10)'
if(is_contiguous(aptr(1:10,1:10,1:10,1:5:2)) .neqv. .false.) print*,136,'aptr(1:10,1:10,1:10,1:5:2)'

if(sub(trg(:,:,:,2:6))==1) print*,'pass'
