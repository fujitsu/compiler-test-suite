...
allocate(d1% cmp%cmp%cmp_alc)
allocate(d1% cmp%cmp_alc%cmp%alc)
end subroutine
subroutine s3(d1)
type(t4),intent(out) :: d1
allocate(d1% cmp_alc)
allocate(d1% cmp_alc%cmp_alc)
allocate(d1% cmp_alc%cmp_alc%cmp_alc)
allocate(d1% cmp%cmp_alc)
allocate(d1% cmp%cmp%cmp_alc)
allocate(d1% cmp%cmp_alc%cmp%alc)
end subroutine
...
allocate(d1% cmp_alc%cmp_alc)
allocate(d1% cmp_alc%cmp_alc%cmp_alc)
allocate(d1% cmp_alc%cmp_alc%cmp_alc%alc)
allocate(d1% cmp%cmp_alc)
allocate(d1% cmp%cmp%cmp_alc)
allocate(d1% cmp%cmp_alc%cmp%alc)
end subroutine
