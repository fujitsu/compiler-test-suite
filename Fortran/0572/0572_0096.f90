...
integer :: jj(2) = findloc(arr,4,BACK = .TRUE.)
integer :: kk(2) = findloc(arr1,'B',BACK = .TRUE.)
integer :: ll(2) = findloc(arr2,4.4,BACK = .TRUE.)
integer :: nn(2) = findloc(arr4,(3,3),BACK = .TRUE.)
if(jj(1) /= 2)print*, 101
if(jj(2) /= 2)print*, 102
if(kk(1) /= 1)print*, 103
if(kk(2) /= 4)print*, 104
