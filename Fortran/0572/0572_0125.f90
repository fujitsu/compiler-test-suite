...
integer :: jj(2) = findloc(arr,7,MASK = m1,KIND = 1,BACK = .TRUE.)
integer :: kk(2) = findloc(arr1,'B',MASK = m1,KIND = 2,BACK = .TRUE.)
integer :: ll(2) = findloc(arr2,4.4,MASK = m1,KIND = 4,BACK = .TRUE.)
integer :: nn(2) = findloc(arr4,(3,3),MASK = m1,KIND = 2,BACK = .TRUE.)
if(jj(1) /= 3)print*, 101
if(jj(2) /= 4)print*, 102
if(kk(1) /= 1)print*, 105
if(kk(2) /= 4)print*, 106
