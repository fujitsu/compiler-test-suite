...
integer :: jj(4) = findloc(arr,7,1,MASK = m1,BACK = .TRUE.)
integer :: kk(4) = findloc(arr1,'B',1,MASK = m1,BACK = .TRUE.)
integer :: ll(3) = findloc(arr2,4.4,2,MASK = m1,BACK = .TRUE.)
integer :: nn(4) = findloc(arr4,(3,3),1,MASK = m1,BACK = .TRUE.)
if(jj(1) /= 0)print*, 101
if(jj(2) /= 0)print*, 102
if(jj(3) /= 1)print*, 103
if(jj(4) /= 3)print*, 104
