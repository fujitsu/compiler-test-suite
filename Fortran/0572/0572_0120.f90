...
integer :: jj(1) = findloc(arr,4,MASK = m1(1:4),BACK = .TRUE.)
integer :: kk(1) = findloc(arr1,'B',MASK = m1,BACK = .TRUE.)
integer :: ll(1) = findloc(arr2,4.4,MASK = m1,BACK = .TRUE.)
integer :: nn(1) = findloc(arr4,(3,3),MASK = m1,BACK = .TRUE.)
if(jj(1) /= 4)print*, 101
if(kk(1) /= 3)print*, 102
if(ll(1) /= 5)print*, 103
if(nn(1) /= 5)print*, 105
