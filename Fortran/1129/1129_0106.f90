...
!
   ...
   if (ij/=minval(b2(:,:),mask=a1(:,:))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3(:,:),mask=a1(:,:))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=a1(v1(1):v1(2),v2(1):v2(3)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=a1(v1(1):v1(2),v2(1):v2(3)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=a1(v1(1):v1(2),v2(1):v2(3)))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=a1(v1,v2))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=a1(v1,v2))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=a1(v1,v2))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=reshape((/a1(v1,v2)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=reshape((/a1(v1,v2)/),(/2,3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=reshape((/a1(v1,v2)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=reshape((/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/),(/2,3/)))) then;else ;print *,'fail';endif
 end do; end do
