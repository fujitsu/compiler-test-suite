...
!
   ...
   call zz(ij,+maxval(b3,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/).and.&
                (/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix,ix=1,100,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,+maxval(b1,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix,ix=1,100,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,+maxval(b2,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix,ix=1,100,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,+maxval(b3,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix,ix=1,100,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,+maxval(b1,mask=reshape((/a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix,ix=1,100,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
