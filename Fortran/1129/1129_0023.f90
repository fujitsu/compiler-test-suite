...
!
   ...
   call zz(ij,maxval(b2(:,:,:,:,:,:),mask=a1(:,:,:,:,:,:))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b3(:,:,:,:,:,:),mask=a1(:,:,:,:,:,:))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b1,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b2,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b3,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b1,mask=a1(:,:,:,:,v1,v2))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b2,mask=a1(:,:,:,:,v1,v2))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b3,mask=a1(:,:,:,:,v1,v2))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b1,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b2,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b3,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b1,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b2,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)))+(/(i,i=1,ik)/))
   call zz(ij,maxval(b3,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)))+(/(i,i=1,ik)/))
 end do; end do
