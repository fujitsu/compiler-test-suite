...
!
 ...
 do i2=1,mm1; do i1=1,mm2
   ...
   a1(n,n,n,n,i1,i2)=.true.;ik=ik+1;ij=maxval((/(i,i=1,ik)/))
!
   call zz(ij,(/(i,i=1,ik)/)+maxval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
   call zz(ij,(/(i,i=1,ik)/)+maxval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
   call zz(ij,(/(i,i=1,ik)/)+maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
   ...
   call zz(ij,(/(i,i=1,ik)/)+maxval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))) 
   call zz(ij,(/(i,i=1,ik)/)+maxval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))) 
   call zz(ij,(/(i,i=1,ik)/)+maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
!
 end do; end do
 if (6/=count(a1)) print *,'fail'
