...
!
   call zz(ij,minval(b1        ))
   call zz(ij,minval(b2        ))
   call zz(ij,minval(b3        ))
   call zz(ij,minval(b1        (:,:,:,:,:,:)))
   call zz(ij,minval(b2        (:,:,:,:,:,:)))
   call zz(ij,minval(b3        (:,:,:,:,:,:)))
   call zz(ij,minval(b1        (:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,minval(b2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,minval(b3(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,minval(b1(:,:,:,:,v1,v2)))
   call zz(ij,minval(b2(:,:,:,:,v1,v2)))
   call zz(ij,minval(b3(:,:,:,:,v1,v2)))
   call zz(ij,minval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
!
 end do; end do
