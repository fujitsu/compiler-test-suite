...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,reshape((/(i,i=1,100)/),(/1,1,1,ik/))+maxval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
   call zz(ij,reshape((/(i,i=1,100)/),(/1,1,1,ik/))+maxval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
   call zz(ij,reshape((/(i,i=1,100)/),(/1,1,1,ik/))+maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
   ...
   call zz(ij,reshape((/(i,i=1,100)/),(/1,1,1,ik/))+maxval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))) 
   call zz(ij,reshape((/(i,i=1,100)/),(/1,1,1,ik/))+maxval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))) 
   call zz(ij,reshape((/(i,i=1,100)/),(/1,1,1,ik/))+maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) 
!
 end do; end do
 if (6/=count(a1)) print *,'fail'
