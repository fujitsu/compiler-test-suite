...
!
   ...
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b2(:,:,:,:,:,:),mask=a1(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b3(:,:,:,:,:,:),mask=a1(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b1,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b2,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b3,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b1,mask=a1(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b2,mask=a1(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b3,mask=a1(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b1,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,k1,k1,ik/))+maxval(b2,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
 end do; end do
