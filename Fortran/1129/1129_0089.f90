...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,maxval(b1*k1,mask=a1.and.a1)+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2*k1,mask=a1.and.a1)+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3,mask=a1.and.a1)+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1(:,:,:,:,:,:)*k1,mask=a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2(:,:,:,:,:,:)*k1,mask=a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3(:,:,:,:,:,:)*k1,mask=a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1(:,:,:,:,v1,v2)*k1,mask=a1(:,:,:,:,v1,v2).and.a1(:,:,:,:,v1,v2))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2(:,:,:,:,v1,v2)*k1,mask=a1(:,:,:,:,v1,v2).and.a1(:,:,:,:,v1,v2))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3(:,:,:,:,v1,v2)*k1,mask=a1(:,:,:,:,v1,v2).and.a1(:,:,:,:,v1,v2))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
 end do; end do
...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,maxval(b1        )+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2        )+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3        )+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1        (:,:,:,:,:,:))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2        (:,:,:,:,:,:))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3        (:,:,:,:,:,:))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1        (:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+reshape((/(((i*j*k,i=1,ik),j=1,k1,k2),k=1,10)/),(/k1,1,1,1,1,1,ik/)))
!
 end do; end do
 if (6/=count(a1))print *,'fail'
!
