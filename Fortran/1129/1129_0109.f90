...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   if (ij==minval(        reshape((/b1(1,1),b1(2,1),b1(1,2),b1(2,2),b1(1,3),b1(2,3)/),(/2,3/)) &
                 ,mask=reshape((/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(        reshape((/b2(1,1),b2(2,1),b2(1,2),b2(2,2),b2(1,3),b2(2,3)/),(/2,3/)) &
                 ,mask=reshape((/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/),(/2,3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(        reshape((/b3(1,1),b3(2,1),b3(1,2),b3(2,2),b3(1,3),b3(2,3)/),(/2,3/)) &
                           ,mask=reshape((/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij==minval(b1*k1,mask=a1.and.a1)) then;else ;print *,'fail';endif
   if (ij/=minval(b2*k1,mask=a1.and.a1)) then;print *,'fail';else ;endif
   if (cmplx(ij*k1,ij*k1)==minval(b3,mask=a1.and.a1)) then;else ;print *,'fail';endif
   if (ij==minval(b1(:,:)*k1,mask=a1(:,:).and.a1(:,:))) then;else ;print *,'fail';endif
   if (ij/=minval(b2(:,:)*k1,mask=a1(:,:).and.a1(:,:))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3(:,:)*k1,mask=a1(:,:).and.a1(:,:))) then;else ;print *,'fail';endif
   if (ij==minval(b1(v1,v2)*k1,mask=a1(v1,v2).and.a1(v1,v2))) then;else ;print *,'fail';endif
   if (ij/=minval(b2(v1,v2)*k1,mask=a1(v1,v2).and.a1(v1,v2))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3(v1,v2)*k1,mask=a1(v1,v2).and.a1(v1,v2))) then;else ;print *,'fail';endif
 end do; end do
