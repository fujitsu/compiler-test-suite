...
!
   ...
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1*k1))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2*k1))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3*k1))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                ))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                ))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1  &
                ))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3(:,:,:,:,v1,v2)*k1))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
