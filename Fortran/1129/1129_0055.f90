...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)).and.&
                a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b2,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik)/),(/k1,1,1,ik/))+maxval(b3,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
