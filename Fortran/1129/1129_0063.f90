...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b2(:,:,:,:,v1(1):v1(2),v2(1):v2(3)) &
                 ,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b3(:,:,:,:,v1(1):v1(2),v2(1):v2(3)) &
                           ,mask=a2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b1(:,:,:,:,v1,v2) ,mask=a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b2(:,:,:,:,v1,v2),mask=a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b3(:,:,:,:,v1,v2),mask=a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(        reshape((/b1(n,n,n,n,1,1),b1(n,n,n,n,2,1),b1(n,n,n,n,1,2),b1(n,n,n,n,2,2),b1(n,n,n,n,1,3),b1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)) &
                 ,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(        reshape((/b2(n,n,n,n,1,1),b2(n,n,n,n,2,1),b2(n,n,n,n,1,2),b2(n,n,n,n,2,2),b2(n,n,n,n,1,3),b2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)) &
                 ,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(        reshape((/b3(n,n,n,n,1,1),b3(n,n,n,n,2,1),b3(n,n,n,n,1,2),b3(n,n,n,n,2,2),b3(n,n,n,n,1,3),b3(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)) &
                           ,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b1*k1,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b2*k1,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b3,mask=a2.and.a2))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b1(:,:,:,:,:,:)*k1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b2(:,:,:,:,:,:)*k1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b3(:,:,:,:,:,:)*k1,mask=a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b1(:,:,:,:,v1,v2)*k1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b2(:,:,:,:,v1,v2)*k1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
   call zz(ij,reshape((/(i,i=1,ik*10)/),(/k1,1,1,ik/))+maxval(b3(:,:,:,:,v1,v2)*k1,mask=a2(:,:,:,:,v1,v2).and.a2(:,:,:,:,v1,v2)))
 end do; end do
