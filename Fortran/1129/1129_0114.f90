...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   if (ij==minval(b1,mask=a1(:,:,:,:,v1(k1):v1(k2),v2(k1):v2(k3)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=a1(:,:,:,:,v1(k1):v1(k2),v2(k1):v2(k3)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=a1(:,:,:,:,v1(k1):v1(k2),v2(k1):v2(k3)))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=reshape((/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=reshape((/a1(:,:,:,:,v1,v2)/).and.(/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=reshape((/a1(:,:,:,:,v1,v2)/).and.(/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=reshape((/a1(:,:,:,:,v1,v2)/).and.(/a1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij==minval(b1,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/).and.&
