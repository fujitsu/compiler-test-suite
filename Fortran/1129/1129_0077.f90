...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,maxval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b1(n,n,n,n,1,1),b1(n,n,n,n,2,1),b1(n,n,n,n,1,2),b1(n,n,n,n,2,2),b1(n,n,n,n,1,3),b1(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b2(n,n,n,n,1,1),b2(n,n,n,n,2,1),b2(n,n,n,n,1,2),b2(n,n,n,n,2,2),b2(n,n,n,n,1,3),b2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b3(n,n,n,n,1,1),b3(n,n,n,n,2,1),b3(n,n,n,n,1,2),b3(n,n,n,n,2,2),b3(n,n,n,n,1,3),b3(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))+reshape((/(((j*k1,j=k3,k3),k3=k1,ik),jz=1,10)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
!
 end do; end do
 if (6/=count(a1)) print *,'fail'
