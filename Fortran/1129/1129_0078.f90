...
!
   ...
   call zz(ij,maxval(b2(:,:,:,:,:,:),mask=a1(:,:,:,:,:,:))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3(:,:,:,:,:,:),mask=a1(:,:,:,:,:,:))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3,mask=a1(:,:,:,:,v1(1):v1(2),v2(1):v2(3)))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1,mask=a1(:,:,:,:,v1,v2))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2,mask=a1(:,:,:,:,v1,v2))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3,mask=a1(:,:,:,:,v1,v2))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
 end do; end do
