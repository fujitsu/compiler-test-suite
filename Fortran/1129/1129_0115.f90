...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   if (ij==minval(b1,mask=reshape((/a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(b2,mask=reshape((/a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(b3,mask=reshape((/a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
