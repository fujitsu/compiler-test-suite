...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b1,mask=a2(:,:,:,:,v1(k1):v1(k2),v2(k1):v2(k3))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b2,mask=a2(:,:,:,:,v1(k1):v1(k2),v2(k1):v2(k3))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b3,mask=a2(:,:,:,:,v1(k1):v1(k2),v2(k1):v2(k3))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b1,mask=reshape((/a2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b2,mask=reshape((/a2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b3,mask=reshape((/a2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b1,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b2,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b3,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/))))
   ...
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b3,mask=reshape((/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/).and.&
                (/a2(n,n,n,n,1,1),a2(n,n,n,n,2,1),a2(n,n,n,n,1,2),a2(n,n,n,n,2,2),a2(n,n,n,n,1,3),a2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b1,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b2,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/))))
   call zz(ij,reshape((/((i,i=k1,ik),ij=k1,ik)/),(/k1,k1,k1,k1,k1,k1,ik/))+maxval(b3,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/))))
 end do; end do
