...
!
 ...
 do i2=1,mm1; do i1=1,mm2
   ...
   a2(n,n,n,n,i1,i2)=.true.;ik=ik-1;ij=minval((/(i,i=-1,ik,-1)/))
!
   if (ij==minval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij==minval(reshape((/b1(n,n,n,n,1,1),b1(n,n,n,n,2,1),b1(n,n,n,n,1,2),b1(n,n,n,n,2,2),b1(n,n,n,n,1,3),b1(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(reshape((/b2(n,n,n,n,1,1),b2(n,n,n,n,2,1),b2(n,n,n,n,1,2),b2(n,n,n,n,2,2),b2(n,n,n,n,1,3),b2(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(reshape((/b3(n,n,n,n,1,1),b3(n,n,n,n,2,1),b3(n,n,n,n,1,2),b3(n,n,n,n,2,2),b3(n,n,n,n,1,3),b3(n,n,n,n,2,3)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij==minval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=minval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,k2,k3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,k2,k3/)))) then;else ;print *,'fail';endif
!
 end do; end do
 if (6==count(a2)) then;else ;print *,'fail';endif
