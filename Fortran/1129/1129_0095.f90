...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,+maxval(b1,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix=1,k1)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,+maxval(b2,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix=1,k1)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
   call zz(ij,+maxval(b3,mask=reshape((/a2(:,:,:,:,:,:).and.a2(:,:,:,:,:,:)/),(/1,1,1,1,k2,k3/)))+reshape((/(((ix*iy*iz,iy=1,k1),iz=1,6,k1),ix=1,k1)/),(/k1,k1,k1,k1,k1,k1,ik/))) 
