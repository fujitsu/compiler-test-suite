...
!
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
!
   call zz(ij,maxval(b1*k1)+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2*k1)+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3*k1)+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                )+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                )+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1  &
                )+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b1(:,:,:,:,v1,v2)*k1        )+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b2(:,:,:,:,v1,v2)*k1        )+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(b3(:,:,:,:,v1,v2)*k1)+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/)))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
   call zz(ij,maxval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/)))+reshape((/(i,i=1,ik*k1)/),(/k1,1,1,1,1,1,ik/)))
