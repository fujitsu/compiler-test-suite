...
!
   call zz(ij,minval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,minval(reshape((/b1(n,n,n,n,1,1),b1(n,n,n,n,2,1),b1(n,n,n,n,1,2),b1(n,n,n,n,2,2),b1(n,n,n,n,1,3),b1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,minval(reshape((/b2(n,n,n,n,1,1),b2(n,n,n,n,2,1),b2(n,n,n,n,1,2),b2(n,n,n,n,2,2),b2(n,n,n,n,1,3),b2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,minval(reshape((/b3(n,n,n,n,1,1),b3(n,n,n,n,2,1),b3(n,n,n,n,1,2),b3(n,n,n,n,2,2),b3(n,n,n,n,1,3),b3(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,minval(b1*k1))
   call zz(ij,minval(b2*k1))
   call zz(ij,minval(b3*k1))
   call zz(ij,minval(b1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                ))
   call zz(ij,minval(b2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                ))
   call zz(ij,minval(b3(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1  &
                ))
   call zz(ij,minval(b1(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,minval(b2(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,minval(b3(:,:,:,:,v1,v2)*k1))
   call zz(ij,minval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,minval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
!
 end do; end do
