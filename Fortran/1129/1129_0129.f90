...
!
 ...
 do i2=1,mm1; do i1=1,mm2
   ...
   a2(n,n,n,n,i1,i2)=.true.;ik=ik-1;ij=minval((/(i,i=-1,ik,-1)/))
!
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b1(n,n,n,n,1,1),b1(n,n,n,n,2,1),b1(n,n,n,n,1,2),b1(n,n,n,n,2,2),b1(n,n,n,n,1,3),b1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b2(n,n,n,n,1,1),b2(n,n,n,n,2,1),b2(n,n,n,n,1,2),b2(n,n,n,n,2,2),b2(n,n,n,n,1,3),b2(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b3(n,n,n,n,1,1),b3(n,n,n,n,2,1),b3(n,n,n,n,1,2),b3(n,n,n,n,2,2),b3(n,n,n,n,1,3),b3(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b1*k1))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b2*k1))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b3*k1))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b1(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                ))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b2(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1 &
                ))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b3(:,:,:,:,v1(1):v1(2),v2(1):v2(3))*k1  &
                ))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b1(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b2(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(b3(:,:,:,:,v1,v2)*k1))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,(/(i,i=-1,ik,-1)/)+minval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
