...
allocate(e, ee,eee,SOURCE = g(nn())%w(mm+2:mm+4))
...
if (k1/=1) print *,421
 ...
 if (ee(3)%j /= 20) print *,513
 if (any(ee(1)%c(1)%d /= 11)) print *,3311
 if (any(ee(1)%c(2)%d /= 12)) print *,3312
 if (any(ee(3)%c(1)%d /= 11)) print *,3321
 if (any(ee(3)%c(2)%d /= 12)) print *,3322
...
if (k1/=1) print *,421
 ...
 if (eee(3)%j /= 20) print *,513
 if (any(eee(1)%c(1)%d /= 11)) print *,3311
 if (any(eee(1)%c(2)%d /= 12)) print *,3312
 if (any(eee(3)%c(1)%d /= 11)) print *,3321
 if (any(eee(3)%c(2)%d /= 12)) print *,3322
