...
select type (a=>obj%lhs)
 type is (ty)
  select type (b=>obj%lhs)
   type is (ty)
    deallocate(obj%lhs)
    allocate(obj%lhs, source = rhs0)
...
select type (a=>obj%lhs)
 type is (ty)
  select type (b=>obj%lhs)
   type is (ty)
    deallocate(obj%lhs)
    allocate(obj%lhs, source = rhs1(2))
...
select type (a=>obj%lhs)
 type is (ty)
  select type (b=>obj%lhs)
   type is (ty)
    deallocate(obj%lhs)
    allocate(obj%lhs, source = objTT(2)%base1)
...
select type (a=>obj%lhs)
 type is (ty)
  select type (b=>obj%lhs)
   type is (ty)
    deallocate(obj%lhs)
    allocate(obj%lhs, source = objTT(2)%base2(3))
