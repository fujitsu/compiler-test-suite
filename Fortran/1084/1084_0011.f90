...
select type (a=>obj(2)%lhs)
 type is (ty)
  select type (b=>obj(2)%lhs)
   type is (ty)
    deallocate(obj(2)%lhs)
    allocate(obj(2)%lhs, source = rhs0)
...
select type (a=>obj(2)%lhs)
 type is (ty)
  select type (b=>obj(2)%lhs)
   type is (ty)
    deallocate(obj(2)%lhs)
    allocate(obj(2)%lhs, mold = rhs1(2))
    if(allocated(obj(2)%lhs)) then
     deallocate(obj(2)%lhs)
     allocate(obj(2)%lhs, source = rhs1(2))
    endif
...
select type (a=>obj(2)%lhs)
 type is (ty)
  select type (b=>obj(2)%lhs)
   type is (ty)
    deallocate(obj(2)%lhs)
    allocate(obj(2)%lhs, source = objTT(2)%base1)
...
select type (a=>obj(2)%lhs)
 type is (ty)
  select type (b=>obj(2)%lhs)
   type is (ty)
    deallocate(obj(2)%lhs)
    allocate(obj(2)%lhs, source = objTT(2)%base2(3))
