...
TYPE(type4),TARGET :: type4_obj2
 
allocate(fun2%cmp_type4)
...
CHARACTER(LEN=UBOUND(arr,fun(fun2())-2)-1)::aa
aa='ABCDEFG-HIJ'
IF(aa.eq.'ABCDEFG')PRINT*,'PASS'
END SUBROUTINE
END
