...
PROGRAM main
 ...
 END INTERFACE
 ALLOCATE(ty3_obj(2))
 ALLOCATE(ty3_obj(1)%cmp_ty1(1)%cmp_ty%ii)
 ALLOCATE(ty3_obj(1)%cmp_ty1(2)%cmp_ty%ii)

 ty3_obj(1)%ll = 100
 ty3_obj(1)%cmp_ty1%jj = 200
 ty3_obj(1)%cmp_ty1(1)%cmp_ty%ii = 300
 ty3_obj(1)%cmp_ty1(2)%cmp_ty%ii = 400
 ty3_obj(1)%kk = 500
 CALL FOO2(ty3_obj(1))
END PROGRAM
