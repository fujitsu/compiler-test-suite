...
PURE FUNCTION fun(dmy)
  ...
  ALLOCATE(fun)
  fun=dmy(3)%cmp_type4%kk
END FUNCTION

PURE FUNCTION fun1(dmy)
  TYPE(type5) :: fun1(dmy)
  INTEGER,INTENT(IN) :: dmy
  TYPE(type4) :: type4_obj1
  fun1(3)%cmp_type4%kk=400
  fun1(3)%cmp_type4%jj=300
  fun1(3)%cmp_type4%cmp_type2(1)%ii=800
  fun1(3)%cmp_type4%cmp_type2(2)%ii=700
  fun1(3)%cmp_type4%cmp_type2(1)%cmp_type1%hh=200
  fun1(3)%cmp_type4%cmp_type2(2)%cmp_type1%hh=100
  fun1(3)%cmp_type4=type4_obj1
END FUNCTION
END MODULE 
...
CHARACTER(LEN=UBOUND(arr,fun(fun1(3))-2)-2)::aa
aa='ABCDEFG-HIJ'
