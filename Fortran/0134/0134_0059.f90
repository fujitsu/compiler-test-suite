...
allocate(c1(2),c2)
call move_alloc(a1,c1(1)%k1)
call move_alloc(a2,c1(1)%k2)
call move_alloc(a3,c1(2)%k1)
call move_alloc(a4,c1(2)%k2)
call move_alloc(a5,c2%k1)
call move_alloc(a6,c2%k2)
c1(1)%k1   =1
c1(2)%k1   =1
c1(1)%k2(1)=1
c1(2)%k2(1)=1
