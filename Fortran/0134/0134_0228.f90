...
rewind 81
read(81,'(a)') c;if (c/=x)print *,101,c
read(81,'(a)') c;if (c/=x)print *,102,c
read(81,'(a)') c;if (c/=x)print *,103,c
read(81,'(a)') c;if (c/=y)print *,104,c
read(81,'(a)') c;if (c/=y)print *,105,c
read(81,'(a)') c;if (c/=y)print *,106,c
end
