...
if (chk(0.0))then
if (sign(1.0,real(a))>0) print *,1001,a
else
if (sign(1.0,real(a))<0) print *,1002,a
endif
end subroutine
subroutine bp(b)
implicit real(4)(d),real(8)(e),real(16)(f),complex(4)(a),complex(8)(b),complex(16)(c)
if (chk(0.0))then
if (sign(1.0_8,real(b,8))>0) print *,2001,b
else
if (sign(1.0_8,real(b,8))<0) print *,2002,b
endif
end subroutine
subroutine cp(c)
implicit real(4)(d),real(8)(e),real(16)(f),complex(4)(a),complex(8)(b),complex(16)(c)
if (chk(0.0))then
if (sign(1.0_16,real(c,16))>0) print *,3001,c
else
if (sign(1.0_16,real(c,16))<0) print *,3002,c
endif
end subroutine
end
subroutine s1
