...
write(77,'(z32.32,1x,z32.32)')b1
write(77, '(z32.32,1x,z32.32)')b2
write(77, '(z32.32,1x,z32.32)')b3
end
subroutine s2
...
rewind 77
read(77,'(a)') c;if (c/=x)print *,101,c
read(77,'(a)') c;if (c/=x)print *,102,c
read(77,'(a)') c;if (c/=x)print *,103,c
read(77,'(a)') c;if (c/=y)print *,104,c
read(77,'(a)') c;if (c/=y)print *,105,c
read(77,'(a)') c;if (c/=y)print *,106,c
end
