type ty1
complex(16):: cmp1(10,20,30)
end type
type(ty1),target,save :: str(2,3)
real(16   ),pointer,save :: ptr11(:,:,:)=>str(2,3)%cmp1(1:10:2,2:15:5,3:29:3)%re
real(16   ),pointer,save :: ptr12(:,:,:)=>str(2,3)%cmp1(1:10:2,2:15:5,3:29:3)%im
real(16   ),pointer,save :: ptr11a(:,:,:)
real(16   ),pointer,save :: ptr12a(:,:,:)
