...
real(4),pointer,save :: ptr11=>cmp1(2)%re
real(4),pointer,save :: ptr12=>cmp1(2)%im

complex(8),target,save:: cmp2(10)
real(8),pointer,save :: ptr21=>cmp2(2)%re
real(8),pointer,save :: ptr22=>cmp2(2)%im

complex(16),target,save:: cmp3(10)
real(16),pointer,save :: ptr31=>cmp3(2)%re
real(16),pointer,save :: ptr32=>cmp3(2)%im
