module m1
contains
function f1(x1,d1,d2,d3,d4,d5,c1,c2,c3,c4,c5,x2)
...
entry f2(x1,d1,d2,d3,d4,d5,c1,c2,c3,c4,c5,x2)
...
d4='d'
d5='e'
if (f1(x1=x1,x2=x2,c1=c1,c2=c2,c3=c3,c4=c4,c5=c5)/='12')print *,"fail"
if (abs(x1-(1,2))>0.001)print *,"fail"
if (abs(x2-(3,4))>0.001)print *,"fail"
if (c1/='x')print *,"fail"
if (c2/='b')print *,"fail"
...
d4='d'
d5='e'
if (f2(x1=x1,x2=x2,c1=c1,c2=c2,c3=c3,c4=c4,c5=c5)/='12')print *,"fail"
if (abs(x1-(1,2))>0.001)print *,"fail"
if (abs(x2-(3,4))>0.001)print *,"fail"
if (c1/='x')print *,"fail"
if (c2/='b')print *,"fail"
