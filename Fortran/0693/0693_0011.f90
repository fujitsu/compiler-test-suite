module m1
contains
function f1(x1,c1,c3,c5,d1,d3,d5,d2,d4,c2,c4,x2)
character(2)::f1,f2
character(*):: c1
...
entry    f2(x1,c1,c3,c5,d1,d3,d5,d2,d4,c2,c4,x2)
...
d4='d'
d5='e'
if (f2(c1=c1,c2=c2,c3=c3,c4=c4,c5=c5,x1=x1,x2=x2)/='12')print *,"fail"
if (abs(x1-(1,2))>0.001)print *,"fail"
if (abs(x2-(3,4))>0.001)print *,"fail"
if (c1/='x')print *,"fail"
if (c2/='b')print *,"fail"
