PROGRAM MyProgram
        ...
        if(kind(a0) /= kind(a1)) print*,113
        if(kind(a0) /= kind(a2)) print*,114
        if(kind(a0) /= kind(a3)) print*,115

        if(kind(a0) /= kind(a6)) print*,117
        if(kind(a0) /= kind(a7)) print*,118
        if(kind(a0) /= kind(a8)) print*,119
        if(kind(a0) /= kind(a9)) print*,120
        if(kind(a0) /= kind(a10)) print*,121
        if(kind(a0) /= kind(a11)) print*,122
        if(kind(a0) /= kind(a12)) print*,123
        if(kind(a0) /= kind(a13)) print*,124
