      ...
      c1()=fdf(a//b                    ,aa,bb,1,5,1,5,121,' ')
      c2()=fdf(a(:,:)(2:3)//b(:,:)(2:3),aa,bb,2,3,2,3,122,' ')
      c3()=fdf(a(:,:)(2: )//b(:,:)(2: ),aa,bb,2,5,2,5,123,' ')
      c4()=fdf(a(:,:)( : )//b(:,:)( : ),aa,bb,1,5,1,5,124,' ')
      c5()=fdf(a(:,:)( :2)//b(:,:)( :2),aa,bb,1,2,1,2,125,' ')
      c6()=fdf(a(:,:)(i:3)//b(:,:)(i:3),aa,bb,i,3,i,3,126,' ')
      c7()=fdf(a(:,:)     //b(:,:)     ,aa,bb,1,5,1,5,127,' ')
      p1(q)=fdf(a//b                    //q,aa,bb,1,5,1,5,121,'12')
      p2(q)=fdf(a(:,:)(2:3)//b(:,:)(2:3)//q,aa,bb,2,3,2,3,122,'12')
      p3(q)=fdf(a(:,:)(2: )//b(:,:)(2: )//q,aa,bb,2,5,2,5,123,'12')
      p4(q)=fdf(a(:,:)( : )//b(:,:)( : )//q,aa,bb,1,5,1,5,124,'12')
      p5(q)=fdf(a(:,:)( :2)//b(:,:)( :2)//q,aa,bb,1,2,1,2,125,'12')
      p6(q)=fdf(a(:,:)(i:3)//b(:,:)(i:3)//q,aa,bb,i,3,i,3,126,'12')
      p7(q)=fdf(a(:,:)//b(:,:)          //q,aa,bb,1,5,1,5,127,'12')
      r1(q)=fdf(a//b                    //q(2:2),aa,bb,1,5,1,5,121,'2')
      r2(q)=fdf(a(:,:)(2:3)//b(:,:)(2:3)//q(2:2),aa,bb,2,3,2,3,122,'2')
      r3(q)=fdf(a(:,:)(2: )//b(:,:)(2: )//q(2:2),aa,bb,2,5,2,5,123,'2')
      r4(q)=fdf(a(:,:)( : )//b(:,:)( : )//q(2:2),aa,bb,1,5,1,5,124,'2')
      r5(q)=fdf(a(:,:)( :2)//b(:,:)( :2)//q(2:2),aa,bb,1,2,1,2,125,'2')
      r6(q)=fdf(a(:,:)(i:3)//b(:,:)(i:3)//q(2:2),aa,bb,i,3,i,3,126,'2')
      r7(q)=fdf(a(:,:)     //b(:,:)     //q(2:2),aa,bb,1,5,1,5,127,'2')
      call sdf(a//b               ,aa,bb,1,5,1,5,21)
      call sdf(a(:,:)(2:3)//b(:,:)(2:3),aa,bb,2,3,2,3,22)
      call sdf(a(:,:)(2: )//b(:,:)(2: ),aa,bb,2,5,2,5,23)
      call sdf(a(:,:)( : )//b(:,:)( : ),aa,bb,1,5,1,5,24)
      call sdf(a(:,:)( :2)//b(:,:)( :2),aa,bb,1,2,1,2,25)
      call sdf(a(:,:)(i:3)//b(:,:)(i:3),aa,bb,i,3,i,3,26)
      call sdf(a(:,:)(i:j+1)//b(:,:)(i:j+1),aa,bb,i,3,i,3,27)
      call sdf(a(:,:)//b(:,:)         ,aa,bb,1,5,1,5,28)
