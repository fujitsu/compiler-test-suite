      ...
      aa=a  
      bb=b  
      call       ss1(a,b,i,j,aa,bb)
      end
      subroutine ss1(a,b,i,j,aa,bb)
      character*(*),dimension(i,i):: a,b,aa*5,bb*5
      logical r(2,2)
      integer t(2,2)
      a(:,:)(j+1:5)='?'//a(:,:)(j:j+1)//b(:,:)(j:2)
      if (a(1,1)/=aa(1,1)(1:2)//'?'//aa(1,1)(2:3))
     1                                      call err(a(1,1),01,01)
      if (a(2,1)/=aa(2,1)(1:2)//'?'//aa(2,1)(2:3))
     1                                      call err(a(2,1),01,01)
      if (a(1,2)/=aa(1,2)(1:2)//'?'//aa(1,2)(2:3))
     1                                      call err(a(1,2),01,01)
      if (a(2,2)/=aa(2,2)(1:2)//'?'//aa(2,2)(2:3))
     1                                      call err(a(2,2),01,01)
      a=aa
      call cz(a(:,:)(j:j+1)//b(:,:)(j:2),aa,bb,61)
      call cy('?'//a(:,:)(j:j+1)//b(:,:)(j:2),aa,bb,60)
      r(:,:)='?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) /=
     1       '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  )
     ...
     1       aa(:,:)(2:4  )//bb(:,:)(2:3  ),78)
      call rc('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) /=
     1       '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  ),79)
      call t_s(index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1               '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  )) -1,91,0)
      call t_s(index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1               '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  )) ,92,1)
      call t_c(char(index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1                    '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  )) -1),95,0)
      call t_c(char(index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1             '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  ))) ,96,1)
      call t_t(real(index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1             '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  ))) -1,93,0)
      call t_t(real(index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1             '?'//aa(:,:)(2:4  )//bb(:,:)(2:3  ))) ,94,1)
      t=0       
      t(:,:)=index('?'//a (:,:)(j:j+2)//b (:,:)(j:j+1) ,  
     1             aa(:,:)(3:4  )//bb(:,:)(2:3  )) -1
      ...
      a(:,:)(j+1:5)='?'//a(:,:)(j:j+2)
      if (a(1,1)/=aa(1,1)(:2)//'?'//aa(1,1)(2:3))call err(a(1,1),17,05)
      if (a(2,1)/=aa(2,1)(:2)//'?'//aa(2,1)(2:3))call err(a(2,1),18,05)
      if (a(1,2)/=aa(1,2)(:2)//'?'//aa(1,2)(2:3))call err(a(1,2),19,05)
      if (a(2,2)/=aa(2,2)(:2)//'?'//aa(2,2)(2:3))call err(a(2,2),20,05)
      a=aa
      call cx('?'//a(:,:)(j:j+2),80,aa)
      end
