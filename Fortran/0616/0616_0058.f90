...
if (any(lbound(w8(3)%p4)/=2))print *,008301
if (any(w8(3)%p4/='x'))print *,008302
if (len(w8(3)%p4)/=1)print *,008303
w8(3)%p4(2:25)=>p4f(p4)
if (    w8(3)%xx/='z')print *,108304
if (any(lbound(w8(3)%p4)/=2))print *,018301
if (any(w8(3)%p4/='x'))print *,018302
if (len(w8(3)%p4)/=1)print *,018303
end subroutine
subroutine set
