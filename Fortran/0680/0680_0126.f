 ...
 99   CONTINUE
      ...
      DO 1 I=1,N
        I4A1(I+1) = I4C1(I)-I4A1(I)*I4B1(I)+I4C1(I)
        R4A1(I+1) = R4C1(I)-R4A1(I)*R4B1(I)+R4C1(I)
        R8A1(I+1) = R8C1(I)-R8A1(I)*R8B1(I)+R8C1(I)
        I4A2(I+1) = I4S2 - I4A2(I)*I4S1   -I4S2
        R4A2(I+1) = R4S2 - R4A2(I)*R4S1   -R4S2
        R8A2(I+1) = R8S2 - R8A2(I)*R8S1   -R8S2
 1    CONTINUE
