     ...
     integer(8)::k1(4),k2(4)
    ! allocate(value(2))
     allocate(value(1)%w(2))
     allocate(value(2)%w(2))
     allocate(value(1)%w(1)%name,source='11')
     allocate(value(2)%w(1)%name,source='21')
     allocate(value(1)%w(2)%name,source='12')
     allocate(value(2)%w(2)%name,source='22')
     call s1(var, value) 
     k=0
     select type(var)
     type is(ext)
     ...
     if (value(2)%w(1)%name(:)/='21') print *,1021
     if (value(1)%w(2)%name(:)/='12') print *,1002
     if (value(2)%w(2)%name(:)/='22') print *,1022
