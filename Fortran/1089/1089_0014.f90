...
contains
 subroutine s1()
     integer :: c1(len ([ '1234'(1:p1)])) 
     integer :: c2(len ([ '1234'(1:p1)])) 
     integer :: c3(len ([ '1234'(1:x1)])) 
     integer :: c4(len ([ '1234'(1:x1)])) 
   block
     integer :: d1(len ([ '1234'(1:p1)])) 
     integer :: d2(len ([ '1234'(1:p1)])) 
     integer :: d3(len ([ '1234'(1:x1)])) 
     integer :: d4(len ([ '1234'(1:x1)])) 
...
contains
 subroutine s2
     integer :: e1(len ([ '1234'(1:p1)])) 
     integer :: e2(len ([ '1234'(1:p1)])) 
     integer :: e3(len ([ '1234'(1:x1)])) 
     integer :: e4(len ([ '1234'(1:x1)])) 
   block
     integer :: f1(len ([ '1234'(1:p1)])) 
     integer :: f2(len ([ '1234'(1:p1)])) 
     integer :: f3(len ([ '1234'(1:x1)])) 
     integer :: f4(len ([ '1234'(1:x1)])) 
