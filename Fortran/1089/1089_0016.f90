...
contains
 subroutine s1()
     integer :: c1(len ([ '1234'(1:t1)])) 
     integer :: c2(len ([ '1234'(1:t1)])) 
     integer :: c3(len ([ '1234'(1:w1)])) 
     integer :: c4(len ([ '1234'(1:w1)])) 
...
contains
 subroutine s2
     integer :: e1(len ([ '1234'(1:t1)])) 
     integer :: e2(len ([ '1234'(1:t1)])) 
     integer :: e3(len ([ '1234'(1:w1)])) 
     integer :: e4(len ([ '1234'(1:w1)])) 
associate(p1=>t1,x1=>w1)
   block
