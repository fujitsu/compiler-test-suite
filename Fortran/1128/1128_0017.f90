 ...
 do i2=1,ubound(a1,k2); do i1=1,ubound(a1,1)
   a1(i1,i2)='x'
   if (1/=count((/'x'==a1(v1,v2).and.'x'==a1(v1,v2)/))) then;print *,'fail';else ;endif
 ...
 do i2=1,ubound(a2,2); do i1=1,ubound(a2,1)
   ...
   if (1/=count((1,2)==a2(v1(1):v1(2),v2(1):v2(3)))) then;print *,'fail';else ;endif
   if (     1==count((1,2)==a2(v1,v2))) then;else ;print *,'fail';endif
   if (1/=count((1,2)==a2(v1,v2))) then;print *,'fail';else ;endif
   if (     1==count((1,2)==(/a2(v1,v2)/))) then;else ;print *,'fail';endif
   if (1/=count((1,2)==(/a2(v1,v2)/))) then;print *,'fail';else ;endif
   if (     1==count((1,2)==(/a2(1,1),a2(2,1),a2(1,2),a2(2,2),a2(1,3),a2(2,3)/))) then;else ;print *,'fail';endif
   if (1/=count((1,2)==(/a2(1,1),a2(2,1),a2(1,2),a2(2,2),a2(1,3),a2(2,3)/))) then;print *,'fail';else ;endif
   if (     1==count((1,2)==a2.and.(1,2)==a2)) then;else ;print *,'fail';endif
   if (1/=count((1,2)==a2.and.(1,2)==a2)) then;print *,'fail';else ;endif
   if (     1==count((1,2)==a2(:,:).and.(1,2)==a2(:,:))) then;else ;print *,'fail';endif
   a2(i1,i2)=(0,0)
