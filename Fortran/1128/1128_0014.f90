 ...
 do i2=1,ubound(a2,5); do i1=1,ubound(a2,4)
   ...
   if (.not.all((1,2)==a2(j,j,j,:,:))) then;else ;print *,'fail';endif
   if (     all((1,2)==a2(j,j,j,:,:))) then;print *,'fail';else ;endif
   if (.not.all((1,2)==a2(j,j,j,v1(1):v1(2),v2(1):v2(3)))) then;else ;print *,'fail';endif
   if (     all((1,2)==a2(j,j,j,v1(1):v1(2),v2(1):v2(3)))) then;print *,'fail';else ;endif
   if (.not.all((1,2)==a2(j,j,j,v1,v2))) then;else ;print *,'fail';endif
   if (     all((1,2)==a2(j,j,j,v1,v2))) then;print *,'fail';else ;endif
   a2(j,j,j,i1,i2)=(8,9)
   if (.not.all((8,9)==a2))print *,'fail'
 end do; end do
 if (     all((8,9)==a2)) then;else ;print *,'fail';endif
 if (.not.all((8,9)==a2)) then;print *,'fail';else ;endif
!
 end do
 end subroutine
 end
