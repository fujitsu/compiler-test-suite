 ...
 do i2=k1,ubound(a1,5); do i1=k1,ubound(a1,4)
   ...
   if (.not.all('x'==a1(j,j,j,:,:))) then;else ;print *,'fail';endif
   if (     all('x'==a1(j,j,j,:,:))) then;print *,'fail';else ;endif
   if (.not.all('x'==a1(j,j,j,v1(1):v1(2),v2(1):v2(3)))) then;else ;print *,'fail';endif
   if (     all('x'==a1(j,j,j,v1(1):v1(2),v2(1):v2(3)))) then;print *,'fail';else ;endif
   if (.not.all('x'==a1(j,j,j,v1,v2))) then;else ;print *,'fail';endif
   if (     all('x'==a1(j,j,j,v1,v2))) then;print *,'fail';else ;endif
   if (.not.all('x'==(/a1(j,j,j,v1,v2)/))) then;else ;print *,'fail';endif
   if (     all('x'==(/a1(j,j,j,v1,v2)/))) then;print *,'fail';else ;endif
   if (.not.all('x'==(/a1(j,j,j,1,1),a1(j,j,j,2,1),a1(j,j,j,1,2),a1(j,j,j,2,2),a1(j,j,j,1,3),a1(j,j,j,2,3)/))) then;else ;print *,'fail';endif
   if (     all('x'==(/a1(j,j,j,1,1),a1(j,j,j,2,1),a1(j,j,j,1,2),a1(j,j,j,2,2),a1(j,j,j,1,3),a1(j,j,j,2,3)/))) then;print *,'fail';else ;endif
