     ...
     type is(ext)
       ...
       write (350,"('var     :',z16.16)") loc(var)
       write (351,"('var%name:',z16.16)") loc(var(2,2,2)%name)
       write (352,"(z16.16)") loc(var)
       write (353,"(z16.16)") loc(var(2,2,2)%name)
       !!!!!deallocate(var%name)
     end select
     select type(var2)
     type is(ext)
