...
is=1
     ...
     type is(ext)
       ...
       write (117,"('var     :',z16.16)") loc(var)
       write (118,"('var%name:',z16.16)") loc(var(2,2,2)%name)
       write (119,"(z16.16)") loc(var)
       write (120,"(z16.16)") loc(var(2,2,2)%name)
       !!!!!deallocate(var%name)
     end select
     select type(vas)
     type is(ext)
       allocate(character(m)::vas(2,2,2)%n(2,2,2))
     end select
     select type(vat)
     type is(ext)
       allocate(character(m)::vat(2,2,2)%n(2,2,2))
     end select
