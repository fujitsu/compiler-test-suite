     ...
     use mod
      character(100)::er='11'
       integer::is
     class(base), allocatable :: var,vas,vaw,vat
is=1
     ...
     type is(ext)
       ...
       var%n='a'
       var%name='a'
       write (161,"('var     :',z16.16)") loc(var)
       write (162,"('var%name:',z16.16)") loc(var%name)
       write (163,"(z16.16)") loc(var)
       write (164,"(z16.16)") loc(var%name)
       !!!!!deallocate(var%name)
     end select
is=1
