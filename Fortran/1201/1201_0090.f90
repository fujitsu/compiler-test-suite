     ...
     type is(ext)
       ...
       write (374,"('var     :',z16.16)") loc(var)
       write (375,"('var%name:',z16.16)") loc(var(3)%name)
       write (376,"(z16.16)") loc(var)
       write (377,"(z16.16)") loc(var(3)%name)
     end select
     select type(vas)
     type is(ext)
