...
allocate(f(5,5));f=a
if (i==1) then
call sub(v%w(2:5,2),i,f,t%w1%w1%w2(2:5,2))
call sub(v%w(k2:k5,k2),i,f,t%w1%w1%w2(k2:k5,k2))
call sub(v%w(k5-k2-1:k5-k2+2,k5-k2-1),i,f,t%w1%w1%w2(k5-k2-1:k5-k2+2,k5-k2-1))
else
call sub(v%w(2:3,2),i,f,t%w1%w1%w2(2:3,2))
call sub(v%w(k2:k3,k2),i,f,t%w1%w1%w2(k2:k3,k2))
call sub(v%w(k5-k2-1:k5-k2,k5-k3),i,f,t%w1%w1%w2(k5-k2-1:k5-2,k5-3))
endif
end subroutine
