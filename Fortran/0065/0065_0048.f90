subroutine sub(a,b,c,d,m1,m2,m3,m4,m5,n)
real(8),dimension(1:n,1:n) :: a,b,c,d
integer,dimension(1:n,1:n) :: m1,m2,m3,m4,m5

do j=1,n
  do i=1,n
    if (m1(i,j) + m2(i,j) .lt. m5(i,j)) then
      if (m3(i,j)*m4(i,j)+m5(i,j) .gt. 2) then
...
integer,parameter :: ians=1764330
real(8),dimension(1:n,1:n) :: a,b,c,d
integer,dimension(1:n,1:n) :: m1,m2,m3,m4,m5
...
m5 = reshape((/(mod(i,6),i=1,n*n)/),(/n,n/))
call sub(a,b,c,d,m1,m2,m3,m4,m5,n)
