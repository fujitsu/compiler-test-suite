...
integer,parameter :: ians=-2528169
real(8),dimension(1:n,1:n) :: a,b,c,d
integer,dimension(1:n,1:n) :: m1,m2,m3,m4
...
m1 = reshape((/(2147483000,i=1,n*n)/),(/n,n/))
m2 = reshape((/(2147483101,i=1,n*n)/),(/n,n/))
m3 = reshape((/(-2147483202,i=1,n*n)/),(/n,n/))
m4 = reshape((/(-2147483303,i=1,n*n)/),(/n,n/))
