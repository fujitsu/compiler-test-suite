...
select case(k)
  case(1)
    allocate(g%r,source=1_1)
  case(2)
    allocate(g%r,source=2_2)
  case(3)
    allocate(g%r,source=3_4)
  case(4)
    allocate(g%r,source=4_8)
  case(5)
    allocate(g%r,source=1.1_4)
  case(6)
    allocate(g%r,source=1.2_8)
  case(7)
    allocate(g%r,source=1.3_16)
  case(8)
    allocate(g%r,source=(1.1_4,1.1_4))
  case(9)
    allocate(g%r,source=(1.2_8,1.2_8))
  case(10)
    allocate(g%r,source=(1.3_16,1.3_16))
  case(11)
    allocate(g%r,source=.true._1)
  case(12)
    allocate(g%r,source=.true._4)
  case(13)
    allocate(g%r,source=.true._8)
  case(14)
    allocate(g%r,source='x')
  case(15)
    allocate(g%r,source='123456789abcdef')
  case(16)
    allocate(z(2),source=[1,2])
    allocate(g%r,source=x(z))
    z=-z
    select type (r=>g%r)
      type is(x)
    end select
