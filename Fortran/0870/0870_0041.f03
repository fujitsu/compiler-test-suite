...
select case(k)
  case(1)
    allocate(p(2),source=1_1)
  case(2)
    allocate(p(2),source=2_2)
  case(3)
    allocate(p(2),source=3_4)
  case(4)
    allocate(p(2),source=4_8)
  case(5)
    allocate(p(2),source=1.1_4)
  case(6)
    allocate(p(2),source=1.2_8)
  case(7)
    allocate(p(2),source=1.3_16)
  case(8)
    allocate(p(2),source=(1.1_4,1.1_4))
  case(9)
    allocate(p(2),source=(1.2_8,1.2_8))
  case(10)
    allocate(p(2),source=(1.3_16,1.3_16))
  case(11)
    allocate(p(2),source=.true._1)
  case(12)
    allocate(p(2),source=.true._4)
  case(13)
    allocate(p(2),source=.true._8)
  case(14)
    allocate(p(2),source='x')
  case(15)
    allocate(p(2),source='123456789abcdef')
  case(16)
    allocate(z(2),source=[1,2])
    allocate(p(2),source=x(z))
    z=-z
    select type (p)
      type is(x)
    end select
