...
select type(p=>r)
 ...
 type is(character(*))
   ...
   if (k==14) then
     ...
     if (len(p(:))/=15) print *,201431
     if (any(p(:)/='123456789abcdef')) print *,201441
     if (len(p(:)(1:15))/=15) print *,201431
     if (any(p(:)(1:15)/='123456789abcdef')) print *,201441
     if (len(p(:)(k2:))/=14) print *,201431
     if (any(p(:)(k2:)/='23456789abcdef')) print *,201441
     if (len(p(:)(k2:k14))/=13) print *,201431
     if (any(p(:)(k2:k14)/='23456789abcde')) print *,201441
   end if
   kk=1
 type is(complex(16))
   if (k/=10) print *,1010
