...
subroutine i1_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  integer(kind=1),dimension(1:10) :: v,u,t,s
...
subroutine i2_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  integer(kind=2),dimension(1:10) :: v,u,t,s
...
subroutine i4_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  integer(kind=4),dimension(1:10) :: v,u,t,s
...
subroutine i8_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  integer(kind=8),dimension(1:10) :: v,u,t,s
...
subroutine r4_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  real(kind=4),dimension(1:10) :: v,u,t,s
  real(kind=4),parameter :: ans = 5._4
  real(kind=4) res
...
subroutine r8_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  real(kind=8),dimension(1:10) :: v,u,t,s
  real(kind=8),parameter :: ans = 5._8
  real(kind=8) res
...
subroutine r16_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  real(kind=16),dimension(1:10) :: v,u,t,s
  real(kind=16),parameter :: ans = 5._16
  real(kind=16) res
...
subroutine c8_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  complex(kind=4),dimension(1:10) :: v,u,t,s
  complex(kind=4),parameter :: ans = 0._4
  real(kind=4) res
...
subroutine c16_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  complex(kind=8),dimension(1:10) :: v,u,t,s
  complex(kind=8),parameter :: ans = 0._8
  real(kind=8) res
...
subroutine c32_test
  ...
  common /com/ok  
  logical(kind=1) :: ok
  complex(kind=16),dimension(1:10) :: v,u,t,s
  complex(kind=16),parameter :: ans = 0._16
  real(kind=16) res
