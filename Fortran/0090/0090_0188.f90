...
subroutine i1_test
  ...
  integer(kind=1),parameter :: ans = -15_1
  integer(kind=1) res

  call init

  v(1:10:2) = v(1:10:2) + u(1:10:2)
  t(1:10) = t(1:10) + s(5:14)
...
subroutine i2_test
  ...
  integer(kind=2),parameter :: ans = -15_2
  integer(kind=2) res
...
subroutine i4_test
  ...
  integer(kind=4),parameter :: ans = -15_4
  integer(kind=4) res
...
subroutine i8_test
  ...
  integer(kind=8),parameter :: ans = -15_8
  integer(kind=8) res
...
subroutine r4_test
  ...
  real(kind=4),parameter :: ans = -15._4
  real(kind=4) res
...
subroutine r8_test
  ...
  real(kind=8),parameter :: ans = -15._8
  real(kind=8) res
...
subroutine r16_test
  ...
  real(kind=16),parameter :: ans = -15._16
  real(kind=16) res
...
subroutine c8_test
  ...
  complex(kind=4),parameter :: ans = -15._4
  real(kind=4) res
...
subroutine c16_test
  ...
  complex(kind=8),parameter :: ans = -15._8
  real(kind=8) res
...
subroutine c32_test
  ...
  complex(kind=16),parameter :: ans = -15._16
  real(kind=16) res
