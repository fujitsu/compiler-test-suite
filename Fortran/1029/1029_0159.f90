...
subroutine sub1(n)
  ...
  common /com1/ c0 ,c1 ,c2 ,c3 ,c4 ,c5 ,c6 ,c7 ,c8 ,c9 ,&
                c10,c11,c12,c13,c14,c15,c16,c17,c18,c19
  if ( ( ( ( ( ( ( ( ( ( ( ( ( ( &
       (c0.ne.(1.0,1.0).or.c1.ne.(1.0,1.0).or. &
        c2.ne.(1.0,1.0).or.c3.ne.(1.0,1.0).or.c4.ne.(1.0,1.0)) &
       .and. (c5.ne.(1.0,1.0).and.c6.ne.(1.0,1.0)) ) &
       .or. c7.ne.(1.0,1.0) ) .or. c8.ne.(1.0,1.0) ) .or. c9.ne.(1.0,1.0)) &
       .and. c10.ne.(1.0,1.0) ) .and. c11.ne.(1.0,1.0) ) .and. &
             c12.ne.(1.0,1.0) ) .and. c13.ne.(1.0,1.0) ) &
       .or. c14.ne.(1.0,1.0) ) .or. c15.ne.(1.0,1.0) ) .or. &
            c16.ne.(1.0,1.0) ) .or. c17.ne.(1.0,1.0) ) &
       .and. c18.ne.(1.0,1.0) ) &
