...
if(l1.and.l2.and.l3.and.l4.and..not.(l5.and.l6.and.l7.and.l8)) then
  r1 = .true.
else 
  r1 = .false.
endif
if(.not.(l1.and.l2.and.l3.and.l4.and..not.(l5.and.l6.and.l7.and.l8))) then
  r2 = .true.
else 
  r2 = .false.
endif
...
do i=1, 256
  if((c_result(i).neqv.base(i)).or.(n_result(i).eqv.base(i))) &
    print *, 'ng:', i, base(i), c_result(i), n_result(i)
enddo
end
