...
subroutine sub1(n)
 implicit complex(c)
  ...
  if ( .not. &
     ( ( ( ( ( ( ( ( ( ( ( ( ( ( &
       (c0.eq.(1.0,1.0).or.c1.eq.(1.0,1.0).or.c2.eq.(1.0,1.0).or. &
        c3.eq.(1.0,1.0).or.c4.eq.(1.0,1.0)) &
       .and. (c5.eq.(1.0,1.0).and.c6.eq.(1.0,1.0)) ) &
       .or. c7.eq.(1.0,1.0) ) .or. c8.eq.(1.0,1.0) ) .or. c9.eq.(1.0,1.0) ) &
       .and. c10.eq.(1.0,1.0) ) .and. c11.eq.(1.0,1.0) ) &
       .and. c12.eq.(1.0,1.0) ) .and. c13.eq.(1.0,1.0) ) &
       .or. c14.eq.(1.0,1.0) ) .or. c15.eq.(1.0,1.0) ) &
       .or. c16.eq.(1.0,1.0) ) .or. c17.eq.(1.0,1.0) ) &
       .and. c18.eq.(1.0,1.0) ) &
       .and. c19.eq.(1.0,1.0) ) ) then
    write(6,*) "NG"
  else
    n=n+1
  endif
