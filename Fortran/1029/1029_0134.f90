 ...
 100  continue
      if ( ( .not. n/=9 ) .or. &
           ( c1.eq.(0.0,0.0) .and. c2.eq.(0.0,0.0) ) .or.   &  
           ( c3.eq.(0.0,0.0) .and. c4.eq.(0.0,0.0) ) ) goto200
        write(6,*) "NG"
 200  continue
    ...
    subroutine sub(c1,c2,c3,c4,c5,c6,n)
      ...
      if ( ( c1.eq.(0.0,0.0) .and. c2.eq.(2.0,2.0) ) .or.   &  
           ( c3.eq.(0.0,0.0) .and. c4.eq.(4.0,4.0) ) ) then
        write(6,*) "NG"
      else
        n=n+1
      endif
      ...
      if ( ( c1.eq.(1.0,1.0) .and. c2.eq.(0.0,0.0) ) .or.   &  
           ( c3.eq.(3.0,3.0) .and. c4.eq.(0.0,0.0) ) ) then
        write(6,*) "NG"
      else
        n=n+1
      endif
      ...
      if ( ( c1.eq.(0.0,1.0) .and. c2.eq.(0.0,2.0) ) .or.   &  
           ( c3.eq.(0.0,3.0) .and. c4.eq.(0.0,4.0) ) ) then
        write(6,*) "NG"
      else
        n=n+1
      endif
      ...
      if ( ( c1.eq.(1.0,0.0) .and. c2.eq.(2.0,0.0) ) .or.   &  
           ( c3.eq.(3.0,0.0) .and. c4.eq.(4.0,0.0) ) ) then
        write(6,*) "NG"
      else
        n=n+1
      endif
