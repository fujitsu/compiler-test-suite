...
!$OMP parallel do private(sum)
  do i=1,N
     ...
     b(i,1) = b(i,1) + a(4,1)*sum(1,4)
     b(i,2) = b(i,2) + a(1,2)*sum(2,1)
     b(i,2) = b(i,2) + a(2,2)*sum(2,2)
     b(i,2) = b(i,2) + a(3,2)*sum(2,3)
     b(i,2) = b(i,2) + a(4,2)*sum(2,4)
     b(i,3) = b(i,3) + a(1,1)*sum(3,1)
     b(i,3) = b(i,3) + a(2,1)*sum(3,2)
     b(i,3) = b(i,3) + a(3,1)*sum(3,3)
     b(i,3) = b(i,3) + a(4,1)*sum(3,4)
     b(i,4) = b(i,4) + a(1,1)*sum(4,1)
     b(i,4) = b(i,4) + a(2,1)*sum(4,2)
     b(i,4) = b(i,4) + a(3,1)*sum(4,3)
     b(i,4) = b(i,4) + a(4,1)*sum(4,4)
  end do
!$OMP end parallel do
end subroutine sub1
