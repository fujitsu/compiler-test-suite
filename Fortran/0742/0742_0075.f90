...
forall (ii=i1:1)
where(mask)
x0(ii:ii,2:,ii:ii)=y0(i1:ii,:5,ii:ii)
x1(ii:ii,2:,ii:ii)=y1(i1:ii,:5,ii:ii)
x2(ii:ii,2:,ii:ii)=y2(i1:ii,:5,ii:ii)
end where
end forall
...
forall (ii=1:5,ii==3)
where(mask)
x0(1:i1,ii-1:,ii-2:ii-2)=y0(1:i1,:ii+2,ii-2:ii-2)
x1(1:i1,ii-1:,ii-2:ii-2)=y1(1:i1,:ii+2,ii-2:ii-2)
x2(1:i1,ii-1:,ii-2:ii-2)=y2(1:i1,:ii+2,ii-2:ii-2)
end where
end forall
if(any(prt(x0)/=(/ma(:,1),-ma(:,:5)/)))write(6,*) "NG"
if(any(prt(x1)/=(/ma(:,1),-ma(:,:5)/)))write(6,*) "NG"
...
forall (ii=i1:5,ii==3)
where(mask)
x0(ii-2:i1,ii-1:,i1:ii-2)=y0(ii-2:i1,:ii+2,i1:ii-2)
x1(ii-2:i1,ii-1:,i1:ii-2)=y1(ii-2:i1,:ii+2,i1:ii-2)
x2(ii-2:i1,ii-1:,i1:ii-2)=y2(ii-2:i1,:ii+2,i1:ii-2)
end where
end forall
if(any(prt(x0)/=(/ma(:,1),-ma(:,:5)/)))write(6,*) "NG"
if(any(prt(x1)/=(/ma(:,1),-ma(:,:5)/)))write(6,*) "NG"
