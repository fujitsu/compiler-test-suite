...
a2(1)%y0=11
a3(1)%y0=13
allocate(a2(1)%y1,source=x12(1,2))  ! nomsg
allocate(a3(1)%y1,source=x12(3,4) ) ! nomsg
!allocate(a1,source=[(f(a2(1)),f(a3(1)),n=1,1)])   ! msg
allocate(a1,source=[f(a2(1)),f(a3(1))])
k=0
select type (a1)
  type is(yy)
   k=1
