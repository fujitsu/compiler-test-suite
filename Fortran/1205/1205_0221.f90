...
select type(d)
 ...
 select type(z=>d(2)%c2)
 type is(character(*))
 if (z      (2)/=a1) print *,7002
end select
select type(p=>d(2)%node1)
 class is(ty)
 if (p         (2)%value/=1) print *,7003
 select type(z=>p(2)%c1)
 type is(character(*))
 if (z               (2)/=a1) print *,7004
end select
select type(q=>p(2)%node)
 class is(ty)
 if (q                 (2)%value/=2) print *,7013
 select type(z=>q(2)%c1)
 type is(character(*))
 if (z                       (2)/=a1) print *,7014
    end select
    end select
    end select
select type(p=>d(2)%node2)
 ...
 select type(z=>p(2)%c2)
 type is(character(*))
 if (z               (2)/=a1) print *,7012
 end select
select type(q=>p(2)%node1)
 class is(ty)
 if (q                  (2)%value/=1) print *,7031
 select type(z=>q(2)%c1)
 type is(character(*))
 if (z                        (2)/=a1) print *,7032
 end select
select type(w=>q(2)%node)
 class is(ty)
 if (w                          (2)%value/=2) print *,7042
 select type(z=>w(2)%c1)
 type is(character(*))
 if (z                                (2)/=a1) print *,7042
    end select
 end select
end select
end select
 ...
 select type(t=>d)
   type is(tte)
 select type(z=>t(2)%c2e)
 type is(character(*))
    if (z       (2)/=a1) print *,70001
 end select
    select type(p=>t(2)%node1)
      type is(tye)
 select type(z=>p(2)%c1e)
 type is(character(*))
        if (z             (2)/=a1) print *,70002
 end select
        select type(q=>p(2)%node)
          type is(tye)
 select type(z=>q(2)%c1e)
 type is(character(*))
            if (z              (2)/=a1) print *,70003
            k=1
 end select
        end select
    end select
    ...
    select type(p=>t(2)%node2)
      type is(tte)
 select type(z=>p(2)%c2e)
 type is(character(*))
        if (z              (2)/=a1) print *,70011
    end select
        select type(q=>p(2)%node1)
          type is(tye)
 select type(z=>q(2)%c1e)
 type is(character(*))
            if (z              (2)/=a1) print *,70012
    end select
            select type(w=>q(2)%node)
              type is(tye)
 select type(z=>w(2)%c1e)
 type is(character(*))
              if (z              (2)/=a1) print *,70013
            k=1
    end select
            end select
        end select
