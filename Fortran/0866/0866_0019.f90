class(*),allocatable::a(:)
type t
character(3)::ch1(3),ch2(3),ch3(3)
end type
type(t)::tt
tt%ch1="123"
tt%ch2="abc"
tt%ch3="xyz"
a=[(tt%ch1(:1)(:1),i=1,1),tt%ch3(2:)(:1)]
select type(a)
type is(character(*))
if(len(a)/=1) print *,'err1'
if(a(1)//"1"/="11") print *,'err2',a(1)//"1"
if(a(2)//"1"/="x1") print *,'err4',a(2)//"1",a(2)//"1"
end select

a=[(tt%ch1(:1)(:1),i=1,1),(tt%ch2(2:2)(:1),k=1,1),tt%ch3(3:3)(:1)]
select type(a)
type is(character(*))
if(len(a)/=1) print *,'err1'
if(a(1)//"1"/="11") print *,'err2',a(1)//"1"
...
a=[(tt%ch1(1:1)(2:),i=1,1),(tt%ch2(2:2)(2:),k=1,1),tt%ch3(3:3)(2:)]
select type(a)
type is(character(*))
