 ...
 subroutine s1
  ...
  integer,dimension(15)::ay=(/(k,k=1,15)/),aa
      interface cf1
...
subroutine chk(iu)
  integer,dimension(15)::aa
 rewind iu
 read (iu,*) aa;if (any(aa/=(/(k,k=1,15)/)))print *,'fail'
end
