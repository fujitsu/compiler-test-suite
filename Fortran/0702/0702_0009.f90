      ...
      contains
       ...
       integer(kind=4) j
       integer ,parameter :: k=idim(10_4,0_4)     
       integer b(idim(j,j-10_4),idim(10_4,0_4))
       b=k
       end subroutine
       subroutine sss08(b,j)
       integer(kind=4) j
       integer ,parameter :: k=dim(10_4,0_4)     
       integer b(dim(j,j-10_4),dim(10_4,0_4))
       b=k
       end subroutine
       subroutine sss07(b,j)
       integer(kind=4) j
       integer ,parameter :: k=isign(10_4,10_4)     
       integer b(isign(j,j),isign(-10_4,1_4))
       b=k
       end subroutine
       subroutine sss06(b,j)
       integer(kind=4) j
       integer ,parameter :: k=sign(10_4,10_4)     
       integer b(sign(j,j),sign(-10_4,1_4))
       b=k
       end subroutine
       ...
       integer(kind=4) j
       integer ,parameter :: k=iabs(1_4)     
       integer b(iabs(j),iabs(10_4))
       b=k
       end subroutine
       subroutine sss03(b,j)
       integer(kind=4) j
       integer ,parameter :: k=abs(1_4)     
       integer b(abs(j),abs(10_4))
       b=k
       end subroutine
