 ...
 module mcc
  ...
  contains
    subroutine chki8(a,iu)
      ...
      integer(2),dimension(ubound(a,1),ubound(a,2),ubound(a,3),ubound(a,4),ubound(a,5),ubound(a,6),ubound(a,7))::ax
      integer(4)::iu
  ...
  use mcc,only:ri
   contains
     function ba(i) result(ar)
      dimension i(:)
      integer(2),dimension(ubound(i,1)-1,ubound(i,1)-1,ubound(i,1)-1,ubound(i,1)-1,ubound(i,1)-1,ubound(i,1)+0,ubound(i,1)+1):: ar
      ar=ri
