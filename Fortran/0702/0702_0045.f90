 ...
 subroutine s1
  ...
  if (any(shape(aa(w2))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  write(iu,*)aa(w2)
  call chk(aa(w2),iu)
  bb=aa(w2)
  ...
  if (any(shape(aax(w2))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  write(iu,*)aax(w2)
  call chk(aax(w2),iu)
  bb=aax(w2)
  if (any(bb/=ri))print *,'fail'
  ...
  if (any(shape(aaax(w2))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  write(iu,*)aaax(w2)
  call chk(aaax(w2),iu)
  bb=aaax(w2)
  if (any(bb/=ri))print *,'fail'
  ...
  if (any(shape(aa(za(3,4,4:k3+2)))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aax(za(3,4,4:k3+2)))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aaax(za(3,4,4:k3+2)))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aa(y(k3,4,k3+2)%za))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aax(y(k3,4,k3+2)%za))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aaax(y(k3,4,k3+2)%za))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aa(zf(char(2))))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aax(zf(char(2))))/=(/1,1,1,1,1,2,3/)))print *,'fail'
  ...
  if (any(shape(aaax(zf(char(2))))/=(/1,1,1,1,1,2,3/)))print *,'fail'
