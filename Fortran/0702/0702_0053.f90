  ...
  use mcc,only:ri
   contains
     function ba(i) result(ar)
      dimension i(:)
      integer(8),dimension(i(1)-2,i(2)-2)::ar
      ar=ri
 ...
 subroutine s1
  ...
  if (any(chk(aa(y(k3,4,k3+2)%za),iu)))print *,'fail'
  ...
  if (any(chk(aax(y(k3,4,k3+2)%za),iu)))print *,'fail'
  ...
  if (any(chk(aaax(y(k3,4,k3+2)%za),iu)))print *,'fail'
  ...
  if (any(chk(aa(zf(char(2))),iu)))print *,'fail'
  bb=aa(zf(char(2)))
  if (any(bb/=ri))print *,'fail'
  iu=iu+1
  ...
  if (any(chk(aax(zf(char(2))),iu)))print *,'fail'
  bb=aax(zf(char(2)))
  if (any(bb/=ri))print *,'fail'
  iu=iu+1
  ...
  if (any(chk(aaax(zf(char(2))),iu)))print *,'fail'
  bb=aaax(zf(char(2)))
  if (any(bb/=ri))print *,'fail'
  iu=iu+1
  end subroutine
