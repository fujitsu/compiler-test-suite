  ...
  use mcc,only:ri
   contains
     function ba(x1,x2,i,x3) result(ar)
      dimension i(:)
      integer(8),pointer::ar(:,:,:,:,:,:,:)
      character*(*) x1(:),x2(:),x3(:)
      allocate(ar(size(i)-1,size(i)-1,size(i)-1,size(i)-1,size(i)-1,size(i)+0,size(i)+1))
      ar=ri
      call xx(x1,x2,x3)
 ...
 subroutine s1
  ...
  if (any(chk(aa(xx,xx,za(k3,4,k3+1:5),xx),iu)))print *,'fail'
  ...
  if (any(chk(aax(za(k3,4,k3+1:5),xx,xx,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaax(xx,za(k3,4,k3+1:5),xx,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaaax(xx,xx,za(k3,4,k3+1:5),xx),iu)))print *,'fail'
  ...
  if (any(chk(aaaaax(xx,xx,xx,za(k3,4,k3+1:5)),iu)))print *,'fail'
  ...
  if (any(chk(aa(xx,xx,y(k3,4,4:k3+2)%za,xx),iu)))print *,'fail'
  ...
  if (any(chk(aax(y(k3,4,4:k3+2)%za,xx,xx,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaax(xx,y(k3,4,4:k3+2)%za,xx,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaaax(xx,xx,y(k3,4,4:k3+2)%za,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaaaax(xx,xx,xx,y(k3,4,4:k3+2)%za),iu)))print *,'fail'
  ...
  if (any(chk(aa(xx,xx,zf(char(2)),xx),iu)))print *,'fail'
  ...
  if (any(chk(aax(zf(char(2)),xx,xx,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaax(xx,zf(char(2)),xx,xx),iu)))print *,'fail'
  ...
  if (any(chk(aaaax(xx,xx,zf(char(2)),xx),iu)))print *,'fail'
  ...
  if (any(chk(aaaaax(xx,xx,xx,zf(char(2))),iu)))print *,'fail'
