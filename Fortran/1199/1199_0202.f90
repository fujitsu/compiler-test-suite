...
type(x)::v(2,2,2)
    ...
    kk=1
         allocate(v(2,2,2)%var, v(2,2,2)%v2,source=value,stat=kk)
if (kk/=0) print *,601
       end subroutine s1
     end module mod
...
subroutine s
     ...
     if (k1==k2) print *,2002
     k=0
     select type(w=>v(2,2,2)%v2)
     type is(ext)
     associate (p=>w(2,2,2)%bv)
     if (p    (2,2,2)%name(2,2,2)(:)/='ok') print *,3001
     end associate 
       select type(p=>w(2,2,2)%bv3)
       type is(e)
     if (p    (2,2,2)%name(2,2,2)(:)/='ok') print *,3002
     end select
       select type(p=>w(2,2,2)%bv2)
       type is(e)
     if (p    (2,2,2)%name(2,2,2)(:)/='ok') print *,3003
       k1=loc(p(2,2,2)%name(2,2,2))
       k=1
     end select
     end select
