      ...
      ANS(41)  =    C1+(R4+(-5.0))
      ANS(42)  =    C2-(-5.0-(-R4))
      ANS(43)  =    -((3.0,4.0)*(R2+250.0))
      ANS(44)  =    (C1+(4.0,3.0))+R1
      ANS(45)  =    ((5.0,4.0)+C3)-R2
      ANS(46)  =    -(C3+C5)*5.0
      ANS(47)  =    (C4+(5.0,-2.0))/4.0
      ANS(48)  =    (C1+(2.0,-2.0))-(R5+6.0)
      ANS(49)  =    -(-(-5.0,-4.0)+C4)*((-2.0)+R5)
  ...
  100 FORMAT(1H1/1H0,5X,35H* TEST OF EXPRESSION ( INTEGER*4 = ,
     *    23H COMPLEX*8 , REAL*4 ) *//1H0,21X,15HCONSTANT VALUE.,
     *    12X,13HRESULT VALUE.)
  101 FORMAT(1H0,5X,5HANS (,I3,5H ) = ,8X,I10,15X,I10)
  102 FORMAT(1H1/1H0,5X,33HERROR IS NOT DETECTED BY TEST0430)
  103 FORMAT(1H1/1H0,5X,37H*** ERROR IS DETECTED BY TEST0430 ***)
      END
