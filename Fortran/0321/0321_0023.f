      INTEGER*4     ANS(40),CNT(40),K1,K2,K3,K4,K5
      ...
      R4       =    -50.0
      R5       =      3.0
      ANS(1)   =    0.529D 02+32768
      ANS(2)   =    0.455D 02-32768
      ANS(3)   =    0.25D  01*32768
      ANS(4)   =    0.32768D 06/32768
      ANS(5)   =    R5+K1
      ANS(6)   =    R4-K2
      ANS(7)   =    R3*K3
      ANS(8)   =    R2/K4
  ...
  102 FORMAT(1H1/1H0,5X,33HERROR IS NOT DETECTED BY TEST0380)
  103 FORMAT(1H0,5X,37H*** ERROR IS DETECTED BY TEST0380 ***)
      END
