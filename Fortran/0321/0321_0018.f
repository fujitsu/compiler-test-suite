  ...
  100 FORMAT(1H1/1H0,5X,43H* TEST OF EXPRESSION ( INTEGER*4 = REAL*4 ,,
     ...
     *         12X,13HRESULT VALUE.)
  102 FORMAT(1H1/1H0,5X,33HERROR IS NOT DETECTED BY TEST0330)
  101 FORMAT(1H0,5X,5HANS (,I3,5H ) = ,8X,I10,15X,I10,
     *              12X,13HRESULT VALUE./)
  103 FORMAT(1H0,5X,37H*** ERROR IS DETECTED BY TEST0330 ***)
      END
