 ...
 1000 ITEM = ITEM+1
  ...
  100 FORMAT(1H1/1H0,5X,41H* TEST OF EXPRESSION (  C*32  =   C*32  ,,
     *                  29H DOUBLE COMPLEX) ERROR LIST *//1H0,5X,
     *                   7HITEM.NO,
     *              14X,9HREAL PART,14X,14HIMAGINARY PART)
  101 FORMAT(1H1/1H0,5X,33HERROR IS NOT DETECTED BY TEST0530)
  102 FORMAT    (1H0,5X,37H*** ERROR IS DETECTED BY TEST0530 ***)
