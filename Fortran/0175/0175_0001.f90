...
c=sum( cmplx( r +1.0 ) )
if (abs(real(c)-4)>0.00001) print *,111
if (    imag(c)/= 0     ) print *,112
c=sum( cmplx( r  ) )
if (abs(real(c)-2)>0.00001) print *,121
if (    imag(c)/= 0     ) print *,122
...
c=sum( cmplx( rr(::2) ,kind=4) )
if (abs(real(c)-2)>0.00001) print *,301
if (    imag(c)/= 0     ) print *,302
c=sum( cmplx( r +1.0 ,kind=4) )
if (abs(real(c)-4)>0.00001) print *,311
if (    imag(c)/= 0     ) print *,312
c=sum( cmplx( r  ,kind=4) )
if (abs(real(c)-2)>0.00001) print *,321
