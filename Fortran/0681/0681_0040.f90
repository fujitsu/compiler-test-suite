...
contains
  ...
  complex(kind=res_rkind) function my_fun(arg, arg2)
    implicit none
    !$omp declare simd inbranch uniform(arg2)
    real(kind=arg_rkind):: arg, arg2
    my_fun = arg ** 3.3 + arg2
  end function my_fun
  ...
  subroutine foo()
    ...
    !$omp simd
    do i=1,N
       if (m(i) .ne. 0) a(i) = my_fun(b(i), real(1.0, kind=arg_rkind))
    end do
  end subroutine

  subroutine check(ff)
    interface
      complex(kind=res_rkind) function ff(arg, arg2)
      use type_mod_1_1
      real(kind=arg_rkind):: arg, arg2
      end function ff
    end interface
    ...
    do i=1,N
       ...
       if (a(i) .ne. ff(b(i), real(1.0, kind=arg_rkind))) then
         stop
       endif
    end do
