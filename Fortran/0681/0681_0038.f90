...
contains
  ...
  complex(kind=res_rkind) function my_fun(arg0, arg, arg2)
    implicit none
    !$omp declare simd inbranch linear(arg0)
    integer,value::arg0; complex(kind=arg_ckind):: arg; integer::arg2
    my_fun = arg / arg0 + 3 - arg2
  end function my_fun
  ...
  subroutine foo()
    ...
    !$omp simd
    do i=1,N
       if (m(i) .ne. 0) a(i) = my_fun(int(i), b(i), int(i+1))
    end do
  end subroutine

  subroutine check(ff)
    interface
      complex(kind=res_rkind) function ff(arg0, arg, arg2)
      use type_mod_1_1
      integer,value::arg0; complex(kind=arg_ckind):: arg; integer::arg2
      end function ff
    end interface
    ...
    do i=1,N
       ...
       if (a(i) .ne. ff(int(i), b(i), int(i+1))) then
         stop
       endif
    end do
