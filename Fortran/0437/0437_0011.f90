...
use m1
type(xxxx):: w
if (w%xxxx1/=1111)print *,3101
if (any(w%xxxx2/=[1,2]))print *,3102
if (size(w%xxxx2)/=2)print *,3103
call sxxxxx(w%xxxx3(1))
call sxxxxx(w%xxxx3(2))
end
subroutine sxxxxx(w)
use m1
type(xxxxx):: w
if (w%xxxxx1/=11111)print *,4101
if (any(w%xxxxx2/=[1,2]))print *,4102
if (size(w%xxxxx2)/=2)print *,4103
end
