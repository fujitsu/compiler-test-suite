 subroutine s1
  ...
  type xq1
     type(q1)::h(2,3)=q1(0,1)
  end type
  type xq2
     type(q2)::h(2,3)=q2(1,null())
  end type
  type xq3
     type(q3)::h(2,3)=q3(1,null())
  end type
  type xq4
     type(q4)::h(2,3)=q4(1,null())
  end type
  type xq5
     type(q5)::h(2,3)=q5(1,null())
  end type
  type xq6
     type(q6)::h(2,3)=q6(1,null())
  end type
  type xq7
     type(q7)::h(2,3)=q7(1,null())
  end type
  type t
     integer(8)::d
  end type
...
select type(v)
  ...
  do k2=1,3
    ...
    if (.not.same_type_as(g,v(m)%h6(n1,n2)%h(k1,k2)%d6)) print *,3868
    if (v(m)%h6(n1,n2)%h(k1,k2)%dz6/=1) print *,38215
    if (allocated(v(m)%h7(n1,n2)%h(k1,k2)%d7)) print *,3827
    if (.not.same_type_as(g,v(m)%h7(n1,n2)%h(k1,k2)%d7)) print *,3869
