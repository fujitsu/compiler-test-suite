...
REAL(KIND(0D0)) :: Sinc(1:k),STRESS(1:k),Z2(1:k-10)
REAL(KIND(0D0)), PARAMETER :: Z1 = 5.D+0
Sinc(1:12:2) = (/STRESS(1:8:i2),Z1,Z2(2)/)
END SUBROUTINE
...
REAL(KIND(0D0)) :: Sinc(1:k),STRESS(1:k),Z2(1:k-10),Z3
Sinc(1:12:2) = (/STRESS(1:8:i2),Z3,Z2(j)/)
END SUBROUTINE
SUBROUTINE SUB24(STRESS,Sinc,Z4,k)
REAL(KIND(0D0)) :: Sinc(1:k),STRESS(1:k),Z4(1:k-10)
Sinc(1:12:2) = (/STRESS(1:8:i2),Z4/)
END SUBROUTINE
