...
subroutine sub01(i)
integer a(i)
integer,dimension(i,i,i)::x1,x2,x3,x4,x5,x6
x1=reshape((/(i,i=1,8)/),(/i,i,i/))
x2=x1;x3=x2;x4=x3;x5=x4
if (any(x1/=reshape((/(i,i=1,8)/),(/i,i,i/))))print *,'error-51'
if (any(x2/=reshape((/(i,i=1,8)/),(/i,i,i/))))print *,'error-52'
if (any(x3/=reshape((/(i,i=1,8)/),(/i,i,i/))))print *,'error-53'
if (any(x4/=reshape((/(i,i=1,8)/),(/i,i,i/))))print *,'error-54'
if (any(x5/=reshape((/(i,i=1,8)/),(/i,i,i/))))print *,'error-55'
a=(/1,2/)
