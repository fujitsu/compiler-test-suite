...
Contains
  ...
  Subroutine Wprint(pT1, nT1, pT2, nT2, header)
    ...
    Integer :: i
    If (Present(header)) Write (25,*) '**** ', Trim(header)

    Do i = 1, nT1
       If (i == 1) Then
          Write (25,9230) Lead, hT1, i, pT1(i)%p_iary
       Else
          Write (25,9230) Repeat(' ', Len(Lead)), hT1, i, pT1(i)%p_iary
       End If
    End Do
9230 Format (1x, a, a, i0, ')%p_iary: ', 10i5)
    ...
    Do i = 1, nT2
       If (i == 1) Then
          Write (25,9230) Lead, hT2, i, pT2(i)%p_iary
       Else
          Write (25,9230) Repeat(' ', Len(Lead)), hT2, i, pT2(i)%p_iary
       End If
    End Do
