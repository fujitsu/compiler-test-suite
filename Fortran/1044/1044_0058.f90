module mod
  complex,target:: array(3,3)
  complex,pointer::pointer_array(:,:)
contains
...
use mod
  array=0
    ...
    pointer_array=reshape((/(1,11),(2,22),(3,33),(4,44),(5,55),(6,66)/),(/2,3/))
call test01( item=01 )
call test02( array(2:,:),item=02)
  array=0
    pointer_array=> array(:,1:3:2)
    pointer_array=reshape((/(1,11),(2,22),(3,33),(4,44),(5,55),(6,66)/),(/3,2/))
call test01( item=03 )
