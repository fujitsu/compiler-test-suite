   ...
   do n=1,2
        call test_regist( ip(:,n,:,:))
   end do
   do n=1,2
        call test_regist( ip(:,n,:,1:))
   end do
   do n=1,2
        call test_regist( ip(:,n,:,:3))
   end do
   do n=1,2
        call test_regist( ip(:,n,:,1:3))
   end do
      do n=1,3
      do k=1,2
        call test_regiss( ip(:,k,:,n))
      end do
      end do
call chk
call chk2
...
rewind 2
read(2,*) a
if (any(a/=(/1,2,3,10,11,12,19,20,21/)))write(6,*) "NG"
read(2,*) a
if (any(a/=(/7,8,9,16,17,18,25,26,27/)))write(6,*) "NG"
read(2,*) a
if (any(a/=(/1,2,3,10,11,12,19,20,21/)))write(6,*) "NG"
read(2,*) a
if (any(a/=(/7,8,9,16,17,18,25,26,27/)))write(6,*) "NG"
