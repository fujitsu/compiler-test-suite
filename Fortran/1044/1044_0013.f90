...
module mod1
use mod,only:iii,i1,i9,i2
use mod0,only:jjj,j1,j9,j2
end module
module mod2
...
module kod1
use kod,only:iii,i1,i9,i2,i3
use kod0,only:jjj,j1,j9,j2,j3
end module
...
module nod1
use nod,only:iii,i1,i9,i2,i3
use nod0,only:jjj,j1,j9,j2,j3
...
module fod1
use fod,only:iii,i1,i9,i2,i3
use fod0,only:jjj,j1,j9,j2,j3
use fod,only:v=>iii
end module
