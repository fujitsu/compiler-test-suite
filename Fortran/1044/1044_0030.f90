...
if (any(PHI(1:6)/=(/1,3,4,6,7,9/)).or.&
    any(PHI(7:12)/=(/10,12,13,15,16,18/)).or.&
    any(PHI(13:18)/=(/19,21,22,24,25,27/)))write(6,*) "NG"
...
select case(n)
case(1)
if (any(PHI(1:6)/=(/1,3,4,6,7,9/)))write(6,*) "NG"
case(2)
if (any(PHI(1:6)/=(/10,12,13,15,16,18/)))write(6,*) "NG"
case(3)
if (any(PHI(1:6)/=(/19,21,22,24,25,27/)))write(6,*) "NG"
end select
