...
!$omp parallel reduction(+:ia,ib)
!$omp sections
      call sub1(ia, ib, ie, loop)
!$omp section
      call sub1(ia, ib, ie, loop)
!$omp section
      call sub1(ib, ia, ie, loop)
!$omp section
      call sub2(ia, ie, loop)
!$omp section
      call sub2(ib, ie, loop)
!$omp section
      call sub3(ia, ie, loop)
!$omp section
...
!$omp end parallel
      ...
      call sub1(ic, id, ie, loop)
      call sub1(id, ic, ie, loop)
      call sub2(ic, ie, loop)
      call sub2(id, ie, loop)
      call sub3(ic, ie, loop)
