...
v=a4(x1=i18,x2=c4,x3=c1617,x4=w)
if (v%x1/=i18)print *,'error-01'
if (v%x2/=c4)print *,'error-02'
if (abs(v%x3-c1617)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
...
if (abs(v%x3-c67)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
v=a4(a1(i18),x2=c4,x3=c1617,x4=w)
if (v%x1/=i18)print *,'error-01'
if (v%x2/=c4)print *,'error-02'
if (abs(v%x3-c1617)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
...
if (abs(v%x3-c67)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
v=a4(a3(x1=i18,x2=c4,x3=c1617),x4=w)
if (v%x1/=i18)print *,'error-01'
if (v%x2/=c4)print *,'error-02'
if (abs(v%x3-c1617)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
...
if (abs(v%x3-c67)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
v=a4(a3(a2(x1=i18,x2=c4),x3=c1617),x4=w)
if (v%x1/=i18)print *,'error-01'
if (v%x2/=c4)print *,'error-02'
if (abs(v%x3-c1617)>0.0001)print *,'error-03'
if (.not.v%x4)print *,'error-04'
