...
write(47,*)kk,a,b,c,d,e
 end subroutine
end
subroutine x
rewind 47
read(47,*) ii;if (ii/=1)print *,'error-1'
read(47,*) ii;if (ii/=1)print *,'error-1'
read(47,*) ii;if (ii/=1)print *,'error-1'
read(47,*) ii,jj,kk,ll;if (ii/=2)print *,'error-2';if (any((/jj,kk,ll/)/=1))print *,'error-3'
read(47,*) ii,jj,kk,ll;if (ii/=2)print *,'error-2';if (any((/jj,kk,ll/)/=1))print *,'error-3'
read(47,*) ii,jj,kk,ll;if (ii/=2)print *,'error-2';if (any((/jj,kk,ll/)/=1))print *,'error-3'
read(47,*) ii;if (ii/=3)print *,'error-4'
read(47,*) ii;if (ii/=3)print *,'error-4'
read(47,*) ii;if (ii/=3)print *,'error-4'
read(47,*,end=1) ii
print *,'error-5'
