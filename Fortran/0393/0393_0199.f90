subroutine s1(k2)
character(k2),contiguous,pointer::pp(:)
character(k2),contiguous,pointer::p5(:,:,:,:,:)
character(k2),contiguous,pointer::p4(:,:,:,:)
character(k2),contiguous,pointer::p3(:,:,:)
character(k2),contiguous,pointer::p2(:,:)
character(k2),contiguous,pointer::p1(:)
allocate (pp(6))
pp='12'
p1(6:11)=>pp
