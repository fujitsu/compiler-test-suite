...
class(x),pointer::p2(:,:)
class(x),pointer::p1(:)
allocate (z::dd(2)%pp(13))
k=0
select type(dx=>dd(2)%pp(2:13:2))
type is(z)
k=1
dx%z11=2
end select
if (k/=1) print *,605
p1(6:11)=>dd(2)%pp(2:13:2)
k=0
select type(p1)
type is(z)
...
p4(2:3,6:6,7:7,3:5)=>dd(2)%pp(2:13:2)
k=0
select type(p4)
type is(z)
...
p5(8:8,2:3,6:6,7:7,3:5)=>dd(2)%pp(2:13:2)
k=0
select type(p5)
type is(z)
