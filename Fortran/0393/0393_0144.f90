...
allocate (z::dd(2)%pp(3,1,1,1,2))
k=0
select type(xd=>dd(2)%pp)
type is(z)
k=1
xd%z11=2
end select
...
p5(8:8,2:3,6:6,7:7,3:5)=>dd(2)%pp
k=0
select type(p5)
type is(z)
