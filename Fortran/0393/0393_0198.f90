subroutine s1
character(2),contiguous,pointer::pp(:)
character(2),contiguous,pointer::p5(:,:,:,:,:)
character(2),contiguous,pointer::p4(:,:,:,:)
character(2),contiguous,pointer::p3(:,:,:)
character(2),contiguous,pointer::p2(:,:)
character(2),contiguous,pointer::p1(:)
allocate (pp(6))
pp='12'
p1(6:11)=>pp
