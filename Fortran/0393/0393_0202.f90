subroutine s1
integer(8),contiguous,pointer::pp(:,:,:)
integer(8),contiguous,pointer::p5(:,:,:,:,:)
integer(8),contiguous,pointer::p4(:,:,:,:)
integer(8),contiguous,pointer::p3(:,:,:)
integer(8),contiguous,pointer::p2(:,:)
integer(8),contiguous,pointer::p1(:)
allocate (pp(2,1,3))
pp=2
p1(6:11)=>pp
