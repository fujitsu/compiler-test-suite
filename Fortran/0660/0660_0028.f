      program main
       ...
       write(8,'(i7,1x,a10)') 10,'john0'
       rewind 8
       read (8,'(i7,1x,a10)') code,name 
       root%next%code=code
       root%next%name=name
       nullify(root%next%next)
       write(11,'(i7,1x,a10)') 19,'john1'
       write(12,'(i7,1x,a10)') 17,'john2'
       write(13,'(i7,1x,a10)') 15,'john3'
       write(14,'(i7,1x,a10)') 13,'john4'
       write(15,'(i7,1x,a10)') 12,'john5'
       write(16,'(i7,1x,a10)') 11,'john6'
       jj=11
       do 
         write(*,*) 'input data : code name'
         rewind jj
