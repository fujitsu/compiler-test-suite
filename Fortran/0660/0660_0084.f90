...
print *,'pass'
       ...
       if (bit_size( int(kfun())  ).ne.32) call err(4,11)
       if (bit_size(int(-kfun())  ).ne.32) call err(4,12)
       if (bit_size(int(+kfun(),4)  ).ne.32) call err(4,13)
       if (bit_size( int(kfun(),4)+1).ne.32) call err(4,14)
       ...
       if (bit_size( int(kfun())  ).ne.32) call err(3, 3)
