...
type (z)::a(4),b(4)
  ...
  if (any(a(4)%za/=(/1,2,3,4/))) write(6,*) "NG"
  ...
  if (any(ubound(a(3)%za)/=(/3/))) write(6,*) "NG"
  if (any(lbound(a(4)%za)/=(/1/))) write(6,*) "NG"
  if (any(ubound(a(4)%za)/=(/4/))) write(6,*) "NG"
