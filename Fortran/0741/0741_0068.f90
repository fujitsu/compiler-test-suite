...
integer,allocatable::pp(:,:)
  ...
  if (any(a(1,1)%za/=reshape((/1,1,1,1/),(/2,2/)))) write(6,*) "NG"
  if (any(a(2,1)%za/=reshape((/1,1,1,1/),(/2,2/)))) write(6,*) "NG"
  if (any(a(1,2)%za/=reshape((/0,0/),(/1,1/)))) write(6,*) "NG"
  if (any(a(2,2)%za/=reshape((/0,0/),(/1,1/)))) write(6,*) "NG"
