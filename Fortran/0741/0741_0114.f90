...
integer,allocatable,dimension(:,:)::p1,p2,p3,p4,p5
  ...
  p5=reshape((/5,5,5,5, 5,7,7,5, 5,5,5,5/),(/4,3/))
  ...
  if (.not.allocated(a(1,1)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(2,1)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(3,1)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(4,1)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(1,2)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(4,2)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(1,3)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(2,3)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(3,3)%ya(1)%za)) write(6,*) "NG"
  if (.not.allocated(a(4,3)%ya(1)%za)) write(6,*) "NG"
  if (any(a(1,1)%ya(1)%za/=(/2/))) write(6,*) "NG"
  if (any(a(2,1)%ya(1)%za/=(/3/))) write(6,*) "NG"
  if (any(a(3,1)%ya(1)%za/=(/4/))) write(6,*) "NG"
  if (any(a(4,1)%ya(1)%za/=(/5/))) write(6,*) "NG"
  if (any(a(1,2)%ya(1)%za/=(/3/))) write(6,*) "NG"
  if (any(a(4,2)%ya(1)%za/=(/6/))) write(6,*) "NG"
  if (any(a(1,3)%ya(1)%za/=(/4/))) write(6,*) "NG"
  if (any(a(2,3)%ya(1)%za/=(/5/))) write(6,*) "NG"
  if (any(a(3,3)%ya(1)%za/=(/6/))) write(6,*) "NG"
  if (any(a(4,3)%ya(1)%za/=(/7/))) write(6,*) "NG"
