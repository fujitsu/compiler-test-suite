...
type(z),allocatable::a(:,:)
  ...
  if (any(lbound(a(1,1)%za)/=(/5,6/))) write(6,*) "NG"
  if (any(lbound(a(2,1)%za)/=(/5,6/))) write(6,*) "NG"
  if (any(lbound(a(3,1)%za)/=(/5,6/))) write(6,*) "NG"
  if (any(ubound(a(1,1)%za)/=(/7,7/))) write(6,*) "NG"
  if (any(ubound(a(2,1)%za)/=(/7,7/))) write(6,*) "NG"
  if (any(ubound(a(3,1)%za)/=(/7,7/))) write(6,*) "NG"
  if (any(lbound(a(1,2)%za)/=(/5,6/))) write(6,*) "NG"
  if (any(lbound(a(2,2)%za)/=(/5,6/))) write(6,*) "NG"
  if (any(lbound(a(3,2)%za)/=(/5,6/))) write(6,*) "NG"
  if (any(ubound(a(1,2)%za)/=(/7,7/))) write(6,*) "NG"
  if (any(ubound(a(2,2)%za)/=(/7,7/))) write(6,*) "NG"
  if (any(ubound(a(3,2)%za)/=(/7,7/))) write(6,*) "NG"
  if (any(a(1,1)%za/=reshape((/0,1,0,0,1,0/),(/3,2/)))) write(6,*) "NG"
  if (any(a(2,1)%za/=reshape((/0,2,0,0,2,0/),(/3,2/)))) write(6,*) "NG"
  if (any(a(3,1)%za/=reshape((/0,3,0,0,3,0/),(/3,2/)))) write(6,*) "NG"
  if (any(a(1,2)%za/=reshape((/0,0,0,0,0,0/),(/3,2/)))) write(6,*) "NG"
  if (any(a(2,2)%za/=reshape((/0,0,0,0,0,0/),(/3,2/)))) write(6,*) "NG"
  if (any(a(3,2)%za/=reshape((/0,0,0,0,0,0/),(/3,2/)))) write(6,*) "NG"
