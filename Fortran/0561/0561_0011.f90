...
program main
  ...
  type(cover) :: obj,obj1
   open(unit=71, file='fort.14',form='FORMATTED')  
write(unit=71,'(DT)') obj%t1
  close(unit=71)

open(unit=77, file='fort.14',form='FORMATTED')
 read(unit=77,'(DT)')obj1%t1
  close(unit=77,status='delete')

if(obj1%t1%x .ne.11)print*,101
print*,'pass'
End program
