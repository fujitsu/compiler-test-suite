...
program main
  ...
  integer::i
  i=4
open(unit=71, file='fort.23',form='FORMATTED')
  write(unit=71,'(I,DT(2,3))')i, t1
close(unit=71)
 open(unit=77, file='fort.23',form='FORMATTED')
  read(unit=77,'(I1 ,DT(2,3))')i,t2
close(unit=77,status='delete')
if(t2%x .ne. 12)print*,101
print*,'pass'
