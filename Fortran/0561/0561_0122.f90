...
program main
  USE m
  TYPE (ty) :: t1(7),t2(7)
  OPEN(2,file ='fort.28',form="unformatted")
  WRITE(2) t1([2,5,7,3,6])
  close(2)
  OPEN(22,file ='fort.28',form="unformatted")
  READ(22) t2([2,5,7,3,6])
  close(22,status="delete")
  if(any(t2([2,5,7,3,6])%x.ne.11))print*,101
  if(any(t2([2,5,7,3,6])%y.ne.10))print*,102
  print*,"pass"
End program
