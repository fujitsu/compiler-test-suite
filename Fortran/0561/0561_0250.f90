...
SUBROUTINE SUB (DTV, UNIT, IOTYPE, V_LIST, IOSTAT,IOMSG)
    ...
    IF(SIZE(V_LIST)/=0) THEN
      ...
      ELSE
        WRITE(UNIT,*,IOSTAT=IOSTAT,IOMSG=IOMSG) DTV%A+2,IOTYPE
      END IF
...
SUBROUTINE SUB2 (DTV, UNIT, IOTYPE, V_LIST, IOSTAT,IOMSG)
    ...
    CHARACTER(LEN=*), INTENT(INOUT) :: IOMSG
    IF(SIZE(V_LIST)/=0) THEN
        WRITE(UNIT,*,IOSTAT=IOSTAT,IOMSG=IOMSG) V_LIST(1),V_LIST(2),DTV%CC,IOTYPE
      ELSE
        WRITE(UNIT,*,IOSTAT=IOSTAT,IOMSG=IOMSG) DTV%CC+1,IOTYPE
      END IF
