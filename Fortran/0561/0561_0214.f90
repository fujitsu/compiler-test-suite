...
program main
  USE m
  type(ty)::t2(7)
open(unit=71, file='fort.63',form='FORMATTED')
write(unit=71,'(DT(2,3))'),[ty(9,8),ty(9,8),ty(9,8),ty(9,8)]
close(unit=71)
 open(unit=77, file='fort.63',form='FORMATTED')
read(unit=77,'(DT(2,3))')t2(1:4:1)
close(unit=77,status='delete')
if(any(t2(1:4:1)%x .ne.13))print*,101
print*,'pass'
