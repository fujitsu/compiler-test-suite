...
program main
  ...
  TYPE (ty) :: t2(4,5,6)
  OPEN(2,file ='fort.39',form="unformatted")
  WRITE(2) fun()
  close(2)
  OPEN(22,file ='fort.39',form="unformatted")
  READ(22) t2
  close(22,status="delete")
  if(any(t2%x.ne.21))print*,101
  if(any(t2%y.ne.20))print*,102
  print*,"pass"
End program

 function fun()
  use m
  TYPE (ty),target,save :: d(4,5,6)
  TYPE (ty),pointer :: fun(:,:,:)
  fun=>d
  fun%x = fun%x+10
  fun%y = fun%y+10
