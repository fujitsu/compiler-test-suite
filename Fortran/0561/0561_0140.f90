...
program main
  ...
  OPEN(2,file ='fort.54',form="unformatted")
  WRITE(2) obj1(1:8:2)%t1
  close(2)
  OPEN(22,file ='fort.54',form="unformatted")
  READ(22) obj2(1:8:2)%t1
  close(22,status="delete")
  if(any(obj2(1:8:2)%t1%x.ne.11))print*,101
  if(any(obj2(1:8:2)%t1%y.ne.10))print*,102
  print*,"pass"
End program
