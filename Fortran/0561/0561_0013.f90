...
program main
  ...
  type(cover) :: obj,obj1
open(unit=71, file='fort.16',form='FORMATTED')
  write(unit=71,'(DT)'),obj%t1(::2)
close(unit=71)
open(unit=77, file='fort.16',form='FORMATTED')
  read(unit=77,'(DT)'),obj1%t1(::2)
  close(unit=77,status='delete')

if(any(obj1%t1(::2)%x .ne. 11))print*,101
print*,'pass'
