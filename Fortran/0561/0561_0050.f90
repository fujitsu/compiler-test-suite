...
if(any(c%cmp(1)%v/= 502))print*,'101'
if(any(c%cmp(2)%v/= 502))print*,'105'
if(c%cmp(1)%A/= 8)print*,'103'
if(c%cmp(2)%A/= 8)print*,'106'
if(any(c%cmp1(1)%v/= 602))print*,'102'
if(any(c%cmp1(2)%v/= 602))print*,'107'
if(c%cmp1(1)%A/= 13)print*,'104'
if(c%cmp1(2)%A/= 13)print*,'108'
print*,'pass'
END
