...
integer ians
call sub(i1fun,ians)
if (ians.ne.1) print *,'fail'
call sub(i2fun,ians)
if (ians.ne.2) print *,'fail'
call sub(i4fun,ians)
if (ians.ne.4) print *,'fail'
call sub(i8fun,ians)
if (ians.ne.8) print *,'fail'

call sub(r4fun,ians)
if (ians.ne.40) print *,'fail'
call sub(r8fun,ians)
if (ians.ne.80) print *,'fail'
call sub(r16fun,ians)
if (ians.ne.160) print *,'fail'

call sub(c4fun,ians)
if (ians.ne.400) print *,'fail'
call sub(c8fun,ians)
if (ians.ne.800) print *,'fail'
call sub(c16fun,ians)
if (ians.ne.1600) print *,'fail'

call sub(l1fun,ians)
if (ians.ne.11) print *,'fail'
call sub(l2fun,ians)
if (ians.ne.12) print *,'fail'
call sub(l4fun,ians)
if (ians.ne.13) print *,'fail'
call sub(l8fun,ians)
if (ians.ne.14) print *,'fail'

call sub(chafun,ians)
if (ians.ne.15) print *,'fail'
