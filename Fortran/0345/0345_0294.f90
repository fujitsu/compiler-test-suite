      program main
       use m1
        ...
        complex(8),pointer,dimension(:,:,:,:,:,:,:)::p
        complex(8),target ,dimension(n7,n6,n5,n4,n3,n2,n1)::t
        complex(8)::sum=0
        t(:,:,:,:,:,:,:)=(1.0d0,-1.0d0)
        p=>t
        call s1(p,n7,n6,n5,n4,n3,n2,n1,sum) 
        if (sum/=(5040d0,-5040d0)) print *,'error ',sum
        print *,'pass'
      end program
      ...
      module m1
       ...
       contains
        subroutine s1(p,n7,n6,n5,n4,n3,n2,n1,sum)
         complex(8),dimension(n7,n6,n5,n4,n3,n2,n1)::p
         complex(8)::sum
          do i7=1,n1
