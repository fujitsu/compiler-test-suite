...
INTEGER*1::RES1=INT(R2,KIND=1)
INTEGER*1::RES2=INT(RR2,KIND=1)
INTEGER*1::RES3=INT(RR3,KIND=1)
INTEGER*1::RES4=INT(C2 ,KIND=1)
INTEGER*1::RES5=INT(CC2,KIND=1)
INTEGER*1::RES6=INT(CC3,KIND=1)
