...
do k=1,5
 ...
 OBJW(1)%CC2=(3.5_2,4.5_2)
  OPEN(2,FILE='FORT.4',FORM="UNFORMATTED")
 WRITE(2) ((((((((OBJW(I),I=1,2),J=1,2),K=1,2),S=1,2),R=1,2),Y=1,2),F=1,2),G=1,2)

  CLOSE(2)

  OPEN(55,FILE ='FORT.4',FORM="UNFORMATTED")
 READ(55)((((((((OBJR(I),I=1,2),J=1,2),K=1,2),S=1,2),R=1,2),Y=1,2),F=1,2),G=1,2)
  CLOSE(55,STATUS="DELETE")
  IF(ANY(OBJR(2)%RR2 /= 1.5_2+2 )) PRINT*,"101"
