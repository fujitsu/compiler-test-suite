...
class(x),pointer::c3=>null()
class(x),pointer::c4(:)=>null()
write(3,'(z16.16)') loc(c1)
write(3,'(z16.16)') loc(c2)
write(3,'(z16.16)') loc(c3)
write(3,'(z16.16)') loc(c4)
