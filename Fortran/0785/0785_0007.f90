...
call       ssx(c1,c2,c3,c4,n1,n2,n3,n4)
end subroutine
subroutine ssx(c1,c2,c3,c4,n1,n2,n3,n4)
class(*)::c1
class(*)::c2(:)
class(x)::c3
class(x)::c4(:)
optional:: c1,c2,c3,c4
k=0
write(9,'(z16.16)') loc(c1)
write(9,'(z16.16)') loc(c2)
write(9,'(z16.16)') loc(c3)
write(9,'(z16.16)') loc(c4)
if (present(c1)) then
 k=1
 select type (c1)
  type is(y)
...
do k=1,4
read(9,'(a)') c ;if (c/=z) print *,77101,k
end do
do k=1,8
read(9,'(a)') c ;if (c==z) print *,77102,k
end do
read(9,'(a)',end=1) c
print *,77
1 end
