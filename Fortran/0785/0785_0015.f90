...
pointer (base1, ivar1(2))
pointer (base2, ivar2(2))
pointer (base3, ivar3(2))
pointer (base4, ivar4(2))
if (present(c1)) then
  base1=loc(c1)
  base2=loc(c2)
  base3=loc(c3)
  base4=loc(c4)
  if (n1==1) then
   write(11,*) ivar1(1),ivar2(1),ivar3(1),ivar4(1)
  else
   write(11,*) ivar1(1),ivar2(1),ivar3(1),ivar4(1)
   write(11,*) ivar1(2),ivar2(2),ivar3(2),ivar4(2)
  endif
endif
k=0
write(1,'(z16.16)') loc(c1)
if (present(c2)) then
write(1,'(z16.16)') loc(c2(1))
else
write(1,'(z16.16)') loc(c2)
endif
write(1,'(z16.16)') loc(c3)
if (present(c4)) then
write(1,'(z16.16)') loc(c4(1))
else
write(1,'(z16.16)') loc(c4)
endif
write(2,'(z16.16)') loc(c1)
write(2,'(z16.16)') loc(c2)
write(2,'(z16.16)') loc(c3)
write(2,'(z16.16)') loc(c4)
if (present(c1)) then
 k=1
 select type (c1)
  type is(y)
...
rewind 11
read(11,*) k
if (any(k/=1)) print *,30331
read(11,*) k
if (any(k/=1)) print *,30332
read(11,*) k
if (any(k/=10)) print *,30333
end
