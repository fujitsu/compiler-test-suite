...
real(8),parameter,dimension(4:7)::b1=a1,b2=a2
real(16),parameter,dimension(4:7)::b3=a1,b4=a2
real(4),parameter,dimension(4:7)::b5=a1,b6=a2
...
complex(8),parameter,dimension(4)::x1=dot_product(d1,d2)
complex(8),parameter,dimension(4)::x2=dot_product(vector_b=d4,vector_a=d1)
complex(8),parameter,dimension(4)::x3=dot_product(vEctor_a=d3,Vector_b=d2)
complex(8),parameter,dimension(4)::x4=dot_product(d5,d2)
