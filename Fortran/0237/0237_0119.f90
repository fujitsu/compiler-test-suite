...
flag=0
v00(kk)%x01=1
if (v00(kk)%t_prc01(2 )/= 4) print *,'error-001' 
if (flag/=1)print *,201
if (v00(kk)%t_prc02(2 )/= 4) print *,'error-002' 
if (flag/=2)print *,202
if (v00(kk)%prc03(2 )/= 4) print *,'error-003' 
if (flag/=3)print *,203
end do
end subroutine
...
flag=0
v00(kk)%x01=2
if (v00(kk)%t_prc01(2 )/= 9) print *,'error-011' 
if (flag/=1)print *,204
if (v00(kk)%t_prc02(2 )/= 9) print *,'error-012' 
if (flag/=2)print *,205
if (v00(kk)%prc03(2 )/= 9) print *,'error-013' 
if (flag/=3)print *,206
end do
end subroutine
end
