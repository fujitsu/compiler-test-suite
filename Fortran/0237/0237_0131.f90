...
write (1,*) ((( ncnt(k1,k2,k3), k1=1,n3),k2=1,n4),k3=n1,n5 ) 
write(1,*)  ncnt(:3,:4,:5)
write (2,*) ((( ncnt(k1,k2,k3), k1=n2-1,n3),k2=1,n4),k3=n1,n5 ) 
write (2,*) ((( ncnt(k1,k2+n1,k3), k1=n2-1,n3),k2=0,n3),k3=n1,n5 ) 
write (2,*) ncnt(n2-1:n3,0+n1:n4,n1:n5)
end
call       s1(1,2,3,4,5)
call chk
print *,'pass'
