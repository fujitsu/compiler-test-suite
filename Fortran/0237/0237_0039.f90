...
write(1,'(z16.16)')a8
write(1,'(z16.16)')b8
write(1,'(z16.16)')mod(-huge(1._8)-1._8,-1._8)
write(1,'(z32.32)')a
write(1,'(z32.32)')b
write(1,'(z32.32)')mod(-huge(1._16)-1._16,-1._16)
call chk
print *,'pass'
end
subroutine chk
...
rewind 1
read (1,'(a)') r2;if (r2/=fa)print *,101
read (1,'(a)') r2;if (r2/=fa)print *,102
read (1,'(a)') r2;if (r2/=fb)print *,103
read (1,'(a)') r1;if (r1/=fc)print *,121
read (1,'(a)') r1;if (r1/=fc)print *,122
read (1,'(a)') r1;if (r1/=fd)print *,123
end
