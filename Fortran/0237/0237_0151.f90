module m1
  ...
  integer::flag
contains
 function   prc00z(x) result(kk)
 entry      prc00(x) result(kk)
 ...
 function   prc01z(x,y) result(kk)
 entry      prc01w(x,y) result(kk)
 entry      prc01(x,y) result(kk)
   class(x0),intent(in)::x
   integer,intent(in)::y
   select type(x)
    type is(x0)
 ...
 function   prc03w(x,y) result(kk)
 entry      prc03t(x,y) result(kk)
 entry      prc03(x,y) result(kk)
 entry      prc03z(x,y) result(kk)
   class(x0),intent(in)::x
 ...
 function   prc10w(x) result(kk)
 entry      prc10z(x) result(kk)
 entry      prc10(x) result(kk)
 ...
 function   prc13w(x,y) result(kk)
 entry      prc13(x,y) result(kk)
   class(x1),intent(in)::x
   integer(8),intent(in)::y
   select type(x)
    type is(x1)
