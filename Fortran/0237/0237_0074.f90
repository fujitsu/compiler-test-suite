...
real(4),parameter,dimension(4:7)::b1=a1,b2=a2
real(8),parameter,dimension(4:7)::b3=a1,b4=a2
real(16),parameter,dimension(4:7)::b5=a1,b6=a2
complex(4),parameter,dimension(4)::d1=cmplx(b1,b1,4),d2=cmplx(b2,b2,4)
complex(8),parameter,dimension(4)::d3=cmplx(b1,b1,8),d4=cmplx(b2,b2,8)
complex(16),parameter,dimension(4)::d5=cmplx(b1,b1,16),s6=cmplx(b2,b2,16)
complex(4),parameter,dimension(4)::x1=dot_product(b1,b2)
complex(4),parameter,dimension(4)::x2=dot_product(vector_b=b4,vector_a=b1)
complex(4),parameter,dimension(4)::x3=dot_product(vEctor_a=b3,Vector_b=b2)
complex(4),parameter,dimension(4)::x4=dot_product(b5,b2)
...
complex(4),dimension(4):: y1,y2,y3,y4
