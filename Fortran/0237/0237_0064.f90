...
real(16),parameter:: b1(3,4)= reshape([(k,k=1,24)],[3,4])
real(16),parameter:: b2(4,3)= reshape([(k,k=1,24)],[4,3])
real(16),parameter:: b3(3)= reshape([(k,k=1,24)],[3])
real(16),parameter:: b4(4)= reshape([(k,k=1,24)],[4])
