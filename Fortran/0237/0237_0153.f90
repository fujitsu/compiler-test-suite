...
contains
 ...
 function   prc01w(x,y) result(kk)
 entry      prc01(x,y) result(kk)
 entry      prc01z(x,y) result(kk)
   class(x0),intent(in)::x
   integer,intent(in)::y
   select type(x)
    type is(x0)
 ...
 function   prc02w(x,y) result(kk)
 entry      prc02q(x,y) result(kk)
 ...
 function   prc12w(x) result(kk)
 entry      prc12(x,y) result(kk)
 entry      prc12z() result(kk)
   class(x1),intent(in)::x
   integer(1) ,intent(in)::y
   select type(x)
    type is(x1)
