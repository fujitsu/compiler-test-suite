...
contains
   impure elemental subroutine s0(xx,yy,zz)
   type(x),intent(out)::xx,yy,zz
   optional::xx,zz
    call s2(xx,yy,zz)
   end subroutine
   impure elemental subroutine s1(a1,a2,a3)
   entry      s2(a1,a2,a3)
