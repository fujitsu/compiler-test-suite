     ...
     1        z0(10),z1(10),z2(10),z3(10),z4(10)
      ...
      enddo
      do i=1,10
         x0(i)=x1(i)*y1(i)+x2(i)*y2(i)+x3(i)*x3(i)+x4(i)*y4(i)
         y0(i)=y1(i)*z1(i)+y2(i)*z2(i)+y3(i)*z3(i)+y4(i)*z4(i)
         z0(i)=z1(i)*x1(i)+z2(i)*x2(i)+z3(i)*x3(i)+z4(i)*x4(i)
      enddo
      res=0
      do i=1,10
