...
contains
  ...
  subroutine hsysssrrrr(tttttyyy)
    ...
    real(8):: a(6)
    integer::k
    write(61,*      ) tttttyyy%shshys1, tttttyyy%hhuustts2, tttttyyy%kkskhsss3, tttttyyy%hshshuss4, tttttyyy%jhshsyss5, tttttyyy%ssshhhk
     rewind 61
    read(61,*) a
...
contains
  ...
  subroutine hsysssrrrr(tttttyyy)
    ...
    real(8)::a(6)
    write(62,*          ) tttttyyy%shshys1, tttttyyy%hhuustts2, tttttyyy%kkskhsss3, tttttyyy%hhysstssr1, tttttyyy%yysysssr2, tttttyyy%hsysysr3
    rewind 62
    read(62,*) a
    if (any(abs(a-[0.3,0.3,0.3,0.6,1.0,0.6])>0.001)) print *,87722,a
  end subroutine hsysssrrrr 
...
contains
  ...
  subroutine hsysyssswww(tttttyyy, hyyyssssss, hshshiiis, hhshyysssuuu, hgststsnnn, hsysssqqq)
    ...
    case(2)
   block
  type(type_mod04ypppss), allocatable :: tp_
    allocate( tp_ )
    tp_%shshys1 = hyyyssssss%shshys1
    tp_%hhuustts2 = hyyyssssss%hhuustts2
    tp_%kkskhsss3 = hyyyssssss%kkskhsss3
    tp_%hhysstssr1 = hyyyssssss%hhysstssr1
    tp_%yysysssr2 = rrrrrhsys
    tp_%hsysysr3 = hyyyssssss%hsysysr3
    call move_alloc(tp_, tttttyyy%kksksssspppp)
    end block
