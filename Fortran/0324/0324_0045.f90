...
type(ty1) :: a
a%b=1
call sub06(a%b(1),100)
end
subroutine sub06(a,j)
integer a(j)
...
type(ty1) :: a(1)
a(1)%b=1
call sub07(a(1)%b,100)
end
subroutine sub07(a,j)
integer a(j)
...
type(ty1) :: a(1)
a(1)%b(1)=1
call sub08(a(1)%b,100)
end
subroutine sub08(a,j)
integer a(j)
...
subroutine test09()
call sub09(int(1),100)
end
subroutine sub09(a,j)
integer a(j)
