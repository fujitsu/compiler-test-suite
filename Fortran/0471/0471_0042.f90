...
subroutine sub1()
           ...
           integer(1) ,pointer :: ptr1(:,:)=>tar1(1:10,1:20)
           integer(2) ,pointer :: ptr2(:,:)=>tar2(1:10,1:20)
           integer(4) ,pointer :: ptr3(:,:)=>tar3(1:10,1:20)
           integer(8) ,pointer :: ptr4(:,:)=>tar4(1:10,1:20)
           logical(1) ,pointer :: ptr5(:,:)=>tar5(1:10,1:20)
           logical(2) ,pointer :: ptr6(:,:)=>tar6(1:10,1:20)
           logical(4) ,pointer :: ptr7(:,:)=>tar7(1:10,1:20)
           logical(8) ,pointer :: ptr8(:,:)=>tar8(1:10,1:20)
           real   (4) ,pointer :: ptr9(:,:)=>tar9(1:10,1:20)
           real   (8) ,pointer :: ptra(:,:)=>tara(1:10,1:20)
           real   (16),pointer :: ptrb(:,:)=>tarb(1:10,1:20)
           complex(4) ,pointer :: ptrc(:,:)=>tarc(1:10,1:20)
           complex(8) ,pointer :: ptrd(:,:)=>tard(1:10,1:20)
           complex(16),pointer :: ptre(:,:)=>tare(1:10,1:20)
           character  ,pointer :: ptrf(:,:)=>tarf(1:10,1:20)
