subroutine ss(a01,a02,a03,a04,a05,a11,a12,a13,a14,a15,k1,k2,k3,k4)
integer::a01(k2:k3)
...
namelist /nam/a01,a02,a03,a04,a05
...
integer::a15(k3:k3,k4-k1:k4-k1,k2:k3-k1,k2:k3,k1:k3)
do k=1,10
call       ss(a01,a02,a03,a04,a05,a11,a12,a13,a14,a15,k1,k2,k3,k4)
end do
call     chk(a01,a02,a03,a04,a05,a11,a12,a13,a14,a15,k1,k2,k3,k4)
end
call s1
print *,'pass'
end
subroutine chk(a01,a02,a03,a04,a05,a11,a12,a13,a14,a15,k1,k2,k3,k4)
integer::a01(k2:k3)
integer::a02(k2:k3,k1:k3)
integer::a03(k2:k3-k1,k2:k3,k1:k3)
integer::a04(k4-k1:k4-k1,k2:k3-k1,k2:k3,k1:k3)
