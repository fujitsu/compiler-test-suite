...
ww2(2)%z3(2)%y1(2)%x1(2)=1
ww2(2)%z3(2)%y1(2)%x1(2)=w2(2)%z3(2)%y1(2)%x1(2)+1
if (w2(2)%z3(2)%y1(2)%x1(2)/=2) print *,101
if (ww2(2)%z3(2)%y1(2)%x1(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y1(2)%x1(2),1)
call ss1(ww2(2)%z3(2)%y1(2)%x1(2),2)
w2(2)%z3(2)%y1(2)%x2(2)=0
ww2(2)%z3(2)%y1(2)%x2(2)=1
ww2(2)%z3(2)%y1(2)%x2(2)=w2(2)%z3(2)%y1(2)%x2(2)+1
if (w2(2)%z3(2)%y1(2)%x2(2)/=2) print *,101
if (ww2(2)%z3(2)%y1(2)%x2(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y1(2)%x2(2),1)
call ss1(ww2(2)%z3(2)%y1(2)%x2(2),2)
w2(2)%z3(2)%y1(2)%x3(2)=0
ww2(2)%z3(2)%y1(2)%x3(2)=1
ww2(2)%z3(2)%y1(2)%x3(2)=w2(2)%z3(2)%y1(2)%x3(2)+1
if (w2(2)%z3(2)%y1(2)%x3(2)/=2) print *,101
if (ww2(2)%z3(2)%y1(2)%x3(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y1(2)%x3(2),1)
call ss1(ww2(2)%z3(2)%y1(2)%x3(2),2)
w2(2)%z3(2)%y2(2)%x1(2)=0
ww2(2)%z3(2)%y2(2)%x1(2)=1
ww2(2)%z3(2)%y2(2)%x1(2)=w2(2)%z3(2)%y2(2)%x1(2)+1
if (w2(2)%z3(2)%y2(2)%x1(2)/=2) print *,101
if (ww2(2)%z3(2)%y2(2)%x1(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y2(2)%x1(2),1)
call ss1(ww2(2)%z3(2)%y2(2)%x1(2),2)
call ss2(w2(2)%z3(2),1)
call ss2(ww2(2)%z3(2),2)
w2(2)%z3(2)%y2(2)%x2(2)=0
ww2(2)%z3(2)%y2(2)%x2(2)=1
ww2(2)%z3(2)%y2(2)%x2(2)=w2(2)%z3(2)%y2(2)%x2(2)+1
if (w2(2)%z3(2)%y2(2)%x2(2)/=2) print *,101
if (ww2(2)%z3(2)%y2(2)%x2(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y2(2)%x2(2),1)
call ss1(ww2(2)%z3(2)%y2(2)%x2(2),2)
w2(2)%z3(2)%y2(2)%x3(2)=0
ww2(2)%z3(2)%y2(2)%x3(2)=1
ww2(2)%z3(2)%y2(2)%x3(2)=w2(2)%z3(2)%y2(2)%x3(2)+1
if (w2(2)%z3(2)%y2(2)%x3(2)/=2) print *,101
if (ww2(2)%z3(2)%y2(2)%x3(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y2(2)%x3(2),1)
call ss1(ww2(2)%z3(2)%y2(2)%x3(2),2)
w2(2)%z3(2)%y3(2)%x1(2)=0
ww2(2)%z3(2)%y3(2)%x1(2)=1
ww2(2)%z3(2)%y3(2)%x1(2)=w2(2)%z3(2)%y3(2)%x1(2)+1
if (w2(2)%z3(2)%y3(2)%x1(2)/=2) print *,101
if (ww2(2)%z3(2)%y3(2)%x1(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y3(2)%x1(2),1)
call ss1(ww2(2)%z3(2)%y3(2)%x1(2),2)
w2(2)%z3(2)%y3(2)%x2(2)=0
ww2(2)%z3(2)%y3(2)%x2(2)=1
ww2(2)%z3(2)%y3(2)%x2(2)=w2(2)%z3(2)%y3(2)%x2(2)+1
if (w2(2)%z3(2)%y3(2)%x2(2)/=2) print *,101
if (ww2(2)%z3(2)%y3(2)%x2(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y3(2)%x2(2),1)
call ss1(ww2(2)%z3(2)%y3(2)%x2(2),2)
w2(2)%z3(2)%y3(2)%x3(2)=0
ww2(2)%z3(2)%y3(2)%x3(2)=1
ww2(2)%z3(2)%y3(2)%x3(2)=w2(2)%z3(2)%y3(2)%x3(2)+1
if (w2(2)%z3(2)%y3(2)%x3(2)/=2) print *,101
if (ww2(2)%z3(2)%y3(2)%x3(2)/=2) print *,101
call ss1(w2(2)%z3(2)%y3(2)%x3(2),1)
call ss1(ww2(2)%z3(2)%y3(2)%x3(2),2)
