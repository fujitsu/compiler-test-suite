...
character(2)::d(2,3)
allocate(a,f)
call s1(2,b,a,3,c,d,e,f)
call s2(2,b,a,3,c,d,e,f)
call s3(2,b,a,3,c,d,e,f)
contains
subroutine s1(i,b,a,j,c,d,e,f)
integer,allocatable::a
integer,pointer    ::f
integer         :: b(i:j,j:j+2),c(2,3),e(:,:)
character(*)::d(:,:)
namelist /nam/ b,a,x,c,y,d,e,f
...
subroutine s3(i,b,a,j,c,d,e,f)
character(*)::d(:,:)
integer,allocatable::a
integer,pointer    ::f
integer         :: b(i:j,j:j+2),c(2,3),e(:,:)
namelist /nam/ b,a,x,c,y,e,d,f
!$omp parallel
do k=i,2
...
integer:: b(2,3),a,x,c(2,3),y(2,3),e(2,3),f
