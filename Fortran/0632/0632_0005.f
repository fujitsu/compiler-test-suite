   ...
   60 CONTINUE
      ...
      IF (SUM(V).NE.(659539.000,0.00000000)) PRINT *,'NG9'
      IF (SUM(W).NE.(505000.000,0.00000000)) PRINT *,'NG10'
      IF (SUM(X).NE.(505000.0000000000,0.000000000000000))
     1 PRINT *,'NG11'
      IF (SUM(Y).NE.(1105615.000000000,0.000000000000000))
     1 PRINT *,'NG12'
      PRINT *,'*** OK ***'
      END
