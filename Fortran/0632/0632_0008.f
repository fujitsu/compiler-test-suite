   ...
   60 CONTINUE
      IF (SUM(A).NE.5275) PRINT *,'NG1'
      IF (SUM(B).NE.3600) PRINT *,'NG2'
      IF (SUM(C).NE.4400) PRINT *,'NG3'
      IF (SUM(D).NE.8731) PRINT *,'NG4'

      IF (SUM(O).NE.3600.000000000000D0) PRINT *,'NG6'
      IF (SUM(P).NE.4400.00000) PRINT *,'NG7'

      IF (ABS(SUM(V)-(6500.835109958249D0,0.000000000000000))>1.0E-6)
     1 PRINT *,'NG9'
      IF (SUM(W).NE.(4400.000000000000,0.000000000000000))
     1 PRINT *,'NG10'
      IF (SUM(X).NE.(3600.000000000000,0.000000000000000))
     1 PRINT *,'NG11'
      IF (ABS(SUM(Y)-(8945.626332468673D0,0.000000000000000))>1.0E-6)
     1 PRINT *,'NG12'
      PRINT *,'*** OK ***'
      END
