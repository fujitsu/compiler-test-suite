   ...
   10 CONTINUE
      ...
      IF (SUM(A).NE.3780) PRINT *,'NG1'
      IF (SUM(B).NE.1350) PRINT *,'NG2'
      IF (SUM(C).NE.   0) PRINT *,'NG3'
      IF (SUM(D).NE.3640) PRINT *,'NG4'
      IF (SUM(E).NE.   0) PRINT *,'NG5'

      IF (SUM(G).NE.0.0) PRINT *,'NG7'
      IF (SUM(H).NE.-1350.00000) PRINT *,'NG8'

      IF (SUM(P).NE.0.0) PRINT *,'NG10'
      IF (ABS(SUM(Q)-(27586.24724314925D0,11362.02752686299D0))>1.0E-6)
     1 PRINT *,'NG11'
      IF (SUM(R).NE.(0.000000000000000D0,24300.00000000000D0))
     1 PRINT *,'NG12'
      PRINT *,'*** OK ***'
      END
