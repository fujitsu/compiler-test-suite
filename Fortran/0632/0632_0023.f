   ...
   30 CONTINUE
      ...
      IF (ABS(SUM(B)-5.13016504E+10)>1.0E+8) PRINT *,'NG SUB02-03-B'
   ...
   30 CONTINUE
      ...
      IF (ABS(SUM(B)-5.13036902E+10)>1.0E+8) PRINT *,'NG SUB03-03-B'
   ...
   10 CONTINUE
      ...
      IF (ABS(SUM(A)-5.13036902E+10)>1.0E+9) PRINT *,'NG MAIN-A'
      IF (ABS(SUM(B)-5.13036902E+10)>1.0E+9) PRINT *,'NG MAIN-B'
