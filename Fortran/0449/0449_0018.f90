...
allocate(a)
   if (a%z1%y1/=1) print *,801
   if (a%z1%y2/=1) print *,801
   if (a%y1%y3/=1) print *,801
   if (a%y1%y4/=1) print *,801
   if (a%z1%ww%y5/=1) print *,801
   if (a%z1%ww%y6/=1) print *,801
   allocate ( &
     a%z1%x1(n),a%z1%x2(n*n),a%y1%x3(n),a%y1%x4(n*n),a%z1%ww%x5(n),a%z1%ww%x6(n*n),stat=k)
   if (k/=0) stop 1000
   write(31,'(z16.16)') loc(a%z1%x1)
  end subroutine
end
use m1
