 ...
 subroutine ss1
 logical(1),dimension(3)::a11v,a12v
 logical(4),dimension(3)::a21v,a22v
 real(16)  ,dimension(3)::b11v,b12v
 integer(8),dimension(3)::b21v,b22v
 complex(16),dimension(3)::b31v,b32v
 logical ::nn
 real(16)::rr
 integer(8)::ii
 complex(16)::cx,cy
...
!
   ...
   cx=sum(conjg(b31v)*cmplx(b22v)); cy=sum(conjg(cmplx(b21v))*b32v)
