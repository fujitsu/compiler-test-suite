     ...
     +       -11,-12,13,14,-15,-16/
      ...
      do i=1,16
         i4a(i) = sign(abs(i4b(1)),i4c(i))
      enddo
      write(1,*)
      do i=1,16
         r4a(i) = sign(abs(r4b(1)),r4c(i))
      enddo
      write(1,*)
      do i=1,16
         r8a(i) = sign(abs(r8b(1)),r8c(i))
      enddo
      write(1,*)
 ...
 20   continue
      ...
      do i=1,16
         i4a(i) = sign(i4b(i),abs(i4c(1)))
      enddo
      write(1,*)
      do i=1,16
         r4a(i) = sign(r4b(i),abs(r4c(1)))
      enddo
      write(1,*)
      do i=1,16
         r8a(i) = sign(r8b(i),abs(r8c(1)))
      enddo
      write(1,*)
