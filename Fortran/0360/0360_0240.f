      ...
      do i=1,10
         r8a1 = max(r8a1,abs(r4b(i)),r8c(i))
         r4a2 = min(r4a2,r4b(i),abs(r8c(i)))
      enddo
      r8a(1) = r8a1
      r4a(2) = r4a2

      do i=1,10
         r4a3 = max(r4a3,abs(r8b(i)),r4c(i))
         r8a4 = min(r8a4,r8b(i),abs(r4c(i)))
      enddo
      r4a(3) = r4a3
      r8a(4) = r8a4

      do i=1,10
         r8a5 = max(r8a5,abs(r8b(i)),r4c(i))
         r4a6 = min(r4a6,r8b(i),abs(r4c(i)))
      enddo
      ...
      do i=1,10
         r4a7 = max(r4a7,abs(r4b(i)),r8c(i))
         r8a8 = min(r8a8,r4b(i),abs(r8c(i)))
      enddo

      r4a(7) = r4a7
      r8a(8) = r8a8
      do i=1,10
         r8a9 = max(r8a9,abs(r8b(i)),r4c(i))
         r4a10 = min(r4a10,r8b(i),abs(r4c(i)))
      enddo
      r8a(9) = r8a9
      r4a(10) = r4a10
 ...
 20   continue
      ...
      do i=1,10
         r4a1 = max(r4a1,abs(r8b(i)),r8c(i))
         r8a2 = min(r8a2,r4b(i),abs(r4c(i)))
      enddo
      ...
      do i=1,10
         r8a3 = max(r8a3,abs(r4b(i)),r4c(i))
         r4a4 = min(r4a4,r8b(i),abs(r8c(i)))
      enddo

      r8a(3) = r8a3
      r4a(4) = r4a4
      do i=1,10
         r4a5 = max(r4a5,abs(r8b(i)),r8c(i))
         r8a6 = min(r8a6,r4b(i),abs(r4c(i)))
      enddo

      r4a(5) = r4a5
      r8a(6) = r8a6
      do i=1,10
         r8a7 = max(r8a7,abs(r4b(i)),r4c(i))
         r4a8 = min(r4a8,r8b(i),abs(r8c(i)))
      enddo

      r8a(7) = r8a7
      r4a(8) = r4a8
      do i=1,10
         r4a9 = max(r4a9,abs(r8b(i)),r8c(i))
         r8a10 = min(r8a10,r4b(i),abs(r4c(i)))
      enddo
      r4a(9) = r4a9
      r8a(10) = r8a10
