     ...
     +     .true.,.true.,.true.,.true./
      ...
      do i=1,19
         if (mask(i)) r4x(1) = r4a(i)
      enddo
      write(6,*) r4x(1)
      do i=1,n
         if (mask(i)) r4x(2) = r4a(i)
      enddo
      write(6,*) r4x(2)

      do i=1,19
         if (mask(i)) r8x(1) = r8a(i)
      enddo
      write(6,*) r8x(1)
      do i=1,n
         if (mask(i)) r8x(2) = r8a(i)
      enddo
      write(6,*) r8x(2)
      end
      ...
      do i=1,19
         if (mask(i)) r4x(1) = r8a(i)
      enddo
      write(6,*) r4x(1)
      do i=1,n
         if (mask(i)) r4x(2) = r8a(i)
      enddo
      write(6,*) r4x(2)

      do i=1,19
         if (mask(i)) r8x(1) = r4a(i)
      enddo
      write(6,*) r8x(1)
      do i=1,n
         if (mask(i)) r8x(2) = r4a(i)
      enddo
      write(6,*) r8x(2)
      end
