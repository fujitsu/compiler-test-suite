      ...
      integer*1 d(10)/10*-1/
      integer*1 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
      i1 = 0
      ...
      integer*2 d(10)/10*-1/
      integer*2 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
      ...
      integer*4 d(10)/10*-1/
      integer*4 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
      ...
      integer*8 d(10)/10*-1/
      integer*8 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
      ...
      real*4 d(10)/10*-1/
      real*4 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
      ...
      real*8 d(10)/10*-1/
      real*8 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
      ...
      real*16 d(10)/10*-1/
      real*16 res(10)/1,-1,8,7,5,-1,7,3,9,1/
      do i=1,10
         a(i) = max(b(i),c(i),d(i))  
      end do
