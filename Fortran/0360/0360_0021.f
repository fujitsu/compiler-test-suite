     ...
     +     .true.,.true.,.true.,.true./
      ...
      do i=1,19
         if (mask(i)) i4x(1) = i4a(i)
      enddo
      write(6,*) i4x(1)
      do i=1,n
         if (mask(i)) i4x(2) = i4a(i)
      enddo
      write(6,*) i4x(2)

      do i=1,19
         if (mask(i)) i8x(1) = i8a(i)
      enddo
      write(6,*) i8x(1)
      do i=1,n
         if (mask(i)) i8x(2) = i8a(i)
      enddo
      write(6,*) i8x(2)
      end
      ...
      do i=1,19
         if (mask(i)) i4x(1) = i8a(i)
      enddo
      write(6,*) i4x(1)
      do i=1,n
         if (mask(i)) i4x(2) = i8a(i)
      enddo
      write(6,*) i4x(2)

      do i=1,19
         if (mask(i)) i8x(1) = i4a(i)
      enddo
      write(6,*) i8x(1)
      do i=1,n
         if (mask(i)) i8x(2) = i4a(i)
      enddo
      write(6,*) i8x(2)
      end
