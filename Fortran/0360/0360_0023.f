     ...
     +     .true.,.true.,.true.,.true./
      ...
      do i=1,19
         if (mask(i)) l4x(1) = l4a(i)
      enddo
      write(6,*) l4x(1)
      do i=1,n
         if (mask(i)) l4x(2) = l4a(i)
      enddo
      write(6,*) l4x(2)

      do i=1,19
         if (mask(i)) l8x(1) = l8a(i)
      enddo
      write(6,*) l8x(1)
      do i=1,n
         if (mask(i)) l8x(2) = l8a(i)
      enddo
      write(6,*) l8x(2)
      end
      ...
      do i=1,19
         if (mask(i)) l4x(1) = l8a(i)
      enddo
      write(6,*) l4x(1)
      do i=1,n
         if (mask(i)) l4x(2) = l8a(i)
      enddo
      write(6,*) l4x(2)

      do i=1,19
         if (mask(i)) l8x(1) = l4a(i)
      enddo
      write(6,*) l8x(1)
      do i=1,n
         if (mask(i)) l8x(2) = l4a(i)
      enddo
      write(6,*) l8x(2)
      end
