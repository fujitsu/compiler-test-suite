      ...
      enddo
      if (r4.ne.100)  write(6,*) "test1 ",r4
      r4 = 200
      do i=1,16
         r4 = max(r4,imag(c8a(i)))
      enddo
      if (r4.ne.200) write(6,*) "test2 ",r4
      r4 = -100
      do i=1,16
         r4 = min(r4,real(c8a(i)))
      enddo
      if (r4.ne.-100) write(6,*) "test3 ",r4
      r4 = -200
      do i=1,16
         r4 = min(r4,imag(c8a(i)))
      enddo
      if (r4.ne.-200) write(6,*) "test4 ",r4
      ...
      enddo
      if (r8.ne.100) write(6,*) "test5 ",r8
      r8 = 200
      do i=1,16
         r8 = max(r8,dimag(c16a(i)))
      enddo
      if (r8.ne.200) write(6,*) "test6 ",r8
      r8 = -100
      do i=1,16
         r8 = min(r8,dreal(c16a(i)))
      enddo
      if (r8.ne.-100) write(6,*) "test7 ",r8
      r8 = -200
      do i=1,16
         r8 = min(r8,dimag(c16a(i)))
      enddo
      if (r8.ne.-200) write(6,*) "test8 ",r8
      end
