...
real(k),pointer:: p1(:,:),p2(:,:),p3(:,:),p4(:,:),p5(:,:)
real(k),pointer:: w1(:,:),w2(:,:),w3(:,:)
contains
subroutine s000(p1,w1,w2,w3)
real(k):: w1(3,3),w2(:,:),w3(:,:)
real(k):: p1(:,:)
w1=matmul(w2,w3)+p1
if (any(abs([w1-r1]-&
...
allocate(p3(3*3,3),source=0._k)
allocate(p4(3*3,3),source=0._k)
allocate(p5(3*3,3),source=0._k)
p1=>p2(1:5:2,:)
w1=>p3(1:5:2,:)
w2=>p4(1:5:2,:)
w3=>p5(1:5:2,:)
...
w2=r1
w3=r1
call s000(p1,w1,w2,w3)
w1=0
w2=r1
call s001(p1,w1,w2,w3)
w1=0
w2=r1
call s002(p1,w1,w2,w3)
w1=r1
w2=r1
call s003(p1,w1,w2,w3)
print *,'pass'
end
