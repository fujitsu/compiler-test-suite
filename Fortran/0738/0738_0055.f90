...
subroutine test()
  ...
  a%ya(2:1:-1,2:1:-1) = b%ya(1:2:1,1:2:1)
  ...
  if (any(a%ya(2,2)%zi/=(/1,2,3/))) write(6,*) "NG"
  if (any(a%ya(2,1)%zi/=(/1,2,3/))) write(6,*) "NG"
  if (any(a%ya(1,2)%zi/=(/2,3,4/))) write(6,*) "NG"
  if (any(a%ya(1,1)%zi/=(/2,3,4/))) write(6,*) "NG"
  ...
  if (abs(a%ya(2,2)%zr(1)-2.0D0).gt.1.0D-5) write(6,*) "NG"
  if (abs(a%ya(2,1)%zr(1)-3.0D0).gt.1.0D-5) write(6,*) "NG"
  if (abs(a%ya(1,2)%zr(1)-3.0D0).gt.1.0D-5) write(6,*) "NG"
  if (abs(a%ya(1,1)%zr(1)-4.0D0).gt.1.0D-5) write(6,*) "NG"
  if (any(a%ya(2,2)%za/=(/1,1/))) write(6,*) "NG"
  if (any(a%ya(2,1)%za/=(/2,2,2/))) write(6,*) "NG"
  if (any(a%ya(1,2)%za/=(/2,2,2/))) write(6,*) "NG"
  if (any(a%ya(1,1)%za/=(/4,4,4,4,4/))) write(6,*) "NG"
