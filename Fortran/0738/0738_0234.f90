...
program main
 use mod
 interface
  subroutine sub(a,b,ss,cc,qq,sv1,sv2,sv3,sv4)
   use mod
   ...
   intent(inout)::a
   intent(in)::b,ss,cc,qq,sv1,sv2,sv3,sv4
  end subroutine
 end interface
   type(x)   ,allocatable,dimension(:)::a
   type(z)   ,allocatable,dimension(:)::b
   ...
   call sub(a,b,ss,cc,qq,sv1,sv2,sv3,sv4)

   deallocate(sv1,sv2,sv3,sv4,ss,cc,qq,b)
