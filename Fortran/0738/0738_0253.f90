...
type z03
  type(z02),allocatable,dimension(:)::z03a
end type
type z04
...
type z06
  type(z05),allocatable,dimension(:)::z06a
end type
type z07
...
type z09
  type(z08),allocatable,dimension(:)::z09a
end type
type z10
...
complex(16),allocatable,dimension(:)::x1c16,x2c16
  ...
  allocate(a(1)%z10a(1))
  allocate(a(1)%z10a(1)%z09a(1))
  allocate(a(1)%z10a(1)%z09a(1)%z08a(1))
  allocate(a(1)%z10a(1)%z09a(1)%z08a(1)%z07a(1))
  allocate(a(1)%z10a(1)%z09a(1)%z08a(1)%z07a(1)%z06a(1))
