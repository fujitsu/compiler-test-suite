...
type(w)                           ::a,b
  ...
  if (.not.allocated(a%x_w1(2)%y_x1(1)%ya1)) write(6,*) "NG"
  ...
  if (     allocated(a%x_w1(1)%y_x1(1)%z_y2(1)%za1)) write(6,*) "NG"
  if (.not.allocated(a%x_w1(2)%y_x1(1)%z_y2(1)%za1)) write(6,*) "NG"
  if (.not.allocated(a%x_w1(1)%y_x1(1)%z_y2(2)%za1)) write(6,*) "NG"
  if (     allocated(a%x_w1(2)%y_x1(1)%z_y2(2)%za1)) write(6,*) "NG"
  if (.not.allocated(a%x_w1(1)%z_x2(1)%za1)) write(6,*) "NG"
  if (.not.allocated(a%x_w1(1)%z_x2(2)%za1)) write(6,*) "NG"
  if (.not.allocated(a%x_w1(2)%z_x2(1)%za1)) write(6,*) "NG"
  if (.not.allocated(a%x_w1(2)%z_x2(2)%za1)) write(6,*) "NG"
