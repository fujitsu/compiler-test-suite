...
type (z)                ,dimension(2,2,2,2)::a,b
  ...
  b(k1,k1,k1,k1) = a(k2,k2,k2,k2)
  b(k2,k2,k2,k2) = b(k1,k1,k1,k1)
  ...
  if (     allocated(b(1,1,2,1)%za)) write(6,*) "NG"
  ...
  if (.not.allocated(b(2,2,2,2)%za)) write(6,*) "NG"
  if (any(b(1,1,1,1)%za/=(/16,16/))) write(6,*) "NG"
  if (any(b(2,2,2,2)%za/=(/16,16/))) write(6,*) "NG"
