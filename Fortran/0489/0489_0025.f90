...
select type( b)
  type is(x2)
    ...
    if (any(b(n)%y2(1)%y02/=1)) write(1,*)211,n
    if (any(b(n)%y2(2)%y02/=1)) write(1,*)221,n
    write(1,'("b%x22 :",z16.16)') n,loc(b(n)%x22)
    write(1,'("b%y2(1)%y02 :",z16.16)') n,loc(b(n)%y2(1)%y02)
    write(1,'("b%y2(2)%y02 :",z16.16)') n,loc(b(n)%y2(2)%y02)
    k=1
  type is(x1)
    k=2
end select
...
select type( a)
  type is(x2)
    ...
    if (any(a(n)%y2(1)%y02/=1)) write(1,*)212,n
    if (any(a(n)%y2(2)%y02/=1)) write(1,*)222,n
    write(1,'("a%x22 :",z16.16)') n,loc(a(n)%x22)
    write(1,'("a%y2(1)%y02 :",z16.16)') n,loc(a(n)%y2(1)%y02)
    write(1,'("a%y2(2)%y02 :",z16.16)') n,loc(a(n)%y2(2)%y02)
    deallocate ( a(n)%x22 )
...
select type( b)
  type is(x2)
    ...
    if (any(b(n)%y2(1)%y02/=1)) write(1,*)"error 213a",n
    if (any(b(n)%y2(2)%y02/=1)) write(1,*)"error 223a",n
    write(1,'("b%x22 :",z16.16)') n, loc(b(n)%x22)
    write(1,'("b%y2(1)%y02 :",z16.16)') n,loc(b(n)%y2(1)%y02)
    write(1,'("b%y2(2)%y02 :",z16.16)') n,loc(b(n)%y2(2)%y02)
    k=1
