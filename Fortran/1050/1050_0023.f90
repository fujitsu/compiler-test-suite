...
subroutine bar(a,val1,val2,val3,val4,val5,val6)
  ...
  integer(4)::val1,val3,val5
  integer(8)::val2,val4,val6
...
subroutine sub01(init1,end1,step1,init2,end2,step2)
  integer(4) :: init1,end1,step1
  integer(8) :: init2,end2,step2
  common /my_global/ginit1,gend1,gstep1,ginit2,gend2,gstep2
  integer(8) :: linit1,lend1,lstep1
  integer(4) :: linit2,lend2,lstep2
  integer(4) :: i,k,m
  integer(8) :: j,l,n
