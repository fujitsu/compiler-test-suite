...
program main
  ...
  c=0
  d=0
  !$omp parallel sections private(a1,b1,now) firstprivate(a2,b2) lastprivate(a3,b3) reduction(+:a4,b4) copyin(a5,b5)
  !$omp section
  do i=1,n
  ...
  do i=1,n
     ...
     if (a1(i).ne.b1(i)) d(i,now)=d(i,now)+1
     if (a2(i).ne.b2(i)) d(i,now)=d(i,now)+1
     if (a3(i).ne.b3(i)) d(i,now)=d(i,now)+1
     if (a4(i).ne.b4(i)) d(i,now)=d(i,now)+1
     if (a5(i).ne.b5(i)) d(i,now)=d(i,now)+1
  end do
