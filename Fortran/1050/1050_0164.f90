...
program main
  ...
  b4=n
  c=0
  !$omp parallel private(a1,b1,now) firstprivate(a2,b2) reduction(+:a3,b3) copyin(a4,b4)
  do i=1,n
     ...
     a3(1,1,1,1,1,1,i)=a3(1,1,1,1,1,1,i)+i
     b3(1,1,1,1,1,1,i)=b3(1,1,1,1,1,1,i)+i
