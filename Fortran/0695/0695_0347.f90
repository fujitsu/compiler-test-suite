...
subroutine sub01(x,a,b,s,mask)
  use mod_data
  integer(kind=8) i,mask(77),ida
  real(kind=8) z, idx, a(77), b(77)
  real(kind=4) x
  logical(kind=8) s(77),u
  logical(kind=4) r(77)/77*.true./
...
program main
  ...
  logical(kind=8) s(77)/77*.false./, t(77)/77*.false./
  real(kind=8) b(77)/77*0/, d(77)/77*0/
  real(kind=4) x/0/,y/0/
