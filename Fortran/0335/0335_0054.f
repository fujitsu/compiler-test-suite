     ...
     *    66.0,69.0,63.0,72.0,75.0,69.0,14*0.0/
      ...
      M2 = 10
      M3 = 50
      CALL SUB07 (ANS,CNST,A,M1,M2,M3)
      STOP
      END
      SUBROUTINE SUB07 (ANS,CNST,A,M1,M2,M3)
      DIMENSION CNST(M3),ANS(50),A(M1,M2)
      X        =    0.0
      DO  1  I =    1,10
      DO  1  J =    1,10
      X        =    X+1.
    ...
    5 WRITE(6,103)
      STOP
  100 FORMAT(1H1/1H0,5X,40H* TEST OF OPTIMIZATION NO-7 ERROR LIST *//
