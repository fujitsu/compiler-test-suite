     ...
     *                             75,69,14*0/
      ...
      M2 = 10
      M3 = 50
      CALL     SUB06 (ANS,CNST,A,M1,M2,M3)
      STOP
      END
      SUBROUTINE SUB06 (ANS,CNST,A,M1,M2,M3)
      INTEGER*4    ANS(M3),CNST(50),A(M1,M2)
    ...
    5 WRITE(6,103)
      STOP
  100 FORMAT(1H1/1H0,40H* TEST OF OPTIMIZATION NO-6 ERROR LIST *//1H0,
