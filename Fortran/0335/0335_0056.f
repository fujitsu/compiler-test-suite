     ...
     *    141.0,135.0,69.0,72.0,66.0,78.0,81.0,75.0,14*0.0/
      ...
      M2 = 10
      M3 = 50
      CALL SUB09 (ANS,CNST,A,M1,M2,M3)
      STOP
      END
      SUBROUTINE SUB09 (ANS,CNST,A,M1,M2,M3)
      REAL*8    ANS(M3),CNST(M3),A(M1,M2)
   ...
   10 WRITE(6,103)
      STOP
  100 FORMAT(1H1/1H0,5X,40H* TEST OF OPTIMIZATION NO-9 ERROR LIST *//
