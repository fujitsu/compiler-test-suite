     ...
     *    26,32,26,32,86,92,86,92,30*0/
      ...
      M2 = 10
      M3 = 50
      CALL  SUB37 (ANS,CNST,A,M1,M2,M3)
      STOP
      END
      SUBROUTINE SUB37 (ANS,CNST,A,M1,M2,M3)
      INTEGER*4     ANS(M3),CNST(M3),A(M1,M2)
      N        =    1
      DO  1  I =    1,10
      DO  1  J =    1,10
      A(I,J)   =    N
    ...
    9 WRITE(6,103)
      RETURN
  100 FORMAT(1H1/1H0,5X,43H* TEST OF OPTIMIZATION ( NO-37 ) ERROR LIST,
