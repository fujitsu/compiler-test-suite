     ...
     *    64,222,224,262,264,4,8,24,28,204,208,224,228,11*0/
      M1 = 10
      M2 = 10
      CALL SUB32 ( ANS,CNST,A,M1,M2)
      STOP
      END
      SUBROUTINE  SUB32 (ANS,CNST,A,M1,M2)
      INTEGER*4    ANS(50),CNST(50),A(M2,10,M1)
      M        =    1
      DO  1  I =    1,10
      DO  1  J =    1,10
      DO  1  K =    1,10
    ...
    5 WRITE(6,103)
      RETURN
  100 FORMAT(1H1/1H0,5X,43H* TEST OF OPTIMIZATION ( NO-32 ) ERROR LIST,
