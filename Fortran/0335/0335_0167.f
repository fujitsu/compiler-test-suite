      ...
      DATA          ANS/50*0/,CNST/824,826,822,828,830,826,844,846,842,
     *    848,850,846,804,806,802,808,810,806,864,866,862,868,870,866,
     *    884,886,882,888,890,886,844,846,842,848,850,846,14*0/
      CALL     SUB23 (ANS,CNST,A)
      STOP
      END
      SUBROUTINE    SUB23 (ANS,CNST,A)
      INTEGER*4     ANS(50),CNST(50),A(10,10,10)
   ...
   10 WRITE(6,103)
      RETURN
  100 FORMAT(1H1/1H0,5X,43H* TEST OF OPTIMIZATION ( NO-23 ) ERROR LIST,
