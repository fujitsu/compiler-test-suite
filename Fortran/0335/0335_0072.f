      ...
      M1 = 10
      CALL     SUB26 (ANS,CNST,A,M1)
      STOP
      END
      SUBROUTINE SUB26 (ANS,CNST,A,M1)
      INTEGER*4     ANS(M1),CNST(M1),A(M1,M1,M1)
    ...
    5 WRITE(6,103)
      RETURN
  100 FORMAT(1H1/1H0,5X,43H* TEST OF OPTIMIZATION ( NO-26 ) ERROR LIST,
