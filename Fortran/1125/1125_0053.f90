 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
   ...
   if (ij==maxval(        reshape((/b1(1,1),b1(2,1),b1(1,2),b1(2,2),b1(1,3),b1(2,3)/),(/k2,k3/)) &
                 ,mask=reshape((/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/),(/k2,k3/)))) then;else ;print *,'fail';endif
   if (ij/=maxval(        reshape((/b2(1,1),b2(2,1),b2(1,2),b2(2,2),b2(1,3),b2(2,3)/),(/k2,k3/)) &
                 ,mask=reshape((/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/),(/k2,k3/)))) then;print *,'fail';else ;endif
