...
1  continue
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
   ...
   call zz(ij,maxval(b1(:,:,:,:,v1,v2) ,mask=a1(:,:,:,:,v1,v2)))
   call zz(ij,maxval(b2(:,:,:,:,v1,v2),mask=a1(:,:,:,:,v1,v2)))
   call zz(ij,maxval(b3(:,:,:,:,v1,v2),mask=a1(:,:,:,:,v1,v2)))
   ...
   call zz(ij,maxval(        reshape((/b3(n,n,n,n,1,1),b3(n,n,n,n,2,1),b3(n,n,n,n,1,2),b3(n,n,n,n,2,2),b3(n,n,n,n,1,3),b3(n,n,n,n,2,3)/),(/1,1,1,1,2,3/)) &
                           ,mask=reshape((/a1(n,n,n,n,1,1),a1(n,n,n,n,2,1),a1(n,n,n,n,1,2),a1(n,n,n,n,2,2),a1(n,n,n,n,1,3),a1(n,n,n,n,2,3)/),(/1,1,1,1,2,3/))))
   call zz(ij,maxval(b1*k1,mask=a1.and.a1))
   call zz(ij,maxval(b2*k1,mask=a1.and.a1))
   call zz(ij,maxval(b3,mask=a1.and.a1))
   call zz(ij,maxval(b1(:,:,:,:,:,:)*k1,mask=a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:)))
   call zz(ij,maxval(b2(:,:,:,:,:,:)*k1,mask=a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:)))
   call zz(ij,maxval(b3(:,:,:,:,:,:)*k1,mask=a1(:,:,:,:,:,:).and.a1(:,:,:,:,:,:)))
   call zz(ij,maxval(b1(:,:,:,:,v1,v2)*k1,mask=a1(:,:,:,:,v1,v2).and.a1(:,:,:,:,v1,v2)))
   call zz(ij,maxval(b2(:,:,:,:,v1,v2)*k1,mask=a1(:,:,:,:,v1,v2).and.a1(:,:,:,:,v1,v2)))
   call zz(ij,maxval(b3(:,:,:,:,v1,v2)*k1,mask=a1(:,:,:,:,v1,v2).and.a1(:,:,:,:,v1,v2)))
 end do; end do
