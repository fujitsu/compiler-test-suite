...
1  continue
 ...
 do i2=1,mm1; do i1=1,mm2
   ...
   b3(n,n,n,n,i1,i2)=c3(n,n,n,n,i1,i2)
   a1(n,n,n,n,i1,i2)=.true.;ik=ik+1;ij=maxval((/(i,i=1,ik)/))
   call zz(ij,maxval(b1        ))
   call zz(ij,maxval(b2        ))
   call zz(ij,maxval(b3        ))
   call zz(ij,maxval(b1        (:,:,:,:,:,:)))
   call zz(ij,maxval(b2        (:,:,:,:,:,:)))
   call zz(ij,maxval(b3        (:,:,:,:,:,:)))
   ...
   call zz(ij,maxval(b1(:,:,:,:,v1,v2)))
   call zz(ij,maxval(b2(:,:,:,:,v1,v2)))
   call zz(ij,maxval(b3(:,:,:,:,v1,v2)))
   call zz(ij,maxval(reshape((/b1(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,maxval(reshape((/b2(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   call zz(ij,maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
   ...
   call zz(ij,maxval(b1*k1))
   call zz(ij,maxval(b2*k1))
   call zz(ij,maxval(b3*k1))
   ...
   call zz(ij,maxval(b1(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,maxval(b2(:,:,:,:,v1,v2)*k1        ))
   call zz(ij,maxval(b3(:,:,:,:,v1,v2)*k1))
   call zz(ij,maxval(reshape((/b1(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,maxval(reshape((/b2(:,:,:,:,v1,v2)/)*k1,(/1,1,1,1,2,3/))))
   call zz(ij,maxval(reshape((/b3(:,:,:,:,v1,v2)/),(/1,1,1,1,2,3/))))
 end do; end do
 if (6/=count(a1))print *,'fail'
 end do
