...
1  continue
 ...
 do i2=1,mm1; do i1=1,mm2
  ...
  if (ij/=ik)print *,'fail'
   if (ij==maxval(b1,mask=reshape((/a2(:,:).and.a2(:,:)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij/=maxval(b2,mask=reshape((/a2(:,:).and.a2(:,:)/),(/2,3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==maxval(b3,mask=reshape((/a2(:,:).and.a2(:,:)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij==maxval(b1,mask=reshape((/a2(v1(1):v1(2),v2(1):v2(3)).and.&
                a2(v1(1):v1(2),v2(1):v2(3))/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij/=maxval(b2,mask=reshape((/a2(v1(1):v1(2),v2(1):v2(3)).and.&
                a2(v1(1):v1(2),v2(1):v2(3))/),(/2,3/)))) then;print *,'fail';else ;endif
   ...
   if (cmplx(ij,ij)==maxval(b3,mask=reshape((/a2(v1,v2).and.a2(v1,v2)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij==maxval(b1,mask=reshape((/(/a2(v1,v2)/).and.(/a2(v1,v2)/)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij/=maxval(b2,mask=reshape((/(/a2(v1,v2)/).and.(/a2(v1,v2)/)/),(/2,3/)))) then;print *,'fail';else ;endif
   if (cmplx(ij,ij)==maxval(b3,mask=reshape((/(/a2(v1,v2)/).and.(/a2(v1,v2)/)/),(/2,3/)))) then;else ;print *,'fail';endif
   ...
   if (ij/=maxval(b2,mask=reshape((/(/a2(1,1),a2(2,1),a2(1,2),a2(2,2),a2(1,3),a2(2,3)/).and.&
                (/a2(1,1),a2(2,1),a2(1,2),a2(2,2),a2(1,3),a2(2,3)/)/),(/2,3/)))) then;print *,'fail';else ;endif
   ...
   if (ij==maxval(        reshape((/b1(1,1),b1(2,1),b1(1,2),b1(2,2),b1(1,3),b1(2,3)/),(/2,3/)) &
                 ,mask=reshape((/a2(1,1),a2(2,1),a2(1,2),a2(2,2),a2(1,3),a2(2,3)/),(/2,3/)))) then;else ;print *,'fail';endif
   if (ij/=maxval(        reshape((/b2(1,1),b2(2,1),b2(1,2),b2(2,2),b2(1,3),b2(2,3)/),(/2,3/)) &
                 ,mask=reshape((/a2(1,1),a2(2,1),a2(1,2),a2(2,2),a2(1,3),a2(2,3)/),(/2,3/)))) then;print *,'fail';else ;endif
