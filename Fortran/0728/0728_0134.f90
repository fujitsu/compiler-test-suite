...
subroutine ss1(abc,it)
  ...
  call assignment1(b , (/(abc,i=1,500)/))
  if (any(b/=3))write(6,*) "NG"
  call assignment2(b , (/(abc,i=1,500)/))
  if (any(b/=4))write(6,*) "NG"
  call assignment1(b(500) , repeat(abc,it))
  if (b(500)/=3*5)write(6,*) "NG"
  call assignment3(b , (/(abc,i=1,500)/),*1,1)
  write(6,*) "NG"
  1 if (any(b/=1))write(6,*) "NG"
  call assignment3(b , (/(abc,i=1,500)/),*2,0)
