...
x1=0;x2=0;x3=0;x4=0;x5=0
  ...
  read (ubound(a,lbound(a,k)),*,end=1,err=1)x(lbound(a,lbound(a,k))),y(lbound(a,lbound(a,k))+1),(z(i),i=lbound(a,lbound(a,k)),2),(z(i),i=lbound(a,lbound(a,k))+2,lbound(a,lbound(a,k))+3,lbound(a,lbound(a,k)))
