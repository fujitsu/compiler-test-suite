...
select case(val%tag)
   case(1);write(10,*)transfer(val%element,(/1./))
   case (2);write(10,*)transfer(val%element,(/' '/))
end select
end subroutine
...
character*10 cc
rewind 10
read(10,*) i;if (i/=123)write(6,*) "NG"
read(10,*) a,b;if (abs(a-23.)>0.0001)write(6,*) "NG";if (abs(b-34.)>0.0001)write(6,*) "NG"
read(10,*) i;if (i/=1234567890)write(6,*) "NG"
read(10,*) a2,a3,a4,a5,a6,a7,a8,a9
if (any(abs((/a2,a3,a4,a5,a6,a7,a8,a9/)-(/(ii,ii=2,9)/))>0.000001))write(6,*) "NG"
read(10,*) a;if (abs(a-0.)>0.000001)write(6,*) "NG"
read(10,'(a)') cc;if (index(cc,'claudia')==0)write(6,*) "NG"
read(10,*) a;if (abs(a-3.14)>0.001)write(6,*) "NG"
read(10,'(a)') cc;if (index(cc,'d')==0)write(6,*) "NG"
read(10,*) a;if (abs(a-12.)>0.001)write(6,*) "NG"
read(10,*) a;if (abs(a-0.)>0.000001)write(6,*) "NG"
read(10,*) a;if (abs(a-0.)>0.000001)write(6,*) "NG"
read(10,*) a2,a3,a4,a5,a6,a7,a8,a9
if (any(abs((/a2,a3,a4,a5,a6,a7,a8,a9/)-(/(ii,ii=2,9)/))>0.000001))write(6,*) "NG"
