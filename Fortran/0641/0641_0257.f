     ...
     X  , RR11, RR10, RR9, RR8, RR7, RR6, RR5, RR4, RR3, RR2, RR1
      LOGICAL LL1
C$OMP PARALLEL SHARED (C,B,A,LF,LT,K,R) PRIVATE (RR1,RR2,RR3,RR4,RR5,RR6
       ...
       IF (LL1) THEN
        DO I=1,17,4
         DO J=1,20,1
          ...
          END IF
          R(J,I+1,II2) = A(J,I+1,II2) - C(J,I+1,II2) * B(J,I+1,II2)
          ...
          END IF
          R(J,I+2,II2) = A(J,I+2,II2) - C(J,I+2,II2) * B(J,I+2,II2)
          ...
          END IF
          R(J,I+3,II2) = A(J,I+3,II2) - C(J,I+3,II2) * B(J,I+3,II2)
         END DO
        END DO
       END IF
      END DO
