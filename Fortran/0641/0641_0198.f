     ...
     X   ,L33,L41,L42,L51,L52,L61,L62)
       ...
       DO I2=1,7,4
        ...
        DO I1=1,10
         ...
         END IF
         IF (ABS (E22(I1,I2+1)) .GT. .5) THEN
          D21(I1,I2+1) = E21(I1,I2+1) * 10 / DBLE (E22(I1,I2+1))
         END IF
         IF (ABS (E22(I1,I2+2)) .GT. .5) THEN
          D21(I1,I2+2) = E21(I1,I2+2) * 10 / DBLE (E22(I1,I2+2))
         END IF
         IF (ABS (E22(I1,I2+3)) .GT. .5) THEN
          D21(I1,I2+3) = E21(I1,I2+3) * 10 / DBLE (E22(I1,I2+3))
         END IF
        END DO
       END DO
       DO I2=9,10,1
