      PROGRAM MAIN
       ...
       INTEGER N
       PARAMETER (N = 1)
       COMMON /CV5314K/ CD62, CD61, CD52, CD51, CD42, RR1, CD41, RR2, 
     ...
     X   D23, D22, D21, E62, E61, E52, E51, E42, E41
       COMMON /CV5314K/ E33, E32, E31, E23, E22, RR6, E21, N62, N61, N52
     ...
     X   L23, L22, RR13, L21
       ...
       LOGICAL LL9, LL8, LL7, LL6, LL5, LL4, LL3, LL2, LL1
...
C$OMP PARALLEL SHARED (N41,N31,N61,N42,D11) PRIVATE (II1,I1,I2,I3,I4,IS1
C$OMP& ,I5,IS2)
C$OMP DO 
       DO I1=1,5
        DO I2=1,3
         DO I3=1,3
          DO I4=1,3
           ...
           DO I5=1,3
            IS2 = N31(I1,I2,I5)
            IS2 = IS2 * II1
            N61(I1,I2,I3,I4,I5,1) = IS2
            IS2 = IS2 * II1
            N61(I1,I2,I3,I4,I5,2) = IS2
           END DO
