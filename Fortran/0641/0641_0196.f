      PROGRAM MAIN
       ...
       INTEGER N
       PARAMETER (N = 1)
       COMMON /CV5305K/ CD62, CD61, CD52, CD51, CD42, RR1, CD41, RR2, 
...
C$OMP PARALLEL SHARED (N11,N41,N61,N42,D11) PRIVATE (II1,II2,II3,II4,I1,
C$OMP& I2,I3,I4,I5,I61,IS2,I7,I6)
C$OMP DO 
       DO I1=1,5
        II4 = N11(I1) - 1
        DO I2=1,3
...
C$OMP END PARALLEL 
       ...
       DO I1=1,5
        ...
        DO I2=1,3,2
         DO I3=1,3
          DS1 = I3
          LL1 = LS1 .OR. DS1 .GT. 0.5D0
          LL2 = LS1 .OR. DS1 .GT. 0.5D0
          DO I4=1,3
           DO I5=1,3
            L41(I5,I4,I3,I2) = LS1
            L61(I1,I2,I3,I4,I5,1) = LL1
            L61(I1,I2,I3,I4,I5,2) = LL2
           END DO
          END DO
         END DO
         N41(I1,I2,I1,I2) = DS1
