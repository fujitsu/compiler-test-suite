      PROGRAM MAIN
       ...
       INTEGER N
       PARAMETER (N = 2)
       COMMON /CV5309K/ CD62, CD61, CD52, CD51, CD42, RR1, CD41, RR2, 
     ...
     X   D23, D22, D21, E62, E61, E52, E51, E42, E41
       COMMON /CV5309K/ E33, E32, E31, E23, E22, RR6, E21, N62, N61, N52
...
C$OMP PARALLEL SHARED (NS1,L22,N21,D31,DS1,E11,E12,IS2) PRIVATE (LL1,LL2
C$OMP& ,I3,I1,I21,I2)
C$OMP DO LASTPRIVATE (IS2)
       DO I1=1,10
        IF (I1 .GT. NS1) THEN
         LL1 = I1 .GT. NS1
         DO I21=1,10
          L22(I1,I21) = L22(I1,I21) .AND. LL1
          IF (L22(I1,I21) .EQV. .FALSE.) THEN
           IS2 = N21(I1,I21)
           DO I3=1,6,5
            D31(I1,I21,I3) = DS1 / IS2
            D31(I1,I21,I3+1) = DS1 / IS2
            D31(I1,I21,I3+2) = DS1 / IS2
            D31(I1,I21,I3+3) = DS1 / IS2
            D31(I1,I21,I3+4) = DS1 / IS2
           END DO
          ELSE
           IS2 = N21(I1,I21)
          END IF
...
C$OMP END DO NOWAIT
C$OMP END PARALLEL 
       WRITE (6, *) L22, D31, E11, IS2

                                                       
       DO I1=1,10
        CC2 = CMPLX (DFLOAT (I1), DFLOAT (-I1))
        CC1 = CMPLX (DFLOAT (I1), DFLOAT (-I1))
        DO I21=1,10
         CE21(I1,I21) = CC2
         DO I3=1,10
          D31(I1,I21,I3) = -CC1 * CMPLX (REAL (CDS1), IMAG (CDS1))
         END DO
        END DO
       END DO
       CES1 = CMPLX (10D0, -10D0)
       WRITE (6, *) D31, CE21, CES1
