   ...
   88  FORMAT(A,(2D14.7))
      ...
      SUBROUTINE SUB2 ( N )
       ...
       DO J=1,2
        ...
        DO I=1,NX-3,4
         DC1 = B(I) - CX
         CY = DMIN1 (DIMAG (C(I)), DREAL (DC1)) - CX
         B(I) = DC1
         CX = CX + C(I)
         DC2 = B(I+1) - CX
         CY = DMIN1 (DIMAG (C(I+1)), DREAL (DC2)) - CX
         B(I+1) = DC2
         CX = CX + C(I+1)
         DC3 = B(I+2) - CX
         CY = DMIN1 (DIMAG (C(I+2)), DREAL (DC3)) - CX
         B(I+2) = DC3
         CX = CX + C(I+2)
         DC4 = B(I+3) - CX
         CY = DMIN1 (DIMAG (C(I+3)), DREAL (DC4)) - CX
         B(I+3) = DC4
         CX = CX + C(I+3)
        END DO
        DO I=II1,NX,1
         DC5 = B(I) - CX
         CY = DMIN1 (DIMAG (C(I)), DREAL (DC5)) - CX
         B(I) = DC5
         CX = CX + C(I)
        END DO
       END DO
