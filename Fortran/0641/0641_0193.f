      PROGRAM MAIN
       ...
       INTEGER N
       PARAMETER (N = 5)
       COMMON /CV5302K/ CD62, CD61, CD52, CD51, CD42, RR3, CD41, RR4, 
     X   CD33, CD32, CD31, CD23, CD22, CD21, CD13, CD12, CD11, CE62, 
     X   CE61, CE52, CE51, CE42, CE41, RR5, CE33, CE32, CE31, CE23, CE22
     X   , CE21, D62, D61, D52, D51, RR6, D42, D41, RR7, D33, D32, D31, 
     X   D23, D22, D21, E62, E61, E52, E42, E41, E33
       COMMON /CV5302K/ E32, E23, E22, E21, RR8, N62, N61, N52, RR9, N51
     X   , N42, N41, N33, N32, N31, N23, N22, N21, L62, RR10, L61, L52, 
     X   L51, L42, L41, RR11, L33, L32, L31, L23, L22, L21
       INTEGER II3, II2, II1, I51, I31, I21
       REAL RR2, RR1
       DOUBLE PRECISION DD5, DD4, DD3, DD2, DD1
       COMPLEX*16 DC5, DC4, DC3, DC2, DC1
       REAL RR11 (86), RR10 (102), RR9 (86), RR8 (86), RR7 (86), RR6 (
     X   102), RR5 (150), RR4 (86), RR3 (86)
...
C$OMP PARALLEL SHARED (N11,CD51) PRIVATE (RR1,II2,DD1,DD2,DD3,DD4,DD5,
C$OMP& DC1,DC2,DC3,DC4,DC5,I1,I51,I21,I31)
C$OMP DO 
       DO I1=1,5
        II2 = N11(11-I1)
        DO I51=1,5
         ...
         DO I21=1,5
          DO I31=1,5
           DD2 = REAL (CD51(I1,I21,I31,1,I51))
           DD3 = REAL (CD51(I1,I21,I31,2,I51))
           DD4 = REAL (CD51(I1,I21,I31,3,I51))
           DD5 = REAL (CD51(I1,I21,I31,4,I51))
           DD1 = REAL (CD51(I1,I21,I31,5,I51))
           DC1 = CMPLX (RR1, DD2)
           DC2 = CMPLX (RR1, DD3)
           DC3 = CMPLX (RR1, DD4)
           DC4 = CMPLX (RR1, DD5)
           DC5 = CMPLX (RR1, DD1)
           CD51(I1,I21,I31,5,I51) = DC5
           CD51(I1,I21,I31,4,I51) = DC4
           CD51(I1,I21,I31,3,I51) = DC3
           CD51(I1,I21,I31,2,I51) = DC2
           CD51(I1,I21,I31,1,I51) = DC1
          END DO
         END DO
        END DO
       END DO
       ...
       DO I1=1,10
        ...
        DO I21=1,5
         ...
         DO I31=1,5
          ...
          DO I4=1,5
           DO I51=I4,5
            E51(I4,I51,I31,I21,II3) = REAL (CDS1) + IMAG (CDS1) * NS2
           END DO
          END DO
          E31(I1,I21,I31) = CDS1 * RR2
         END DO
         I3 = 6
        END DO
        N11(I1) = N21(6,I1) - 10
