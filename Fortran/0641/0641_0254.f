...
C$OMP& ,RR10,RR11,RR12,RR13,RR14,RR15,K,J,I,M)
C$OMP DO 
      DO K=1,6,5
       DO J=1,10
       ...
       DO J=2,11
        DO M=1,10
         DO I=1,8,4
          ...
          RR19 = B(I+2,J,M) * 2.
          RR16 = B(I+3,J,M) * 2.
          RR20 = A(I,J-1,K-1) + RR17
          RR21 = A(I+1,J-1,K-1) + RR18
          RR22 = A(I+2,J-1,K-1) + RR19
          A(I+3,J,K) = A(I+3,J-1,K-1) + RR16
          A(I+2,J,K) = RR22
          A(I+1,J,K) = RR21
          A(I,J,K) = RR20
         END DO
