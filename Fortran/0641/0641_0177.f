      PROGRAM MAIN
       ...
       COMMON /CV5282K/ CC3, CB3, CA3, CC2, CB2, CA2, QC2, QB2, QA2, DC3
     X   , DB3, DA3, DC2, DB2, DA2, RC3, RB3, RA3, RC2, RB2, RA2, IC2, 
     X   IB2, IA2, LC3, RR27, LB3, LA3
...
C$OMP& PRIVATE (RR6,RR7,CC4,CC5,CC6,CC7,CC8,CC9,CC10,CC11,CC12,CC13,RR17
C$OMP& ,RR18,RR19,RR20,RR21,DD1,DD2,DD3,DD4,DD5,RR22,RR23,RR24,RR25,RR26
C$OMP& ,DD6,DD7,DD8,DD9,DD10,I,J,K)
C$OMP DO 
       DO I=1,10
        IF (COS ((RB1(I) + RC1(I)) * RR2) .GE. SIN (RB1(I))) THEN
         ...
         DO J=1,10
          ...
          DO K=1,6,5
           ...
           RR20 = RA3(I,J,K+3) * RB3(I,J,K+3)
           RR21 = RA3(I,J,K+4) * RB3(I,J,K+4)
        ...
        ELSE
         DO J=1,10
          ...
          DO K=1,6,5
           ...
           CA3(I,J,K) = RR7 + CC10
           CA3(I,J,K+1) = RR7 + CC11
           CA3(I,J,K+2) = RR7 + CC12
           CA3(I,J,K+3) = RR7 + CC13
           CA3(I,J,K+4) = RR7 + CC5
           RR22 = RA3(I,J,K) + RC3(I,J,K)
           RR23 = RA3(I,J,K+1) + RC3(I,J,K+1)
           RR24 = RA3(I,J,K+2) + RC3(I,J,K+2)
           RR25 = RA3(I,J,K+3) + RC3(I,J,K+3)
           RR26 = RA3(I,J,K+4) + RC3(I,J,K+4)
