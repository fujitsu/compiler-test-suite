      PROGRAM MAIN
       ...
       COMMON /CV6402K/ CC3, CB3, CA3, CC2, CB2, CA2, QC2, QB2, QA2, DC3
     X   , DB3, DA3, DC2, DB2, DA2, RC3, RB3, RA3, RC2, RB2, RA2, IC2, 
     X   IB2, IA2, LC3, RR14, LB3, LA3
       INTEGER II10, II9, II8, II7, II6, II5, II4, II3, II2, II1, K1
       REAL RR13, RR12, RR11, RR10, RR9, RR8, RR7, RR6, RR5, RR4
       ...
       DO J=1,7,4
        ...
        DO I=1,9,2
         ...
         RA2(I+1,J) = (I + 1) * J + 5
         RA2(I,J+1) = I * II1 + 5
         RA2(I+1,J+1) = (I + 1) * II1 + 5
         RA2(I,J+2) = I * II2 + 5
         RA2(I+1,J+2) = (I + 1) * II2 + 5
         RA2(I,J+3) = I * II3 + 5
         RA2(I+1,J+3) = (I + 1) * II3 + 5
         RB2(I,J) = I - J - 5
         RB2(I+1,J) = I - J - 4
         RB2(I,J+1) = I - J - 6
         RB2(I+1,J+1) = I - J - 5
...
C$OMP PARALLEL SHARED (LA3) PRIVATE (LL1,LL2,LL3,LL4,II6,II7,II8,LL5,K1,
C$OMP& J,I)
C$OMP DO 
       DO K1=1,10
        II6 = K1 - 1
