...
type (t2):: y1
class (t2),allocatable:: y2(:)
end
subroutine s1
use m1
implicit none
type (t2):: y3
class (t2),allocatable:: y4(:)
allocate( y2(2), y4(2) )
...
if (any(y1%xx%n/=[1,1])) print *,102
if (y2(1)%x%n/=1) print *,111
if (any(y2(1)%xx%n/=[1,1])) print *,112
if (y2(2)%x%n/=1) print *,121
if (any(y2(2)%xx%n/=[1,1])) print *,122
if (y3%x%n/=1) print *,131
if (any(y3%xx%n/=[1,1])) print *,132
if (y4(1)%x%n/=1) print *,141
if (any(y4(1)%xx%n/=[1,1])) print *,142
if (y4(2)%x%n/=1) print *,151
if (any(y4(2)%xx%n/=[1,1])) print *,152
end
