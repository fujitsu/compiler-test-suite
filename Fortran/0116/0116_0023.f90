  ...
  subroutine sub_test(structXX)
    ...
    do i1=1,10
	  ...
	  do i4=1,10
	        ...
	        structXX(i1, :)%memStructXX(i3,i4)%memberXX(i5,i6) = 1
	        structXX( :, :)%memStructXX(i3,i4)%memberXX(i5,i6) = 1
	        structXX(i1,i2)%memStructXX( :,i4)%memberXX(i5,i6) = 1
	        structXX(i1,i2)%memStructXX( :, :)%memberXX(i5,i6) = 1
