...
z1=xs*matmul(r1,r2)
z2=xa(2,2)*matmul(r1,r2)
z3=ys%im*matmul(r1,r2)
z4=ya(2,2)%im*matmul(r1,r2)
z5=xa(k,k)*matmul(r1,r2)
z6=ya(k,k)%im*matmul(r1,r2)
z7=ca2(2,2)%im*matmul(r1,r2)
z8=ca2(k,k)%im*matmul(r1,r2)
if (any(z1/=z2)) then
  print *,101,z1
  print *,102,z2
endif
