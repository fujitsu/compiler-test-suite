...
logical::f=.false.
     ...
     i8=maxval(i8),r=maxval(r),d=maxval(d),q=maxval(q))
      ...
      if(present(i1).neqv..true.) print *,'fail'
      if(present(i2).neqv..true.) print *,'fail'
      if(present(i4).neqv..true.) print *,'fail'
      if(present(i8).neqv..true.) print *,'fail'
      if(present(r).neqv..true.) print *,'fail'
      if(present(d).neqv..true.) print *,'fail'
      if(present(q).neqv..true.) print *,'fail'
      if(i1(1).ne.1) print *,'fail'
      if(i2(1).ne.1) print *,'fail'
      if(i4(1).ne.1) print *,'fail'
      if(i8(1).ne.1) print *,'fail'
      if(r(1).ne.1) print *,'fail'
      if(d(1).ne.1) print *,'fail'
      if(q(1).ne.1) print *,'fail'
      end subroutine
      ...
      if(present(d).neqv..true.) print *,'fail'
      if(present(q).neqv..true.) print *,'fail'
      if(i1.ne.i11) print *,'fail'
      if(i2.ne.i22) print *,'fail'
      if(i4.ne.i44) print *,'fail'
      if(i8.ne.i88) print *,'fail'
      if(r.ne.rr) print *,'fail'
      if(d.ne.dd) print *,'fail'
      if(q.ne.qq) print *,'fail'
      end subroutine
      ...
      if(present(d).neqv..true.) print *,'fail'
      if(present(q).neqv..true.) print *,'fail'
      if(i1(1).ne.2) print *,'fail'
      if(i2(1).ne.2) print *,'fail'
      if(i4(1).ne.2) print *,'fail'
      if(i8(1).ne.2) print *,'fail'
      if(r(1).ne.2) print *,'fail'
      if(d(1).ne.2) print *,'fail'
      if(q(1).ne.2) print *,'fail'
      end subroutine
