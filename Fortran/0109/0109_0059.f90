      ...
      integer (kind=4)::check,i04a(10),i04t(10)
      data L04m/"ba","ab","ba","ab","ba","ab","ba","ab","ba","ab"/
      data i04t/0,2,2,4,4,6,6,8,8,10/
      ...
      character(len=2)::L04m(10)
      integer (kind=4)::check,i04a(10),i04t(10)
      data L04m/"aa","bb","ab","bc","aa","bd","ab","cc","aa","ac"/
      data i04t/0,2,2,4,4,6,6,8,8,10/
      ...
      character(len=2)::L04m(10)
      integer (kind=4)::check,i04a(10),i04t(10)
      data L04m/"aa","bb","aa","bc","aa","bd","aa","cc","aa","ab"/
      data i04t/0,2,2,4,4,6,6,8,8,10/
      ...
      character(len=2)::L04m(10)
      integer (kind=4)::check,i04a(10),i04t(10)
      data L04m/"ba","aa","bb","ab","bc","aa","cc","ab","cd","ab"/
      data i04t/0,2,2,4,4,6,6,8,8,10/
      ...
      character(len=2)::L04m(10)
      integer (kind=4)::check,i04a(10),i04t(10)
      data L04m/"ba","aa","bb","aa","bc","aa","cc","aa","cd","aa"/
      data i04t/0,2,2,4,4,6,6,8,8,10/
