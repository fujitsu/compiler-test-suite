...
!$omp atomic update seq_cst
   s_x_r2    =    min  ( s_expr_r2 , s_x_r2)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r2    =    max  ( s_expr_r4 , s_x_r2)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r2    =    min  ( s_expr_r8 , s_x_r2)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r2    =    max  ( s_expr_r16 , s_x_r2)
!$omp end atomic


!$omp atomic update seq_cst
   s_x_r4    =    min  ( s_expr_r2 , s_x_r4)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r4    =    max  ( s_expr_r4 , s_x_r4)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r4    =    min  ( s_expr_r8 , s_x_r4)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r4    =    max  ( s_expr_r16 , s_x_r4)
!$omp end atomic


!$omp atomic update seq_cst
   s_x_r8    =    min  ( s_expr_r2 , s_x_r8)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r8    =    max  ( s_expr_r4 , s_x_r8)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r8    =    min  ( s_expr_r8 , s_x_r8)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r8    =    max  ( s_expr_r16 , s_x_r8)
!$omp end atomic


!$omp atomic update seq_cst
   s_x_r16   =    max  ( s_expr_r2 , s_x_r16)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r16   =    min  ( s_expr_r4 , s_x_r16)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r16   =    max  ( s_expr_r8 , s_x_r16)
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r16   =    min  ( s_expr_r16 , s_x_r16)
!$omp end atomic
