...
!$omp atomic update
   s_x_l1    =       s_x_l1  .AND.  s_expr_l1
!$omp end atomic

!$omp atomic update
   s_x_l1    =       s_x_l1  .OR.   s_expr_l2
!$omp end atomic

!$omp atomic update
   s_x_l1    =       s_x_l1  .EQV.  s_expr_l4
!$omp end atomic

!$omp atomic update
   s_x_l1    =       s_x_l1  .NEQV. s_expr_l8
!$omp end atomic

!$omp atomic update
   s_x_i1    = IAND (s_x_i1 ,       s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i1    = IOR  (s_x_i1 ,       s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i1    = IEOR (s_x_i1 ,       s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_l2    =       s_x_l2  .AND.  s_expr_l1
!$omp end atomic

!$omp atomic update
   s_x_l2    =       s_x_l2  .OR.   s_expr_l2
!$omp end atomic

!$omp atomic update
   s_x_l2    =       s_x_l2  .EQV.  s_expr_l4
!$omp end atomic

!$omp atomic update
   s_x_l2    =       s_x_l2  .NEQV. s_expr_l8
!$omp end atomic

!$omp atomic update
   s_x_i2    = IAND (s_x_i2 ,       s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i2    = IOR  (s_x_i2 ,       s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i2    = IEOR (s_x_i2 ,       s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_l4    =       s_x_l4  .AND.  s_expr_l1
!$omp end atomic

!$omp atomic update
   s_x_l4    =       s_x_l4  .OR.   s_expr_l2
!$omp end atomic

!$omp atomic update
   s_x_l4    =       s_x_l4  .EQV.  s_expr_l4
!$omp end atomic

!$omp atomic update
   s_x_l4    =       s_x_l4  .NEQV. s_expr_l8
!$omp end atomic

!$omp atomic update
   s_x_i4    = IAND (s_x_i4 ,       s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i4    = IOR  (s_x_i4 ,       s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i4    = IEOR (s_x_i4 ,       s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_l8    =       s_x_l8  .AND.  s_expr_l1
!$omp end atomic

!$omp atomic update
   s_x_l8    =       s_x_l8  .OR.   s_expr_l2
!$omp end atomic

!$omp atomic update
   s_x_l8    =       s_x_l8  .EQV.  s_expr_l4
!$omp end atomic

!$omp atomic update
   s_x_l8    =       s_x_l8  .NEQV. s_expr_l8
!$omp end atomic

!$omp atomic update
   s_x_i8    = IAND (s_x_i8 ,       s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i8    = IOR  (s_x_i8 ,       s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i8    = IEOR (s_x_i8 ,       s_expr_i8 )
!$omp end atomic
