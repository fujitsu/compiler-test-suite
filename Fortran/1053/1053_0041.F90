...
!$omp atomic capture seq_cst
   a_x_r2(1) =    a_x_r2(1) -    s_expr_c4
   s_v_c8    =    a_x_r2(1)
!$omp end atomic
!$omp atomic capture
   s_x_r2    =    s_x_r2    *    a_expr_c8(1)
   s_v_c4    =    s_x_r2
!$omp end atomic
!$omp atomic capture seq_cst
   a_x_r2(1) =    a_x_r2(1) /    a_expr_c16(1)
   s_v_c2    =    a_x_r2(1)
!$omp end atomic

!$omp atomic capture
   a_x_r4(1) =    a_x_r4(1) -    a_expr_c2(1)
   s_v_c2    =    a_x_r4(1)
!$omp end atomic
!$omp atomic capture seq_cst
   s_x_r4    =    s_x_r4    *    a_expr_c4(1)
   s_v_c4    =    s_x_r4
!$omp end atomic
!$omp atomic capture
   a_x_r4(1) =    a_x_r4(1) /    s_expr_c8
   s_v_c8    =    a_x_r4(1)
!$omp end atomic
!$omp atomic capture seq_cst
   s_x_r4    =    s_x_r4    +    s_expr_c16
   s_v_c16   =    s_x_r4
!$omp end atomic

!$omp atomic capture
   s_x_r8    =    s_x_r8    *    s_expr_c2
   s_v_c16   =    s_x_r8
!$omp end atomic
!$omp atomic capture seq_cst
   a_x_r8(1) =    a_x_r8(1) /    s_expr_c4
   s_v_c8    =    a_x_r8(1)
!$omp end atomic
!$omp atomic capture
   s_x_r8    =    s_x_r8    +    a_expr_c8(1)
   s_v_c4    =    s_x_r8
!$omp end atomic
!$omp atomic capture seq_cst
   a_x_r8(1) =    a_x_r8(1) -    a_expr_c16(1)
   s_v_c2    =    a_x_r8(1)
!$omp end atomic

!$omp atomic capture
   a_x_r16(1)=    a_x_r16(1)/    a_expr_c2(1)
   s_v_c2    =    a_x_r16(1)
!$omp end atomic
!$omp atomic capture seq_cst
   s_x_r16   =    s_x_r16   +    a_expr_c4(1)
   s_v_c4    =    s_x_r16
!$omp end atomic
!$omp atomic capture
   a_x_r16(1)=    a_x_r16(1)-    s_expr_c8
   s_v_c8    =    a_x_r16(1)
!$omp end atomic
!$omp atomic capture seq_cst
   s_x_r16   =    s_x_r16   *    s_expr_c16
   s_v_c16   =    s_x_r16
!$omp end atomic
