...
!$omp atomic capture seq_cst
   s_v_r8    =    a_x_i1(1)
   a_x_i1(1) =    min (a_x_i1(1) ,    s_expr_i2 )
!$omp end atomic
!$omp atomic capture
   s_v_r4    =    s_x_i1
   s_x_i1    =    max (s_x_i1    ,    a_expr_i4(1) )
!$omp end atomic
!$omp atomic capture seq_cst
   s_v_r2    =    a_x_i1(1)
   a_x_i1(1) =    min (a_x_i1(1) ,    a_expr_i8(1) )
!$omp end atomic

!$omp atomic capture
   s_v_r2    =    a_x_i2(1)
   a_x_i2(1) =    max (a_x_i2(1) ,    a_expr_i1(1) )
!$omp end atomic
!$omp atomic capture seq_cst
   s_v_r4    =    s_x_i2
   s_x_i2    =    min (s_x_i2    ,    a_expr_i2(1) )
!$omp end atomic
!$omp atomic capture
   s_v_r8    =    a_x_i2(1)
   a_x_i2(1) =    max (a_x_i2(1) ,    s_expr_i4 )
!$omp end atomic
!$omp atomic capture seq_cst
   s_v_r16   =    s_x_i2
