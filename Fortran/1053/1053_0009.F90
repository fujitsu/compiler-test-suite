...
!$omp atomic update
   s_x_i1    =    max  ( s_x_i1 , s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i1    =    min  ( s_x_i1 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_i1    =    max  ( s_x_i1 , s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i1    =    min  ( s_x_i1 , s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_i2    =    max  ( s_x_i2 , s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i2    =    min  ( s_x_i2 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_i2    =    max  ( s_x_i2 , s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i2    =    min  ( s_x_i2 , s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_i4    =    max  ( s_x_i4 , s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i4    =    min  ( s_x_i4 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_i4    =    max  ( s_x_i4 , s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i4    =    min  ( s_x_i4 , s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_i8    =    max  ( s_x_i8 , s_expr_i1 )
!$omp end atomic

!$omp atomic update
   s_x_i8    =    min  ( s_x_i8 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_i8    =    max  ( s_x_i8 , s_expr_i4 )
!$omp end atomic

!$omp atomic update
   s_x_i8    =    min  ( s_x_i8 , s_expr_i8 )
!$omp end atomic
