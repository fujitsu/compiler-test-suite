...
!$omp atomic update
   s_x_i1    =    max  ( s_expr_r2 , s_x_i1)
!$omp end atomic

!$omp atomic update
   s_x_i1    =    min  ( s_expr_r4 , s_x_i1)
!$omp end atomic

!$omp atomic update
   s_x_i1    =    max  ( s_expr_r8 , s_x_i1)
!$omp end atomic

!$omp atomic update
   s_x_i1    =    min  ( s_expr_r16 , s_x_i1)
!$omp end atomic


!$omp atomic update
   s_x_i2    =    min  ( s_expr_r2 , s_x_i2)
!$omp end atomic

!$omp atomic update
   s_x_i2    =    max  ( s_expr_r4 , s_x_i2)
!$omp end atomic

!$omp atomic update
   s_x_i2    =    min  ( s_expr_r8 , s_x_i2)
!$omp end atomic

!$omp atomic update
   s_x_i2    =    max  ( s_expr_r16 , s_x_i2)
!$omp end atomic


!$omp atomic update
   s_x_i4    =    min  ( s_expr_r2 , s_x_i4)
!$omp end atomic

!$omp atomic update
   s_x_i4    =    max  ( s_expr_r4 , s_x_i4)
!$omp end atomic

!$omp atomic update
   s_x_i4    =    min  ( s_expr_r8 , s_x_i4)
!$omp end atomic

!$omp atomic update
   s_x_i4    =    max  ( s_expr_r16 , s_x_i4)
!$omp end atomic


!$omp atomic update
   s_x_i8    =    min  ( s_expr_r2 , s_x_i8)
!$omp end atomic

!$omp atomic update
   s_x_i8    =    max  ( s_expr_r4 , s_x_i8)
!$omp end atomic

!$omp atomic update
   s_x_i8    =    min  ( s_expr_r8 , s_x_i8)
!$omp end atomic

!$omp atomic update
   s_x_i8    =    max  ( s_expr_r16 , s_x_i8)
!$omp end atomic
