...
!$omp atomic update
   s_x_r2    =    max  ( s_x_r2 , s_expr_i1 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r2    =    min  ( s_x_r2 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_r2    =    max  ( s_x_r2 , s_expr_i4 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r2    =    min  ( s_x_r2 , s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_r4    =    max  ( s_x_r4 , s_expr_i1 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r4    =    min  ( s_x_r4 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_r4    =    max  ( s_x_r4 , s_expr_i4 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r4    =    min  ( s_x_r4 , s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_r8    =    max  ( s_x_r8 , s_expr_i1 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r8    =    min  ( s_x_r8 , s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_r8    =    max  ( s_x_r8 , s_expr_i4 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r8    =    min  ( s_x_r8 , s_expr_i8 )
!$omp end atomic


!$omp atomic update
   s_x_r16   =    max  ( s_x_r16, s_expr_i1 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r16   =    min  ( s_x_r16, s_expr_i2 )
!$omp end atomic

!$omp atomic update
   s_x_r16   =    max  ( s_x_r16, s_expr_i4 )
!$omp end atomic

!$omp atomic update seq_cst
   s_x_r16   =    min  ( s_x_r16, s_expr_i8 )
!$omp end atomic
