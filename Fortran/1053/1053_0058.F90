...
!$omp atomic update seq_cst
   s_x_c2    =    s_x_c2    *    s_expr_i1
!$omp end atomic
!$omp atomic update seq_cst
   a_x_c2(1) =    a_x_c2(1) /    s_expr_i2
!$omp end atomic
!$omp atomic update seq_cst
   s_x_c2    =    s_x_c2    +    a_expr_i4(1)
!$omp end atomic
!$omp atomic update seq_cst
   a_x_c2(1) =    a_x_c2(1) -    a_expr_i8(1)
!$omp end atomic

!$omp atomic update seq_cst
   a_x_c4(1) =    a_x_c4(1) /    a_expr_i1(1)
!$omp end atomic
!$omp atomic update seq_cst
   s_x_c4    =    s_x_c4    +    a_expr_i2(1)
!$omp end atomic
!$omp atomic update seq_cst
   a_x_c4(1) =    a_x_c4(1) -    s_expr_i4
!$omp end atomic
!$omp atomic update seq_cst
   s_x_c4    =    s_x_c4    *    s_expr_i8
!$omp end atomic
