...
real*4, parameter::r(2,2,2) = reshape(b, (/2,2,2/))
integer, parameter::c = 3
integer, parameter::e = 2
integer::m(4)
real*4::d(2,3,2,2) = spread(r, e , c)
real*4::f(2,3,2,2)
integer::i,j
integer::g(4) = shape(spread(r, e , c))
...
do k =1,2
do kk=1,2
print*, d(i, j, k, kk), '---', f(i, j, k, kk)
if (d(i, j, k, kk).ne.f(i, j, k, kk)) then
print*, '??? (Error: R->R) ???'
else
print*, 'R -> R'
endif
