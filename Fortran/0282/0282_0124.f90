program main
character(len=2,kind=1), parameter::a(12) = (/"ab", "bc", "cd", "ef", &
                             "gh", "ij", "jk", "lm", &
							 "mn", "op", "pq", "rs" /)
character(len =2,kind=1), parameter::b(3,2,2) = reshape(a, (/3,2,2/))

integer*4, parameter::c(4) = (/1_4, 2_4, 3_4, 4_4/)

integer*4, parameter::d(2,2) = reshape(c, (/2,2/))

character(len=2,kind=1),parameter::h(3,2,2) = eoshift(b,d)

character(len =2, kind=1)::m(3,2,2)
