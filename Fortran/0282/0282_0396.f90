...
complex*32,parameter, dimension (2,3,2,1) :: b = reshape((/(0.5_16,0.5_16),(-30.0_16,-30.0_16),(-100.0_16,-100.0_16),&
...
logical*1,parameter,dimension(2,3,2,1)::m = reshape((/.true., .true.,.false.,.false.,.false.,&
...
a = reshape((/(0.5_16,0.5_16),(-30.0_16,-30.0_16),(-100.0_16,-100.0_16),(-50.0_16,-50.0_16),&
