program main
real*16, parameter::a(24) = (/1.0_16, 2.0_16, 3.0_16, 4.0_16, &
                             5.0_16, 6.0_16, 7.0_16, 8.0_16, &
							 1.0_16, 2.0_16, 3.0_16, 4.0_16, &
                             1.0_16, 2.0_16, 3.0_16, 4.0_16, &
                             5.0_16, 6.0_16, 7.0_16, 8.0_16, &
							 1.0_16, 2.0_16, 3.0_16, 4.0_16/)
real*16, parameter::b(3,4,2) = reshape(a, (/3,4,2/))
integer*4, parameter::c(6) = (/1_4, 2_4, 3_4, 4_4, 5_4, 6_4/)
integer*4, parameter::d(3,2) = reshape(c, (/3,2/))
real*16, parameter::e(6) = (/3.0_16, 3.0_16, 4.0_16, 4.0_16, 5.0_16, 6.0_16/)
real*16, parameter::f(3,2) = reshape(e, (/3,2/))
integer*4, parameter::g = 2
real*16::h(3,4,2) = eoshift(b,d,f,g)
real*16::m(3,4,2)
integer::i,j,k
