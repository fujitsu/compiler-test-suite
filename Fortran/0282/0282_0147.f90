program main
real*8, parameter::a(24) = (/1.0_8, 2.0_8, 3.0_8, 4.0_8, &
                             5.0_8, 6.0_8, 7.0_8, 8.0_8, &
							 1.0_8, 2.0_8, 3.0_8, 4.0_8, &
                             1.0_8, 2.0_8, 3.0_8, 4.0_8, &
                             5.0_8, 6.0_8, 7.0_8, 8.0_8, &
							 1.0_8, 2.0_8, 3.0_8, 4.0_8/)
real*8, parameter::b(3,4,2) = reshape(a, (/3,4,2/))
integer*4, parameter::c(6) = (/1_4, 2_4, 3_4, 4_4, 5_4, 6_4/)
integer*4, parameter::d(3,2) = reshape(c, (/3,2/))
real*8, parameter::e(6) = (/3.0_8, 3.0_8, 4.0_8, 4.0_8, 5.0_8, 6.0_8/)
real*8, parameter::f(3,2) = reshape(e, (/3,2/))
integer*4, parameter::g = 2
real*8::h(3,4,2) = eoshift(b,d,f,g)
real*8::m(3,4,2)
integer::i,j,k
integer::z(3)
