program main
integer*8, parameter::a(24) = (/1_8, 2_8, 3_8, 4_8, &
                                5_8, 6_8, 7_8, 8_8, &
							    1_8, 2_8, 3_8, 4_8, &
                                1_8, 2_8, 3_8, 4_8, &
                                5_8, 6_8, 7_8, 8_8, &
							    1_8, 2_8, 3_8, 4_8/)
integer*8, parameter::b(3,4,2) = reshape(a, (/3,4,2/))
integer*4, parameter::c(6) = (/1_4, 2_4, 3_4, 4_4, 5_4, 6_4/)
integer*4, parameter::d(3,2) = reshape(c, (/3,2/))
integer*8, parameter::e(6) = (/3_8, 3_8, 4_8, 4_8, 5_8, 6_8/)
integer*8, parameter::f(3,2) = reshape(e, (/3,2/))
integer*4, parameter::g = 2
integer*8::h(3,4,2) = eoshift(b,d,f,g)
integer*8::m(3,4,2)
integer::i,j,k
