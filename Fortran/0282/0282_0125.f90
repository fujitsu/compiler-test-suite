program main
integer*4, parameter::a(24) = (/1_4, 2_4, 3_4, 4_4, &
                                5_4, 6_4, 7_4, 8_4, &
							    1_4, 2_4, 3_4, 4_4, &
                                1_4, 2_4, 3_4, 4_4, &
                                5_4, 6_4, 7_4, 8_4, &
							    1_4, 2_4, 3_4, 4_4/)
integer*4, parameter::b(3,4,2) = reshape(a, (/3,4,2/))
integer*4, parameter::c(6) = (/1_4, 2_4, 3_4, 4_4, 5_4, 6_4/)
integer*4, parameter::d(3,2) = reshape(c, (/3,2/))
integer*4, parameter::e(6) = (/3_4, 3_4, 4_4, 4_4, 5_4, 6_4/)
integer*4, parameter::f(3,2) = reshape(e, (/3,2/))
integer*4, parameter::g = 2
integer*4::h(3,4,2) = eoshift(b,d,f,g)
integer*4::m(3,4,2)
integer::i,j,k
