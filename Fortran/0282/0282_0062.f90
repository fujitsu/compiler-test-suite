program main
character(len = 2), parameter::a(8) = (/"ab", "bc", "cd", "ef", "gh", "ij", "lm", "no"/)							
character(len = 2), parameter::b(2,4) = reshape(a, (/2,4/))
integer*4, parameter::d(4) = (/1_4, 2_4, 3_4, 4_4/)
integer*4, parameter::e = 1
character(len = 2)::f(2,4) = cshift(b,d,e)
character(len = 2)::g(2,4)
integer::i,j
integer::z(2)
