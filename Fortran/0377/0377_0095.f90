...
ir=1
arr=1
write(10,*) (/character(ir) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(ir+1) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character((ir)) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(ir) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(+ir) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(ir) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(1) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(arr(1)) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(arr(1)+2) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(arr(1)+2) :: ("1_2",i=1,10),"1"/)
write(10,*) (/character(arr(1)+int(1)) :: ("1_2",i=1,10),"1"/)
end subroutine
subroutine test02()
