...
jj = findloc(arr,7,1,MASK = m1,KIND = 8,BACK = .TRUE.)
kk = findloc(arr1,'B',1,MASK = m1,KIND = 4,BACK = .TRUE.)
ll = findloc(arr2,4.4,2,MASK = m1,KIND = 2,BACK = .TRUE.)
nn = findloc(arr4,(3,3),1,MASK = m1,KIND = 2,BACK = .TRUE.)
if(jj(1) /= 0)print*, 101
if(jj(2) /= 0)print*, 102
if(jj(3) /= 1)print*, 103
if(jj(4) /= 3)print*, 104
