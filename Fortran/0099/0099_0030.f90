...
jj = findloc((/1,4,8,4/),arr(4),arr(1),MASK = m1(1:4),KIND = 8,BACK = m1(1))
kk = findloc(reshape(['A','B','B','C','D'],[5]),arr1(2),arr(1),MASK = m1,KIND = 2,BACK = m1(1))
ll = findloc((arr2(1:5)),arr2(5),arr(1),MASK = m1,KIND = 4,BACK = m1(1))
nn = findloc(arr4(1:5),arr4(2),arr(1),MASK = m1,KIND = 4,BACK = m1(1))
if(jj(1) /= 4)print*, 101
