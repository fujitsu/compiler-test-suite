...
jj = findloc(ARRAY = arr(1:3,1:4),VALUE = arr(1,3),DIM = arr(3,1),MASK = m1,KIND = 8,BACK = arr3(1,1))
kk = findloc(arr1(1:3,1:4),VALUE = arr1(2,1),DIM = arr(3,1),MASK = m1,KIND = 4,BACK = arr3(1,1))
ll = findloc(arr2(3:5,4:7),arr2(4,5),arr(2,4),MASK = m1,KIND = 2,BACK = arr3(1,1))
nn = findloc(arr4(1:3,1:4),arr4(1,4),arr(3,1),m1,KIND = 2,BACK = arr3(1,1))
if(jj(1) /= 0)print*, 101
if(jj(2) /= 0)print*, 102
if(jj(3) /= 1)print*, 103
if(jj(4) /= 3)print*, 104
