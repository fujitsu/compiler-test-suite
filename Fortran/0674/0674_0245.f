...
90    CONTINUE
      ...
      DO 100 I=10,19
        A(I,I+10)=B(I+10,J)*10+A(I+10,I+10)+10
        A(I,I+9)=B(I+9,J)*9+A(I+9,I+9)+9
        A(I,I+8)=B(I+8,J)*8+A(I+8,I+8)+8
        A(I,I+7)=B(I+7,J)*7+A(I+7,I+7)+7
        A(I,I+6)=B(I+6,J)*6+A(I+6,I+6)+6
        A(I,I+5)=B(I+5,J)*5+A(I+5,I+5)+5
        A(I,I+4)=B(I+4,J)*4+A(I+4,I+4)+4
        A(I,I+3)=B(I+3,J)*3+A(I+3,I+3)+3
        A(I,I+2)=B(I+2,J)*2+A(I+2,I+2)+2
        A(I,I+1)=B(I+1,J)*1+A(I+1,I+1)+1
100   CONTINUE
