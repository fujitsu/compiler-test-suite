...
real(8),dimension(1:n,1:n,1:n) :: a01,a03,a05,a07,a09,a06,a08
real(8),dimension(1:n,1:n) :: a02,a04
real(8),dimension(1:n) :: a10

do k=1,n
 do j=1,n
  do i=1,n
    a09(i,j,k) = a01(i,j,k) + a02(i,j) + a03(i,j,k) + a04(i,k) + a05(i,j,k) + a06(i,i,k) + a07(i,j,k) + a08(i,1,2) + a10(i) 
  enddo
 enddo
enddo
end subroutine
