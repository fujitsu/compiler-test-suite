...
type tt
 integer :: ip
 type(ty1),pointer  :: ipstr => null()
end type
type ty1
 type(tt) :: i1p = tt(2,null())
...
if (str%i1a(1).ne.2) print *,'fail'
call isub()
str=ty1(i1a=ia+1,i1p=tt(5),ip=9)
if (str%i1p%ip.ne.5) print *,'fail'
if (str%i1a(1).ne.3) print *,'fail'
str=ty1(i1a=ia+1,ip=8,i1p=tt(5))
if (str%i1p%ip.ne.5) print *,'fail'
if (str%i1a(1).ne.3) print *,'fail'
str=ty1(i1a=ia+1,i1p=tt(5),tt=tt(8))
if (str%i1p%ip.ne.5) print *,'fail'
if (str%i1a(1).ne.3) print *,'fail'
str=ty1(i1a=ia+1,i1p=tt(5),tt=tt(ip=8))
if (str%i1p%ip.ne.5) print *,'fail'
if (str%i1a(1).ne.3) print *,'fail'
str=ty1(i1a=ia+1,i1p=tt(5),tt=tt(ip=8,ipstr=null()))
if (str%i1p%ip.ne.5) print *,'fail'
if (str%i1a(1).ne.3) print *,'fail'
str=ty1(i1a=ia+1,i1p=tt(5),ip=8,ipstr=null())
if (str%i1p%ip.ne.5) print *,'fail'
if (str%i1a(1).ne.3) print *,'fail'
end
