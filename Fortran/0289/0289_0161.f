      ...
      real*8              w_r8_array_1(10),w_r8_array_2(10)
      pointer (p1 ,r8_array_1) ,(p2 ,r8_array_2)
      real*8,allocatable::r8_array_3(:,:,:,:)

      data w_r8_array_1/3.3,5.2,6.5,1.1,6.4,3.7,0.2,3.1,4.2,2.4/

      real*8 r8_dvt_10(10),result_vector(10),result_scalar(10)
      real*8 w_r8_dvt_10(10)
      pointer (p10 ,w_r8_dvt_10)
      logical                             no_good/.false./

      integer i,n1,n2,n3

      p1 = loc(w_r8_array_1(1))
      p2 = loc(w_r8_array_2(1))
      p10= loc(w_r8_dvt_10(1))
