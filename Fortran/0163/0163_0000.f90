...
if(real_kinds(2_1)/=4) print *,'err'
if(real_kinds(2_2)/=4) print *,'err'
if(real_kinds(2_4)/=4) print *,'err'
if(real_kinds(2_8)/=4) print *,'err'
if(real_kinds(3_1)/=8) print *,'err'
if(real_kinds(3_2)/=8) print *,'err'
if(real_kinds(3_4)/=8) print *,'err'
if(real_kinds(3_8)/=8) print *,'err'
end subroutine s2
