...
contains
     ...
     allocate(xv,yv)
             write (1231,"(z16.16)") loc(xv )
             write (1232,"(z16.16)") loc(yv )
      allocate(e ::xv%v)
    k=0
    select type(p=>xv%v)
      type is(e)
        k=1
             write (1211,"(z16.16)") loc(xv%v   )
          allocate(p%n,source=a)
             write (1212,"(z16.16)") loc(xv%v%n   )
          allocate(p   %na,source=a)
             write (1213,"(z16.16)") loc(p   %na  )
          allocate(p   %nam,source=a)
             write (1214,"(z16.16)") loc(p   %nam )
     allocate(b3::p   %b2v)
    kk=0
      select type(q=>p%b2v)
      type is(b3)
        kk=1
         write (1241,"(z16.16)") loc(q      )
          allocate(ww::q%z01)
        kkk=0
          select type(r=>q%z01)
            type is(ww)
        kkk=1
              ...
              write (1242,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1243,"(z16.16)") loc(r %w02  )
           end select
        if (kkk/=1) print *,862
          allocate(ww::q%z02)
        kkk=0
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1244,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1245,"(z16.16)") loc(r %w02  )
           end select
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1246,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1247,"(z16.16)") loc(r %w02  )
           end select
        if (kkk/=1) print *,8624
          allocate(ww::q%z12)
        kkk=0
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1248,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1249,"(z16.16)") loc(r %w02  )
           end select
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1250,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1251,"(z16.16)") loc(r %w02  )
           end select
        if (kkk/=1) print *,8664
          allocate(ww::q%z22)
        kkk=0
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1252,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1253,"(z16.16)") loc(r %w02  )
           end select
      ...
      type is(ext)
        k=1
          allocate(p   %n,source=b)
             write (1222,"(z16.16)") loc(p   %n   )
          allocate(p   %na,source=b)
             write (1223,"(z16.16)") loc(p   %na  )
     allocate(b3::p   %b2v)
    kk=0
      select type(q=>p%b2v)
      type is(b3)
