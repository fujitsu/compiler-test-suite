...
contains
     ...
     allocate(x2::xv)
             write (1471,"(z16.16)") loc(xv )
     select type(y=>xv)
      type is(x2)
        allocate(y%xn,source='a')
             write (1472,"(z16.16)") loc(y%xn )
     end select
     allocate(x3::yv)
             write (1461,"(z16.16)") loc(yv )
     select type(y=>yv)
      type is(x3)
        allocate(y%xn,source='a')
             write (1462,"(z16.16)") loc(y%xn )
        allocate(y%xna,source='a')
             write (1463,"(z16.16)") loc(y%xna)
     end select
      allocate(e ::xv%v)
    k=0
    select type(p=>xv%v)
      type is(e)
        k=1
             write (1411,"(z16.16)") loc(xv%v   )
          allocate(p%n,source=a)
             write (1412,"(z16.16)") loc(xv%v%n   )
          allocate(p   %na,source=a)
             write (1413,"(z16.16)") loc(p   %na  )
          allocate(p   %nam,source=a)
             write (1414,"(z16.16)") loc(p   %nam )
     allocate(b3::p   %b2v)
    kk=0
      select type(q=>p%b2v)
      type is(b3)
        kk=1
         write (1441,"(z16.16)") loc(q      )
          allocate(ww::q%z01)
        kkk=0
          select type(r=>q%z01)
            type is(ww)
        kkk=1
              ...
              write (1442,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1443,"(z16.16)") loc(r %w02  )
           end select
        if (kkk/=1) print *,862
          allocate(ww::q%z02)
        kkk=0
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1444,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1445,"(z16.16)") loc(r %w02  )
           end select
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1446,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1447,"(z16.16)") loc(r %w02  )
           end select
        if (kkk/=1) print *,8624
          allocate(ww::q%z12)
        kkk=0
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1448,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1449,"(z16.16)") loc(r %w02  )
           end select
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1450,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1451,"(z16.16)") loc(r %w02  )
           end select
        if (kkk/=1) print *,8664
          allocate(ww::q%z22)
        kkk=0
        ...
        kkk=1
              allocate(r%w01,source=a)
              write (1452,"(z16.16)") loc(r %w01  )
              allocate(r%w02,source=a)
              write (1453,"(z16.16)") loc(r %w02  )
           end select
      ...
      type is(ext)
        k=1
          allocate(p   %n,source=b)
             write (1422,"(z16.16)") loc(p   %n   )
          allocate(p   %na,source=b)
             write (1423,"(z16.16)") loc(p   %na  )
     allocate(b3::p   %b2v)
    kk=0
      select type(q=>p%b2v)
      type is(b3)
