...
module m3
 ...
 contains
  ...
  print *, "sub chk d1(1,1)%ix0     =", d1(2,1)%ix1   
  print *, "sub chk d2(1,1)%ix1     =", d2(2,1)%ix0   

  print *, "sub chk d3(2,2)%ix0     =", d3(3,1)%ix0   

  print *, "sub chk d4(1,1,1)%ix0   =", d4(1,1,1)%ix1 
...
print *, "sub s1 t1(1,1)%ix0     =", t1(1,1)%ix0   
print *, "sub s1 t1(1,2)%ix0     =", t1(1,2)%ix0   
print *, "sub s1 t1(1,3)%ix0     =", t1(1,3)%ix0   
print *, "sub s1 t1(2,1)%ix0     =", t1(2,1)%ix0   
print *, "sub s1 t1(2,2)%ix0     =", t1(2,2)%ix0   
print *, "sub s1 t1(2,3)%ix0     =", t1(2,3)%ix0   
