 ...
 subroutine test2(Pntr,id)
  ...
  write(53,'(z16.16)') temp1
  write(53,'(z16.16)') LOC(Pntr%segment(id)%sList%seg(id)%sList)
 ...
 subroutine test3(Pntr,id)
  ...
  write(53,'(z16.16)') temp1
  write(53,'(z16.16)')LOC(Pntr%segment(id)%sList2)
  write(53,'(z16.16)')LOC(Pntr%segment(id)%sList2(:))
  write(53,'(z16.16)')LOC(Pntr%segment(id)%sList2(::2))
...
character*16 c,c1
rewind 53
read (53,*) c;if (c/='0000000000000000')print *,101,c
read (53,*) c;if (c=='0000000000000000')print *,102,c
read (53,*) c;if (c=='0000000000000000')print *,103,c
read (53,*) c1;if (c/=c1)print *,104,c
read (53,*) c;if (c=='0000000000000000')print *,105,c
read (53,*) c1;if (c/=c1)print *,106,c
read (53,*) c1;if (c/=c1)print *,107,c
read (53,*) c1;if (c/=c1)print *,108,c
end
