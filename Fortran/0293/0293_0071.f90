 ...
 subroutine test2(Pntr,id)
  ...
  write(1,'(z16.16)') temp1
  write(1,'(z16.16)') LOC(Pntr%segment(id)%sList%segment(id)%sList)
...
read (1,*) c;if (c=='0000000000000000')print *,109,c
read (1,*) c1;if (c/=c1)print *,110,c
read (1,*) c1;if (c/=c1)print *,111,c
read (1,*) c1;if (c/=c1)print *,112,c
read (1,*) c;if (c=='0000000000000000')print *,113,c
read (1,*) c1;if (c/=c1)print *,114,c
read (1,*) c1;if (c/=c1)print *,115,c
read (1,*) c1;if (c/=c1)print *,116,c
end
