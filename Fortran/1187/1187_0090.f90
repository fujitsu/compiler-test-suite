program main
 ...
 type :: struct_ty
   ...
   integer::k
   integer,parameter::k_data(100)=[(k,k=1,100)]

 type(struct_ty)::var
 real(8)::ddd=1.0D0

var%disp_16_data=k_data
allocate(ext::xx(2))
if (any(var%disp_16_data/=k_data)) print *,'error-0'
xx = ext(ddd)
var%class_alc = [xx]      
if (any(var%disp_16_data/=k_data)) print *,'error-1',var%disp_16_data
