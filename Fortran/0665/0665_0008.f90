...
type(ty1) :: str
if (str%i01.ne.0_1) print *,'fail'
if (str%i02.ne.0_2) print *,'fail'
if (str%i03.ne.0_4) print *,'fail'
if (str%i04.ne.0_8) print *,'fail'
if (str%i05.ne.0.0_4) print *,'fail'
if (str%i06.ne.0.0_8) print *,'fail'
if (str%i07.ne.0.0_16) print *,'fail'
if (str%i08.ne.(0.0_4,0.0_4)) print *,'fail'
if (str%i09.ne.(0.0_8,0.0_8)) print *,'fail'
if (str%i10.ne.(0.0_16,0.0_16)) print *,'fail'
end subroutine
subroutine test02()
type ty1
...
if (.not.all(str%i01.eq.0_1)) print *,'fail'
if (.not.all(str%i02.eq.0_2)) print *,'fail'
if (.not.all(str%i03.eq.0_4)) print *,'fail'
if (.not.all(str%i04.eq.0_8)) print *,'fail'
if (.not.all(str%i05.eq.0.0_4)) print *,'fail'
if (.not.all(str%i06.eq.0.0_8)) print *,'fail'
if (.not.all(str%i07.eq.0.0_16)) print *,'fail'
if (.not.all(str%i08.eq.(0.0_4,0.0_4))) print *,'fail'
if (.not.all(str%i09.eq.(0.0_8,0.0_8))) print *,'fail'
if (.not.all(str%i10.eq.(0.0_16,0.0_16))) print *,'fail'
end subroutine
subroutine test12()
type ty1
