...
implicit real(16)(y)
  ...
  real(16),parameter:: x1=-am
  real(16),parameter:: x2=ap-am
  real(16),parameter:: x3=-ap
...
implicit real(y)
  ...
  real,parameter:: x1=-am
  real,parameter:: x2=ap-am
  real,parameter:: x3=-ap
...
read(u,'(a)') c2(3)
read(u,'(a)') c2(4)
if (c1(1)/=m8)print *,11101
if (c1(2)/=mb)print *,11102
if (c1(3)/=m3)print *,11103
if (c1(4)/=m0)print *,11104
if (c2(1)/=m8)print *,11201
if (c2(2)/=mb)print *,11202
if (c2(3)/=m3)print *,11203
if (c2(4)/=m0)print *,11204
