...
res2=min(dmy1,r2_1,r2_2)
if(res2 /= dmy1)print*,"102"
res4=min(r4_1,r4_2,dmy1)
if(res4 /= dmy1)print*,"103"
res8=min(r8_1,r8_2,dmy1)
if(res8 /= dmy1)print*,"104"
res16=min(r16_1,r16_2,dmy1)
if(res16 /= dmy1)print*,"105"
res4=min(r4_1,dmy1,r4_1)
if(res4 /= dmy1)print*,"106"
res8=min(r8_1,dmy1,r8_2)
if(res8 /= dmy1)print*,"107"
res16=min(r16_1,dmy1,r16_2)
if(res16 /= dmy1)print*,"108"
res2=min(i1_1,i1_2,dmy1)
if(res2 /= dmy1)print*,"109"
res2=min(i1_4,i1_2,dmy1)
