     ...
     1     x3(2,2).zone ,  x3(2,2).values
      ...
      write(100)x1.date, x1.time ,x1.zone 
      call date_and_time(x2(2,2).date,
     1     x2(2,2).time                            )
      write(100)x2(2,2).date, x2(2,2).time ,
     1     x2(2,2).zone 
     ...
     1     x3(2,2).zone 
      ...
      write(100)x1.date, x1.time
      call date_and_time(x2(2,2).date)
      write(100)x2(2,2).date
      call date_and_time(x3(2,2).date)
      write(100)x3(2,2).date
      call date_and_time(    )
      call sd
      end
      subroutine sd
      ...
      write(100)count,count_rate,count_max
      call system_clock( x1.count,x1.count_rate,x1.count_max)
      write(100)x1.count,x1.count_rate,x1.count_max
      call system_clock( x2(2,2).count,x2(2,2).count_rate,
     1                   x2(2,2).count_max)
      write(100)x2(2,2).count,x2(2,2).count_rate,x2(2,2).count_max
      call system_clock( count,count_rate          )
      write(100)count,count_rate
      call system_clock( x1.count,x1.count_rate             )
      write(100)x1.count,x1.count_rate
      call system_clock( x2(2,1).count,x2(2,1).count_rate)
      write(100)x2(2,1).count,x2(2,1).count_rate
      call system_clock( count                     )
      write(100)count
      call system_clock( x1.count                           )
      write(100)x1.count
      call system_clock( x2(1,2).count                   )
      write(100)x2(1,2).count
      call system_clock(                           )
      end
