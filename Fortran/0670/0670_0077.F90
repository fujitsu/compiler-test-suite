...
subroutine s(k)
  ...
  complex(8) :: v04,v14(2),v24(k)
  complex(8),pointer :: v34(:)
  complex(8),target :: t43(3)

  character*16 v05,v15(2),v25(k)
  character*16,pointer:: v35(:)
  character*16,target :: t45(3)

  character(k+14) v06,v16(2),v26(k)
  character(k+14),pointer:: v36(:)
  character(k+14),target :: t46(3)

allocate(v36(2))
  if (sizeof(v06)/=16)print *,'error-61'
  if (sizeof(v16)/=16*2)print *,'error-62'
  if (sizeof(v26)/=16*2)print *,'error-63'
  if (sizeof(v36)/=16*2)print *,'error-64'
v36=>t46(1:3:2)
  if (sizeof(v36)/=16*2)print *,'error-65'

allocate(v35(2))
  if (sizeof(v05)/=16)print *,'error-51'
  if (sizeof(v15)/=16*2)print *,'error-52'
  if (sizeof(v25)/=16*2)print *,'error-53'
  if (sizeof(v35)/=16*2)print *,'error-54'
v35=>t45(1:3:2)
  if (sizeof(v35)/=16*2)print *,'error-55'

allocate(v34(2))
  if (sizeof(v04)/=16)print *,'error-41'
  if (sizeof(v14)/=16*2)print *,'error-42'
  if (sizeof(v24)/=16*2)print *,'error-43'
  if (sizeof(v34)/=16*2)print *,'error-44'
v34=>t43(1:3:2)
  if (sizeof(v34)/=16*2)print *,'error-45'
