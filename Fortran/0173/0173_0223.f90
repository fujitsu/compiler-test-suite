...
k=1
t%h%w=ff( f(  v ),k+1)
if (t%h%w(1)%z1(1)/=2+2 ) print *,101
if (t%h%w(1)%z2/=2+2 ) print *,101
if (t%h%w(1)%z3(1)/=2+2 ) print *,101
if (t%h%w(2)%z1(1)/=2+2 ) print *,101
if (t%h%w(2)%z2/=2+2 ) print *,101
if (t%h%w(2)%z3(1)/=2+2 ) print *,101
end
do k=1,100
call s1
end do
