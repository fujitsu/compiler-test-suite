...
subroutine chk 
rewind 4
read(4,*) k;if (k/=1) print *,301
read(4,*) k;if (k/=1) print *,302
read(4,*) k;if (k/=1) print *,303
read(4,*) k;if (k/=2) print *,305
read(4,*) k;if (k/=1) print *,306
read(4,*,end=10) k; print *,304
10 end 
