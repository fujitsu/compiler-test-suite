...
CONTAINS
 ...
 if (allocated(d%z1)) r%z1=d%z1+a%z1+1
   r%z2=d%z2+a%z2+1
 if (allocated(d%z1)) r%z3=d%z2+a%z3+1
  END FUNCTION 
END MODULE 
subroutine s1(k)
use  m1
...
if (allocated(v(5)%z3 )) print *,202
if (allocated(v(6)%z3 )) print *,203
if (any(w(1)%z1/=[13,15]+[23,25]+1)) print *,101
if (any(w(2)%z1/=[23,25]+[23,25]+1)) print *,102
if (any(w(3)%z1/=[33,35]+[23,25]+1)) print *,103
if (allocated(w(4)%z1 )) print *,201
if (allocated(w(5)%z1 )) print *,202
if (allocated(w(6)%z1 )) print *,203
if (any(w(1)%z2/=[13,15]+[23,25]+1) ) print *,101
if (any(w(2)%z2/=[23,25]+[23,25]+1) ) print *,102
if (any(w(3)%z2/=[33,35]+[23,25]+1) ) print *,103
if (any(w(1)%z3/=[13,15]+[23,25]+1) ) print *,101
if (any(w(2)%z3/=[23,25]+[23,25]+1) ) print *,102
if (any(w(3)%z3/=[33,35]+[23,25]+1) ) print *,103
if (allocated(w(4)%z3 )) print *,201
if (allocated(w(5)%z3 )) print *,202
if (allocated(w(6)%z3 )) print *,203
end
do kk=1,100
call s1(6)
end do
