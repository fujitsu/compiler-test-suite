...
deallocate(p)
if (t%h%w(1)%z1(1)/=4 ) print *,101
if (t%h%w(1)%z2/=4 ) print *,101
if (t%h%w(1)%z3(1)/=4 ) print *,101
if (t%h%w(2)%z1(1)/=4 ) print *,101
if (t%h%w(2)%z2/=4 ) print *,101
if (t%h%w(2)%z3(1)/=4 ) print *,101
end
do k=1,100
call s1
end do
