...
v(n2:n3)= ff(f(  v(n1:n2) ),n1+1)
if (v(n1)%z1(n1)/=1 ) print *,101
if (v(n1)%z2/=1 ) print *,101
if (v(n1)%z3(n1)/=1 ) print *,101
if (v(n2)%z1(n1)/=2+2 ) print *,101
if (v(n2)%z2/=2+2 ) print *,101
if (v(n2)%z3(n1)/=2+2 ) print *,101
if (v(n3)%z1(n1)/=2+2 ) print *,101
if (v(n3)%z2/=2+2 ) print *,101
if (v(n3)%z3(n1)/=2+2 ) print *,101
end
do k=1,100
call s1(1,2,3)
end do
