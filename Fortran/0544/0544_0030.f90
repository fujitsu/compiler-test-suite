...
v00p%x01=1
v00t%x01=0
call v00p%t_prc00(5_2) 
if (kk            /= 2006) print *,'error-067',kk
call v00t%t_prc00(5_2) 
if (kk            /= 105) print *,'error-0671',kk
call v00t%gen    (5_2) 
if (kk            /= 105) print *,'error-0672',kk
call v00p%gen    (5_2) 
if (kk            /= 2006) print *,'error-0673',kk
deallocate(v00p)
allocate(x1::v00p)
v00p%x01=1
call v00p%t_prc00(3_2) 
if (kk            /= 1004) print *,'error-034',kk
call v00t%t_prc00(3_2) 
if (kk            /= 103) print *,'error-0341',kk
call v00t%gen    (3_2) 
if (kk            /= 103) print *,'error-0342',kk
call v00p%gen    (3_2) 
if (kk            /= 1004) print *,'error-0343',kk
deallocate(v00p)
allocate(v00p)
v00p%x01=1
...
if (kk            /= 102) print *,'error-0331',kk
call v00t%gen    (2_2) 
if (kk            /= 102) print *,'error-0332',kk
call v00p%gen    (2_2) 
