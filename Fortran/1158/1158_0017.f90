...
use mod
  ...
  call aaa%y1234(   )
rewind 25
read(25,*)n;if(n/=2)print *,10111
read(25,*)n;if(n/=1)print *,10312
read(25,*)n;if(n/=2)print *,101111
read(25,*)n;if(n/=1)print *,103122

read(25,*)n;if(n/=2)print *,101
read(25,*)n;if(n/=4)print *,101
read(25,*)n;if(n/=3)print *,101
read(25,*)n;if(n/=2)print *,1011
read(25,*)n;if(n/=4)print *,1012
read(25,*)n;if(n/=3)print *,1031
