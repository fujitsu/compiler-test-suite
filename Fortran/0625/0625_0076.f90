...
type(a)::x
 character(k2),allocatable::p1(:,:,:)
allocate(character(k2)::p1(2,1,3))
p1='cdefgxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
x= a(2,p1)
if (x%a0/=2)print *,301,x%a0
...
type (aaa) :: v(:)
i2=-3
allocate(character(k2)::v(2)%p1(2,1,3))
v(2)%p1='cdefgxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
x= a(2,v(i2+5)%p1)
if (x%a0/=2)print *,301,x%a0
...
x= a(2,p1af())
if (x%a0/=2)print *,301,x%a0
if (len(x%a1)/=35)print *,7302,len(x%a1)
