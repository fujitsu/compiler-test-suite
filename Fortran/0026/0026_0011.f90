subroutine s1
real,parameter::a01   =bessel_jn( 0,    1.0_8)
real,parameter::a02   =bessel_jn( 1,    0.0_8)
real,parameter::a03(*)=bessel_jn( 0 ,0 ,1.0_8)
real,parameter::a04(*)=bessel_jn( 1 ,0 ,1.0_8)
real,parameter::a05(*)=bessel_jn( 0 ,1 ,1.0_8)
real,parameter::a06(*)=bessel_jn( 1 ,1 ,0.0_8)
real,parameter::a07   =bessel_jn( 1,    -0.0_8)
real,parameter::a08(*)=bessel_jn( 1 ,1 ,-0.0_8)

real,parameter::a11   =bessel_yn( 0,    1.0_8)
!!!real,parameter::a12(*)=bessel_yn( 1,    0.0_8)
real,parameter::a13(*)=bessel_yn( 0 ,0 ,1.0_8)
real,parameter::a14(*)=bessel_yn( 1 ,0 ,1.0_8)
real,parameter::a15(*)=bessel_yn( 0 ,1 ,1.0_8)
