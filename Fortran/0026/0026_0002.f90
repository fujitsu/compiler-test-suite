subroutine s1
write(2,*)bessel_jn( 0,    1.0_16)
write(2,*)bessel_jn( 1,    0.0_16)
write(2,*)bessel_jn( 0 ,0 ,1.0_16)
write(2,*)bessel_jn( 1 ,0 ,1.0_16)
write(2,*)bessel_jn( 0 ,1 ,1.0_16)
write(2,*)bessel_jn( 1 ,1 ,0.0_16)
write(2,*)bessel_jn( 1,    -0.0_16)
write(2,*)bessel_jn( 1 ,1 ,-0.0_16)

write(2,*)bessel_yn( 0,    1.0_16)
write(2,*)bessel_yn( 0 ,0 ,1.0_16)
write(2,*)bessel_yn( 1 ,0 ,1.0_16)
write(2,*)bessel_yn( 0 ,1 ,1.0_16)
end
call s1
call chk
print *,'pass'
