...
associate(nn=>n)
block
  character ,dimension(5)::a     (2)*(nn)
  character ,dimension(5)::b     (nn)*(nn)
  character ,dimension(5)::c     (nn)*(2 )
  character ,dimension(5)::d     (2 )*(2 )
  character(nn) ,dimension(5)::e     (2)*(nn)
  character(nn) ,dimension(5)::f     (nn)*(nn)
  character(nn) ,dimension(5)::g     (nn)*(2 )
  character(nn) ,dimension(5)::h     (2 )*(2 )
