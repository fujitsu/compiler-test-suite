...
associate(nn=>n)
block
  character ,dimension(100)::a*(nn)(2)
  character ,dimension(100)::b*(nn)(nn)
  character ,dimension(100)::c*(2 )(nn)
  character ,dimension(100)::d*(2 )(2 )
  character(nn) ,dimension(100)::e*(nn)(2)
  character(nn) ,dimension(100)::f*(nn)(nn)
  character(nn) ,dimension(100)::g*(2 )(nn)
  character(nn) ,dimension(100)::h*(2 )(2 )
