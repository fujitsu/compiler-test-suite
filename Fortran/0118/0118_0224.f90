...
real(4),dimension(1:3) :: ans = (/0.142899990_4,0.227479994_4,0.312059999_4/)
integer :: test_no
...
call sub1(a,s,x,w,2.7_4)
call check_x(x,1)
a = reshape((/(real(i,kind=4)*0.03_4,i=1,3*3)/),(/3,3/))
s = (/(real(i,kind=4)*0.03_4,i=1,3)/)
x = (/(real(i,kind=4)*0.03_4,i=4,6)/)
w = (/(real(i,kind=4)*0.07_4,i=1,3)/)
call sub2(a,s,x,w,2.7_4)
call check_x(x,2)
a = reshape((/(real(i,kind=4)*0.03_4,i=1,3*3)/),(/3,3/))
s = (/(real(i,kind=4)*0.03_4,i=1,3)/)
x = (/(real(i,kind=4)*0.03_4,i=4,6)/)
w = (/(real(i,kind=4)*0.07_4,i=1,3)/)
call sub3(a,s,x,w,2.7_4)
call check_x(x,3)
end program
