...
x = 3.3_8*matmul(transpose(a),s)+w
end subroutine
...
real(8),dimension(1:3) :: ans = (/0.1115799973328412_8,0.2350399930281938_8,0.3584999959897253_8/)
real(8),parameter :: error = 7.0000002028496E-02_8
integer :: test_no
do i=1,3
