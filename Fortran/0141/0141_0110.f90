...
contains
subroutine s1
call gnr( ceiling( a ) ,1)
call gnr( ceiling( a,kind=1 ),2 )
call gnr( ceiling( a,kind=2 ),3 )
call gnr( ceiling( a,kind=4 ),4 )
call gnr( ceiling( a,kind=8 ),5 )
end subroutine
