...
write(1,*) allocated(objTT%obj1(1,2)%alc)  &
       ...
       , allocated(objTT%obj1(2,3)%msg)  &
       , allocated(objTS%obj2(1,2)%alc)  &
       , allocated(objTS%obj2(2,2)%alc)  &
       , allocated(objTS%obj2(1,2)%alc2) &
       , allocated(objTS%obj2(2,2)%alc2) &
       , allocated(objTS%obj2(3,2)%msg)
