...
subroutine ss
     ...
     type is(ext)
       ...
       write(31,"(z16.16)") loc(p%name)
       write(32,"(z16.16)") loc(p%na)
       k=1
     end select
     if (k/=1) print *,1002
     k=0
     ...
     type is(ext)
       allocate(p  %name,source= a)
       allocate(p  %na,source= a)
       write(33,"(z16.16)") loc(p  %name)
       write(34,"(z16.16)") loc(p  %na)
       k=1
     end select
     if (k/=1) print *,1002
     end select
     ...
     k=0
      select type(v1)
       type is(e)
         ...
         if (.not.allocated(v1(2)%ma)) print *,645219
         if (.not.allocated(v1(2)%mame)) print *,645319
         if (.not.allocated(v1(2)%qa  )) print *,645419
       k=1
     end select
     if (k/=1) print *,1022
