integer arr1(3,2,1)
integer arr2(3,2,1)
if (ubound(arr1,1).ne.ubound(arr2,1)) print *,'fail'
if (ubound(arr1,2).ne.ubound(arr2,2)) print *,'fail'
if (ubound(arr1,3).ne.ubound(arr2,3)) print *,'fail'
if (lbound(arr1,1).ne.lbound(arr2,1)) print *,'fail'
if (lbound(arr1,2).ne.lbound(arr2,2)) print *,'fail'
if (lbound(arr1,3).ne.lbound(arr2,3)) print *,'fail'
call sub01()
call sub02()
call sub03()
call sub04()
