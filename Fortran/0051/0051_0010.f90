...
subroutine sub
 ...
 if(associated(ptr7).neqv..true.)print*,"107"
  ptr6 = "b"
 if(t6.ne."b")print*,"108"
 ptr4 =12
 if(tar2.ne.12)print*,"109"
 ptr =[1,2]
 if(tar(1).ne.1)print*,"110"
 if(tar(3).ne.2)print*,"110"
 ptr7 =["a","b"]
 if(t7(1).ne."a")print*,"111"
 if(t7(3).ne."b")print*,"112"
 print*,"PASS"
end
end
use m
