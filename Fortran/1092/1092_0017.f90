...
associate( k=> n)
  block
   character(k-1),dimension(p+int(k)) ::ary*(2),cry*(2)(2+k),bry*(2)(2+2),ary2*(2),bry2*(2)(2+2),cry2*(2)(2+k)
...
associate( k=> n)
  block
   character(k-1),dimension(p+2     ) ::ary*(2),cry*(2)(2+k),bry*(2)(2+2),ary2*(2),bry2*(2)(2+2),cry2*(2)(2+k)
    if (len (ary)/=2) print *,1001
