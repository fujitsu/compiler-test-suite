  ...
  144 CONTINUE
      DO 145 I=1,3000
        H006(3,I,1)=MOD(P006(2,I,1,1,1,1),Q006(1,1,I,1,1,1,1))
  145 CONTINUE
      WRITE(6,*) (H004(I),I=1,100,10)
      WRITE(6,*) (R004(I),I=1,10000,1000)
      WRITE(6,*)  H005
      WRITE(6,*) ((R005(J,I),J=1,3000,100),I=1,2)
      WRITE(6,*) (((H006(K,J,I),J=1,3000,300),I=1,1),K=1,3)
      END
