   ...
   40 CONTINUE
      ...
      DO 50 J=1,10
      DO 50 I=1,20
       A(I,J,K,L)=B(I,J,K+10,L)+1.
       B(I,J,K,L)=B(I,J+1,K+10,L)+1./6.
   50 CONTINUE
      WRITE(6,*) (A(I,10,10,10),I=1,10)
      WRITE(6,*) (B(I,10,10,10),I=1,10)
