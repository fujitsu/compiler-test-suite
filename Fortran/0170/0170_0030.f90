...
aa=[ complex::a1, a2(vs,m,m) , a3 , [(((a2(k1,k2,k3),k1=1,n),k2=1,m),k3=1,m)],  a2(n,m,m) , a4, a1+a1 , a2+a2 , a3+a3, n+a4 ]
call foo([ complex::a1, a2(vs,m,m), a3 , [(((a2(k1,k2,k3),k1=1,n),k2=1,m),k3=1,m)],  a2(n,m,m) , a4, a1+a1 , a2+a2 , a3+a3, n+a4 ])
if (size([ complex:: a1, a2(vs,m,m), a3 , [(((a2(k1,k2,k3),k1=1,n),k2=1,m),k3=1,m)],  a2(n,m,m) , a4, a1+a1 , a2+a2 , a3+a3, n+a4 ])/=size(am)) print *,201
if (any(ubound([ complex::a1, a2(vs,m,m), a3 , [(((a2(k1,k2,k3),k1=1,n),k2=1,m),k3=1,m)],  a2(n,m,m) , a4, a1+a1 , a2+a2 , a3+a3, n+a4 ])/=size(am))) print *,202
