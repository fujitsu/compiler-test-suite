...
p1=> t(:,::2)
if (any([ p1 ]/=[1,2,5,6])) print *,101
call ss( [ p1 ],[1,2,5,6])
if (any(ubound([ p1])/= 4)) print *,102
p2=> t(2,::2)
if (any([ p2 ]/=[2,6])) print *,201
call ss( [ p2 ],[2,6])
if (any([ fp1() ]/=[1,2,5,6])) print *,101
call ss( [ fp1() ],[1,2,5,6])
if (any(ubound([ fp1()])/= 4)) print *,102
if (any([ fp2() ]/=[2,6])) print *,201
call ss( [ fp2() ],[2,6])
if (any([ ep1(p1) ]/=[1,2,5,6])) print *,101
call ss( [ ep1(p1) ],[1,2,5,6])
if (any(ubound([ ep1(p1)])/= 4)) print *,102
if (any([ ep1(p2) ]/=[2,6])) print *,201
call ss( [ ep1(p2) ],[2,6])
contains
subroutine ss(x,y)
integer::x(:)
