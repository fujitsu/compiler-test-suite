...
integer:: a(k2,k3),b(k1)
b(:(k2*k3)*2)= [ ((a(n1,n2),n1=1,k2),n2=1,k3),((a(n1,n2),n1=1,k2),n2=1,k3)   ]
end
subroutine t06(a,b)
...
integer:: a(k2,k3),b(k1)
b(:)= [ ((a(n1,n2)+1,n1=1,k2),n2=1,k3),((a(n1,n2)+1,n1=1,k2),n2=1,k3)   ]
end
subroutine t16(a,b)
integer:: a(600),b(600*2)
b(:)= [ a+1, a+1   ]
