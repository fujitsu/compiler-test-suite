...
use m1
integer         ::t1(2),k1(2)=[1,2]
integer         ::t2(2,1,3),k2(2,1,3)=reshape([1,2,3,4,5,6],[2,1,3])
t1=k1
t2=k2
ip1=loc(t1)
ip2=loc(t2)
call s1(n=0)
call s1(t1,t2,3)
 if (any([t2]/=10+[1,2,3,4,5,6])) print *,27024
 if (any(t1/=[3,4])) print *,237014
t1=k1
call s1(t1,n=1)
 if (any(t1/=[3,4])) print *,337014
t2=k2
call s1(b=t2,n=2)
 if (any([t2]/=10+[1,2,3,4,5,6])) print *,37024
print *,'pass'
end
