module m1
  contains
    subroutine s1(p1,p2,p3,p4,n1,n2,n3,n4)
      ...
      if (n1==0) then
      call ss2(   x=p2,y=p3,z=p4,n1=n1,n2=n2,n3=n3,n4=n4)
      if (fs2(   x=p2,y=p3,z=p4,n1=n1,n2=n2,n3=n3,n4=n4)/=0) print *,104
       endif
      if (n1==0 .and. n4==0) then
      call ss2(   x=p2,y=p3,      n1=n1,n2=n2,n3=n3,n4=n4)
      if (fs2(   x=p2,y=p3,      n1=n1,n2=n2,n3=n3,n4=n4)/=0) print *,104
       endif
    end subroutine
    subroutine ss2(w,x,y,z,n1,n2,n3,n4)
      integer,optional:: w(6),x(:,:),y(:,:),z(6)
    if (n1==0) then
