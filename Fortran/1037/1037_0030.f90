...
real(8),dimension(i2:,i2:)::y
real(8),dimension(i2:)::x,z
z=matmul(x,y)
end subroutine sub1
end
subroutine b124
...
contains
subroutine sub1(x,y,z)
real(4),dimension(i2:,i2:)::y
real(4),dimension(i2:)::x,z
z=matmul(x,y)
end subroutine sub1
end
subroutine b214
...
contains
subroutine sub1(x,y,z)
real(4),dimension(i2:,i2:)::x
real(4),dimension(i2:)::y,z
z=matmul(x,y)
end subroutine sub1
end
subroutine b218
...
contains
subroutine sub1(x,y,z)
real(8),dimension(i2:,i2:)::x
real(8),dimension(i2:)::y,z
z=matmul(x,y)
end subroutine sub1
end
subroutine b224
