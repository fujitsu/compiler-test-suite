...
if (any(abs((/c(::2,3)/)-(/143,683,1223/)-5)>0.001))print *,'error-124'
contains
subroutine sub1(x,y,z,w)
real(kk),dimension(:,:)::y
real(kk),dimension(:)::x,z,w
w=3
z=matmul(x,y)+w+2.0*z
end subroutine sub1
end subroutine 
subroutine b214(a,b,c,d)
real(kk),dimension(:,:)::a,b,c,d
call sub1(a(::2,::2),b(::2,3),c(::2,3),d(::2,3))
if (any(abs((/c(::2,3)/)-(/633,723,813/)-5)>0.001))print *,'error-218'
contains
subroutine sub1(x,y,z,w)
real(kk),dimension(:,:)::x
...
if (any(abs((/c(::2,::2)/)-5-(/165,183,201,633,723,813,1101,1263,1425/))>0.001))print *,'error-228'
contains
subroutine sub1(x,y,z,w)
