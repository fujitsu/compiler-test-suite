module mod01
 type m01ty01
  ...
  procedure(integer), nopass, pointer :: m01t01_ppii_01 => null()
 end type
end module
...
if (m01ty01_tt01%m01t01_ppii_01(2, 1).ne.1) print *,'error'
...
function m02ifunc01() result(m02irst01)
 ...
 intrinsic :: iabs
 type (m01ty01) :: m02irst01
 m02irst01 = m01ty01(m01t01_ppii_01 = iabs)
end function
