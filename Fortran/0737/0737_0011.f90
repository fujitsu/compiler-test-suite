      ...
      if (     present(a1)) then;if (len(a1(1))/=1)write(6,*) "NG";endif
      if (     present(a2)) then;if (len(a2)/=1)write(6,*) "NG";endif
      if (     present(a2)) then;a2='1';endif
      ...
      a1='0';a2='0';f1=t;f2=t;call s11(a1=a1f,a2=a2,f1=f1,f2=f2)
      if (a1/='0')write(6,*) "NG"; if (any(a2/='1'))write(6,*) "NG"
!
      a1='0';a2='0';f1=f;f2=t;call s11(      a2=a2,f1=f1,f2=f2)
      if (a1/='0')write(6,*) "NG"; if (any(a2/='1'))write(6,*) "NG"
!
      a1='0';a2='0';f1=t;f2=f;call s11(a1=a1f     ,f1=f1,f2=f2)
