...
if (allocated(xv1%x0))write(6,*) "NG"
if (allocated(xv1%x1))write(6,*) "NG"
if (allocated(xv1%x2))write(6,*) "NG"
if (allocated(xv1%x3))write(6,*) "NG"
if (allocated(xv1%x4))write(6,*) "NG"
if (allocated(xv1%x5))write(6,*) "NG"
xv1=x(null(),xx0,xx1,xx2,xx3,xx4,xx5)
if (associated(xv1%next))write(6,*) "NG"
if (allocated(xv1%x0))write(6,*) "NG"
if (allocated(xv1%x1))write(6,*) "NG"
if (allocated(xv1%x2))write(6,*) "NG"
...
xv1=x(null(),yy0,yy1,yy2,yy3,yy4,yy5)
if (associated(xv1%next))write(6,*) "NG"
if (any(xv1%x0/=yy0))write(6,*) "NG"
if (any(xv1%x1/=yy1))write(6,*) "NG"
if (any(xv1%x2/=yy2))write(6,*) "NG"
...
if (any(xv1%x4/=yy4))write(6,*) "NG"
if (any(xv1%x5/=yy5))write(6,*) "NG"
xv1=x(null(),y0(:,:)+yy0-y0,y1(:,:)+yy1-y1,y2(:,:)+yy2-y2,y3(:,:).or.yy3,cx//y4(:,:),y5(:,:))
if (associated(xv1%next))write(6,*) "NG"
if (any(abs(xv1%x0-yy0)>0.0001))write(6,*) "NG"
if (any(xv1%x0/=yy0))write(6,*) "NG"
if (any(xv1%x1/=yy1))write(6,*) "NG"
if (any(xv1%x2/=yy2))write(6,*) "NG"
if (any(xv1%x3/=yy3))write(6,*) "NG"
