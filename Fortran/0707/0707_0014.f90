 ...
 module m1
  ...
  subroutine i4_4(a)
   character(n),dimension(1,1,2*3,4,5)::a,ax(1,1,2*2*3,4,5);target ax
   ...
   call ss2(reshape(ax(:,:,v3,:,:),(/2*3,4,5/)))
   ...
   call ss3(reshape(ax(:,:,v3,:,:),(/2*3,4,5/)))
   ...
   write(iu,*) reshape(ax(:,:,v3,:,:),(/2*3,4,5/))
   write(iu,*) reshape(ax(:,:,v3,:,:),(/2*3,4,5/))
   call ss4
  end subroutine
  subroutine i4_3(a)
  ...
  subroutine i4_1(a)
   ...
   call ss2(reshape(ap,(/2*3,4,5/)))
   call ss2(reshape(ax(2::2),(/2*3,4,5/)))
   call ss2(reshape(ax(v5),(/2*3,4,5/)))
   call ss2(reshape((/(cmplx(i,i,16),i=11,11+2*3*4*5-1)/),(/2*3,4,5/)))
   call ss3(reshape(a, (/2*3,4,5/)))
   call ss3(reshape(ap,(/2*3,4,5/)))
   call ss3(reshape(ax(2::2),(/2*3,4,5/)))
   call ss3(reshape(ax(v5),(/2*3,4,5/)))
   call ss3(reshape((/(cmplx(i,i,16),i=11,11+2*3*4*5-1)/),(/2*3,4,5/)))
   write(iu,*) reshape(a,(/2*3,4,5/))
   write(iu,*) reshape(ap,(/2*3,4,5/))
   write(iu,*) reshape(ax(2::2),(/2*3,4,5/))
   write(iu,*) reshape(ax(v5),(/2*3,4,5/))
   write(iu,*) reshape(ax(v5),(/2*3,4,5/))
   call ss4
  end subroutine
  subroutine ss2(a)
 ...
 subroutine s1
 use m1
 integer(4),dimension(2*3*4*5),parameter::a1=reshape((/(i,i=11,11+2*3*4*5-1)/),(/2*3*4*5/))
 integer(4),dimension(2*3,4*5),parameter::a2=reshape((/(i,i=11,11+2*3*4*5-1)/),(/2*3,4*5/))
 integer(4),dimension(2*3,4,5),parameter::a3=reshape((/(i,i=11,11+2*3*4*5-1)/),(/2*3,4,5/))
 integer(4),dimension(1,1,2*3,4,5),parameter::a4=reshape((/(i,i=11,11+2*3*4*5-1)/),(/1,1,2*3,4,5/))
 iu=25
