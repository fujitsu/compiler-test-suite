...
i=0; call ss6(ia1,ia2,ia3,ia4);if (i.ne.j)print *,'fail'
 ...
 if (c1(k1:k2).eq.c3(k1:k2).and. &
     c2(k1:k2).eq.c4(k1:k2)) i=i+2 
 end subroutine
 subroutine ss4(id1,id2,id3,id4)
 character*(2) d1,d2,d3,d4
 pointer (id1,d1); pointer (id2,d2); pointer (id3,d3); pointer (id4,d4)
 if (d1(k1:k2).eq.d2(k1:k2)) i=i+1 
 if (d1(k1:k2).eq.d3(k1:k2).and. &
     d2(k1:k2).eq.d4(k1:k2)) i=i+2 
 end subroutine
 subroutine ss5
 if (c1(k1:k2).eq.c2(k1:k2).and. &
     c1(k1:k2).eq.c2(k1:k2)) i=i+1 
 if (c1(k1:k2).eq.c3(k1:k2).and. &
     c2(k1:k2).eq.c4(k1:k2).and. &
     c1(k1:k2).eq.c3(k1:k2).and. &
     c2(k1:k2).eq.c4(k1:k2)) i=i+2 
 end subroutine
 ...
 if (d1(k1:k2).eq.d3(k1:k2).and.   &
     d2(k1:k2).eq.d4(k1:k2).and.   &
     d1(k1:k2).eq.d3(k1:k2).and.   &
     d2(k1:k2).eq.d4(k1:k2)) i=i+2 
 end subroutine
end
