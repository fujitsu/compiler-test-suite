    program foralls
      ...
      subroutine sub1()
        forall(i7=1:n,a1(i7)>=2)
          a1(i7)=a1(i7)+1
          forall(i6=1:n,a2(i7,i6)>=4)
            a2(i7,i6)=a2(i7,i6)+1
            forall(i5=1:n,a3(i7,i6,i5)>=6)
              a3(i7,i6,i5)=a3(i7,i6,i5)+1
              forall(i4=1:n,a4(i7,i6,i5,i4)>=8)
                a4(i7,i6,i5,i4)=a4(i7,i6,i5,i4)+1
                forall(i3=1:n,a5(i7,i6,i5,i4,i3)>=10)
                  a5(i7,i6,i5,i4,i3)=a5(i7,i6,i5,i4,i3)+1
                  forall(i2=1:n,a6(i7,i6,i5,i4,i3,i2)>=12)
                    a6(i7,i6,i5,i4,i3,i2)=a6(i7,i6,i5,i4,i3,i2)+1
                    forall(i1=1:n,a7(i7,i6,i5,i4,i3,i2,i1)>=14)
