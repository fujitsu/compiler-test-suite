...
use m1
      type(*),dimension(..)::b
integer::a=1
write(106,  '("z a:",z16.16)')loc(a)
write(106,  '("z b:",z16.16)')loc(b)
call sub1(a)
call sub1(b)
call sub2(a)
call sub3(a)
