...
use mod3,only : jjj,lll
use mod3_1,only : iii
use mod_b,only:jjj2=>jjj
use mod4_1,only:vvv,jjj2,mmmv=>mmm,mmm=>mmma
if(500.ne.mmm) write(6,*) "NG"
if(123.ne.mmmv) write(6,*) "NG"
