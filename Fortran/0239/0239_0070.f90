...
b=2
associate( p=>a(-n1:-n5:-n1,-n1:-n4:-n1),w=>c(-n1:-n5:-n1,-n1:-n4:-n1))
 w(6-n1:6-n5:-n1,5-n1:5-n4:-n1)=p(6-n1:6-n5:-n1,5-n1:5-n4:-n1)+b(-n1:-n5:-n1,-n1:-n4:-n1)
end associate
...
do k2=-1,-4,-1
do k1=-1,-5,-1
 w(6+k1,5+k2)=p(6+k1,5+k2)+b(k1,k2)
end do
end do
end associate
...
allocate (b(n5,n4),stat=kkk)
allocate (c(n5,n4),stat=kkk)
a=1
b=2
do k2=1,4
do k1=1,5
