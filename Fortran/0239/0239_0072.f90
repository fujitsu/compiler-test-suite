...
do k2=1,3
do k1=1,4
associate( p=>a(k1,k2),w=>a)
 w(k1+1,k2+1)=p+b(k1,k2)
end associate
end do
end do
...
a=1
b=2
associate( p=>a(n1:n5,n1:n4),w=>a(n1:n5,n1:n4))
 w(n2:n5,n2:n4)=p(:n4,:n3)+b(:n4,:n3)
end associate
...
b=2
associate( p=>a(n1:n5,n1:n4),w=>a(n1:n5,n1:n4))
 w(n2:n5,n2:n4)=p(n1:n4,n1:n3)+b(n1:n4,n1:n3)
end associate
