program main
  ...
  call test_basic_mult_r4(fa, fb, fc, fd, 10)
  call test_basic_mult_r8(da, db, dc, dd, 10)
  
  write(*,*) 'fd =', fd
  write(*,*) 'dd =', dd
end program main

subroutine test_basic_mult_r4(a, b, c, d, n)
  integer :: n
...
end subroutine test_basic_mult_r4

subroutine test_basic_mult_r8(a, b, c, d, n)
  integer :: n
...
end subroutine test_basic_mult_r8
