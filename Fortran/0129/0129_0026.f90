program main
  ...
  call test_extended_msub_r4(fa, fb, fc, fd, 10)
  call test_extended_msub_r8(da, db, dc, dd, 10)
  
  write(*,*) 'fd =', fd
  write(*,*) 'dd =', dd
end program main

subroutine test_extended_msub_r4(a, b, c, d, n)
  integer :: n
  ...
  do i=1, n-1, 2
     d(i) = a(i) * c(i)
     d(i+1) = (-a(i+1) * b(i+1) + c(i+1)) * c(i+1)
  end do
end subroutine test_extended_msub_r4

subroutine test_extended_msub_r8(a, b, c, d, n)
  integer :: n
...
end subroutine test_extended_msub_r8
