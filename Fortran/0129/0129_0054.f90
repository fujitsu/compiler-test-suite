...
subroutine test_basic_add_r4_1(a, b, c, j, n)
  integer :: n
  real*4, dimension(n) :: a, b, c
  integer :: j
  a(j) = b(j) + c(j)
end subroutine test_basic_add_r4_1

subroutine test_basic_add_r4_2(a, b, c, j, n)
  integer :: n
  real*4, dimension(n) :: a, b, c
  integer :: j
  a(j+1) = b(j+1) + c(j+1)
end subroutine test_basic_add_r4_2
...
subroutine test_basic_add_r4(a, b, c, d, n)
  ...
  do j=1, n-1, 2
    call test_basic_add_r4_1(a, b, c, j,n)
    call test_basic_add_r4_2(a, b, c, j,n)
  end do
