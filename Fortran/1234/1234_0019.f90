...
module m4
  ...
  allocate(d%x12)
  allocate(d%x12%y01,source='12')
  allocate(d%x21,source='12')
  allocate(d%x22)
  allocate(d%x22%y01,source='12')
  allocate(d%x22%y11,source='12')
  ...
  select type(d)
    type is(x3)
      ...
      if (d%x12%y01/='12') print *,3012
      if (d%x21/='12') print *,3003
      if (d%x22%y01/='12') print *,3013
      if (d%x22%y11/='12') print *,3023
