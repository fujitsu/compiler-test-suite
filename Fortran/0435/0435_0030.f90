...
v=x(0,[0,0])
v=[f(w)]
if (v(1)%a/=2) print *,1061112
if (v(2)%a/=2) print *,1061213
if (any(v(1)%z/=[1,2])) print *,101212,v(1)%z
if (any(v(2)%z/=[1,2])) print *,106213
if (size(v(2)%z)/=2) print *,106313
v=x(0,[0,0])
v=[(f(w),n=1,1)]
if (v(1)%a/=2) print *,1061114
if (v(2)%a/=2) print *,1061215
if (any(v(1)%z/=[1,2])) print *,101212,v(1)%z
if (any(v(2)%z/=[1,2])) print *,106213
if (size(v(2)%z)/=2) print *,106313
v=x(0,[0,0])
v=[(f(w(2)),n=1,2)]
if (v(1)%a/=2) print *,106111
if (v(2)%a/=2) print *,106121
if (any(v(1)%z/=[1,2])) print *,101212,v(1)%z
if (any(v(2)%z/=[1,2])) print *,106213
if (size(v(2)%z)/=2) print *,106313
v=x(0,[0,0])
