...
type(ty3)::obj6 = ty3(ty1(ty(E1),[ty2(tty(t1),t1),ty2(t1,t1),ty2(t1,NULL())],[ty(E1),ty(E1),ty(NULL())]))
type(ty3)::obj5
type(ty3)::obj7 = ty3(ty1(ty(E1),[ty2(tty(t1),t1),ty2(t1,t1),ty2(t1,NULL())],[ty(E1),ty(E1),ty(NULL())])) 
data obj5 /ty3(ty1(ty(E1),[ty2(tty(t1),t1),ty2(t1,t1),ty2(t1,NULL())],[ty(E1),ty(E1),ty(NULL())]))/
