...
call jfoo(p1(::k,:),p2,p3(:,::k),p4,p5(:,::k),p6,&
          p11,p12(::k,:),p13,p14(::k,:),p15,p16(::k,:),i)
j=0
end subroutine
end
...
subroutine jfoo(i1,i2,i3,i4,i5,i6,i11,i12,i13,i14,i15,i16,i)
integer i1(6),i2(6),i3(6)
integer i4(6),i5(6),i6(6)
integer i11(6),i12(6),i13(6)
integer i14(6),i15(6),i16(6)
...
case (2)
   ...
   if (any(i11/=r))print *,i11
   if (any(i12/=s))print *,i12
   if (any(i13/=s))print *,i13
   if (any(i14/=r))print *,i14
