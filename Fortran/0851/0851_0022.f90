...
call typeA_foo(type_a,str(1:1,1,1:6)%array(1)(1:))
call foo(type_a,str(1:1,1,1:6)%array(1)(1:))
call type_a%foo(str(1:1,1,1:6)%array(1)(1:))
call= type_a%ffoo(str(1:1,1,1:6)%array(1)(1:))
