...
if ( kind(ar4) .ne. i4) print *,'fail'
if ( kind(ar8) .ne. i8) print *,'fail'
if ( kind(ar16) .ne. i16) print *,'fail'
if ( kind(pr4) .ne. i4) print *,'fail'
if ( kind(pr8) .ne. i8) print *,'fail'
if ( kind(pr16) .ne. i16) print *,'fail'
print *,'pass '
end
