 ...
 do i2=1,ubound(a1,k2); do i1=1,ubound(a1,1)
   ...
   if (     any(reshape(shape=(/2,3/),source='x'==a1(:,:)))) then;else ;print *,'fail';endif
   if (.not.any(reshape(shape=(/2,3/),source='x'==a1(:,:)))) then;print *,'fail';else ;endif
   if (     any(reshape(shape=(/2,3/),source='x'==a1(v1(1):v1(2),v2(1):v2(3))))) then;else ;print *,'fail';endif
   if (.not.any(reshape(shape=(/2,3/),source='x'==a1(v1(1):v1(2),v2(1):v2(3))))) then;print *,'fail';else ;endif
   if (     any(reshape(shape=(/2,3/),source='x'==a1(v1,v2)))) then;else ;print *,'fail';endif
   if (.not.any(reshape(shape=(/2,3/),source='x'==a1(v1,v2)))) then;print *,'fail';else ;endif
   if (     any(reshape(shape=(/2,3/),source='x'==(/a1(v1,v2)/)))) then;else ;print *,'fail';endif
   if (.not.any(reshape(shape=(/2,3/),source='x'==(/a1(v1,v2)/)))) then;print *,'fail';else ;endif
   if (     any(reshape(shape=(/2,3/),source='x'==(/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/)))) then;else ;print *,'fail';endif
   if (.not.any(reshape(shape=(/2,3/),source='x'==(/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/)))) then;print *,'fail';else ;endif
