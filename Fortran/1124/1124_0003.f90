 ...
 do i2=1,ubound(a1,k2); do i1=1,ubound(a1,1)
   ...
   if (     any('x'==a1(v1,v2).and.'x'==a1(v1,v2))) then;else ;print *,'fail';endif
   if (.not.any('x'==a1(v1,v2).and.'x'==a1(v1,v2))) then;print *,'fail';else ;endif
   if (     any('x'==(/a1(v1,v2)/).and.'x'==(/a1(v1,v2)/))) then;else ;print *,'fail';endif
   if (.not.any('x'==(/a1(v1,v2)/).and.'x'==(/a1(v1,v2)/))) then;print *,'fail';else ;endif
   if (     any('x'==(/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/).and.&
                'x'==(/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/))) then;else ;print *,'fail';endif
   if (.not.any('x'==(/a1(1,1),a1(2,1),a1(1,2),a1(2,2),a1(1,3),a1(2,3)/).and.&
