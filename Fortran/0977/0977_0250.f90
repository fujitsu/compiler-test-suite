...
subroutine sp1(p1,p2,p3,p4,p5,p6,j,i)
   integer,optional,pointer::p1(:,:)
   integer,optional,pointer::p2(:,:)
   integer,optional,pointer::p4(:,:)
   integer,optional,pointer::p5(:,:)
   integer,optional,pointer::p6(:,:)
   integer,optional,allocatable::p3(:,:)
if (i/=2) then
