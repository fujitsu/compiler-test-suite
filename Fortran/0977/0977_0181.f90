subroutine s(i,k)
 type x
   complex(8),pointer::p1(:),p2(:)
 end type
 type (x),pointer:: v(:)
 complex(8),target::t1(3)=(/(1,1),(2,2),(3,3)/)
 complex(8),target::t2(4)=(/(4,4),(5,5),(6,6),(7,7)/)
 pointer(n1,d1)
 pointer(n2,d2)
complex(8) j,jfoo
 allocate(v(k))
...
complex(8) function jfoo(i1,i2,n1,n2,i)
complex(8) i1(2),i2(2)
 pointer(n1,d1)
 pointer(n2,d2)
select case(i)
 case (1)
   ...
   if (loc(i1)/=n1)write(41,*) i,'i1 copied'
   if (loc(i2)==n2)write(41,*) i,'i2 no copied'
 case (2)
   ...
   if (loc(i1)/=n1)write(41,*) i,'i1 copied'
   if (loc(i2)/=n2)write(41,*) i,'i2 copied'
 case (3)
   ...
   if (loc(i1)==n1)write(41,*) i,'i1 no copied'
   if (loc(i2)/=n2)write(41,*) i,'i2 copied'
 case (4)
