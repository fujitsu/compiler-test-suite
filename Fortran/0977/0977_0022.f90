module typedef
   ...
   do mu = 1, 4
     do eo = 0, 1
       do i = 1, volh
        ...
        call staple(uuu,gauge(1)%u,i,eo,mu,gauge(1)%u )
      end do
     end do
    end do
 ...
 subroutine staple(uuu, u, i, e, mu,u2)
    use module_vol

      complex(8), dimension (3, 3), intent(out) :: uuu
      complex(8), dimension (3, 3, volh_tot, 0:1, 4), intent(in) :: u,u2
