...
allocate(bi1(3),bi2(3),bi4(3),bi8(3))
ai1 =(/1_1,2_1,3_1/)
ai2 =(/1_2,2_2,3_2/)
ai4 =(/1,2,3/)
ai8 =(/1_8,2_8,3_8/)
...
allocate(br(3),bd(3),bq(3),bdp(3))
ar =(/1.0,2.0,3.0/)
ad =(/1.0d0,2.0d0,3.0d0/)
aq =(/1.0q0,2.0q0,3.0q0/)
adp =(/1.0d0,2.0d0,3.0d0/)
br =(/3.0,2.0,1.0/)
bd =(/3.0d0,2.0d0,1.0d0/)
bq =(/3.0q0,2.0q0,1.0q0/)
bdp =(/3.0d0,2.0d0,1.0d0/)
...
allocate(bc(3),bcd(3),bcq(3),bdc(3))
...
bc =(/(-1.0,1.0),(-2.0,2.0),(-3.0,3.0)/)
bcd =(/(-1.0d0,1.0d0),(-2.0d0,2.0d0),(-3.0d0,3.0d0)/)
bcq =(/(-1.0q0,1.0q0),(-2.0q0,2.0q0),(-3.0q0,3.0q0)/)
bdc =(/(-1.0d0,1.0d0),(-2.0d0,2.0d0),(-3.0d0,3.0d0)/)
...
allocate(bl1(3),bl2(3),bl4(3),bl8(3))
al1 =.true._1
al2 =.true._2
al4 =.true._4
al8 =.true._8
