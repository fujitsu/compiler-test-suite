...
call s1(x1,1)
if (x1/='1234')write(6,*) "NG"
x2(3)(j4-1:j1+2)='a';x2(4)='bcd'
call s1(x2(3)(j4-1:j1+2),1)
if (x2(3)(j4-1:j1+2)//x2(4)/='1234')write(6,*) "NG"
x3(4:)='abcd'
call s1(x3(j4:),1)
if (x3(4:)/='1234')write(6,*) "NG"
x2(2)(2:3)='ab';x2(3)(1:2)='cd'
call s1(x2(2)(j4-2:2),1)
if (x2(2)(2:3)//x2(3)(:2)/='1234')write(6,*) "NG"
x3(2:5)='abcd'
call s1(x3(2:j4+1),1)
if (x3(2:5)/='1234')write(6,*) "NG"
call s2(f('abcd',4),0)
x2(4)(j4-1:j1+2)='a';x2(2)='bcd'
call s2(x2(j4)(j4-1:j1+2)//x2(2),0)
print *,'pass'
end
  subroutine s1(a,i)
   character a(2,1,2)
   if (a(1,1,1)//a(2,1,1)//a(1,1,2)//a(2,1,2)/='abcd')write(6,*) "NG"
   if (i==1)a(:,:,:2)=reshape((/'1','2','3','4'/),(/2,1,2/))
  end subroutine
  subroutine s2(a,i)
   character a(2,1,2)
   if (a(1,1,1)//a(2,1,1)//a(1,1,2)//a(2,1,2)/='abcd')write(6,*) "NG"
