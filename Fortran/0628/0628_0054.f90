...
entry      x011(i1,n1,j1,k1,&
                i2,n2,j2,k2,&
                i4,n4,j4,k4,&
                i7,n7,j7,k7) 
entry      x012(i1,n1,j1,k1,&
                i2,n2,j2,k2,&
                i4,n4,j4,k4,&
                i7,n7,j7,k7) 
entry      x013(i1,n1,j1,k1,&
                i2,n2,j2,k2,&
                i4,n4,j4,k4,&
                i7,n7,j7,k7) 
i1=3;j1=3;k1=n1
...
call x011(v%pis11, 1,v%pis12,v%pis13,&
          v%pia11(:),1, v%pia12(:),v%pia13(:),&
          v%pcs11,1,v%pcs12,v%pcs13,&
          v%pca11(:)(2:3),1,v%pca12(:)(2:3),v%pca13(:)(2:3))
call x012(v%pis11, 1,v%pis12,v%pis13,&
          v%pia11(:),1, v%pia12(:),v%pia13(:),&
          v%pcs11,1,v%pcs12,v%pcs13,&
          v%pca11(:)(2:3),1,v%pca12(:)(2:3),v%pca13(:)(2:3))
call x013(v%pis11, 1,v%pis12,v%pis13,&
          v%pia11(:),1, v%pia12(:),v%pia13(:),&
          v%pcs11,1,v%pcs12,v%pcs13,&
          v%pca11(:)(2:3),1,v%pca12(:)(2:3),v%pca13(:)(2:3))
end subroutine 
...
call x011(pis11, 1,pis12,pis13,&
          pia11(:),1, pia12(:),pia13(:),&
          pcs11,1,pcs12,pcs13,&
          pca11(:)(2:3),1,pca12(:)(2:3),pca13(:)(2:3))
call x012(pis11, 1,pis12,pis13,&
          pia11(:),1, pia12(:),pia13(:),&
          pcs11,1,pcs12,pcs13,&
          pca11(:)(2:3),1,pca12(:)(2:3),pca13(:)(2:3))
call x013(pis11, 1,pis12,pis13,&
          pia11(:),1, pia12(:),pia13(:),&
          pcs11,1,pcs12,pcs13,&
          pca11(:)(2:3),1,pca12(:)(2:3),pca13(:)(2:3))
end subroutine
