 ...
 print *,'pass'
  ...
  subroutine s1
  use m1
procedure(dy),pointer::dyp
procedure(ry),pointer::ryp
procedure(qy),pointer::qyp
dyp=>dy
qyp=>qy
ryp=>ry
  ...
  if (any(abs((/-1_1/))/=1))print *,'fail'
  if (any(abs((/-2_2/))/=2))print *,'fail'
  if (any(abs((/-3_4/))/=3_4))print *,'fail'
  if (any(abs((/-4_8/))/=4))print *,'fail'
  if (any(abs((/-5._4/))/=5._4))print *,'fail'
  if (any(abs((/-7._8/))/=7._8))print *,'fail'
  if (any(abs((/-9._16/))/=9._16))print *,'fail'
  if (any(ry(abs((/(-1._4,-2._4)/))-c1((-1._4,-2._4)))>0.000001))print *,'fail'
  if (any(dy(abs((/(-1._8,-2._8)/))-c2((-1._8,-2._8)))>0.00000001_8))print *,'fail'
  if (any(qy(abs((/(-1._16,-2._16)/))-c3((-1._16,-2._16)))>0.1e-16_16))print *,'fail'
  if (any(ryp(abs((/(-1._4,-2._4)/))-c1((-1._4,-2._4)))>0.000001))print *,'fail'
  if (any(dyp(abs((/(-1._8,-2._8)/))-c2((-1._8,-2._8)))>0.00000001_8))print *,'fail'
  if (any(qyp(abs((/(-1._16,-2._16)/))-c3((-1._16,-2._16)))>0.1e-16_16))print *,'fail'
  contains 
   function rx(r)
   intrinsic abs
   complex(4)::r
