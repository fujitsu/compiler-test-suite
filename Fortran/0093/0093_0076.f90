...
READ(UNIT=77,*) ((((((((OBJR(I)%A%RE,I=1,2),J=1,2),K=1,2),S=1,2),R=1,2),Y=1,2),F=1,2),G=1,2)
READ(UNIT=77,*) ((((((((OBJR(I)%A%IM,I=1,2),J=1,2),K=1,2),S=1,2),R=1,2),Y=1,2),F=1,2),G=1,2)
     CLOSE (UNIT=77,status='delete')


IF( OBJR(2)%A%RE .ne. 3.44)print*,'101'
IF( OBJR(2)%A%IM .ne. 8.44)print*,'102'
 PRINT*,'PASS'
