module m1
integer,parameter:: k1=30,k2=10,k3=5,k4=10
type x
...
forall (n2=1:k1,n3=1:k3)
  z%a(n2,:,n3+1,:)=z%a(n2,:,n3,:)+reshape([(n,n=1,k2*k4)],[k2,k4])+f(z%a(n2,:,n3,:))
  z%a(n2,:,n3+1,:)=z%a(n2,:,n3,:)+reshape([(n,n=1,k2*k4)],[k2,k4])+f(z%a(n2,:,n3,:))
end forall
!$omp end workshare
!$omp end parallel
...
do      n3=1,k3
do      n2=1,k1
  c(n2,:,n3,:)=z%b(n2,:,n3,:)+reshape([(n,n=1,k2*k4)],[k2,k4]) +f(z%b(n2,:,n3,:))
end do
end do
do      n3=1,k3
do      n2=1,k1
