...
subroutine sub(a, b, n)
  ...
  do ii = 1,10
     ...
     do kk = 2,n-1
        if (kk .ne. 948 .and. kk .ne. 949) then
     ...
     enddo
  enddo
 if (answer1.eq.1 .and. answer11.eq.1) then
    write(6,*) "OK1"
 else
    write(6,*) "NG1"
 endif
 if (answer2.eq.1 .and. answer21.eq.1 ) then
    write(6,*) "OK2"
 else
    write(6,*) "NG2"
 endif
 if (answer3.eq.1 .and. answer31.eq.1) then
    write(6,*) "OK3"
 else
    write(6,*) "NG3"
 endif
 if (answer4.eq.1 .and. answer41.eq.1) then
    write(6,*) "OK4"
 else
    write(6,*) "NG4"
 endif
 if (answer5.eq.1 .and. answer51.eq.1) then
    write(6,*) "OK5"
 else
    write(6,*) "NG5"
 endif
 if (answer6.eq.1 .and. answer61.eq.1) then
    write(6,*) "OK6"
 else
    write(6,*) "NG6"
 endif
 if (answer7.eq.1 .and. answer71.eq.1) then
    write(6,*) "OK7"
 else
    write(6,*) "NG7"
 endif
 if (answer8.eq.1 .and. answer81.eq.1) then
    write(6,*) "OK8"
 else
    write(6,*) "NG8"
 endif
 if (answer9.eq.1 .and. answer91.eq.1) then
    write(6,*) "OK9"
 else
    write(6,*) "NG9"
 endif
 if (answer10.eq.1 .and. answer101.eq.1) then
    write(6,*) "OK10"
 else
    write(6,*) "NG10"
 endif
