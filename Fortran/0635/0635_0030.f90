...
SUBROUTINE TEST(D1,D2,D3,B,C,D,E,N,M)
  REAL(KIND=8),DIMENSION(1:N) :: D1,D2,D3,B
  INTEGER(KIND=4) :: I
  INTEGER(KIND=4),INTENT(IN) :: N,M
  INTEGER(KIND=4),DIMENSION(4) :: C,D,E
  DO I=M,N,FUNC(C)
    D1(I)=D1(I)+B(I)
  END DO
  DO I=M,N,FUNC(D)
