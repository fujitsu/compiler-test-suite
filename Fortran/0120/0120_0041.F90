...
subroutine test1(a,b,c,n1,n2)
  ...
  do i=1,n1
     a(1:SVU_N1,i) = b(1:SVU_N1,i) * c(i,1:SVU_N1)
  enddo
...
subroutine test2(a,b,c,n1,n2)
  ...
  do i=1,n1
     a(1:SVU_N2,i) = b(1:SVU_N2,i) * c(i,1:SVU_N2)
  enddo
...
subroutine test3(a,b,c,n1,n2)
  ...
  do i=1,n1
     a(1:SVU_N3,i) = b(1:SVU_N3,i) * c(i,1:SVU_N3)
  enddo
...
subroutine test4(a,b,c,n1,n2)
  ...
  do i=1,n1
     a(1:SVU_N4,i) = b(1:SVU_N4,i) * c(i,1:SVU_N4)
  enddo
...
subroutine test5(a,b,c,n1,n2)
  ...
  do i=1,n1
     a(1:SVU_N5,i) = b(1:SVU_N5,i) * c(i,1:SVU_N5)
  enddo
