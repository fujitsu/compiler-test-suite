...
PROGRAM MAIN
  ...
  obj%jj = 100
  obj%ty0_cmp%ii = 200
print*, " ty1_array_destructor CALL  300 400 100 100"
print*, " ty0_scalar_destructor CALL  500"
print*, " ty0_scalar_destructor CALL  600"
print*, " ty0_scalar_destructor CALL  200"
print*, " ty0_scalar_destructor CALL  200"
  ALLOCATE(ty1_obj, SOURCE = RESHAPE([[Foo()], obj, obj], SHAPE = [2, 2]))
print*, " ty1_array_destructor CALL  300 400"
print*, " ty0_scalar_destructor CALL  500"
print*, " ty0_scalar_destructor CALL  600"
  CONTAINS
