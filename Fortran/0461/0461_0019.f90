...
print*, " ty1_array_destructor CALL  100 200"
print*, " ty0_scalar_destructor CALL  300"
print*, " ty0_scalar_destructor CALL  400"
  CONTAINS
    FUNCTION Foo() RESULT(ty1_res)
      ...
      ty1_res(1)%jj = 100
      ty1_res(2)%jj = 200
      ty1_res(1)%ty0_cmp%ii = 300
      ty1_res(2)%ty0_cmp%ii = 400
    END FUNCTION Foo
END PROGRAM MAIN
