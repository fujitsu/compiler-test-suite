C
  ...
  120 WRITE(6,13)ITEM,N
   13 FORMAT(1H0,7X,9H*** ITEM(,I2,5H) ***,7X,
     ...
     2       11HDBLE(X) -  ,5H*****,21X,9H( PAGE = ,I3,2H )
     3       ///2X,11H- JUSTICE -,8X,12H- ARGUMENT -,10X,
     4       19H- COMPUTED RESULT -,14X,17H- COMPARE VALUE -,14X,
     5       14H- DIFFERENCE - / )
      L=1
  130 X=FLOAT(K)/100.0
      Y=DBLE(X)
