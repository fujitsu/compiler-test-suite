C
      DOUBLE PRECISION   DA1(3,4,5),DA2(4),D1,D2,D3,DW(60),DX,DAMY
...
C
  ...
  310 FORMAT(2(I10,8X /),10X,E10.3 / 8X,E10.3 )
      WRITE(FU,320) I2,D1,D3
  320 FORMAT(247X,I1 / D24.16 / 233X,D23.16 )
      R3=352.618
      DI1=-32767
      DI2=1230007895
      DI3=-74362054
  ...
  335 FORMAT( D12.5,D15.8 / I6,12X/ F7.3,5X,   2D7.1,I10,I9 / L9,L9 /
     *        D20.14,L5  )
      ENDFILE  FU
      REWIND   FU
      READ(FU,340) IW2,IW1,RW1,RW2,IW3,DW(2) ,DW(1)
  340 FORMAT(2(I10 / ),10X,E10.3 / 8X,E10.3 / 246X,I2 / D24.5 / 232X,
     *         D24.16 )
