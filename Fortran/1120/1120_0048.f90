...
procedure(cfunc03),    pointer :: pcfunc03p01
procedure(m01_func03), pointer :: pm01_func03p01

pcfunc02p01    => m01_func01()
pm01_func02p01 => cfunc01()

pcfunc03p01    => pcfunc02p01()
pm01_func03p01 => pm01_func02p01()

if (pcfunc03p01().ne.pm01_func03p01()) print *,'not pass'
