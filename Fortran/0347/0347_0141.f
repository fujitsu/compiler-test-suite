      ...
      integer*4 l1(10),l2(10),aa(20),bb(20),cc(20)
      do 5 i=1,20
        aa(i) = i
        bb(i) = i + 1
        cc(i) = i + 2
 ...
 10    continue
       ...
       do 20 i=3,7
        do 30 j=2,m+1
         do 40 k1=4,m+1
           a(l1(i),l2(j),l1(k1)) = b(i,j+n,k1) + c(j,i,k1+n)
           b(i,j,k1+n) = (a(l1(i),l2(j),l1(k1))-2.0) - c(j,i,k1+1)
           c(j,i,k1+n) = b(i,j,k1) + a(l1(i),l2(j),l1(k1))
 40      continue
         do 50 k2=4,m+1
           b(l1(i),l2(j),l1(k2)) = a(i,j+n,k2) + c(j,i,k2+n)
           a(i,j,k2-1) = (b(l1(i),l2(j),l1(k2))-2.0) - c(j,i,k2+1)
           c(j,i,k2+n) = a(i,j,k2) + b(l1(i),l2(j),l1(k2))
 50      continue
 30    continue
       aa(i) = bb(i+n) * cc(i+m)
       bb(n) = aa(i-1) - cc(i+m)
