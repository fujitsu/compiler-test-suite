      ...
      data a,b,c,aa,bb,cc,amax/4000*0/
      integer n/500/,j/0/,l,m,k,h/1/
      logical logi(500)/500*.true./
      call setd2(n,a,b,c)
      call setd1(n,aa,bb,cc)
      l=1
      k=1
      m=20
      do 10 i=2,500
       ...
       a(i)=m
   10 continue
      write(6,100) j,k,m,(amax(i),i=1,n),(aa(i),i=1,n),(bb(i),i=1,n),
     +    (cc(i),i=1,n),(a(i),i=1,n),(b(i),i=1,n),(c(i),i=1,n)
  100 format(1h ,'j--',i5,2x,'k--',i5,2x,'m--',i5,
     +    /,'--------- other ----------',/,(5e15.6,/))
      end
