 ...
 integer:: n=2
  ...
  associate(k=>n)
  block
   character(2)::s1, a1*(2)(2),g2*(2)(k),m1
   character(2)::s2, a2*(2)(k),g3*(k)(2),m2
   character(2)::s3, a3*(k)(2),g4*(k)(k),m3
   character(2)::s4, a4*(k)(k),g5*(2)(2),m4
   character(k)::s5, a5*(2)(2),g6*(2)(k),m5
   character(k)::s6, a6*(2)(k),g7*(k)(2),m6
   character(k)::s7, a7*(k)(2),g8*(k)(k),m7
   character(k)::s8, a8*(k)(k),g1*(2)(2),m8
   character(2),dimension(2)::t1, b1*(2)(2),h3*(k)(2),n1
   character(2),dimension(2)::t2, b2*(2)(k),h4*(k)(k),n2
   character(2),dimension(2)::t3, b3*(k)(2),h5*(2)(2),n3
   character(2),dimension(2)::t4, b4*(k)(k),h6*(2)(k),n4
   character(k),dimension(2)::t5, b5*(2)(2),h7*(k)(2),n5
   character(k),dimension(2)::t6, b6*(2)(k), h8*(k)(k),n6
   character(k),dimension(2)::t7, b7*(k)(2),h1*(2)(2),n7
   character(k),dimension(2)::t8, b8*(k)(k),h2*(2)(k),n8
   character(2),dimension(k)::u1, c1*(2)(2),l4*(k)(k),o1
   character(2),dimension(k)::u2, c2*(2)(k), l5*(2)(2),o2
   character(2),dimension(k)::u3, c3*(k)(2),l6*(2)(k),o3
   character(2),dimension(k)::u4, c4*(k)(k),l7*(k)(2),o4
   character(k),dimension(k)::u5, c5*(2)(2),l8*(k)(k),o5
   character(k),dimension(k)::u6, c6*(2)(k),l1*(2)(2),o6
   character(k),dimension(k)::u7, c7*(k)(2),l2*(2)(k),o7
   character(k),dimension(k)::u8, c8*(k)(k),l3*(k)(2),o8
   character(2)::v1, d1(2)*(2),i5(2)*(2),p1
   character(2)::v2, d2(k)*(2),i6(k)*(2),p2
   character(2)::v3, d3(2)*(k),i7(2)*(k),p3
   character(2)::v4, d4(k)*(k),i8(k)*(k),p4
   character(k)::v5, d5(2)*(2),i1(2)*(2),p5
   character(k)::v6, d6(k)*(2),i2(k)*(2),p6
   character(k)::v7, d7(2)*(k),i3(2)*(k),p7
   character(k)::v8, d8(k)*(k),i4(k)*(k),p8
   character(2),dimension(2)::w1, e1(2)*(2),j8(k)*(k),q1
   character(2),dimension(2)::w2, e2(k)*(2),j7(2)*(k),q2
   character(2),dimension(2)::w3, e3(2)*(k),j6(k)*(2),q3
   character(2),dimension(2)::w4, e4(k)*(k),j5(2)*(2),q4
   character(k),dimension(2)::w5, e5(2)*(2),j4(k)*(k),q5
   character(k),dimension(2)::w6, e6(k)*(2),j3(2)*(k),q6
   character(k),dimension(2)::w7, e7(2)*(k),j2(k)*(2),q7
   character(k),dimension(2)::w8, e8(k)*(k),j1(2)*(2),q8
   character(2),dimension(k)::x1, f1(2)*(2),k1(2)*(2),r1
   character(2),dimension(k)::x2, f2(k)*(2),k2(k)*(2),r2
   character(2),dimension(k)::x3, f3(2)*(k),k3(2)*(k),r3
   character(2),dimension(k)::x4, f4(k)*(k),k4(k)*(k),r4
   character(k),dimension(k)::x5, f5(2)*(2),k5(2)*(2),r5
   character(k),dimension(k)::x6, f6(k)*(2),k6(k)*(2),r6
   character(k),dimension(k)::x7, f7(2)*(k),k7(2)*(k),r7
   character(k),dimension(k)::x8, f8(k)*(k),k8(k)*(k),r8
   if (len(s1)/=2) print *,1101
   if (len(s2)/=2) print *,1102
   if (len(s3)/=2) print *,1103
   if (len(s4)/=2) print *,1104
   if (len(s5)/=2) print *,1105
   if (len(s6)/=2) print *,1106
   if (len(s7)/=2) print *,1107
   if (len(s8)/=2) print *,1108
   if (len(t1)/=2) print *,1101
   if (len(t2)/=2) print *,1102
   if (len(t3)/=2) print *,1103
   if (len(t4)/=2) print *,1104
   if (len(t5)/=2) print *,1105
   if (len(t6)/=2) print *,1106
   if (len(t7)/=2) print *,1107
   if (len(t8)/=2) print *,1108
   if (size(t1)/=2) print *,1113
   if (size(t2)/=2) print *,1123
   if (size(t3)/=2) print *,1133
   if (size(t4)/=2) print *,1153
   if (size(t5)/=2) print *,1163
   if (size(t6)/=2) print *,1173
   if (size(t7)/=2) print *,1183
   if (size(t8)/=2) print *,1193
   if (len(u1)/=2) print *,1101
   if (len(u2)/=2) print *,1102
   if (len(u3)/=2) print *,1103
   if (len(u4)/=2) print *,1104
   if (len(u5)/=2) print *,1105
   if (len(u6)/=2) print *,1106
   if (len(u7)/=2) print *,1107
   if (len(u8)/=2) print *,1108
   if (size(u1)/=2) print *,1113
   if (size(u2)/=2) print *,1123
   if (size(u3)/=2) print *,1133
   if (size(u4)/=2) print *,1153
   if (size(u5)/=2) print *,1163
   if (size(u6)/=2) print *,1173
   if (size(u7)/=2) print *,1183
   if (size(u8)/=2) print *,1193
   if (len(v1)/=2) print *,1101
   if (len(v2)/=2) print *,1102
   if (len(v3)/=2) print *,1103
   if (len(v4)/=2) print *,1104
   if (len(v5)/=2) print *,1105
   if (len(v6)/=2) print *,1106
   if (len(v7)/=2) print *,1107
   if (len(v8)/=2) print *,1108
   if (len(w1)/=2) print *,1101
   if (len(w2)/=2) print *,1102
   if (len(w3)/=2) print *,1103
   if (len(w4)/=2) print *,1104
   if (len(w5)/=2) print *,1105
   if (len(w6)/=2) print *,1106
   if (len(w7)/=2) print *,1107
   if (len(w8)/=2) print *,1108
   if (size(w1)/=2) print *,1113
   if (size(w2)/=2) print *,1123
   if (size(w3)/=2) print *,1133
   if (size(w4)/=2) print *,1153
   if (size(w5)/=2) print *,1163
   if (size(w6)/=2) print *,1173
   if (size(w7)/=2) print *,1183
   if (size(w8)/=2) print *,1193
   if (len(x1)/=2) print *,1101
   if (len(x2)/=2) print *,1102
   if (len(x3)/=2) print *,1103
   if (len(x4)/=2) print *,1104
   if (len(x5)/=2) print *,1105
   if (len(x6)/=2) print *,1106
   if (len(x7)/=2) print *,1107
   if (len(x8)/=2) print *,1108
   if (size(x1)/=2) print *,1113
   if (size(x2)/=2) print *,1123
   if (size(x3)/=2) print *,1133
   if (size(x4)/=2) print *,1153
   if (size(x5)/=2) print *,1163
   if (size(x6)/=2) print *,1173
   if (size(x7)/=2) print *,1183
   if (size(x8)/=2) print *,1193
