 ...
 integer:: n=2
  ...
  block
  block
   character(2):: a1*(2)(2),g2*(2)(k)
   character(2):: a2*(2)(k),g3*(k)(2)
   character(2):: a3*(k)(2),g4*(k)(k)
   character(2):: a4*(k)(k),g5*(2)(2)
   character(k):: a5*(2)(2),g6*(2)(k)
   character(k):: a6*(2)(k),g7*(k)(2)
   character(k):: a7*(k)(2),g8*(k)(k)
   character(k):: a8*(k)(k),g1*(2)(2)
   character(2),dimension(2):: b1*(2)(2),h3*(k)(2)
   character(2),dimension(2):: b2*(2)(k),h4*(k)(k)
   character(2),dimension(2):: b3*(k)(2),h5*(2)(2)
   character(2),dimension(2):: b4*(k)(k),h6*(2)(k)
   character(k),dimension(2):: b5*(2)(2),h7*(k)(2)
   character(k),dimension(2):: b6*(2)(k), h8*(k)(k)
   character(k),dimension(2):: b7*(k)(2),h1*(2)(2)
   character(k),dimension(2):: b8*(k)(k),h2*(2)(k)
   character(2),dimension(k):: c1*(2)(2),l4*(k)(k)
   character(2),dimension(k):: c2*(2)(k), l5*(2)(2)
   character(2),dimension(k):: c3*(k)(2),l6*(2)(k)
   character(2),dimension(k):: c4*(k)(k),l7*(k)(2)
   character(k),dimension(k):: c5*(2)(2),l8*(k)(k)
   character(k),dimension(k):: c6*(2)(k),l1*(2)(2)
   character(k),dimension(k):: c7*(k)(2),l2*(2)(k)
   character(k),dimension(k):: c8*(k)(k),l3*(k)(2)
   character(2):: d1(2)*(2),i5(2)*(2)
   character(2):: d2(k)*(2),i6(k)*(2)
   character(2):: d3(2)*(k),i7(2)*(k)
   character(2):: d4(k)*(k),i8(k)*(k)
   character(k):: d5(2)*(2),i1(2)*(2)
   character(k):: d6(k)*(2),i2(k)*(2)
   character(k):: d7(2)*(k),i3(2)*(k)
   character(k):: d8(k)*(k),i4(k)*(k)
   character(2),dimension(2):: e1(2)*(2),j8(k)*(k)
   character(2),dimension(2):: e2(k)*(2),j7(2)*(k)
   character(2),dimension(2):: e3(2)*(k),j6(k)*(2)
   character(2),dimension(2):: e4(k)*(k),j5(2)*(2)
   character(k),dimension(2):: e5(2)*(2),j4(k)*(k)
   character(k),dimension(2):: e6(k)*(2),j3(2)*(k)
   character(k),dimension(2):: e7(2)*(k),j2(k)*(2)
   character(k),dimension(2):: e8(k)*(k),j1(2)*(2)
   character(2),dimension(k):: f1(2)*(2),k1(2)*(2)
   character(2),dimension(k):: f2(k)*(2),k2(k)*(2)
   character(2),dimension(k):: f3(2)*(k),k3(2)*(k)
   character(2),dimension(k):: f4(k)*(k),k4(k)*(k)
   character(k),dimension(k):: f5(2)*(2),k5(2)*(2)
   character(k),dimension(k):: f6(k)*(2),k6(k)*(2)
   character(k),dimension(k):: f7(2)*(k),k7(2)*(k)
   character(k),dimension(k):: f8(k)*(k),k8(k)*(k)
