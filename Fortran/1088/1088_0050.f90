 ...
 integer:: n=2
  ...
  block
   ...
   character(k):: a7(2)
   character(k):: a8(k)
   character(2),dimension(2):: b1(2)
   character(2),dimension(2):: b2(k)
   character(2),dimension(2):: b3(2)
   character(2),dimension(2):: b4(k)
   character(k),dimension(2):: b5(2)
   character(k),dimension(2):: b6(k)
   character(k),dimension(2):: b7(2)
   character(k),dimension(2):: b8(k)
   character(2),dimension(k):: c1(2)
   character(2),dimension(k):: c2(k)
   character(2),dimension(k):: c3(2)
   character(2),dimension(k):: c4(k)
   character(k),dimension(k):: c5(2)
   character(k),dimension(k):: c6(k)
   character(k),dimension(k):: c7(2)
   character(k),dimension(k):: c8(k)
   character(2):: d1*(2)
   character(2):: d2*(2)
   character(2):: d3*(k)
   character(2):: d4*(k)
   ...
   character(k):: d7*(k)
   character(k):: d8*(k)
   character(2),dimension(2):: e1*(2)
   character(2),dimension(2):: e2*(2)
   character(2),dimension(2):: e3*(k)
   character(2),dimension(2):: e4*(k)
   character(k),dimension(2):: e5*(2)
   character(k),dimension(2):: e6*(2)
   character(k),dimension(2):: e7*(k)
   character(k),dimension(2):: e8*(k)
   character(2),dimension(k):: f1*(2)
   character(2),dimension(k):: f2*(2)
   character(2),dimension(k):: f3*(k)
   character(2),dimension(k):: f4*(k)
   character(k),dimension(k):: f5*(2)
   character(k),dimension(k):: f6*(2)
   character(k),dimension(k):: f7*(k)
   character(k),dimension(k):: f8*(k)
