 ...
 integer:: n=2
  ...
  block
   ...
   character(2),dimension(2):: b2*(2)
   character(2),dimension(2):: b3*(k)
   character(2),dimension(2):: b4*(k)
   character(k),dimension(2):: b5*(2)
   character(k),dimension(2):: b6*(2)
   character(k),dimension(2):: b7*(k)
   character(k),dimension(2):: b8*(k)
   character(2),dimension(k):: c1*(2)
   character(2),dimension(k):: c2*(2)
   character(2),dimension(k):: c3*(k)
   character(2),dimension(k):: c4*(k)
   character(k),dimension(k):: c5*(2)
   character(k),dimension(k):: c6*(2)
   character(k),dimension(k):: c7*(k)
   ...
   character(2),dimension(2):: e2(k)
   character(2),dimension(2):: e3(2)
   character(2),dimension(2):: e4(k)
   character(k),dimension(2):: e5(2)
   character(k),dimension(2):: e6(k)
   character(k),dimension(2):: e7(2)
   character(k),dimension(2):: e8(k)
   character(2),dimension(k):: f1(2)
   character(2),dimension(k):: f2(k)
   character(2),dimension(k):: f3(2)
   character(2),dimension(k):: f4(k)
   character(k),dimension(k):: f5(2)
   character(k),dimension(k):: f6(k)
   character(k),dimension(k):: f7(2)
