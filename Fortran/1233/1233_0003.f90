module m1
  ...
  type, extends(object) :: command_line_argument
     ! base: object                                                 ! 2-2-3-1
     character(len=:), allocatable, public :: switch                ! -2
...
program main
  ...
  allocate(value%cli_options%clasg(1)%cla(1)%switch,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%switch_ab,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%act      ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%def      ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%nargs    ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%choices  ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%val      ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(1)%envvar   ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%switch,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%switch_ab,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%act      ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%def      ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%nargs    ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%choices  ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%val      ,source="ab")
  allocate(value%cli_options%clasg(1)%cla(2)%envvar   ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2))
  allocate(value%cli_options%clasg(2)%cla(1)%switch,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%switch_ab,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%act      ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%def      ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%nargs    ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%choices  ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%val      ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(1)%envvar   ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%switch,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%switch_ab,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%act      ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%def      ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%nargs    ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%choices  ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%val      ,source="ab")
  allocate(value%cli_options%clasg(2)%cla(2)%envvar   ,source="ab")
