module m1
integer, bind(c) :: i1,jj1,k1
!$omp threadprivate(jj1)
end

module m2
integer, bind(c) :: i2,j2,k2
!$omp threadprivate(j2,i2)
end

module m3
integer, bind(c) :: i3,j3,k3
!$omp threadprivate(j3,k3)
end

module m4
integer, bind(c) :: i4,j4,k4
!$omp threadprivate(j4,i4,k4)
end

module m5
integer, bind(c) :: i5,j5,k5
!$omp threadprivate(j5,k5,i5)
end
