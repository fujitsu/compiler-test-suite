module m1
!$omp threadprivate(i1,jj1,k1)
bind(c) :: jj1
end

module m2
!$omp threadprivate(i2,j2,k2)
bind(c) :: j2
bind(c) :: i2
end

module m3
!$omp threadprivate(i3,j3,k3)
bind(c) :: j3
bind(c) :: k3
end
...
addr_j1(omp_get_thread_num()+1) = loc(jj1)
...
if (any(addr_j1(2:)==addr_j1(1))) print *,21
