...
if(size(objTY%obj3) /= 12) print*, 101,size(objTY%obj3)
if(objTY%obj3(1,2)%alc(1) /= 4) print*,102
if(objTY%obj3(2,2)%alc(2) /= 5) print*,103
if(objTY%obj3(3,3)%alc(2) /= 8) print*,104
if(objTY%obj3(1,2)%alc2 /= 6) print*,105
if(objTY%obj3(2,2)%alc2 /= 7) print*,106
if(objTY%obj3(2,2)%msg(2,2) /= "HELLO") print*,107
print*, "PASS"
end
