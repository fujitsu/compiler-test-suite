...
23100 continue
          write(6,301)
  301     format(1h+,20x,  25h               2147483647,
     *                 5x,21h                  i12,
     *                7x,  25h               2147483647)
          write(6,200) i9ans1
c
...
23103 continue
          write(6,304)
  304     format(1h+,20x,  25h              +2147483647,
     *                5x,  21h                  i12,
     *                7x,  25h               2147483647)
          write(6,200) i9ans1
c
...
23105 continue
          write(6,306)
  306     format(1h+,20x,  25h              -2147483647,
     *                5x,  21h                  i12,
     *                7x,  25h              -2147483647)
          write(6,200) i9ans1
c
...
23107 continue
          write(6,308)
  308     format(1h+,20x,  25h               2147483647,
     *                5x,  21h                  i12,
     *                7x,  25h               2147483647)
          write(6,200) i9ans1
c
...
23110 continue
          write(6,311)
  311     format(1h+,20x,  25h              +2147483647,
     *               5x,   21h                  i12,
     *               7x,   25h               2147483647)
c
          read(5,101) i9ans1
...
23112 continue
          write(6,313)
  313     format(1h+,20x,  25h              -2147483647,
     *               5x,   21h                  i12,
     *               7x,   25h              -2147483647)
          write(6,200) i9ans1
c
...
23114 continue
          write(6,315)
  315     format(1h+,20x,  25h               2147483647,
     *               5x,   21h                  i12,
     *               7x,   25h               2147483647)
          write(6,200) i9ans1
      write(6,31504)
...
23119 continue
          write(6,320)
  320     format(1h+,20x,  25h              -2147483647,
     *                5x,  21h                  i12,
     *                7x,  25h              -2147483647)
          write(6,200) i9ans1
c
