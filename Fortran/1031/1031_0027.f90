...
integer,parameter:: a(2,3,4)=reshape((/(i,i=1,i1*i2*i3)/),(/i1,i2,i3/))
integer,dimension(2,3,4):: a1,a2
integer,parameter:: c(2,3)=reshape((/(i,i=1,i1*i2)/),(/i1,i2/))
integer,dimension(2,3):: c1,c2
a1=cshift(a,1,1)
a2=cshift(a,1,2)
