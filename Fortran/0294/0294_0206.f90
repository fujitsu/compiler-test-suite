...
print *,lbound(sss%ppp,2),ubound(sss%ppp,2)
print *,len(sss%ppp),size(sss%ppp)
sss%ppp(l(4):u(5),l(5):u(6)) => sss%ttt(l(1):u(4))
print *,sss%ppp(4,5)
print *,sss%ppp(5,5)
print *,sss%ppp(4,6)
print *,sss%ppp(5,6)
...
print *,lbound(sss%ppp,2),ubound(sss%ppp,2)
print *,len(sss%ppp),size(sss%ppp)
sss%ppp(u(5):u(6),l(7):u(8)) => sss%ttt(l(1):)
print *,sss%ppp(5,7)
print *,sss%ppp(6,7)
print *,sss%ppp(5,8)
print *,sss%ppp(6,8)
...
print *,lbound(sss%ppp,2),ubound(sss%ppp,2)
print *,len(sss%ppp),size(sss%ppp)
sss%ppp(u(7):u(8),l(2):u(3)) => sss%ttt(:)
print *,sss%ppp(7,2)
print *,sss%ppp(8,2)
print *,sss%ppp(7,3)
print *,sss%ppp(8,3)
