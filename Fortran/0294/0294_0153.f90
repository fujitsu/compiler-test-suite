...
print *,lbound(sss(5)%ppp,2),ubound(sss(5)%ppp,2)
print *,len(sss(5)%ppp),size(sss(5)%ppp)
sss(5)%ppp(l(4):u(5),l(5):u(6)) => ttt(l(1):u(4),3)
print *,sss(5)%ppp(4,5)
print *,sss(5)%ppp(5,5)
print *,sss(5)%ppp(4,6)
print *,sss(5)%ppp(5,6)
...
print *,lbound(sss(5)%ppp,2),ubound(sss(5)%ppp,2)
print *,len(sss(5)%ppp),size(sss(5)%ppp)
sss(5)%ppp(u(5):u(6),l(7):u(8)) => ttt(l(4):,1)
print *,sss(5)%ppp(5,7)
print *,sss(5)%ppp(6,7)
print *,sss(5)%ppp(5,8)
print *,sss(5)%ppp(6,8)
...
print *,lbound(sss(5)%ppp,2),ubound(sss(5)%ppp,2)
print *,len(sss(5)%ppp),size(sss(5)%ppp)
sss(5)%ppp(u(7):u(8),l(2):u(3)) => ttt(:,3)
print *,sss(5)%ppp(7,2)
print *,sss(5)%ppp(8,2)
print *,sss(5)%ppp(7,3)
print *,sss(5)%ppp(8,3)
