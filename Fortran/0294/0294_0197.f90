...
allocate(rrr2(10,10))
allocate(sss2(20,20))
if (size(ppp) .ne. 10) print *,size(ppp)
if (size(qqq) .ne. 20) print *,size(qqq)
if (size(rrr) .ne. 30) print *,size(rrr)
if (size(sss) .ne. 40) print *,size(qqq)
if (size(rrr2) .ne. 100) print *,size(rrr2)
if (size(sss2) .ne. 400) print *,size(sss2)
ppp(9:16) => ttt(:,:,:,:,:)
