...
integer n
common /x/ n
if (.not.present(p).and. .not.present(t))return             
if (present(p))print *,'error-301'
if (present(t))print *,'error-302'
n=2
n=4
call t
...
common /x/ n
if (.not.present(p).and. .not.present(t))return             
if (present(t))print *,'error-601'
if (present(p))print *,'error-602'
n=2
...
optional::t,p
n=0
if (.not.present(t))print *,'error-701'
if (.not.present(p))print *,'error-702'
if (.not.associated(p,sub))print *,'error 401'
