...
if (ubound(result(1,2)%next(3)%next, 1) /= 4) print*, 911
if (lbound(result(1,2)%next(3)%next, 1) /= 1) print*, 912
if (ubound(shape(result(1,2)%next(3)%next), 1) /= 1) print*, 913
if (size(result(1,2)%next(3)%next) /= 4) print*, 914
print*, "PASS"
end
