...
if (OBJ2%II /= 11) print*, 201
if (OBJ2%MSG /= "HELLO") print*, 202, OBJ2%MSG
if (OBJ2%NODE1%JJ /= 12) print*, 203
if (OBJ2%NODE1%NODE2%II /= 13) print*, 204
if (OBJ2%NODE1%NODE2%NODE1%JJ /= 14) print*, 205
if (OBJ2%NODE1%NODE2%NODE1%NODE2%II /= 15) print*, 206
if (OBJ2%NODE1%NODE2%NODE1%NODE2%MSG /= "NIGHT") print*, 207
if (OBJ2%NODE1%NODE2%NODE1%NODE2%NODE1%JJ /= 16) print*, 208
print*,"PASS"
END
