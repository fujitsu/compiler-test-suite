...
if (OBJ%NEXT_NODE(3)%VALUE /= 20) print*, 102
if (OBJ%NEXT_NODE(3)%PREV_NODE(3)%VALUE /= 20) print*, 103
if (OBJ%NEXT_NODE(3)%PREV_NODE(3)%NEXT_NODE(3)%VALUE /= 20) print*, 104

if (OBJ%PREV_NODE(2)%VALUE /= 20) print*, 105
if (OBJ%PREV_NODE(2)%NEXT_NODE(2)%VALUE /= 20) print*, 106
if (OBJ%PREV_NODE(2)%NEXT_NODE(2)%PREV_NODE(2)%VALUE /= 20) print*, 107
