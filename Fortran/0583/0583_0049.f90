...
ALLOCATE(OBJ(3))
ALLOCATE(OBJ(1)%VALUE(2))
ALLOCATE(OBJ(2)%VALUE(3))
ALLOCATE(OBJ(3)%VALUE(4))
...
ALLOCATE(OBJ(2)%NEXT_NODE(2)%VALUE(2))
ALLOCATE(OBJ(2)%NEXT_NODE(1)%NEXT_NODE(2)%VALUE(3))
ALLOCATE(OBJ(2)%NEXT_NODE(2)%NEXT_NODE(3)%VALUE(4))
ALLOCATE(OBJ(2)%NEXT_NODE(1)%NEXT_NODE(1)%NEXT_NODE(3)%VALUE(5))
