...
CALL SUB([TY([200],[OBJ_BASE%OBJ2(4)%NODE3], 300, [OBJ_BASE%OBJ2(4)%NODE6])])
...
IF (DMY(1)%JJ /= 300) print*, 101
IF (DMY(1)%II(1) /= 200) print*, 102
IF (DMY(1)%NODE3(3)%II(3) /= 21) print*, 103, DMY(1)%NODE3(3)%II(3)
IF (DMY(1)%NODE3(3)%NODE1(3)%II(3) /= 22) print*, 104
IF (DMY(1)%NODE3(3)%NODE1(3)%NODE1(3)%II(3) /= 23) print*, 105
IF (DMY(1)%NODE3(3)%NODE1(3)%NODE2(3)%II(3) /= 24) print*, 106
IF (DMY(1)%NODE3(3)%NODE1(3)%NODE2(3)%NODE0(3)%II(3) /= 25) print*, 107
IF (DMY(1)%NODE3(3)%NODE1(3)%NODE2(3)%NODE0(3)%NODE0(3)%II(3) /= 26) print*, 108

IF (DMY(1)%NODE3(3)%NODE2(3)%II(3) /= 27) print*, 109
IF (DMY(1)%NODE3(3)%NODE2(3)%NODE0(4)%II(3) /= 28) print*, 110
IF (DMY(1)%NODE3(3)%NODE2(3)%NODE0(4)%NODE0(4)%II(3) /= 29) print*, 111
IF (DMY(1)%NODE3(3)%NODE2(3)%NODE0(4)%NODE0(4)%NODE0(4)%II(3) /= 299) print*, 112

IF (DMY(1)%NODE6(3)%II(3)  /= 121) print*, 913
IF (DMY(1)%NODE6(3)%NODE3(3)%II(3)  /= 122) print*, 914
IF (DMY(1)%NODE6(3)%NODE3(3)%NODE1(3)%II(3)  /= 123) print*, 915
IF (DMY(1)%NODE6(3)%NODE3(3)%NODE1(3)%NODE1(3)%II(3)  /= 124) print*, 916
IF (DMY(1)%NODE6(3)%NODE3(3)%NODE1(3)%NODE2(3)%II(3)  /= 125) print*, 917
IF (DMY(1)%NODE6(3)%NODE3(3)%NODE1(3)%NODE5(3)%II(3)  /= 126) print*, 918
IF (DMY(1)%NODE6(3)%NODE3(3)%NODE2(3)%II(3)  /= 127) print*, 919
IF (DMY(1)%NODE6(3)%NODE3(3)%NODE5(3)%II(3)  /= 128) print*, 920
END SUBROUTINE
