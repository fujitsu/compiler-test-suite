...
if (ALLOCATED(DMY1)) print*, 912

ALLOCATE(DMY1(N))

DMY1 = DMY2

if (.NOT.ALLOCATED(DMY1)) print*, 913

if (DMY1(2)%VALUE(2) /= 200) print*, 911
if (DMY1(2)%NEXT_NODE(3)%VALUE(2) /= 21) print*, 101
if (DMY1(2)%NEXT_NODE(3)%PREV_NODE(3)%VALUE(2) /= 22) print*, 102
if (DMY1(2)%NEXT_NODE(3)%PREV_NODE(3)%NEXT_NODE(3)%VALUE(2) /= 23) print*, 103
...
if (SIZE(DMY1(2)%NEXT_NODE) /= 3) print*, 202
if (SIZE(DMY1(2)%NEXT_NODE(3)%PREV_NODE) /= 4) print*, 203
if (SIZE(DMY1(2)%NEXT_NODE(3)%PREV_NODE(3)%NEXT_NODE) /= 5) print*, 204
