...
TYPE(NODE),ALLOCATABLE :: DMY2(:)

DMY1 = NODE([DMY2(2)%VALUE], [DMY2(2)%NEXT_NODE], [DMY2(1)%PREV_NODE])

DMY2(2)%VALUE = 400
DMY2(2)%NEXT_NODE(3)%VALUE = 31
DMY2(2)%NEXT_NODE(3)%PREV_NODE(3)%VALUE = 32
DMY2(2)%NEXT_NODE(3)%PREV_NODE(3)%NEXT_NODE(3)%VALUE = 33

DMY2(1)%PREV_NODE(2)%VALUE = 34
DMY2(1)%PREV_NODE(2)%NEXT_NODE(2)%VALUE = 35
DMY2(1)%PREV_NODE(2)%NEXT_NODE(2)%PREV_NODE(2)%VALUE = 36
