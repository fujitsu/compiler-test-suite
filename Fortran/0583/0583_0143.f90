...
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0)
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%KK(1))
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(3))
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(2)%JJ(2))
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(2)%NODE1)
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(2)%NODE1%II(3))
ALLOCATE(BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(2)%NODE1%NODE0)

BASE%OBJ(1)%KK = 10
BASE%OBJ(1)%NODE2(2)%JJ = 11
BASE%OBJ(1)%NODE2(2)%NODE1%II = 12
BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%KK = 13
BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(2)%JJ = 14
BASE%OBJ(1)%NODE2(2)%NODE1%NODE0%NODE2(2)%NODE1%II = 15
