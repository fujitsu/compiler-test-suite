...
ALLOCATE(OBJ_BASE%OBJ(2)%NODE3%NODE1%NODE2%NODE0(3))
ALLOCATE(OBJ_BASE%OBJ(2)%NODE3%NODE1%NODE2%NODE0(2)%II)
ALLOCATE(OBJ_BASE%OBJ(2)%NODE3%NODE1%NODE2%NODE0(2)%NODE0(3))
ALLOCATE(OBJ_BASE%OBJ(2)%NODE3%NODE1%NODE2%NODE0(2)%NODE0(2)%II)
...
OBJ_BASE%OBJ(2)%NODE3%NODE1%NODE2%NODE0(2)%II = 15
OBJ_BASE%OBJ(2)%NODE3%NODE1%NODE2%NODE0(2)%NODE0(2)%II = 16
...
CALL SUB(OBJ_BASE%OBJ, OBJ_BASE%OBJ2)
...
IF (OBJ_BASE%OBJ(4)%NODE3%II /= 21) print*, 103
IF (OBJ_BASE%OBJ(4)%NODE3%NODE1%II /= 22) print*, 104
IF (OBJ_BASE%OBJ(4)%NODE3%NODE1%NODE1%II /= 23) print*, 105
IF (OBJ_BASE%OBJ(4)%NODE3%NODE1%NODE2%II /= 24) print*, 106
IF (OBJ_BASE%OBJ(4)%NODE3%NODE1%NODE2%NODE0(3)%II /= 25) print*, 107
IF (OBJ_BASE%OBJ(4)%NODE3%NODE1%NODE2%NODE0(3)%NODE0(3)%II /= 26) print*, 108
IF (OBJ_BASE%OBJ(4)%NODE3%NODE2%II /= 27) print*, 109
IF (OBJ_BASE%OBJ(4)%NODE3%NODE2%NODE0(4)%II /= 28) print*, 110
IF (OBJ_BASE%OBJ(4)%NODE3%NODE2%NODE0(4)%NODE0(4)%II /= 29) print*, 111
IF (OBJ_BASE%OBJ(4)%NODE3%NODE2%NODE0(4)%NODE0(4)%NODE0(4)%II /= 299) print*, 112

print*,"PASS"

CONTAINS
SUBROUTINE SUB (FUN, DMY)
TYPE(TY),ALLOCATABLE::DMY(:)
TYPE(TY),ALLOCATABLE, INTENT(OUT)::FUN(:)
