...
ALLOCATE(OBJ, SOURCE = DMY(3:5))

DMY(4)%II = 30
DMY(4)%NODE3(3)%II = 31
DMY(4)%NODE3(3)%NODE1(3)%II = 32
DMY(4)%NODE3(3)%NODE1(3)%NODE1(3)%II = 33
DMY(4)%NODE3(3)%NODE1(3)%NODE2(3)%II = 34
DMY(4)%NODE3(3)%NODE1(3)%NODE2(3)%NODE0(3)%II = 35
DMY(4)%NODE3(3)%NODE1(3)%NODE2(3)%NODE0(3)%NODE0(3)%II = 36

DMY(4)%NODE3(3)%NODE2(3)%II = 37
DMY(4)%NODE3(3)%NODE2(3)%NODE0(4)%II = 38
DMY(4)%NODE3(3)%NODE2(3)%NODE0(4)%NODE0(4)%II = 39
DMY(4)%NODE3(3)%NODE2(3)%NODE0(4)%NODE0(4)%NODE0(4)%II = 399

DMY(4)%NODE6(3)%II = 131
DMY(4)%NODE6(3)%NODE3(3)%II = 132
DMY(4)%NODE6(3)%NODE3(3)%NODE1(3)%II = 133
DMY(4)%NODE6(3)%NODE3(3)%NODE1(3)%NODE1(3)%II = 134
DMY(4)%NODE6(3)%NODE3(3)%NODE1(3)%NODE2(3)%II = 135
DMY(4)%NODE6(3)%NODE3(3)%NODE1(3)%NODE5(3)%II = 136
DMY(4)%NODE6(3)%NODE3(3)%NODE2(3)%II = 137
DMY(4)%NODE6(3)%NODE3(3)%NODE5(3)%II = 138

IF (OBJ(2)%II(3) /= 20) print*, 102
IF (OBJ(2)%NODE3(3)%II(3) /= 21) print*, 103
IF (OBJ(2)%NODE3(3)%NODE1(3)%II(3) /= 22) print*, 104
IF (OBJ(2)%NODE3(3)%NODE1(3)%NODE1(3)%II(3) /= 23) print*, 105
IF (OBJ(2)%NODE3(3)%NODE1(3)%NODE2(3)%II(3) /= 24) print*, 106
IF (OBJ(2)%NODE3(3)%NODE1(3)%NODE2(3)%NODE0(3)%II(3) /= 25) print*, 107
IF (OBJ(2)%NODE3(3)%NODE1(3)%NODE2(3)%NODE0(3)%NODE0(3)%II(3) /= 26) print*, 108

IF (OBJ(2)%NODE3(3)%NODE2(3)%II(3) /= 27) print*, 109
IF (OBJ(2)%NODE3(3)%NODE2(3)%NODE0(4)%II(3) /= 28) print*, 110
IF (OBJ(2)%NODE3(3)%NODE2(3)%NODE0(4)%NODE0(4)%II(3) /= 29) print*, 111
IF (OBJ(2)%NODE3(3)%NODE2(3)%NODE0(4)%NODE0(4)%NODE0(4)%II(3) /= 299) print*, 112

IF (OBJ(2)%NODE6(3)%II(3)  /= 121) print*, 913
IF (OBJ(2)%NODE6(3)%NODE3(3)%II(3)  /= 122) print*, 914
IF (OBJ(2)%NODE6(3)%NODE3(3)%NODE1(3)%II(3)  /= 123) print*, 915
IF (OBJ(2)%NODE6(3)%NODE3(3)%NODE1(3)%NODE1(3)%II(3)  /= 124) print*, 916
IF (OBJ(2)%NODE6(3)%NODE3(3)%NODE1(3)%NODE2(3)%II(3)  /= 125) print*, 917
IF (OBJ(2)%NODE6(3)%NODE3(3)%NODE1(3)%NODE5(3)%II(3)  /= 126) print*, 918
IF (OBJ(2)%NODE6(3)%NODE3(3)%NODE2(3)%II(3)  /= 127) print*, 919
IF (OBJ(2)%NODE6(3)%NODE3(3)%NODE5(3)%II(3)  /= 128) print*, 920
