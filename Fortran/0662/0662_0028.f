      ...
      LOGICAL AC
      DO 2 I=R,C11(1)
 2    IF(AC( B11(I)*A11(I+1),B11(I)**A11(I+1),
     1       B11(I)*B11(I+1),B11(I)**B11(I+1),
     1       B11(I)*C11(I+1),B11(I)**C11(I+1),
     1       B11(I)*D11(I+1),B11(I)**D11(I+1),
     1       B11(I)*E11(I+1),B11(I)**E11(I+1),
     1       B11(I)*F11(I+1),B11(I)**F11(I+1),
     1       B11(I)*G11(I+1),B11(I)**G11(I+1),
     1       B11(I)*H11(I+1),B11(I)**H11(I+1),
     1       B11(I)*I11(I+1),B11(I)**I11(I+1),
     1       B11(I)*J11(I+1),B11(I)**J11(I+1)))PRINT *,'FAIL'
      PRINT *,'PASS'
      END
      FUNCTION AC(IA1,IA2,IB1,IB2,IC1,IC2,ID1,ID2,IE1,IE2,IF1,IF2,
     1            IG1,IG2,IH1,IH2,II1,II2,IJ1,IJ2)
      LOGICAL  AC
      INTEGER*2   IA1,IA2,RA1,RA2
      INTEGER*2   IB1,IB2,RB1,RB2
      INTEGER*4   IC1,IC2,RC1,RC2
