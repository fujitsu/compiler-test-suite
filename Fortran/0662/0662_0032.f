      ...
      LOGICAL AC
      DO 2 I=R,C11(1)
 2    IF(AC( J11(I)*A11(I+1),J11(I)**A11(I+1),
     1       J11(I)*B11(I+1),J11(I)**B11(I+1),
     1       J11(I)*C11(I+1),J11(I)**C11(I+1),
     1       J11(I)*D11(I+1),J11(I)**D11(I+1),
     1       J11(I)*E11(I+1),J11(I)**E11(I+1),
     1       J11(I)*F11(I+1),J11(I)**F11(I+1),
     1       J11(I)*G11(I+1),J11(I)**G11(I+1),
     1       J11(I)*H11(I+1),J11(I)**H11(I+1),
     1       J11(I)*I11(I+1),J11(I)**I11(I+1),
     1       J11(I)*J11(I+1),J11(I)**J11(I+1)))PRINT *,'FAIL'
      PRINT *,'PASS'
      END
      FUNCTION AC(IA1,IA2,IB1,IB2,IC1,IC2,ID1,ID2,IE1,IE2,IF1,IF2,
     1            IG1,IG2,IH1,IH2,II1,II2,IJ1,IJ2)
      LOGICAL  AC
      COMPLEX*32  IA1,IA2,RA1,RA2
      COMPLEX*32  IB1,IB2,RB1,RB2
      COMPLEX*32  IC1,IC2,RC1,RC2
      COMPLEX*32  ID1,ID2,RD1,RD2
      COMPLEX*32  IE1,IE2,RE1,RE2
      COMPLEX*32  IF1,IF2,RF1,RF2
      COMPLEX*32  IG1,IG2,RG1,RG2
      COMPLEX*32  IH1,IH2,RH1,RH2
      COMPLEX*32  II1,II2,RI1,RI2
