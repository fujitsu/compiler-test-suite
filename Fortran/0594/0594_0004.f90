integer,parameter::x(1)   = findloc([1,2,3,4,0],0)
integer,parameter::x2(1)  = findloc([1,2,3,4,5],0)
integer,parameter::x2_2(1)  = findloc([1,2,3,4,5],0,dim=1)
integer,parameter::x2_3(1)  = findloc([1,2,3,4,0],0,dim=1)
integer,parameter::x3(3)  = findloc(reshape([1,2,3,0,5,6],[2,3]), 0,dim=1)
integer,parameter::x4(2)  = findloc(reshape([1,2,3,0,8,9],[2,3]), 0,dim=2)
integer,parameter::x3_1(3)  = findloc(reshape([1,2,3,4,5,6],[2,3]),0,dim=1)
integer,parameter::x4_1(2)  = findloc(reshape([1,2,3,4,5,6],[2,3]),0,dim=2)
integer,parameter::x3_2(2)  = findloc(reshape([1,2,3,4,5,6],[2,3]),10)
integer,parameter::x4_2(2)  = findloc(reshape([1,2,3,4,5,6],[2,3]),0)
...
integer,parameter::x7(2)  = findloc(reshape([1,0,3,4],[2,2]),2,mask=.true.)
integer,parameter::x8(2)  = findloc(reshape([1,0,3,4],[2,2]),2,mask=.false.)
integer,parameter::x9(2)  = findloc(reshape([1,2,3,4],[2,2]),2,mask=reshape([.true.,.true.,.true.,.true.],[2,2]))
integer,parameter::x10(2) = findloc(reshape([1,2,3,4],[2,2]),12,mask=reshape([.true.,.false.,.true.,.false.],[2,2]))
integer,parameter::x11(2) = findloc(reshape([1,2,3,4],[2,2]),0,mask=reshape([.true.,.true.,.true.,.true.],[2,2]))
integer,parameter::x12(2) = findloc(reshape([1,2,3,0],[2,2]),0,mask=reshape([.false.,.false.,.true.,.false.],[2,2]))
integer,parameter::x12_1(2) = findloc(reshape([1,2,3,0],[2,2]),0,mask=reshape([.false.,.false.,.true.,.true.],[2,2]))
...
integer,parameter::x18_1(2) = findloc(reshape([1,2,3,0],[2,2]),0,dim=1,kind=4,mask=reshape([.true.,.true.,.true.,.false.],[2,2]),back=.true.)
integer,parameter::x19_1(2) = findloc(reshape([1,12,3,2],[2,2]),2,dim=2,kind=4,mask=reshape([.true.,.true.,.true.,.false.],[2,2]),back=.true.)
...
integer,parameter::x30(2) = findloc(reshape([1,1,3,1],[2,2]),2,mask=.true.,back=.true.)
integer,parameter::x31(2) = findloc(reshape([1,1,3,2],[2,2]),2,mask=.false.,back=.true.)
integer,parameter::x32(2) = findloc(reshape([1,1,3,4],[2,2]),0,mask=.true.,back=.false.)
...
integer,parameter::x34_1(2) = findloc(reshape([1,1,3,1],[2,2]),2,mask=.true.,back=.false.)
integer,parameter::x35_1(2) = findloc(reshape([1,1,3,1],[2,2]),2,mask=.false.,back=.false.)
integer,parameter::x34_2(2) = findloc(reshape([1,1,3,1],[2,2]),2,dim =1,mask=.true.,back=.false.)
integer,parameter::x35_2(2) = findloc(reshape([1,1,3,1],[2,2]),2,dim=2,mask=.true.,back=.false.)
if(any(x.ne.5))print*,"101"
if(any(x2.ne.0))print*,"102",x2
if(any(x2_2.ne.0))print*,"902",x2_2
if(any(x2_3.ne.5))print*,"902",x2_3
if(any(x3.ne.[0,2,0]))print*,"103",x3
if(any(x4.ne.[0,2]))print*,"104",x4
if(any(x3_1.ne.[0,0,0]))print*,"903",x3_1
if(any(x4_1.ne.[0,0]))print*,"904",x4_1
if(any(x3_2.ne.[0,0]))print*,"913",x3_2
if(any(x4_2.ne.[0,0]))print*,"914",x4_2
if(any(x5.ne.[0,0]))print*,"105",x5
if(any(x6.ne.[0,0]))print*,"106",x6
if(any(x7.ne.[0,0]))print*,"107",x7
if(any(x8.ne.[0,0]))print*,"108",x8
if(any(x9.ne.[2,1]))print*,"109",x9
if(any(x10.ne.[0,0]))print*,"110",x10
if(any(x11.ne.[0,0]))print*,"111",x11
if(any(x12_1.ne.[2,2]))print*,"912",x12_1
...
if(any(x18_1.ne.[0,0]))print*,"918",x18_1
if(any(x19_1.ne.[0,0]))print*,"919",x19_1
...
if(any(x27.ne.[2,2]))print*,"627",x27
if(any(x28.ne.[0,0]))print*,"128",x28
if(any(x29.ne.[0,0]))print*,"129",x29
if(any(x28.ne.[0,0]))print*,"128",x28
if(any(x29.ne.[0,0]))print*,"129",x29
if(any(x30.ne.[0,0]))print*,"727",x30
...
if(any(x34_1.ne.[0,0]))print*,"930",x34_1
if(any(x35_1.ne.[0,0]))print*,"931",x35_1
if(any(x34_2.ne.[0,0]))print*,"933",x34_2
if(any(x35_2.ne.[0,0]))print*,"934",x35_2
print*,"pass"
end
