  module mod
        type TAG
        integer,contiguous,pointer:: p01(:,:,:,:,:)
        integer,contiguous,pointer:: p02(:,:,:,:,:)
        integer,contiguous,pointer:: p03(:,:,:,:,:)
        integer,contiguous,pointer:: p04(:,:,:,:,:)
        integer,contiguous,pointer:: p05(:,:,:,:,:)
        integer,contiguous,pointer:: p06(:,:,:,:,:)
        integer,contiguous,pointer:: p07(:,:,:,:,:)
        integer,contiguous,pointer:: p08(:,:,:,:,:)
        integer,contiguous,pointer:: p09(:,:,:,:,:)
        integer,contiguous,pointer:: p10(:,:,:,:,:)
        integer,contiguous,pointer:: p11(:,:,:,:,:)
        integer,contiguous,pointer:: p12(:,:,:,:,:)
        integer,contiguous,pointer:: p13(:,:,:,:,:)
        integer,contiguous,pointer:: p14(:,:,:,:,:)
        integer,contiguous,pointer:: p15(:,:,:,:,:)
        integer,contiguous,pointer:: p16(:,:,:,:,:)
        integer,contiguous,pointer:: p17(:,:,:,:,:)
        integer,contiguous,pointer:: p18(:,:,:,:,:)
        integer,contiguous,pointer:: p19(:,:,:,:,:)
        integer,contiguous,pointer:: p20(:,:,:,:,:)
        integer,contiguous,pointer:: p21(:,:,:,:,:)
        integer,contiguous,pointer:: p22(:,:,:,:,:)
        integer,contiguous,pointer:: p23(:,:,:,:,:)
        integer,contiguous,pointer:: p24(:,:,:,:,:)
        integer,contiguous,pointer:: p25(:,:,:,:,:)
        integer,contiguous,pointer:: p26(:,:,:,:,:)
        integer,contiguous,pointer:: p27(:,:,:,:,:)
        integer,contiguous,pointer:: p28(:,:,:,:,:)
        integer,contiguous,pointer:: p29(:,:,:,:,:)
        end type
        end
        subroutine tt(s)
        use mod
