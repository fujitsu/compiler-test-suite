...
!
 ...
 if (any(iachar(achar(int(reshape(reshape((/c1(v(k1:k2),v(k1:k3))/),(/k2,k1/)),(/k2,k1/))/=c1(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/c3(v(k1:k2),v(k1:k3))/),(/k2,k1/)),(/k2,k1/))/=c3(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/a1(v(k1:k2),v(k1:k3))/),(/k2,k1/)),(/k2,k1/))/=a1(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/a2(v(k1:k2),v(k1:k3))/),(/k2,k1/)),(/k2,k1/))/=a2(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/(/c2(v(k1),v(k1)),c2(v(k2:k2),v(k1:k1)),c2(v(k1),v(k2)),c2(v(k2:k2),v(k2:k2)),c2(v(k1),v(k3)),c2(v(k2:k2),v(k3:k3))/)/),(/k2,k1/)),(/k2,k1/))/=c2(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/(/c1(v(k1),v(k1)),c1(v(k2:k2),v(k1:k1)),c1(v(k1),v(k2)),c1(v(k2:k2),v(k2:k2)),c1(v(k1),v(k3)),c1(v(k2:k2),v(k3:k3))/)/),(/k2,k1/)),(/k2,k1/))/=c1(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/(/c3(v(k1),v(k1)),c3(v(k2:k2),v(k1:k1)),c3(v(k1),v(k2)),c3(v(k2:k2),v(k2:k2)),c3(v(k1),v(k3)),c3(v(k2:k2),v(k3:k3))/)/),(/k2,k1/)),(/k2,k1/))/=c3(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/(/a1(v(k1),v(k1)),a1(v(k2:k2),v(k1:k1)),a1(v(k1),v(k2)),a1(v(k2:k2),v(k2:k2)),a1(v(k1),v(k3)),a1(v(k2:k2),v(k3:k3))/)/),(/k2,k1/)),(/k2,k1/))/=a1(1:2,1:1))))))print *,'fail'
 if (any(iachar(achar(int(reshape(reshape((/(/a2(v(k1),v(k1)),a2(v(k2:k2),v(k1:k1)),a2(v(k1),v(k2)),a2(v(k2:k2),v(k2:k2)),a2(v(k1),v(k3)),a2(v(k2:k2),v(k3:k3))/)/),(/k2,k1/)),(/k2,k1/))/=a2(1:2,1:1))))))print *,'fail'
