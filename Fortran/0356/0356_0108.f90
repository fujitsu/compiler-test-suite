...
subroutine init(a,b,c,d,e,res)
  integer(4) :: i
  integer(4),dimension(1:64) :: a,b,c,d,e,res,neg1,neg2,neg3
  do i=1,64
     a(i) = 0
     b(i) = i
     c(i) = i
...
subroutine test(a,b,c,d,e)
  integer(4) :: i
  integer(4), dimension(1:64) :: a,b,c,d,e, tmp1,neg1,neg2,neg3
  do i=1,64
     neg1(i) = - 1 * e(i)
     neg2(i) = - 1 * c(i)
     neg3(i) = - 1 * b(i)
     tmp1(i) = neg3(i) * neg2(i)
     a(i) = tmp1(i) - neg1(i)
     d(i) = d(i) - b(i) * e(i)
  enddo
end subroutine test
