...
subroutine total(s1)
  ...
  data res1/50.0/,res2/0.0/,res3/45.0/,res4/5.0/,res5/0.0/
  data res6/46.0/,res7/5.0/
  data res11/51.0/,res12/1.0/,res13/46.0/,res14/6.0/,res15/1.0/
  data res16/47.0/,res17/6.0/
  s1 = 0
  s2 = 1
  do i=1,100
     if (l1(i)) then
