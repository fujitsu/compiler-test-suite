...
subroutine total(s1)
  integer(kind=4) :: n
  complex(kind=4) :: s1,s2
  complex(kind=4),dimension(100) :: a
  logical(kind=4),dimension(100) :: l1,l2,l3,l4
  complex(kind=4) :: res1,res2,res3,res4,res5,res6,res7
  complex(kind=4) :: res11,res12,res13,res14,res15,res16,res17
  data a/100*(1.0,1.0)/
  data l1/5*.false.,45*.true.,45*.false.,5*.true./
  data l2/100*.false./,l3/5*.false.,45*.true.,50*.false./
  data l4/95*.false.,5*.true./
  data res1/(50.0,50.0)/,res2/(0.0,0.0)/,res3/(45.0,45.0)/
  data res4/(5.0,5.0)/,res5/(0.0,0.0)/,res6/(46.0,46.0)/
  data res7/(5.0,5.0)/
  data res11/(51.0,51.0)/,res12/(1.0,1.0)/,res13/(46.0,46.0)/
  data res14/(6.0,6.0)/,res15/(1.0,1.0)/,res16/(47.0,47.0)/
  data res17/(6.0,6.0)/
