...
integer,parameter::i=DSHIFTR(huge(a),huge(b),16)
integer,parameter::j=DSHIFTR(huge(c),huge(d),8)
integer*4,parameter::k=DSHIFTR(huge(e),huge(f),32)
integer*8,parameter::l=DSHIFTR(huge(g),huge(h),64)
