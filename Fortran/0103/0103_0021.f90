...
integer,parameter::m(3)=DSHIFTL(a,b,8)
integer,parameter::n(3)=DSHIFTL(c,d,7)
integer,parameter::o(3)=DSHIFTL(e,f,15)
integer,parameter::p(3)=DSHIFTL(g,h,16)
integer*4,parameter::q(3)=DSHIFTL(i,j,32)
integer*4,parameter::r(3)=DSHIFTL(k,l,31)
integer*8,parameter::s(3)=DSHIFTL(ii,jj,63)
integer*8,parameter::t(3)=DSHIFTL(kk,ll,64)

if( any(m .ne. [124,127,125]))print*,"100"
if( any(n .ne. [64,-64,65] ))print*,"102"
if( any(o .ne. [-16385,16383,-16386]))print*,"103"
if( any(p .ne. [-32767_4,-32768_4,-32765_4]))print*,"104"
if( any(q .ne. [2147483646_4,2147483647_4,2147483645_4  ]))print*,"105"
if( any(r .ne. [1073741824_4,-1073741824_4,1073741824_4]))print*,"106"
if( any(s .ne. [-4611686018427387905_8,4611686018427387903_8,-4611686018427387906_8]))print*,"107"
if( any(t .ne. [-9223372036854775807_8,-9223372036854775808_8,-9223372036854775806_8]))print*,"108"
print*,"PASS"
end
