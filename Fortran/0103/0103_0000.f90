...
integer,parameter::m=DSHIFTL(c,d,8)
integer,parameter::n=DSHIFTL(e,g,16)
integer*4,parameter::o=DSHIFTL(j,k,32)
integer*4,parameter::q=DSHIFTL(k,k,32)
integer*8,parameter::p=DSHIFTL(w,y,64)
integer*8,parameter::r=DSHIFTL(w,w,64)
integer,parameter::s=DSHIFTL(g,g,16)
integer,parameter::t=DSHIFTL(c,c,8)
if(m .ne. 127)print*,"100"
if(n .ne. -32768 )print*,"101"
if(o .ne. -2147483648_4 )print*,"102"
if(p .ne. -9223372036854775808_8 )print*,"103"
