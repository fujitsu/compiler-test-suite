      ...
      DO 1 J=1,N1                                                       
        DO 1 I=1,N2                                                     
          ...
          STR_DATA%LBB(I,J) = 0.EQ.MOD(I,4)                                      
          STR_DATA%LBC(I,J) = 0.EQ.MOD(I,5)                                      
          STR_DATA%CA(I,J) = 0                                                   
          STR_DATA%CB(I,J) = I-1                                                 
          STR_DATA%CC(I,J) = I+1                                                 
          STR_DATA%CDA(I,J) = 0                                                  
 ...
 1    CONTINUE                                                          
      ...
      DO 100 I=1,N1                                                     
        STR_DATA%DA(I,1) = DSQRT(DABS(STR_DATA%DB(I,1)))*STR_DATA%DC(I,1)                          
        DO 10 J=1,10                                                    
          DO 10 K=1,10                                                  
            STR_DATA%IA(J,K) = STR_DATA%IB(J,K) + STR_DATA%IC(J,K)                                 
   10   CONTINUE                                                        
        STR_DATA%DC(I,2) = DSQRT(DABS(STR_DATA%DA(I,2)))+ STR_DATA%DB(I,2)                         
        DO 11 L=1,N2                                                    
          DO 11 M=1,N2                                                  
            STR_DATA%RA(L,M) = STR_DATA%RB(L,M)*STR_DATA%RC(L,M)                                   
   11     CONTINUE                                                      
  100 CONTINUE                                                          
  ...
  400 CONTINUE                                                          
   ...
   50   CONTINUE                                                        
        ...
        DO 51 L=1,N2                                                    
          DO 51 M=1,N3                                                  
            STR_DATA%IHA(L,M) = STR_DATA%IHB(L,M)*STR_DATA%IHC(M,L)                                
   51     CONTINUE                                                      
  500 CONTINUE                                                          
