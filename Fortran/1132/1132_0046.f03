!             CVCT3146            LEVEL=4        DATE=84.01.19
!********************************************************************C
! 1. PROGRAM NAME : CVCT3601                                         C
! 2. PURPOSE      : USER'S INDUCTION                                 C
! 3. RESULT       :                                                  C
! 4. ENVIRONMENT  : VPL(4),ADV(EVL),VOCL,VMSG                        C
! 5. RESULT       : 1983-08-04                                       C
!********************************************************************C
!VOCL TOTAL, IT1.GT.0,IT2.GT.1,IM1.LT.0,IM2.LT.-1,IM3.LT.-1
!VOCL TOTAL, INC.GT.0
PROGRAM  CV3601
  IMPLICIT  REAL*8(D),INTEGER*2(H),COMPLEX*16(C),LOGICAL*4(L)
  type TAG
     complex*16 :: CD10(-50:0) = (-1.D0,5.D0)
  end type TAG
  type(TAG) st
  DIMENSION  DA10(50),DA20(50),DA30(-25:25),DA40(0:50), &
       DB10(-10:0,50),DB20(0:10,50),DB30(-10:10,-50:-1), &
       CD20(0:50),CD30(-25:25), &
  ...
  DO I=1,IT2*IT4
     ...
     DX =DREAL(st%CD10(N1)) * DA20(IM1-N1)
     DY = DIMAG(CD20(-N2+IT2)) - DA30(N2)
     IF ( DX .GT. DY ) THEN
        LD10(I) = .TRUE.
        st%CD10(N1) = DCMPLX(DX,DY)
     ...
     ENDIF
     N1 = N1+1
     CD30(N2) = CD30(N2+1) + st%CD10(-50)
     DA20(IM2-N1) = DZ
  END DO
  !
  N1 = 1
  N2 = 25
  DO I=HT1*IT2,IT1*HT2+IT3
     ...
     DO J=2,IT2*IT4+IT1
        ...
        IF ( DB20(N1,N4-1) .GT. DB30(-I,-N3+1) ) THEN
           DB10(-I,N4) = DIMAG(st%CD10(IM2-J)) - DB20(I,I)
           LD30(J) = .TRUE.
        ELSE
           LD10(J) = .TRUE.
           !           DA40(J) = DB30(I,-I-31) + DB30(N1,IM1-N3)
  ...
  DO I=50,30,IM1
     N1 = N1 + INC
     CD30(N2+IT2) = st%CD10(-I) * CD20(N1+1)
     DX = DREAL(CD30(N2))
     DY = DIMAG(CD30(N2))
     IF ( DX .GT. DY ) THEN
        LD20(N1) = .TRUE.
