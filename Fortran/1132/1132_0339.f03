!             CVCT8012            LEVEL=2        DATE=89.10.20
!             CVCT8012            LEVEL=2        DATE=84.07.12
!*********************************************************************C
!  1. PROGRAM NAME   : CVCT8012                                       C
!  2. PURPOSE        : BUSY ON EXIT  STORE & FETCH IN BLOCK (1)       C
!  3. RESULTS        : V , S                                          C
...
!CCCCCCCCC
 ...
 20   CONTINUE
      WRITE(6,*) '** TEST NO. 1-1 **'
      WRITE(6,*)  R4%S1,L4%S1,R4%A2,L4%A2,R4%S3(1),L4%S3(1)
!
!CCCCCCCCCC
! 1 - 2   C
!CCCCCCCCCC
