!             CVCT6120            LEVEL=2        DATE=84.02.09
!********************************************************************C
!*  1. PROGRAM NAME   :  CVCT6120                                   *C
...
PROGRAM CV6120
  ...
  type st1
     ...
     INTEGER*4   L10(10),L20(10,10)
     REAL*4      A(10),B(10),C(10),D(10,10),E(10,10)
     REAL*8      DA(10),DB(10),DC(10),DD(10,10),DE(10,10)
...
500  CONTINUE
  ...
  WRITE(6,*) '----- NO.6 -----'
  DO  I=1,N10
     IF(str%M10(1)) GO TO 600
     L1S = str%L10(I)
     str%A(L1S) = str%B(L1S) + SQRT(str%C(L1S))
...
600  CONTINUE
  ...
  WRITE(6,*) '----- NO.7 -----'
  DO  I=1,N10
     IF(str%M10(I).OR.str%M20(str%L10(I))) THEN
        L2S = str%L20(I,I)
...
801     str%DD(str%L10(I),str%L10(I)) = str%DE(L1S,L1S)
  ...
  WRITE(6,*) '----- NO.9 -----'
  DO  I=1,N10
     IF(str%M10(str%L20(I,I)).OR.str%M20(str%L10(I))) THEN
901     L2S = str%L20(I,I)
