...
10    CONTINUE
      ...
      WRITE(6,*) '----- TEST NO.1 -----  FINDING MAXIMUM       '
      ...
      DO 350 JDMY=1,1
        ...
        DO 120 I=1,L1
         DO 120 J=1,L2
           IF (STR_DATA%RB2(I,J) .GT. VMAX) THEN
              VMAX=STR_DATA%RB2(I,J)
              INDI=I
              INDJ=J
           ENDIF
120      CONTINUE
        ...
        DO 220 KK=1,L1
          IF (VMAX .GT. STR_DATA%RC1(KK)) THEN
            STR_DATA%RC1(KK)=VMAX
          ENDIF

          DO 230 I=1,L1
            DO 240 J=1,L2
              STR_DATA%RA2(I,J)=COS(STR_DATA%RB2(I,J))+SIN(STR_DATA%RC2(I,J))
240         CONTINUE
            KEXP=KEXP+1
            STR_DATA%RB1(I)=SIN(FLOAT(KEXP))

230       CONTINUE
220     CONTINUE
350   CONTINUE

      WRITE (6,901) ' VMAX= ',VMAX,' INDI= ',INDI,' INDJ= ',INDJ
      WRITE (6,900) ' RA2 = ',STR_DATA%RA2
      WRITE (6,900) ' RB1 = ',STR_DATA%RB1


      WRITE(6,*) '----- TEST NO.2 -----  FINDING MINIMUM       '
      ...
      DO 650 JDMY=1,1
        ...
        DO 420 I=1,L1
         DO 420 J=1,L2
           IF (STR_DATA%RB2(I,J) .LT. VMIN) THEN
              VMIN=STR_DATA%RB2(I,J)
              INDI=I
              INDJ=J
           ENDIF
420      CONTINUE
        ...
        DO 520 KK=1,L1
          IF (VMIN .LT. STR_DATA%RC1(KK)) THEN
            STR_DATA%RC1(KK)=VMIN
          ENDIF
...
650   CONTINUE
      ...
      WRITE (6,901) ' VMIN= ',VMIN,' INDI= ',INDI,' INDJ= ',INDJ
      WRITE (6,900) ' RA2 = ',STR_DATA%RA2
      WRITE (6,900) ' RB1 = ',STR_DATA%RB1

  900 FORMAT(' ',A/' ',(6E12.4))
  901 FORMAT(' ',A,E12.4,A,I8,A,I8)
      STOP
      END
