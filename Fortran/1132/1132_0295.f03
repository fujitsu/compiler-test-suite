  !             CVCT6220            LEVEL=2        DATE=83.04.26
  !********************************************************************C
  ...
  !********************************************************************C
  type st1
     INTEGER    I10(10),I11(10),I12(10),I13(10),I10S,I11S
     REAL       R10(10),R11(10),R10S
  ...
  DATA     str%R10S/2/,str%D10S/0/,str%D11/4*1,4*2,2*3/,str%C11/3*(0,1),3*(1,0), &
  ...
  DO  I=1,N
     IF (str%L10(I)) THEN
        str%I10S = str%I10(I)*str%I11(I) - I
        str%R10S = str%R10(I)/str%R11(I)
        str%I11S = str%I10S + str%I10(I)
        str%D10(str%I12(I)) = str%I10S + str%I11S +str%R10(I)
        !
        str%L10S = str%R10S .GT.str%R11(I)
        !
        !*****        str%L11(str%I12(I)) = str%L10S
        str%L11(I) = str%L10S
        !
        str%D10S = str%D10S + str%D11(I)
        !
        str%C10(str%I13(I)) = str%C11(I)/str%C12(I)
     ELSE
        str%I11S = str%I11(I) + str%I10(I) + I
        str%I10S = str%I11S * str%I10(I) - str%I11S
        str%R10S = str%R10(I) * str%R11(I)
        str%L10S = str%I11S .LE. str%I10S
        !
        !*****        str%L12(str%I12(I)) = str%L10S
        str%L12(I) = str%L10S
        !
        str%D12(K) = str%D12(K) + str%R10S
        !
        str%CD10(str%I12(I)) = str%CD11(I)**str%I11S
     ENDIF
  enddo
  !
