!             CVCT5605            LEVEL=3        DATE=84.02.13
!******************************************************************C
!  1. PROGRAM NAME   : CVCT5605                                    C
!  2. PURPOSE        : MI                                          C
!  3. RESULTS        :                                             C
       ...
       IF(ABS(str%CA(H,I,J,K,L,M,N)) .GE. 0.) THEN
         ...
         IF(ABS(str%CB(H,I,J,K,L,M,N)) .GE. 0.) THEN
           ...
           IF(str%RA(I,J,K) .GE. 0.) THEN
              ...
              IF(str%RC(I,J,K) .GE. 0.) THEN
                 str%RC(I,J,K)=str%RA(I,J,K)
                 IF(str%RD(I,J,K) .GE. 0.) THEN
                   str%RD(I,J,K)=str%RA(I,J,K)-str%RC(I,J,K)+I
                 ENDIF
              ENDIF
           ENDIF
         ENDIF
