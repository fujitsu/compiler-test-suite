!             CVCT5319            LEVEL=4        DATE=90.04.05
!
! 1. PROGRAM NAME  : CVCT5319
! 2. PURPOSE       :
! 3. ENVIRONMENT   :
! 4. RESULT        :
...
PROGRAM CV5319
  ...
  !
  WRITE(6,*) '            ### CD21 ###'
  WRITE(6,90) ((str%CD21(I,J),I=1,10),J=1,10)
90 FORMAT(4(3X,E14.7))
  !
  WRITE(6,*) '            ### N31 ###'
  WRITE(6,91) (((str%N31(I,J,K),I=1,10),J=1,10),K=1,10)
91 FORMAT(1H ,10(1X,I6  ))
  !
  WRITE(6,*) '            ### CDS1 ###'
  WRITE(6,*) str%CDS1
  !
  ...
  !
  WRITE(6,*) '            ### N31 ###'
  WRITE(6,99) (((str%N31(I,J,K),I=1,10),J=1,10),K=1,10)
99 FORMAT(10(1X,I6  ))
  !
  STOP
END program
