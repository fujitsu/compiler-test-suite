...
10    CONTINUE                                                          
      ...
      WRITE(6,*) '----- TEST NO.1 -----  INNER PRODUCT           '      
      ...
      DO 120 I=1,L1                                                     
        ...
        DO 130 J=1,L2                                                   
          G=G+STR_DATA%RB1(J)*STR_DATA%RC1(J)                                             
...
120   CONTINUE                                                          
      ...
      WRITE(6,*) '----- TEST NO.2 ----- ''G'' OUTSIDE THE LOOP     '    
                                                                        
      G=0.0                                                             
                                                                        
      DO 140 I=1,L1                                                     
        G=G+STR_DATA%RB1(I)*STR_DATA%RC1(I)                                               
        S=STR_DATA%RA1(I)                                                        
        STR_DATA%RA1(I)=(STR_DATA%RB1(I)+STR_DATA%RC1(I))/2.0                                      
...
140   CONTINUE                                                          
      ...
      WRITE(6,*) '----- TEST NO.3 ----- NO PARTITIONING ?        '      
      ...
      DO 330 I=1,L1                                                     
        ...
        DO 320 J=1,L2                                                   
          V11=V11+STR_DATA%RB2(1,J)*STR_DATA%RC2(J,1)                                     
                                                                        
          DO 310 K=1,L3                                                 
            STR_DATA%RA2(I,K)=STR_DATA%RA2(I,K)+STR_DATA%RB2(I,J)*STR_DATA%RC2(J,K)                         
310       CONTINUE                                                      
320     CONTINUE                                                        
330   CONTINUE                                                          
                                                                        
      STR_DATA%LA3(1,1,1)=STR_DATA%RA2(1,1) .EQ. V11                                      
                                                                        
      WRITE(6,*) ' RA2=',STR_DATA%RA2                                            
      WRITE(6,*) ' LA3(1,1,1)=',STR_DATA%LA3(1,1,1)                              
                                                                       
      WRITE(6,*) '----- TEST NO.4 ----- JUST TO MAKE SURE        '      
      WRITE(6,*) '                  NOT VECTORIZED BY I  ?       '      
...
410       CONTINUE                                                      
          ...
          STR_DATA%QA2(I,J)=STR_DATA%QB2(I,J)                                             
420     CONTINUE                                                        
430   CONTINUE                                                          
