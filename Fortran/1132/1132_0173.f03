!ocl noeval
!             CVCT5310            LEVEL=1        DATE=85.11.22
!
! 1. PROGRAM NAME  : CVCT5310
! 2. PURPOSE       :
! 3. ENVIRONMENT   :
! 4. RESULT        :
...
!
  ...
  DO  I1=1,8,N
     ...
     DO  I2=1,8,2
        ...
        DO  I3=1,8
           ...
           DO  I4=1,8
              str%ES1=str%E11(I1)+str%E11(I2)
              IF(.NOT.str%LS1) str%CD41(I1,I2,I3,I4)=str%CES1+str%NS1-str%ES1
           enddo
  ...
  enddo
  WRITE(6,1000) str%LS1,str%CE21,str%L11,str%ES1
  WRITE(6,1000) str%CD41,str%N21,str%L12
  !
