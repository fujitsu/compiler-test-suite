!             CVCT3159            LEVEL=1        DATE=83.11.27
  module mod
        type TAG1
           REAL*4 :: EA12(-1:12) = 9
           REAL*4 :: EA13(-1:11) = 10
...
! MASKED STORE
       ...
       EA11(I+1,1)=ES1
  10  CONTINUE
      WRITE(6,*) HA11,DA11,EA11,st1%EA12
!
      DO 20 I=2,N
       HA21(I,1)=N
       ES1 = EA23(I-1,1)
