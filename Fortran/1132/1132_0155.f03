...
10    CONTINUE                                                          
      ...
      WRITE(6,*) '----- TEST NO.1 ----- WITHOUT VI(I)            '      
                                                                        
                                                                        
      DO 700 IDMY=1,100                                                 
        DO 710 I=1,L1                                                   
          DO 710 J=1,L2                                                 
            STR_DATA%DA2(I,J)=0.0                                                
            DO 710 K=1,L3                                               
710           STR_DATA%DA2(I,J)=STR_DATA%DA2(I,J)+STR_DATA%DB2(I,K)*STR_DATA%DC2(K,J)                       
700   CONTINUE                                                          
                                                                        
      WRITE (6,*) ' DA2 =',STR_DATA%DA2                                          
                                                                        
                                                                       
      WRITE(6,*) '----- TEST NO.2 ----- WITH    VI(I)            '      
      ...
      DO 800 IDMY=1,100                                                 
        DO 810 I=1,L1                                                   
          DO 810 J=1,L2                                                 
            STR_DATA%DA2(I,J)=0.0                                                
            DO 810 K=1,L3                                               
810           STR_DATA%DA2(I,J)=STR_DATA%DA2(I,J)+STR_DATA%DB2(I,K)*STR_DATA%DC2(K,J)                       
800   CONTINUE                                                          
      ...
      WRITE(6,*) '----- TEST NO.3 ----- WITH LVL <  AVL          '      
      ...
      DO 900 IDMY=1,100                                                 
        DO 910 I=1,L1-1                                                 
          DO 910 J=1,L2-1                                               
            STR_DATA%DA2(I,J)=0.0                                                
            DO 910 K=1,L3-1                                             
910           STR_DATA%DA2(I,J)=STR_DATA%DA2(I,J)+STR_DATA%DB2(I,K)*STR_DATA%DC2(K,J)                       
900   CONTINUE                                                          
      ...
      WRITE(6,*) '----- TEST NO.4 ----- WITH ALL LVL UNKNOWN     '      
      ...
      DO 1000 IDMY=1,100                                                
        DO 1010 I=1,IDX1                                                
          DO 1010 J=1,IDX2                                              
            STR_DATA%DA2(I,J)=0.0                                                
            DO 1010 K=1,IDX3                                            
1010          STR_DATA%DA2(I,J)=STR_DATA%DA2(I,J)+STR_DATA%DB2(I,K)*STR_DATA%DC2(K,J)                       
1000  CONTINUE                                                          
