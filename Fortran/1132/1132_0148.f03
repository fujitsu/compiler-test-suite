  ...
  1   CONTINUE                                                          
      ...
      DO 10 I=1,10                                                      
        ...
        DO 11 J=1,10                                                    
          ...
          DO 12 K=1,2                                                   
            STR_DATA%R30(I,J,K) = STR_DATA%R31(I,J,K) + STR_DATA%R20(I,J)                          
            DO 13 L=1,10                                                
              STR_DATA%R40(I,J,K,L) = STR_DATA%R41(I,J,K,L) + STR_DATA%R30(I,J,K)                  
   13       CONTINUE                                                    
            STR_DATA%R31(I,J,K) = STR_DATA%R30(I,J,K) + STR_DATA%R10(I)                            
   12     CONTINUE                                                      
          STR_DATA%R21(I,J) = STR_DATA%R20(I,J)                                           
   11   CONTINUE                                                        
        STR_DATA%R11(I) = - STR_DATA%R12(I) + J                                           
        DO 21 J=1,2                                                     
          DO 22 K=1,10                                                  
            DO 23 L=1,10                                                
              STR_DATA%R31(K,J,L) = STR_DATA%R32(K,J,L)*2.0                               
   23       CONTINUE                                                    
   22     CONTINUE                                                      
   21   CONTINUE                                                        
   ...
   10 CONTINUE                                                          
      ...
      DO 30 I=1,10                                                      
        ...
        DO 31 J=1,10                                                    
          DO 32 K=1,2                                                   
            STR_DATA%R30(I,J,K) = STR_DATA%R31(I,J,K)                                     
            DO 33 L=1,10                                                
              STR_DATA%R40(I,J,K,L) = STR_DATA%R41(I,J,K,L) + STR_DATA%R30(I,J,K)                  
   33       CONTINUE                                                    
   32     CONTINUE                                                      
   31   CONTINUE                                                        
        ...
        DO 41 J=1,2                                                     
          DO 42 K=1,10                                                  
            STR_DATA%R33(I,J,K) = STR_DATA%R30(I,J,K)*2.                                  
            DO 43 L=1,10                                                
              STR_DATA%R31(K,J,L) = STR_DATA%R32(K,J,L)*2.0                               
   43       CONTINUE                                                    
            STR_DATA%R30(I,J,K) = STR_DATA%R32(I,J,K)*2.                                  
   42     CONTINUE                                                      
   41   CONTINUE                                                        
        ...
        DO 51 J=1,2                                                     
          DO 52 K=1,10                                                  
            DO 53 L=1,10                                                
              STR_DATA%R31(K,J,L) = STR_DATA%R32(K,J,L)*2.0                               
   53       CONTINUE                                                    
            STR_DATA%R30(I,J,K) = STR_DATA%R32(I,J,K)*3.                                  
   52     CONTINUE                                                      
   51   CONTINUE                                                        
