!             CVCT5309            LEVEL=1        DATE=85.11.22
!
! 1. PROGRAM NAME  : CVCT5309
! 2. PURPOSE       :
! 3. ENVIRONMENT   :
! 4. RESULT        :
...
PROGRAM CV5309
  ...
  !
  DO  I1=1,10
     str%LS1=I1.GT.str%NS1
     DO  I2=1,10
        str%L22(I1,I2)=str%L22(I1,I2).AND.str%LS1
        DO  I3=1,10
           IS2=str%N21(I1,I2)
           IF(str%LS1)  THEN
              IF(str%L22(I1,I2).EQV..FALSE.) str%D31(I1,I2,I3)=str%DS1/IS2
           ENDIF
        enddo
     enddo
     IF (str%LS1) str%E11(I1)=I1/3+str%E12(I2)
  enddo
  WRITE(6,*) str%L22,str%D31,str%E11,IS2
  !

  DO  I1=1,10
     str%CES1=CMPLX(DFLOAT(I1),DFLOAT(-I1))
     DO  I2=1,N+8
        str%CE21(I1,I2)=str%CES1
        DO  I3=1,10
           str%D31(I1,I2,I3)=-str%CES1*CMPLX(REAL(str%CDS1),IMAG(str%CDS1))
        enddo
     enddo
  enddo
  WRITE(6,*)  str%D31,str%CE21,str%CES1
  !
  STOP
END program
