!ocl noeval
!             CVCT5311            LEVEL=3        DATE=89.10.09
!
! 1. PROGRAM NAME  : CVCT5311
! 2. PURPOSE       :
! 3. ENVIRONMENT   :
! 4. RESULT        :
! 5. HISTORY       : 1984-11-07
!
PROGRAM CV5311
  type st1
  ...
  DO  I1=N,N+6
     DO  I2=1,8,I1
        str%CES1=I1+I2*(0.,1.)
        str%CE21(I2,I1)=str%CES1+1.
        DO  I3=1,8
           str%NS1=str%ES1*I3-2.
           DO  I4=1,8
              str%ES1=str%E11(I3)+str%E11(I2)
              str%CD41(I1,I2,I3,I4)=str%CES1+str%NS1-str%ES1
              str%CES1=str%CES1+1
           enddo
           str%N21(I1,I3)=IMAG(str%NS1*str%NS1/str%CES1)
        enddo
     enddo
     str%L12(I1)=str%LS1.OR.str%N21(I1,1).GT.2.
  enddo
  WRITE(6,1001) str%LS1,str%CE21,str%L11,str%ES1,str%CES1
1001 FORMAT(' ',(8G12.5))
  WRITE(6,1002) str%CD41,str%N21,str%L12
1002 FORMAT(' ',(8G12.5))
  !

  DO  I1=1,8,2
     str%CDS1=CMPLX(SIN(DFLOAT(I1)),COS(DFLOAT(I1)))
     DO  I2=N,8,2
        str%CDS1=CMPLX(1.D0,IMAG(str%CDS1))
        DO  I3=1,8,N
           DO  I4=1,8
              str%NS2=MIN(I1/2,4)
              str%CD41(I1,I2,I3,I4)=str%CDS1*str%NS1
           enddo
           str%D31(I1,I2,I3)=-str%CDS1*str%CDS1-str%NS2
           str%D31(I1+1,I2,I3)=COS(DFLOAT(I1+I1))
        enddo
     enddo
  enddo
  WRITE(6,1002) str%CD41,str%D31
  !
  STOP
END program
