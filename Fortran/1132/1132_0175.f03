!             CVCT5314            LEVEL=1        DATE=85.11.22
!
! 1. PROGRAM NAME  : CVCT5314
! 2. PURPOSE       :
! 3. ENVIRONMENT   :
! 4. RESULT        :
     ...
     DO  I2=1,3
        DO  I3=1,3
           DO  I4=1,3
              ...
              DO  I5=1,3
                 IS2=str%N31(I1,I2,I5)
                 DO  I6=1,2
                    IS2=IS2*IS1
                    str%N61(I1,I2,I3,I4,I5,I6)=IS2
                 enddo
              enddo
              str%N42(I4,I3,I2,I1)=IS1/3
           enddo
        enddo
     enddo
     str%D11(I1)=IS2
        ...
        DO  I3=1,3
           ...
           DO  I4=1,3,N
              DO  I5=1,3
                 ...
                 DO  I6=1,2
                    str%L61(I2,I1,I3,I4,I5,I6)=str%LS1.OR.(str%DS1.GT.0.5D0)
                 enddo
              enddo
           enddo
        enddo
