 ...
 2    CONTINUE                                                          
   ...
   14        DB3(I,J,K) = DC3(I,J,K) - DA2(I,J)                         
             GO TO 12                                                   
   13        DC3(I,J,K) = RB2(I,J) + DFLOAT(STR_DATA%IB1(I))                     
             GO TO 12                                                   
   15        CONTINUE                                                   
   ...
   12     CONTINUE                                                      
        RA2(I,J) = RB2(I,J)*2.0                                         
        STR_DATA%IC1(J)   = STR_DATA%IB1(I)                                               
        STR_DATA%DS1 = STR_DATA%DS1 + DA2(I,J)                                            
   10 CONTINUE                                                          
      ...
      DO 30 I=1,10                                                      
        ...
        DO 31 J=1,2                                                     
          DO 32 K=1,2                                                   
            ...
            RA2(I,J) = SQRT(ABS(RB2(I,J))) + RA2(I,J) + STR_DATA%RA1(I)          
            IF(LC2(I,J)) STR_DATA%DS1 = STR_DATA%DS1 + DB2(I,J)                           
            CA3(I,J,K) = CA2(I,J) + CB2(I,J)                            
   32     CONTINUE                                                      
          CA2(I,J) = STR_DATA%IA1(I) + STR_DATA%DA1(I)                                    
          DB2(I,J) = DB2(I,J) * 2.0 + STR_DATA%DA1(I)                            
          RA2(I,J) = STR_DATA%RA1(I)                                             
