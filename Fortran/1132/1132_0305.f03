!             CVCT6403            LEVEL=6        DATE=84.11.10
!***************************************************************C
!*  1. PROGRAM NAME   :  CVCT6403                              *C
...
10         CONTINUE
  ...
  DO  I=1,L1
     ...
     str%DC2(I,2)=str%DA2(I,2)*2.0
     str%DB2(I,2)=-str%DC2(I,2)
     DO  J=1,L2
        str%QA2(I,J)=str%QB2(I,J)+str%DB2(I,2)
120     CONTINUE
     enddo
...
480     str%CB1(I)=5.0+str%CA1(I)
     ...
     str%DC2(I,2)=str%DA2(I,2)*str%RA1(I)
     str%DB2(I,2)=-str%DC2(I,2)
     DO  J=1,L2
        str%QA2(I,J)=str%QB2(I,J)+str%DB2(I,2)
488     CONTINUE
     ...
     str%DB1(I)=str%DB2(I,2)

     IF(str%RA1(I) .GT. 17.0) GOTO 410
     IF(I .LE. 4) THEN
     ...
     ENDIF
     IF(str%IC1(I).NE.0) THEN
        str%IA1(I)=MOD(str%IB1(I),str%IC1(I))
     ENDIF
410  CONTINUE
  enddo
