...
if (k/=1) print *,107
deallocate(t1%y12,t1%y16)
if (associated(t1%y12)) print *,112
if (allocated(t1%y13)) print *,113
if (associated(t1%y14)) print *,114
if (allocated(t1%y15)) print *,115
if (associated(t1%y16)) print *,116
if (allocated(t1%y17)) print *,117
if (associated(t1%y18)) print *,118
if (allocated(t1%y19)) print *,119
