 ...
 do i2=k1,ubound(a1,5); do i1=k1,ubound(a1,4)
   a1(j,j,j,i1,i2)='x'
   ik=ik+1
   if (     ik==count((/'x'==a1(j,j,j,v1(1):v1(2),v2(1):v2(3)).and.&
                'x'==a1(j,j,j,v1(1):v1(2),v2(1):v2(3))/))) then;else ;print *,'fail';endif
   if (.not.ik==count((/'x'==a1(j,j,j,v1(1):v1(2),v2(1):v2(3)).and.&
                'x'==a1(j,j,j,v1(1):v1(2),v2(1):v2(3))/))) then;print *,'fail';else ;endif
   if (     ik==count((/'x'==a1(j,j,j,v1,v2).and.'x'==a1(j,j,j,v1,v2)/))) then;else ;print *,'fail';endif
   if (.not.ik==count((/'x'==a1(j,j,j,v1,v2).and.'x'==a1(j,j,j,v1,v2)/))) then;print *,'fail';else ;endif
   if (     ik==count((/'x'==(/a1(j,j,j,v1,v2)/).and.'x'==(/a1(j,j,j,v1,v2)/)/))) then;else ;print *,'fail';endif
   if (.not.ik==count((/'x'==(/a1(j,j,j,v1,v2)/).and.'x'==(/a1(j,j,j,v1,v2)/)/))) then;print *,'fail';else ;endif
   if (     ik==count((/'x'==(/a1(j,j,j,1,1),a1(j,j,j,2,1),a1(j,j,j,1,2),a1(j,j,j,2,2),a1(j,j,j,1,3),a1(j,j,j,2,3)/).and.&
                'x'==(/a1(j,j,j,1,1),a1(j,j,j,2,1),a1(j,j,j,1,2),a1(j,j,j,2,2),a1(j,j,j,1,3),a1(j,j,j,2,3)/)/))) then;else ;print *,'fail';endif
   if (.not.ik==count((/'x'==(/a1(j,j,j,1,1),a1(j,j,j,2,1),a1(j,j,j,1,2),a1(j,j,j,2,2),a1(j,j,j,1,3),a1(j,j,j,2,3)/).and.&
                'x'==(/a1(j,j,j,1,1),a1(j,j,j,2,1),a1(j,j,j,1,2),a1(j,j,j,2,2),a1(j,j,j,1,3),a1(j,j,j,2,3)/)/))) then;print *,'fail';else ;endif
 end do; end do
 if (         all  ('x'==a1)) then;else ;print *,'fail';endif
 if (   .not. all  ('x'==a1)) then;print *,'fail';else ;endif
...
!
 ...
 if (     all      ((1,2)==a2)) then;else ;print *,'fail';endif
 if ( .not.all     ((1,2)==a2)) then;print *,'fail';else ;endif
