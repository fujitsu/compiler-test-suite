...
call ss1(y1,x1 ,[n1,n1+1])
call ss1(y1,[x1],[n1,n1+1])
call ss1(y1,cc  ,[n1,n1+1])
call ss1(y1,[1,3] ,[n1,n1+1])
call ss1(y1,t1(::2),[n1,n1+1])
call ss1(y1,t2   ,[n1,n1+1])
call ss1(y1,t3+1 ,[n1,n1+1])
if (ks1(y1,x1,[n1,n1+1])/=0) print *,1001
if (ks1(y1,[x1],[n1,n1+1]) /=0) print *,1002
if (ks1(y1,cc  ,[n1,n1+1]) /=0) print *,1003
if (ks1(y1,[1,3] ,[n1,n1+1]) /=0) print *,1004
if (ks1(y1,t1(::2),[n1,n1+1]) /=0) print *,1005
if (ks1(y1,t2   ,[n1,n1+1]) /=0) print *,1006
if (ks1(y1,t3+1 ,[n1,n1+1]) /=0) print *,1007
if (n1==1) then
  deallocate(x1)
endif
end subroutine
