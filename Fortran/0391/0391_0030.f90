...
do k0=1,3
if (.not.allocated(v(k0)%x32)) allocate(v(k0)%x32(3))
do k1=1,3
if (.not.allocated(v(k0)%x32(k1)%x22)) allocate(v(k0)%x32(k1)%x22(3))
do k2=1,3
if (.not.allocated(v(k0)%x32(k1)%x22(k2)%x12))allocate(v(k0)%x32(k1)%x22(k2)%x12(3))
end do
end do
if (any(v(k0)%x31/=31)) print *,101
if (any(v(k0)%x33/=33)) print *,102
