...
write(37,*)trg1
rewind(37)
read(UNIT=37,10,IOSTAT = ii, IOMSG =ctrg1,SIZE = ii1 ,ADVANCE = 'no')
read(UNIT=37,10,IOSTAT = obj(2,1)%fun(trg) ,IOMSG = obj(2,1)%cfun(ctrg),SIZE = obj(2,1)%fun(trg1),ADVANCE = 'no')
10 format(3i10)
if (trg /= ii) print *,101
