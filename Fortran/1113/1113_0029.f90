...
write(15,*)trg1
rewind(15)
read(UNIT=15,10,IOSTAT = ii, IOMSG =ctrg1,SIZE = ii1 ,ADVANCE = 'no')
read(UNIT=15,10,IOSTAT = obj(2,1)%test(trg) ,IOMSG = obj(2,1)%test(ctrg),SIZE = obj(2,1)%test(trg1),ADVANCE = 'no')
10 format(3i10)
