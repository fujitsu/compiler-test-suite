...
type(ty1) :: str
str%ip=>ifun
if(str%ip(3).ne."aaa"//"1234567890") print *,'fail'
str%ip2=>ifun
if(str%ip2(3).ne."aaa"//"1234567890") print *,'fail'
str%ip3=>ifun
if(str%ip3(3).ne."aaa"//"1234567890") print *,'fail'
call isub()
call jsub()
contains
subroutine jsub()
...
str%ip2=>ifun1
str%ip3=>ifun1
call ksub(str%ip,str%ip2,str%ip3)
call kasub(str%ip(3),str%ip2(3),str%ip3(3),3)
if(str%ip(3).ne."bbb"//"1234567890") print *,'fail'
if(str%ip2(3).ne."bbb"//"1234567890") print *,'fail'
if(str%ip3(3).ne."bbb"//"1234567890") print *,'fail'
end subroutine
subroutine kasub(ip,ip2,ip3,i)
character(len=i+10) :: ip
character(len=i+10) :: ip2
character(len=i+10) :: ip3
if(ip.ne."bbb"//"1234567890") print *,'fail'
if(ip2.ne."bbb"//"1234567890") print *,'fail'
if(ip3.ne."bbb"//"1234567890") print *,'fail'
end subroutine
subroutine ksub(ip,ip2,ip3)
