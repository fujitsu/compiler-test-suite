...
inline TAG<int>	SG::func(TAG<int>) {return tagobj;}
inline TAG<int>	SG::func(TAG<float>, TAG<bool>*) {return tagobj;}
inline TAG<int>	SG::func(TAG<long long>,...) {return tagobj;}

inline TAG1<short,1>	SG::func(TAG1<int,1>) {return tag1obj;}
inline TAG1<short,1>	SG::func(TAG1<double,1>, TAG1<short,2>*) {return tag1obj;}
inline TAG1<short,1>	SG::func(TAG1<wchar_t,1>,...) {return tag1obj;}

inline TAG2<long>	SG::func(TAG2<short>) {return tag2obj;}
inline TAG2<long>	SG::func(TAG2<wchar_t>, TAG2<char>*) {return tag2obj;}
inline TAG2<long>	SG::func(TAG2<double>,...) {return tag2obj;}

inline TAG2<float>::TAG21<unsigned int,2>
...
inline TAG2<bool>::TAG21<long,3>::TAG22<double,3>
