...
inline signed long		(*SG::func(signed long a7, ...))[1]{ return 0; }
inline double			(*SG::func(...))[1][2]{ return 0; }
...
inline bool			(*CG::func(bool a11, bool &a12))[1]{ return 0; }
inline wchar_t			(*CG::func(wchar_t &a13,...))[1][2]{ return 0; }
inline unsigned long		(*CG::func(...))[1][2][3]{ return 0; }
inline float			(*CG::CSG::func(float a1, float &a2))[1]{ return 0; }
inline long double		(*CG::CSG::func(long double a3, ...))[1][2]{ return 0; }
inline unsigned long long	(*CG::CSG::func(...))[1][2][3]{ return 0; }
