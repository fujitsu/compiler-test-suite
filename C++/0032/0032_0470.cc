...
struct D { private: int x1;
           ...
           public: void fd(int i) { x1 = i; }
                   friend int gd(D *d); };
struct E { public: private: protected: int x2;
           private: protected: public: private: int x1;
           public: void fe(int i) { x1 = i; }
                   friend int ge(E *e); };
struct F { protected: public: private: protected: public: int x3;
...
struct CC : public A, public B, public C, public D, public E, public F {
    public:
        void f(int,int,int);
        friend int gcc(CC *);
};
