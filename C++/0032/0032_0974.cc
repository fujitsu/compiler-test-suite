...
int main()
{
    ...
    xobj1 = 3;
    xobj2 = 2;    operator+=(xobj2,4);
    xobj3 = 10;   operator-=(xobj3,4);
    operator*=(xobj4,5);
    operator/=(xobj5,3);
    operator%=(xobj6,4);
    ...
    xobj7 = xobj1;
    xobj8 = xobj2;    operator+=(xobj8,xobj4);
    xobj9 = xobj3;    operator-=(xobj9,xobj5);
    xobj10 = xobj4;   operator*=(xobj10,xobj6);
    xobj11 = xobj4;   operator/=(xobj11,xobj5);
    xobj12 = xobj3;   operator%=(xobj12,xobj6);
