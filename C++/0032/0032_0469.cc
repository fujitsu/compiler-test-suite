...
struct A { private:   int x1;
           public:    void fa(int i) { x1 = i; }
                     friend int ga(A *); };
struct B { protected: int x2; };
struct C { public:    int x3; };
...
struct D { private: int x1;
           public:    void fd(int i) { x1 = i; }
                      friend int gd(D *); };
struct E { private: protected: int x2; };
struct F { private: protected: public: int x3; };
struct G { private: protected: public: private: int x1;
           public:    void fg(int i) { x1 = i; }
                      friend int gg(G *); };
struct H { private: protected: public: private: protected: int x2; };
struct I { private: protected: public: private: protected: public: int x3; };
...
struct AA : public A, public B, public C {
    public: void f(int); friend int gaa(AA *);
};

struct BB : public D, public E, public F {
    public: void f(int); friend int gbb(BB *);
};

struct CC : public D, public E, public F, public G, public H, public I {
    public: void f(int); friend int gcc(CC *);
};

struct DD : public A, public B, public C, 
