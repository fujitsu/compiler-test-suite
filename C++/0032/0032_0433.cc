...
int sqrtd_v()
{
  ...
  return (std::abs(w[0] - 3.0) <= DBL_2EP) && (std::abs(w[1] - 5.0) <= DBL_2EP);
}
...
int sqrtf_v()
{
  ...
  return (std::abs(w[0] - 3.0) <= FLT_2EP) && (std::abs(w[1] - 5.0) <= FLT_2EP);
}
...
int sqrtl_v()
{
  ...
  return (std::abs(w[0] - 3.0) <= LDBL_2EP) && (std::abs(w[1] - 5.0) <= LDBL_2EP);
}
