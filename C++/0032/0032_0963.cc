...
{
    X xobj1(2,4);
    X xobj2 = xobj1.operator+(3);
    X xobj3 = xobj1.operator-(2);
    X xobj4 = xobj2.operator*(3);
    X xobj5 = xobj4.operator/(4);
    X xobj6 = xobj2.operator%(3);

    X xobj7 = operator+(xobj5,xobj6);
    X xobj8 = operator-(operator+(xobj2,xobj1),xobj7);
    X xobj9 = operator-(xobj4,operator*(xobj1,xobj3));
    X xobj10 = operator*(operator/(xobj9,xobj5),xobj6);
    X xobj11 = operator-(operator%(xobj10,xobj8),xobj3);
