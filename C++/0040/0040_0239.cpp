...
struct TrivialCopyCtor2
{
    ...
    TrivialCopyCtor2& operator =(const TrivialCopyCtor2&) = default; 
};
struct TrivialCopyCtor3
{
    TrivialCopyCtor3() {} 
    TrivialCopyCtor3& operator =(const TrivialCopyCtor3&) = default; 
};
...
struct NonTrivialCopyCtor1 { NonTrivialCopyCtor1& operator =(const NonTrivialCopyCtor1&){ return *this; } };
