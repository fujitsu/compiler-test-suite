...
{
    {
        ...
        std::unordered_multimap<int,std::string>::node_type nt = src.extract(1);
        ...
        std::unordered_multimap<int,std::string>::node_type nt1 = src.extract(3);
    ...
    {
        std::unordered_multimap<int,std::string> src{{1,"one"},{2,"two"},{2,"two"},{3,"three"}};
        std::unordered_multimap<int,std::string>::node_type nt = src.extract(4);
