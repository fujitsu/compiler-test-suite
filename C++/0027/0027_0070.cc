...
template <class test_t> struct TC {
  test_t selstore_test(const test_t *input, const test_t *input2, const int *mask, const test_t *res, int n);
  test_t selstore_test_dis(const test_t *input, const test_t *input2, const int *mask, const test_t *res, int n);
  test_t selstore_test_vts(const test_t *input, const test_t *input2, const int *mask, const test_t res, int n);
  test_t selstore_test_vsum(const test_t *input, const test_t *input2, const int *mask, const test_t res, int n);
};

template <class test_t>
test_t TC<test_t>::selstore_test(const test_t *input, const test_t *input2, const int *mask, const test_t *res, int n) {
  test_t *tmp;
  tmp = new test_t[n];
...
template <class test_t>
test_t TC<test_t>::selstore_test_dis(const test_t *input, const test_t *input2, const int *mask, const test_t *res, int n) {
  test_t *tmp;
  tmp = new test_t[n];
...
template <class test_t>
test_t TC<test_t>::selstore_test_vts(const test_t *input, const test_t *input2, const int *mask, const test_t res, int n) {
  test_t tt[1];
...
template <class test_t>
test_t TC<test_t>::selstore_test_vsum(const test_t *input, const test_t *input2, const int *mask, const test_t res, int n) {
  test_t tt[1] = {0};
