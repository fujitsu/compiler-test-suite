...
void f(A a1, B b, A a2, int i) { data_f[1] = a1.a + b.b + a2.a + i; }
void f(A a, int i, B b, double d) { data_f[2] = a.a + i + b.b + (int)d; }
void f(A a, int i1, int i2, int i3) { data_f[3] = a.a + i1 + i2 + i3; }
void f(B b, A a, int i, double d) { data_f[4] = b.b + a.a + i + (int)d; }
void f(B b1, B b2, A a, int i) { data_f[5] = b1.b + b2.b + a.a + i; }
void f(B b1, int i, B b2, double d) { data_f[6] = b1.b + i + b2.b + (int)d; }
void f(B b, int i1, double d, int i2) { data_f[7] = b.b + i1 + (int)d + i2; }
