...
bool char_test(){
  bool ans = FALSE;
  static __thread char* char_tls = &char_tmp;
  try {
    throw char_tls;
  }
  catch (char *) {
...
bool short_test(){
  bool ans = FALSE;
  static __thread short* short_tls = &short_tmp;
  try {
    throw short_tls;
  }
  catch (short *) {
...
bool int_test(){
  bool ans = FALSE;
  static __thread int* int_tls = &int_tmp;
  try {
    throw int_tls;
  }
  catch (int *) {
...
bool long_test(){
  bool ans = FALSE;
  static __thread long* long_tls = &long_tmp;
  try {
    throw long_tls;
  }
  catch (long *) {
...
bool float_test(){
  bool ans = FALSE;
  static __thread float* float_tls = &float_tmp;
  try {
    throw float_tls;
  }
  catch (float *) {
...
bool double_test(){
  bool ans = FALSE;
  static __thread double* double_tls = &double_tmp;
  try {
    throw double_tls;
  }
  catch (double *) {
...
bool long_double_test(){
  bool ans = FALSE;
  static __thread long double* long_double_tls = &long_double_tmp;
  try {
...
bool struct_test(){
  bool ans = FALSE;
  static __thread struct ST* struct_st = &struct_st_tmp;
  try {
    throw struct_st;
  }
  catch (struct ST *) {
