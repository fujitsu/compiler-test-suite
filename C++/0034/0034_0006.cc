...
int main() {
  int i =
      (expd_v() + expf_v() + expl_v() + powd_vv() + powf_vv() + powl_vv() +
       powd_vc() + powf_vc() + powl_vc() + powd_cv() + powf_cv() + powl_cv());
