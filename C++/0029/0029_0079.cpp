...
class Array {
public:
  Array(int size_) : size(size_) { array = new (std::nothrow) float[size]; }

  Array(float value, int stride, int size_) : size(size_) {
    array = new (std::nothrow) float[size];
    set1d(value, stride);
  }
...
bool check(Array &arr) {
  if (fabs(arr[0] - 180.00000) >= 1.) {
    return false;
  }
  if (fabs(arr[1] - 0.307617188) >= 0.0005) {
    return false;
  }
  if (fabs(arr[2] - 0.008535287) >= 0.0005) {
    return false;
  }
  if (fabs(arr[3] - 0.000708103) >= 0.00005) {
    return false;
  }
  if (fabs(arr[4] - 0.000105431) >= 0.00005) {
    return false;
  }
  if (fabs(arr[5] - 0.000022575) >= 0.000005) {
    return false;
  }
  if (fabs(arr[6] - 0.000006190) >= 0.000005) {
    return false;
  }
  if (fabs(arr[7] - 0.000002031) >= 0.000005) {
    return false;
  }
...
int main() {
  ...
  Array a(any, frac, LEN), b(any, frac, LEN), c(one, frac, LEN),
      d(two, frac, LEN), e(half, frac, LEN);

  Array a1(LEN), b1(LEN), c1(LEN), d1(LEN), x(LEN);
