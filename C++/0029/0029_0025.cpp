...
public:
  ...
  bool check()
  {
    if (std::fabs(values_[0] - (-0.90906))  > 0.005)  { return false; }
    if (std::fabs(values_[1] - (-0.910578)) > 0.0005) { return false; }
    if (std::fabs(values_[2] - (-0.912255)) > 0.0005) { return false; }
    if (std::fabs(values_[3] - (-0.914098)) > 0.0005) { return false; }
    if (std::fabs(values_[4] - (-0.91611))  > 0.005)  { return false; }
